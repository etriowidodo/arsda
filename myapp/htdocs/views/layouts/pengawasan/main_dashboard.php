                            ...
                            <ul class="nav navbar-nav">
                                <?php if (!\Yii::$app->user->isGuest): ?>
                                    ...
                                    <li class="dropdown user user-menu">
                                        ...
                                        <button class="btn btn-info btn-sm" type="button" style="margin: 8px 5px 0 0;cursor: pointer;" onclick = 'js:document.location.href="<?php echo Yii::$app->getUrlManager()->createUrl('pengawasan/dugaan-pelanggaran') ?>"'><i class="fa fa-arrow-left" style="margin-right:5px;"></i>Kembali</button>

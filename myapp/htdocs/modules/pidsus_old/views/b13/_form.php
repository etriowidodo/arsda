							    ...
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
					                                ...
					                                <div class="form-group">
													  ...
													  <div class="col-md-6"><?= $form->field($model, 'perihal_lap')->textArea(array('maxlength' => 4000, 'rows' => 3, 'cols' => 50,'readonly' => 'True')) ?></div>
													</div>   													
					                                <div class="form-group">
					                                ...
					                                <div class="form-group">
					                                    <label for="kepada" class="control-label col-md-3">Kepada Yth Ketua Pengadilan Negeri </label>
											...
											<div>
												...
												<?=str_replace('$noPdsDik',$modelDik->no_spdp,str_replace('$tglPdsDik',$tglLap->format('d-M-Y'),$viewFormFunction->returnDetailFullDik3($form,$modelSuratDetail,$this,'b13')))?>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'b13']) ?>
								      	</div>	
							        </div>

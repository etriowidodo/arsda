           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                ...
							                <div class="box box-solid">
							                    <div class="box-header with-border">
									                <span class="pull-right"><a class="btn btn-primary" id="popUpJpu"><i class="glyphicon glyphicon-user"></i> Tambah JPU</a><a class="btn btn-danger" id="hapusJpu"><i class="glyphicon glyphicon-user"></i> Hapus JPU</a></span>
									                <h3 class="box-title">
									                    Jaksa
									                </h3>
									            </div>
...
$script1 = <<< JS
	$('#popUpJpu').click(function(){
		$('#m_jpu').html('');
        $('#m_jpu').load('/pidsus/p16/jpu');
        $('#m_jpu').modal('show');
	});
	$('#hapusJpu').click(function(){

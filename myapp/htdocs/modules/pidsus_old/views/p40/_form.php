           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
												...
												<div class="form-group">
													...
													<div class="form-group">
														<label for="lampiran" class="control-label col-md-3">Melalui </label>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p40']) ?>
								      	</div>	
							        </div>

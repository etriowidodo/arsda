							    ...
							    <div>
							        <div><div class="box-body">
											...
											<div>
												...
												<?=$viewFormFunction->returnDetailFullDik3($form,$modelSuratDetail,$this,'b7')?>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'b7']) ?>
								      	</div>	
							        </div>

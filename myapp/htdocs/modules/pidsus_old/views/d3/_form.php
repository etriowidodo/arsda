           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
													<div class="form-group">
														<label for="lokasiSurat" class="control-label col-md-3">Tempat dan Tanggal Tanda Terima</label>
											...
											<div>
							                    ...
							                    <div class="box box-solid">
													...
													<?= $viewFormFunction->returnSelect2($sqlPenandatangan,$form,$model,'id_ttd','Yang Menerima Pembayaran','peg_nik','peg_nama','Pilih Penerima Pembayaran ...','penandatangan','full')?>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/d3'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'d3']) ?>
								      	</div>	
							        </div>

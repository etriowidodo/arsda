...
$sqlTersangka="select * from pidsus.get_list_tersangka_tut_ddl('".$_SESSION["idPdsTutSurat"]."')";
$sqlKasusPosisi="select distinct id_jenis_surat from pidsus.jenis_surat";
require('..\modules\pidsus\controllers\viewFormFunction.php');
$viewFormFunction=new viewFormFunction();
?>

<div class="pds-tut-matrix-perkara-form">
	...
	<div class="box-body">
		...
		<div class="form-group">
			<label for="id_tut_tersangka" class="control-label col-md-3">Nama Tersangka </label>
			<div class="col-md-6"><?= $viewFormFunction->returnSelect2($sqlTersangka,$form,$model,'id_tut_tersangka','Nama Tersangka','id_pds_tut_tersangka','nama_tersangka','Pilih Tersangka ...','id_tut_tersangka')?></div>
		</div>  
		<div class="form-group">
...
<div class="box-footer">   	
	        	...
	        	<div class="col-md-1">		   		
		          	<?=Html::a('Batal',$model->isNewRecord ? ['index'] : ['../pidsus/p7tut'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','id' => 'btnCancel']) ?>
    			 </div>

...
$(document).ready(function() {
    ...
    $('#penyitaan-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'showpenyitaan', // the url where we want to POST
		  ...
		  dataType:'json'
            ...
            .done(function(data) {
                ...
                $('#tbody_sita').append(
                        '<tr id="tr_id_sita'+data['id_pds_dik_surat_penyitaan']+'" ondblclick="editPenyitaan(\''+data['id_pds_dik_surat_penyitaan']+'\')">'+
                            '<td>' +
                                $('#pdsdiksuratpenyitaan-no_urut').val()+
                                '</td>' +
                                '<td>' +
                                $('#pdsdiksuratpenyitaan-nama_jabatan').val()+
                                '</td>' +
                            '<td>' +
                            ...
                            '<td>' +
                                ...
                                '</td>' +
                            '<td><input type="checkbox" name="hapusPenyitaanCheck" value="'+data['id_pds_dik_surat_penyitaan']+'" ></td>' +
                        '</tr>'

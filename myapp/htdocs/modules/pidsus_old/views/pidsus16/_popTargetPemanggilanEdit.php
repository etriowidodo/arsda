...
$(document).ready(function() {
    ...
    $('#targetpemanggilan-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'edittargetpemanggilan?id=<?php echo $modelPemanggilan->id_pds_dik_surat_target_pemanggilan?>', // the url where we want to POST
    ...
    $("#tr_id_panggil<?php echo $modelPemanggilan->id_pds_dik_surat_target_pemanggilan?>").remove();
    ...
    $('#tbody_tp').prepend(
            '<tr id="tr_id_panggil<?php echo $modelPemanggilan->id_pds_dik_surat_target_pemanggilan?>" ondblclick="editTargetPemanggilan(\'<?php echo $modelPemanggilan->id_pds_dik_surat_target_pemanggilan?>\')">'+
                '<td>' +
                ...
                '<td>' +
                    ...
                    '</td>' +
                '<td><input type="checkbox" name="hapusTargetPemanggilanCheck" value="<?php echo $modelPemanggilan->id_pds_dik_surat_target_pemanggilan?>" ></td>' +
            '</tr>'

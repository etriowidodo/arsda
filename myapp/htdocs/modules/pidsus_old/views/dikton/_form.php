							    ...
							    <div>
							        <div><div class="box-body">
							                <div>
												...
												<?= $viewFormFunction->returnSelect2($sqlPenerimaSurat,$form,$model,'kepada','Kepada YTH','id_penerima_lap','nama_penerima_lap','Pilih Kepada ...','penerima_surat','full')?>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?=Html::a('Cetak', ['../pidsus/default/viewreport','id'=>$model->id_pds_dik_surat], ['data-pjax'=>0, 'class' => 'btn btn-success', 'title'=>'cancel']) ?>
								      	</div>	
							        </div>

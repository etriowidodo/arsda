...
$sqlPenerimaSurat="select nama_detail as kepada, no_urut as ORDERNO from pidsus.parameter_detail where id_header =45";
           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
					                                ...
					                                <div class="form-group">
					                                    <label for="nomor_surat" class="control-label col-md-3">Kepada </label>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'b16']) ?>
								      	</div>	
							        </div>

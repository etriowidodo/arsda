           ...
           <div>
							    <div>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/tut/viewlaporan?id='.$model->id_pds_tut], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','target'=>'_blank']) ?>
						    			 </div>						    			 
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p18','target'=>'_blank']) ?>

...
<h1><?= Html::encode('Usul untuk pemanggilan Saksi') ?></h1>
	<?php
   ...
   <p>
	<span class="pull-right"><?= Html::a('<i class="fa fa-plus"> </i> Tambah ', ['create','idStatus'=>432], ['class' => 'btn btn-success']) ?>
...
<h1><?= Html::encode('Usul untuk pemanggilan Ahli') ?></h1>
   <p>
	<span class="pull-right"><?= Html::a('<i class="fa fa-plus"> </i> Tambah ', ['create','idStatus'=>433], ['class' => 'btn btn-success']) ?>
    
    <button id="btnHapusBatcha" class="btn btn-danger" type="button"><i class="fa fa-times"></i> Hapus</button>
    </span>
  </br>
  </br>
  </p>
...
<h1><?= Html::encode('Usul untuk pemanggilan Tersangka') ?></h1>
    <p>
	<span class="pull-right"><?= Html::a('<i class="fa fa-plus"> </i> Tambah ', ['create','idStatus'=>431], ['class' => 'btn btn-success']) ?>
    
    <button id="btnHapusBatchs" class="btn btn-danger" type="button"><i class="fa fa-times"></i> Hapus</button>
    </span>
  </br>
  </br>
  </p>

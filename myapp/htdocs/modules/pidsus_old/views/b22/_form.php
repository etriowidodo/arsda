           ...
           <div>
							    <div>
							                ...
							                <div>
							                    <div>
					                                ...
					                                <div class="form-group">
													  ...
													  <div class="col-md-6"><?= $form->field($model, 'perihal_lap')->textArea(array('maxlength' => 4000, 'rows' => 3, 'cols' => 50,'readonly' => false)) ?></div>
													</div>
					                                <div class="form-group">
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'b22']) ?>
								      	</div>	
							        </div>

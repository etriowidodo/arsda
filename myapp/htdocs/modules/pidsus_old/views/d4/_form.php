           ...
           <div>
							    <div>
							                ...
							                <div>
							                    <div>
													<div class="form-group">
														<label for="nomor_surat" class="control-label col-md-3">Nomor Surat Perintah </label>
														<div class="col-md-6"><?= $form->field($model, 'no_surat')->textInput(['readonly' => $readOnly]) ?></div>
													</div>
													<div class="form-group">

														<label for="lokasiSurat" class="control-label col-md-3">Dikeluarkan Di</label>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/d4'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'d4']) ?>
								      	</div>	
							        </div>

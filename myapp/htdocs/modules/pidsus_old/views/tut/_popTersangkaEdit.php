...
$(document).ready(function() {
    ...
    $('#tersangka-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'edit-tersangka?id=<?php echo $modelTersangka->id_pds_tut_tersangka?>', // the url where we want to POST
        ...
        $("#tr_id<?php echo $modelTersangka->id_pds_tut_tersangka?>").remove();
    	$('#tbody_tersangka').prepend(
                '<tr id="tr_id<?php echo $modelTersangka->id_pds_tut_tersangka?>">'+
                    '<td>' +
                    ...
                    '</td>'+    
                    '<td><span class="glyphicon glyphicon-pencil" onclick="editTersangka(\'<?php echo $modelTersangka->id_pds_tut_tersangka?>\')"></span><a class="btn btn-danger btn-sm glyphicon glyphicon-remove hapus" onclick="hapusTersangka(\'<?php echo $modelTersangka->id_pds_tut_tersangka?>\')"></a></td>' +
                '</tr>'

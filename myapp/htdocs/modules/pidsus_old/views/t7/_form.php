...
$sqlPenandatangan="select * from pidsus.get_penandatangan	('".$idSatker."','t7') order by id_penandatangan";
           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
												...
												<div class="form-group">
													...
													<div class="form-group">
														<label for="lokasiSurat" class="control-label col-md-3">Tanggal & Tempat Dikeluarkan</label>
														<div class="col-md-3"><?=
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/t7'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'t7']) ?>
								      	</div>	
							        </div>

...
$sqlListJaksa="select * from pidsus.get_jaksa_satker('".$idSatker."') order by peg_nama";
							        ...
							        <div><div class="box-body">
							                <div>
							                    <div>
													...
													<div class="form-group">
					                                    <label for="lokasiSurat" class="control-label col-md-3">Ditetapkan di</label>
											...
											<?=str_replace('$noPdsDik',$modelDik->no_spdp,str_replace('$tglPdsDik',$tglLap->format('d-M-Y'),$viewFormFunction->returnDetailFullDik3 ($form,$modelSuratDetail,$this,'b14')))?>
								        ...
								        <div class="col-md-1">
											<?=Html::a('Batal', ['../pidsus/b14'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','id'=>'btnCancel']) ?>
						    			 </div>						    			 
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'b1']) ?>
								      	</div>	
							        </div>

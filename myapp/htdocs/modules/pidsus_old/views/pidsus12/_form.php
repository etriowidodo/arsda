...
$sqlPenerimaSurat="SELECT 'JAKSA AGUNG REPUBLIK INDONESIA' AS kepada, 1 AS ORDERNO  UNION SELECT 'DIREKTUR PENUNTUTAN',2 UNION SELECT 'KAJATI',3 UNION SELECT 'KAJARI',4 UNION SELECT 'KACABJARI',5 ORDER BY ORDERNO ";
           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
							                    	<?= $viewFormFunction->returnSelect2($sqlPenerimaSurat,$form,$model,'kepada','Kepada Yth.','kepada','kepada','Pilih penerima ...','penandatangan','full')?>	
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus12']) ?>
								      	</div>	
							        </div>

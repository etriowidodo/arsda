...
if($model->id_jenis_surat=='pidsus3blid'){
 //	$urlback='../pidsus/pidsus3a/indexblid';
	$urlback='../pidsus/default/viewlaporan?id='.$model->id_pds_lid;
}
else if ($model->id_jenis_surat=='pidsus3blit'){
	//$urlback='../pidsus/pidsus3a/indexblit';
	$urlback='../pidsus/default/viewlaporan?id='.$model->id_pds_lid;
}
else {
	$urlback='../pidsus/default/viewlaporan?id='.$model->id_pds_lid;
							    ...
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
					                                ...
					                                <div class="form-group">
					                                    ...
					                                    <div class="col-md-3"><?= $viewFormFunction->returnSelectDisable($sqlLokasi,$form,$model,'lokasi_surat','Lokasi Penerima Laporan','inst_lokinst','inst_lokinst','Pilih Lokasi ...','lokasi_penerima')?></div>
					                               		<div class="col-md-3"><?=
											...
											<div>
					                            ...
					                            <?=$viewFormFunction->returnSuratIsi ($this, $form,$modelSuratIsi,$readOnly)?>        		
					                            </div>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', [$urlback], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','id' => 'btnCancel']) ?>
						    			 </div>
										 ...
										 <div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus3']) ?>
								      	</div>	
							        </div>

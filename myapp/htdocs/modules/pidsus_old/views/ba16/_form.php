...
$sqlPenandatangan="select peg_nik id_penandatangan, peg_nama nama_penandatangan from pidsus.get_jaksa_all_dik	('".$model->id_pds_dik_surat."') order by id_penandatangan";
	 ...
	 [
		...
		<div>
										...
										<div class="box-body">
											<div>
							                    ...
							                    <div class="box box-solid">
													...
													<?=str_replace('$noPdsDik',$modelDik->no_spdp,str_replace('$tglPdsDik',$tglLap->format('d-M-Y'),$viewFormFunction->returnDetailFullDik3 ($form,$modelSuratDetail,$this,$typeSurat)))?>
													<?= $viewFormFunction->returnSelect2($sqlPenandatangan,$form,$model,'id_ttd','Yang melakukan penggeledahan/penyitaan','id_penandatangan','nama_penandatangan','Pilih penggeledah/penyita ...','penandatangan','full')?>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">
								          	<?=Html::a('Batal', ['../pidsus/ba14'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','id' => 'btnCancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'ba16']) ?>
								      	</div>	
							        </div>

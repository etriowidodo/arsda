...
$sqlPerihal="select nama_detail from pidsus.parameter_detail where id_header=130 order by no_urut";
							        ...
							        <div><div class="box-body">
							                <div>
							                    ...
							                    <div class="form-group">
					                                ...
					                                <?= $viewFormFunction->returnSelect2($sqlPerihal,$form,$model,'perihal_lap','Perihal','nama_detail','nama_detail','Pilih Perihal Surat ...','perihal_lap','full')?>		
												...
												<?=str_replace('$noPdsDik',$modelDik->no_spdp,str_replace('$tglPdsDik',$tglLap->format('d-M-Y'),$viewFormFunction->returnDetailFullDik3 ($form,$modelSuratDetail,$this,'b12')))?>

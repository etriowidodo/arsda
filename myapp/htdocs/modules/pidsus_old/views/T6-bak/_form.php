							    ...
							    <div>
							        <div><div class="box-body">
											...
											<div>
					                            ...
					                            <?=$viewFormFunction->returnSuratIsi ($form,$modelSuratIsi)?>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/default/t6'.$model->id_pds_dik], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'t6']) ?>
								      	</div>	
							        </div>

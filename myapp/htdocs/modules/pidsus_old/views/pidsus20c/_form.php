...
$sqlPerihalSurat="select id_detail, nama_detail from pidsus.parameter_detail where id_header=53 order by no_urut";
?>
           ...
           <div>
							    <div>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus20c']) ?>
								      	</div>	
							        </div>

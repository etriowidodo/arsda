           ...
           <div>
							    <div>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/p42'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'p42']) ?>
								      	</div>	
							        </div>

		  ...
		  dataType:'json'
            ...
            .done(function(data) {
                ...
                $('#tbody_tersangka').append(
                        '<tr id="tr_id'+data['id_pds_dik_tersangka']+'" ondblclick="editTersangka(\''+data['id_pds_dik_tersangka']+'\')">'+
                            '<td>' +
                            ...
                            '</td>'+    
                            '<td><input type="checkbox" name="hapusTersangkaCheck" value="'+data['id_pds_dik_tersangka']+'"</input></td>'+
                            '</tr>'

    ...
    <div class="modal-body">
        ...
        <div class="form-group" style="margin-left: 0px;">
        	<div class="col-md-1">
										...
										<div class="col-md-1"><a class="btn btn-danger" id="tambah_tersangka" onclick="$('#m_tersangka').modal('hide');">Batal</a></div>
        </div>
    </div>
</div>
<?php
...
$(document).ready(function() {
    ...
    $('#tersangka-form').submit(function(event) {
    	...
    	$('#tbody_tersangka').prepend(
                '<tr id="tr_id<?php echo $modelTersangka->id_pds_dik_tersangka?>" ondblclick="editTersangka(\'<?php echo $modelTersangka->id_pds_dik_tersangka?>\')">'+
                    '<td>' +
                    ...
                    '</td>'+    
                    '<td><input type="checkbox" name="hapusTersangkaCheck" value="<?php echo $modelTersangka->id_pds_dik_tersangka?>"</input></td>'+
                    '</tr>'

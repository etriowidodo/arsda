           ...
           <div>
							        ...
							        <div><div class="box-body">
							                <div>
												...
												<div class="form-group">
													...
													<div class="col-md-6"> Koordinator-Tim Penyelidik</div>
												</div>
							                    <div class="form-group">
														...
														<div class="col-md-3"><?=
					                                             $form->field($model, 'tgl_surat')->widget(DateControl::classname(), [
					                                                ...
					                                                'options' => [
					                                                    'pluginOptions' => [
					                                                        'autoclose' => true, 'startDate' => $_SESSION['startDatePidsus4'], 'endDate' => $_SESSION['todayDate'],
                                ...
                                <td><input type='checkbox' name='hapusPermintaanDataCheck' value='".$value['id_pds_lid_usulan_permintaan_data']."' ></td>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus4']) ?>
								      	</div>	
							        </div>
					             </div></div></br>      
							            </div>
...
$script = <<< JS
        $('#tambah_permintaan_data').click(function(){
			var tglSurat=$('#pdslidsuratforpidsus4-tgl_surat').val();
            $('#m_permintaan_data').html('');
            $('#m_permintaan_data').load('/pidsus/pidsus4/showpermintaandata?tgl='+tglSurat);

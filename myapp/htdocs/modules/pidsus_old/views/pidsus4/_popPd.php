...
$(document).ready(function() {
    ...
    $('#permintaan_data-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'pidsus4/showpermintaandata', // the url where we want to POST
		  ...
		  dataType:'json'
            ...
            .done(function(data) {
                ...
                $('#tbody_pd').append(
                        '<tr id="tr_id'+data['id_pds_lid_usulan_permintaan_data']+'" ondblclick="editPermintaanData(\''+data['id_pds_lid_usulan_permintaan_data']+'\')">'+
                            '<td>' +

...
if (Yii::$app->controller->action->id === 'login') {
    ...
    <html>
        <head>
			...
			<script type="text/javascript" src="/js/pidsus.js"></script>
         ...
         echo \kartik\widgets\SideNav::widget(
                ...
                <div class="content-wrapper">
                    ...
                    <section class="content-header">
                        <h1 style="margin-left:15px;"><div><table class="col-md-9"><tr><td><?= $this->title ?><small><?= $this->subtitle ?></small></td><td style="text-align: right;color: #777; font-size: 12px; font-weight: bold;"><?= $this->params['idtitle']?></td></tr></table></div>
                        </h1>
                        <ol class="breadcrumb" style="color: #777;">
                            <?= $this->params['idtitle']
                            ?>
                        </ol>
                    </section>

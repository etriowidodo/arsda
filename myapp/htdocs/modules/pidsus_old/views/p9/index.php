...
<h1><?= Html::encode('Surat Panggilan Saksi') ?></h1>
	<?php
   ...
   <div id="btnUpdate"></div>
    <?php \kartik\widgets\ActiveForm::end() ?>
     <p>
	<span class="pull-right"><?= Html::a('<i class="fa fa-plus"> </i> Tambah ', ['create','idJenisSurat'=>'p9sks'], ['class' => 'btn btn-success']) ?>
...
<h1><?= Html::encode('Surat Panggilan Tersangka') ?></h1>
     <p>
	<span class="pull-right"><?= Html::a('<i class="fa fa-plus"> </i> Tambah ', ['create','idJenisSurat'=>'p9tsk'], ['class' => 'btn btn-success']) ?>

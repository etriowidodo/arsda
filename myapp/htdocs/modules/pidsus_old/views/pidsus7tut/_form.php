					               ...
					               <?php 
									...
									?>
					                        ...
					                        <div>
												...
												<?=str_replace('$noPdsDik',$modelDik->no_spdp,str_replace('$tglPdsDik',$tglLap->format('d-M-Y'),$viewFormFunction->returnDetailFullDik3 ($form,$modelSuratDetail,$this,'pidsus7')))?>
					                            </div>
					                        </div>
						        	...
						        	<div>
						    			...
						    			<div class="col-md-1"><input type="hidden" id="hdnIdPdsDikSurat" value="<?= $model->id_pds_dik_surat ?>"/><a class="btn btn-danger" id="hapus-surat-tut"> Hapus</a></div>  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus7']) ?>
								      	</div>	
							        </div>
					             </div></div></br>      
							            </div>

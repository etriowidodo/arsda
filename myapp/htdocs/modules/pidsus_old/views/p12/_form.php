           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
					                               ...
					                               <div class="form-group">
															<label for="id_jenis_surat" class="control-label col-md-3">Sifat Surat</label>
															<div class="col-md-6"><label>Rahasia</label></div>
														</div>
					                                <div class="form-group">
					                                ...
					                                <div class="form-group">
													  ...
													  <div class="col-md-6"><label>Laporan Perkembangan Penyidikan</label></div>
													</div>   													
					                                <div class="form-group">
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p12']) ?>
								      	</div>	
							        </div>

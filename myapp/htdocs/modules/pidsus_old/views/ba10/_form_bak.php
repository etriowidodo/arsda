           ...
           <div>
							    <div>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">
								          	<?=Html::a('Batal', ['../pidsus/ba10'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel','id' => 'btnCancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'data' => ['confirm' => 'Apakah anda yakin ingin menyimpan lalu Cetak?'], 'value'=>'ba10']) ?>
								      	</div>	
							        </div>

							    ...
							    <div>
						        	...
						        	<div>
							        	...
							        	<div class="col-md-5">
											...
											<?php if($modelTut->is_tut == false){?>

												<div class="form-group">
													<label for="isSend" class="control-label col-md-3">Kirim Ke Penuntutan</label>
													<div class="col-md-6"><?= $form->field($modelTut, 'is_tut')->checkbox(array('label'=>'')); ?>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p21']) ?>
								      	</div>	
							        </div>

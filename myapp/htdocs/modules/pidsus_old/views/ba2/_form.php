           ...
           <div>
							    <div>
							        <div><div class="box-body">
											...
											<div class="box-body">
							                    ...
							                    <div class="box box-solid">
													...
													<?= $viewFormFunction->returnSelect2($sqlSaksi,$form,$modelSuratSaksi,'id_saksi','Nama Saksi','id_pds_dik_saksi','nama_saksi','Pilih saksi ...','nama_saksi','full')?>
					                        <div class="form-group">
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'ba2']) ?>
								      	</div>	
							        </div>
...
$script = <<< JS
        $('#btnEditSaksi').click(function(){
            ...
            $('#m_saksi').html('');
            $('#m_saksi').load('/pidsus/ba2/editsaksi?id='+idUPD);
            $('#m_saksi').modal('show');
        });

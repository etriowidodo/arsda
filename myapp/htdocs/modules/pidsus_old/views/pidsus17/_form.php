							    ...
							    <div>
							        <div><div class="box-body">
							                <div>
												...
												<div class="form-group">
															<label for="penerimaSurat" class="control-label col-md-3">Kepada Yth Ketua Pengadilan Negeri</label>
															<div class="col-md-6"><?= $form->field($model, 'kepada')->textInput(['readonly' => $readOnly]) ?></div>
													</div>
												  
					                             <?= $viewFormFunction->returnSelectDisable($sqlLokasi,$form,$model,'kepada_lokasi','Di','inst_lokinst','inst_lokinst','Pilih Lokasi ...','lokasiPenerima','full')?>	
						        	...
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'pidsus17']) ?>
								      	</div>	
							        </div>

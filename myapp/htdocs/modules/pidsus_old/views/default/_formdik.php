...
<div class="pds-dik-form">
	...
	<div><div class="box-body">
		...
		<div>
													...
													<div class="col-md-6"><?=
														$form->field($model, 'tgl_spdp')->widget(DateControl::classname(), [
															...
															'options' => [
																'pluginOptions' => [
																	'autoclose' => true,
																	'mask' => 'Pilih Tanggal...','startDate' => $_SESSION['globalStartDate'],
												...
												<div class="form-group">
													 ...
													 <div class="form-group">
														  ...
														  <div class="col-md-6"><?= $form->field($model, 'dugaan_pelaku')->textArea(array('maxlength' => 4000, 'rows' => 2, 'cols' => 50,'readonly' => false)) ?></div>
													</div> 
        ...
        <div class="box-footer">   	
			...
			<div class="col-md-1">
				<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p6']) ?>

...
$sqlJaksa="select * from pidsus.get_jaksa_lid('".$idSatker."')";
           ...
           <div>
							    <div>
									...
									<div class="box box-solid">
			                                    ...
			                                    <tbody id="tbody_jpu">
			                                            <?php foreach ($modelJaksa as $value): ?>
			                                                <tr id="trjpu<?=  $value->id_jaksa ?>">
			                                                    <td><input type="hidden" name="nip_jpu_update[]" class="form-control" readonly="true" value="<?= $value->id_jaksa ?>">
			                                                    <input type="text" name="nip_jpu_update[]" class="form-control" readonly="true" value="<?= $value->pegawai->peg_nip_baru ?>"></td>
					                        ...
					                        <?=str_replace('$noPdsLid',$modelLid->no_lap,str_replace('$tglPdsLid',$tglLap->format('d F Y'),$viewFormFunction->returnDetailFull ($form,$modelSuratDetail,$this,'p2')))?>        
					                        <!-- <div>
							                    <div>
					               ...
					               <div class="box box-solid">
						        	<div>
							        	...
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'id'=>'btnCetak', 'value'=>'p2']) ?>
								      	</div>	
							        </div>
					               </div>              		
					                        </div></div></br>      

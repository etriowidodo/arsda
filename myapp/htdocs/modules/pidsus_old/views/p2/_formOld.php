           ...
           <div>
							    <div>
							        <div><div class="box-body">
											...
											<div>
							                    <div>
					                            <?=$viewFormFunction->returnDetail ($form,$modelSuratDetailDasar)?>  
					                            </div>
					                        </div>           		
					                        </div></div></br>
					                        <div class="box box-solid">
											...
											<div>
							                    <div>
					                            <?=$viewFormFunction->returnDetail ($form,$modelSuratDetailPertimbangan)?>        		
					                            </div>
					                            <div id="new_pertimbangan"></div>
					                            <a id="tambah-pertimbangan" class="btn btn-success">tambah pertimbangan</a>
					                        </div>           		
					                        </div></div></br> </br><div class="box box-solid">
							                    <div class="box-header with-border">
							                        
							                        <h3 class="box-title">Untuk:</h3>
							                    </div><!-- /.box-header -->
							                    <div class="box-body">   		 
											<div>
							                    <div>
					                            <?=$viewFormFunction->returnDetail ($form,$modelSuratDetailUntuk)?>        		
					                            </div>
					                        </div>           		
					                        </div></div></br>
					                        <div>
					               ...
					               <?= $viewFormFunction->returnDetailFull ($form, $modelSuratDetail, $this) ?>
					               <div class="box box-solid">
						        	<div>
							        	<div class="col-md-8">

           ...
           <div>
							    <div>
							        <div><div class="box-body">
							                <div>
							                    <div>
													<div class="form-group">
														<label for="lokasiSurat" class="control-label col-md-3">Tanggal Surat Pernyataan</label>
														<div class="col-md-6"><?=
											...
											<div>
							                    ...
							                    <div class="box box-solid">
													...
													<?= $viewFormFunction->returnSelect2($sqlPenandatangan,$form,$model,'id_ttd','Yang Menerima Pernyataan','peg_nik','peg_nama','Pilih Penerima Pernyataan ...','penandatangan','full')?>
						        	...
						        	<div>
								        ...
								        <div class="col-md-1">	        		
								          	<?=Html::a('Batal', ['../pidsus/d2'], ['data-pjax'=>0, 'class' => 'btn btn-danger', 'title'=>'cancel']) ?>
						    			 </div>						    			 
						    			  		      		     	
							        	<div class="col-md-1">
								      			<?= Html::submitButton('Cetak', ['data-pjax'=>0, 'class' => 'btn btn-success', 'name'=>'btnCetak', 'value'=>'d2']) ?>
								      	</div>	
							        </div>

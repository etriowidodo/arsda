 ...
 */
class PdsDikSuratforP8A extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik', 'id_jenis_surat','no_urut','kasus_posisi','pasal_disangkakan','alat_bukti','tindakan_hukum','waktu_tempat','koor_dan_dal','keterangan'], 'required'],

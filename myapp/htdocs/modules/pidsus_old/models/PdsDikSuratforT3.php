 ...
 */
class PdsDikSuratforT3 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik', 'id_jenis_surat','no_surat','sifat_surat','lampiran_surat','lokasi_surat','tgl_surat','kepada','kepada_lokasi','id_ttd'], 'required'],

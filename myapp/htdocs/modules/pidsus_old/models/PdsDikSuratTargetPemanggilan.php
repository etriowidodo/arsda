...
/**
 * This is the model class for table "pidsus.pds_dik_surat_target_pemanggilan".
 *
 * @property string $id_pds_dik_surat_target_pemanggilan
 ...
 */
class PdsDikSuratTargetPemanggilan extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pidsus.pds_dik_surat_target_pemanggilan';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_pds_dik_surat_target_pemanggilan', 'id_pds_dik_surat'], 'string', 'max' => 25],
            [['flag'], 'string', 'max' => 1],
            [['nama_jabatan'], 'string', 'max' => 100],
            [['tempat_lokasi'], 'string', 'max' => 500],

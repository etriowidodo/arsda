 ...
 */
class PdsTutSuratforP24 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_tut', 'id_jenis_surat','no_surat','sifat_surat','lampiran_surat','lokasi_surat','tgl_surat','id_ttd'], 'required'],

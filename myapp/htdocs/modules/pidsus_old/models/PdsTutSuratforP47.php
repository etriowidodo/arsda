 ...
 */
class PdsTutSuratforP47 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_tut', 'id_jenis_surat','lokasi_surat','tgl_surat','kepada','kepada_melalui','kepada_lokasi','id_ttd'], 'required'],

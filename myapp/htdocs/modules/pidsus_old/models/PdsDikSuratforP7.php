 ...
 */
class PdsDikSuratforP7 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik', 'id_jenis_surat','no_urut','id_dik_tersangka','kasus_posisi','pasal_disangkakan','uraian_fakta','alat_bukti','barang_bukti','keterangan'], 'required'],

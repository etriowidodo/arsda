 ...
 */
class KpPegawaiSearch2 extends KpPegawai
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['peg_nik', 'peg_nip', 'peg_nrp', 'peg_nama', 'peg_gelar', 'peg_tmplahirkab', 'peg_tgllahir', 'peg_jender', 'peg_agama', 'peg_status', 'peg_instakhir', 'peg_instakhir_tmt', 'peg_jbtakhirstk_es', 'peg_golakhir', 'peg_nip_baru'], 'safe'],
    ...
    public function searchBySatker($params,$idSatker)
    {
        ...
        else  $query = KpPegawai::find()->where(['peg_instakhir'=>$idSatker]) ;
        //$query = KpPegawai::find();

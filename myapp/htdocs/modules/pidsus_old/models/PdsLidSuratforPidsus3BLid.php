 ...
 */
class PdsLidSuratforPidsus3BLid extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
           [['id_pds_lid', 'id_jenis_surat','no_surat','sifat_surat','lampiran_surat','perihal_lap','lokasi_surat','tgl_surat','kepada','kepada_lokasi','id_ttd'], 'required'],

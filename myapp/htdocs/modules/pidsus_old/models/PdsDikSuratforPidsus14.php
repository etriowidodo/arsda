 ...
 */
class PdsDikSuratforPidsus14 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik', 'id_jenis_surat','lampiran_surat','perihal_lap','lokasi_surat','tgl_surat','kepada','kepada_lokasi','id_ttd'], 'required'],

 ...
 */
class PdsLidSuratforPidsus8 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_lid', 'id_jenis_surat','lokasi_surat','tgl_surat'], 'required'],
    ...
    public function getSuratsaksi()
    {
    	return $this->hasOne(PdsLidSaksi::className(), ['id_pds_lid_surat' => 'id_pds_lid_surat']);
    }
}

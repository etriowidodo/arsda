 ...
 */
class PdsDikRendikforP8A extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik_surat','no_urut','kasus_posisi','pasal_disangkakan','alat_bukti','tindakan_hukum','waktu_tempat','koor_dan_dal','keterangan'], 'required'],
            [['no_urut'], 'integer'],

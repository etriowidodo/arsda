 ...
 */
class PdsDikSuratforPidsus12 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_dik', 'id_jenis_surat','no_surat','lampiran_surat','perihal_lap','tgl_surat','kepada','id_ttd'], 'required'],

 ...
 */
class PdsLidSurat extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_lid', 'id_jenis_surat'], 'required'],
    ...
    {
    	return $this->hasOne(PdsLidSuratSaksi::className(), ['id_pds_lid_surat' => 'id_pds_lid_surat']);
    }
}

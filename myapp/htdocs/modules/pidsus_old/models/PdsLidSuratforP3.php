 ...
 */
class PdsLidSuratforP3 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_lid', 'id_jenis_surat','laporan','kasus_posisi','dugaan_pasal','alat_bukti','sumber','pelaksana','tindakan_hukum','waktu_tempat','koor_dan_dal','keterangan'], 'required'],

 ...
 */
class PdsLidSuratforP2 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_pds_lid', 'id_jenis_surat','tgl_surat','no_surat','lokasi_surat'], 'required'],
            [['tgl_surat', 'create_date', 'update_date', 'jam_surat'], 'safe'],

            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?= $viewFormFunction->returnSelect2ParameterDetail($form,$modelTersangka,'jenis_id','Jenis Identitas',36,'')?>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#tersangka-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url         : 'edit-tersangka?id=<?php echo $modelTersangka->id_pds_dik_tersangka?>', // the url where we want to POST
        ...
        $("#tr_id<?php echo $modelTersangka->id_pds_dik_tersangka?>").remove();
    	$('#tbody_tersangka').prepend(
                '<tr id="tr_id<?php echo $modelTersangka->id_pds_dik_tersangka?>">'+
                    '<td>' +
                        $('#pdsdiktersangka-nama_tersangka').val()+
                        '</td>' +
     				'<td>'+
     				$('#pdsdiktersangka-nomor_id').val()+
                    '</td>'+    
                    '<td><span class="glyphicon glyphicon-pencil" onclick="editTersangka(\'<?php echo $modelTersangka->id_pds_dik_tersangka?>\')"></span><a class="btn btn-danger btn-sm glyphicon glyphicon-remove hapus" onclick="hapusTersangka(\'<?php echo $modelTersangka->id_pds_dik_tersangka?>\')"></a></td>' +
                '</tr>'

...
use app\modules\pidsus\models\PdsTutSuratforP21A;
 ...
 */
class P21aController extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsTut,'p21a');
    ...
    {
        if (($model = PdsTutSuratforP21A::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
			$model->perihal_lap='Pemberitahuan susulan hasil penyidikan perkara atas nama tersangka.......... sudah lengkap';
			$model->save();

...
use app\modules\pidsus\models\PdsDikSuratforB1;
...
{
	public $idJenisSurat='b1';
	public $perihalSurat='Permintaan Izin Penggeledahan/Penyitaan';
	public $title='B1 - Surat Permintaan Izin Penggeledahan/Penyitaan';
	...
	public function actionUpdate($id)
	{
		...
		if ($model->load(Yii::$app->request->post()) ) {
			...
			//	return $this->redirect(['../pidsus/default/viewlaporandik','id'=>$idPdsDik]);
				return $this->redirect(['../pidsus/b1']);
			}
			else {
...
*/
   ...
   */
	...
	{
		if (($model = PdsDikSuratforB1::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
			return $model;
		} else {

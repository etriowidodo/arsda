...
use app\modules\pidsus\models\PdsTutSuratforP51;
 ...
 */
class P51Controller extends Controller
{
    public $idJenisSurat='p51';
    public $perihalSurat='Pemberitahuan Pemidanaan Bersyarat';
    public $title='P51 - Pemberitahuan Pemidanaan Bersyarat';
   ...
   //     $modelJaksa=KpPegawai::findBySql("select * from pidsus.get_jaksa_p8tut('".$model->id_pds_tut_surat."')")->all();
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p51']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP51::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

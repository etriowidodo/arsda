...
use app\modules\pidsus\models\PdsDikSuratforBA17;
 ...
 */
class Ba17Controller extends Controller
{
    public $idJenisSurat='ba17';
    public $perihalSurat='BA Penitipan Barang Bukti';
    public $title='BA 17 -  BA Penitipan Barang Bukti';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba17']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA17::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

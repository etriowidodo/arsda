...
use app\modules\pidsus\models\PdsDikSuratforPidsus33B;
 ...
 */
class Pidsus33bController extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus33b');
    ...
    {
        if (($model = PdsDikSuratforPidsus33B::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

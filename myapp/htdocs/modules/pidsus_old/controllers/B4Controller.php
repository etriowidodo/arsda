...
use app\modules\pidsus\models\PdsDikSuratforB4;
...
{
    public $idJenisSurat='b4';
    public $perihalSurat='Surat Perintah Penggeledahan/Penyegelan/Penyitaan';
    public $title='B4 - Surat Perintah Penggeledahan/Penyegelan/Penyitaan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/b4']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforB4::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsTutSuratforP46;
 ...
 */
class P46Controller extends Controller
{
    public $idJenisSurat='p46';
    public $perihalSurat='Memori Banding';
    public $title='P46 - Memori Banding';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p46']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP46::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforPidsus20C;
 ...
 */
class Pidsus20cController extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus20c');
    ...
    {
        if (($model = PdsDikSuratforPidsus20C::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->perihal_lap='Permohonan bantuan pengawalan akan dilakukan tindakan penggeledahan / penyitaan';

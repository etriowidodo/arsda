...
use app\modules\pidsus\models\PdsDikSuratforPidsus20A;
 ...
 */
class Pidsus20aController extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus20a');
    ...
    {
        if (($model = PdsDikSuratforPidsus20A::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

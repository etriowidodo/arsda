...
use app\modules\pidsus\models\PdsDikSuratforBA23;
 ...
 */
class Ba23Controller extends Controller
{
    public $idJenisSurat='ba23';
    public $perihalSurat='BA Pemusnahan Barang Bukti';
    public $title='BA 23 - BA Pemusnahan Barang Bukti';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba23']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA23::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforB12;
 ...
 */
class B12Controller extends Controller
{
	public $idJenisSurat='b12';
	public $perihalSurat='Pemberitahuan dan permintaan persetujuan lelang benda sitaan / barang bukti yang lekas rusak / membahayakan / biaya tinggi';
	public $title='B12 -  Pemberitahuan dan Permintaan Persetujuan Lelang Benda Sitaan';
    ...
    {
        if (($model = PdsDikSuratforB12::find()->where(['id_pds_dik_surat'=>$id])->one()) !== null) {
            return $model;
        } else {
        	return $this->redirect(['index']);
        }

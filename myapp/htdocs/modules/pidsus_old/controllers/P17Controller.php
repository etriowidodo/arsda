...
use app\modules\pidsus\models\PdsTutSuratforP17;
...
class P17Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsTut,'p17');
    ...
    {
        if (($model = PdsTutSuratforP17::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

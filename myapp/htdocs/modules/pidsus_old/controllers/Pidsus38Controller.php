...
use app\modules\pidsus\models\PdsTutSuratforPidsus38;
 ...
 */
class Pidsus38Controller extends Controller
{
    public $idJenisSurat='pidsus38';
    public $perihalSurat='Pelaksanaan Putusan Pengadilan';
    public $title='Pidsus 38 - Pelaksanaan Putusan Pengadilan';
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/pidsus38']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforPidsus38::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

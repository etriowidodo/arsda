...
use app\modules\pidsus\models\PdsTutSuratforP29;
 ...
 */
class P29Controller extends Controller
{
    public $idJenisSurat='p29';
    public $perihalSurat='Surat Dakwaan';
    public $title='P29 - Surat Dakwaan';
...
/*
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p29']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP29::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

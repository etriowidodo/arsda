...
use app\modules\pidsus\models\PdsDikSuratforP9;
...
{
	public $idJenisSuratSaksi='p9sks';
	public $idJenisSuratTersangka='p9tsk';
	public $perihalSurat='Surat Panggilan ';
	public $title='P 9 - Surat  Panggilan Saksi/Tersangka';
...
*/
	public function actionIndex()
	{
		...
		$dataProvidersks = $searchModel->search2(Yii::$app->request->queryParams, 'p9sks',$idPdsDik);
		$dataProvidertsk = $searchModel->search2(Yii::$app->request->queryParams, 'p9tsk',$idPdsDik);

		return $this->render('index', [
			'searchModel' => $searchModel,
			'dataProvidersks' => $dataProvidersks,
			'dataProvidertsk' => $dataProvidertsk,
			'idJenisSurat' => 'p9',
	...
	public function actionCreate($idJenisSurat)
	{
		...
		$idSurat=$this->getIdSurat($idJenisSurat);
		return $this->redirect(['update','id'=>$idSurat]);
	}


	public function getIdSurat($idJenisSurat){
	...
	public function actionUpdate($id)
	{
		...
		if ($model->load(Yii::$app->request->post()) ) {
			...
			//	return $this->redirect(['../pidsus/default/viewlaporandik','id'=>$idPdsDik]);
				return $this->redirect(['../pidsus/p9']);
			}
			else {
...
*/
   ...
   */
	...
	{
		if (($model = PdsDikSuratforP9::find()->where(['id_pds_dik_surat'=>$id])->one()) !== null) {
			return $model;
		} else {

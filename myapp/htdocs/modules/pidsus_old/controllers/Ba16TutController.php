...
use app\modules\pidsus\models\PdsTutSuratforBA16;
...
class Ba16Controller extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $countSuratDetailPenggeledahan= Yii::$app->db->createCommand('select count(*) from pidsus.select_surat_detail_tut(\''.$model->id_pds_tut_surat.'\',\''.Yii::$app->user->id.'\') Where tipe_surat_detail=\'Penggeledahan\'')->queryScalar();
        $countSuratDetailPenyitaan= Yii::$app->db->createCommand('select count(*) from pidsus.select_surat_detail_tut(\''.$model->id_pds_tut_surat.'\',\''.Yii::$app->user->id.'\') Where tipe_surat_detail=\'Penyitaan\'')->queryScalar();
    ...
    {
        if (($model = PdsTutSuratforBA16::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

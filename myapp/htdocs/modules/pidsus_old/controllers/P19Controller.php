...
use app\modules\pidsus\models\PdsTutSuratforP19;
 ...
 */
class P19Controller extends Controller
{
	...
	public function actionIndex()
	{
		...
		$model = $this->findModel($idPdsTut,'p19');
		...
		//petunjuk menggunakan template_surat_detail
	...
	{
		if (($model = PdsTutSuratforP19::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
			return $model;
		} else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
			$model->perihal_lap='Pengembalian Berkas Perkara atas Nama .......... yang Disangka Melanggar Pasal .......... untuk Dilengkapi';
			$model->save();

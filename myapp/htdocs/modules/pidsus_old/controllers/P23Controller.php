...
use app\modules\pidsus\models\PdsTutSuratforP23;
 ...
 */
class P23Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsTut,'p23');
    ...
    {
        if (($model = PdsTutSuratforP23::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
			$model->perihal_lap='Surat Susulan Penyerahan Tersangka dan Barang Bukti a. n. .......... yang Disangka Melanggar Pasal ..........';
			$model->save();

...
use app\modules\pidsus\models\PdsTutSuratforBA6;
 ...
 */
class Ba6Controller extends Controller
{
    public $idJenisSurat='ba6';
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba6']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA6::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforPidsus15;
 ...
 */
class Pidsus15Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus15');
    ...
    {
        if (($model = PdsDikSuratforPidsus15::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
			$model->perihal_lap=' Permintaan persetujuan tertulis Tindakan penyidikan atas nama ..........';
			$model->save();

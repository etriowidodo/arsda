...
use app\modules\pidsus\models\PdsTutSuratforP33;
 ...
 */
class P33Controller extends Controller
{
    public $idJenisSurat='p33';
    public $perihalSurat='Tanda Terima Surat Pelimpahan Perkara APB/APS';
    public $title='P-33 Tanda Terima Surat Pelimpahan Perkara APB/APS';
   ...
   //     $modelJaksa=KpPegawai::findBySql("select * from pidsus.get_jaksa_p8tut('".$model->id_pds_tut_surat."')")->all();
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p33']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP33::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforPidsus13;
 ...
 */
class Pidsus13Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus13');
		$_SESSION['startDatePidsus13']=new \DateTime($this->getStartDate('pidsus12'));
    	$_SESSION['startDatePidsus13']=$_SESSION['startDatePidsus13']->format('d m Y');
    ...
    {
        if (($model = PdsDikSuratforPidsus13::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsTutSuratforT7;
...
{
    public $idJenisSurat='t7';
    public $perihalSurat='Surat Perintah Penahanan / Pengalihan Jenis Penahanan (Tingkat Penuntutan)  ';
    public $title='T-7  Surat Perintah Penahanan / Pengalihan Jenis Penahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        $countSuratDetailDasar= Yii::$app->db->createCommand('select count(*) from pidsus.select_surat_detail_tut(\''.$model->id_pds_tut_surat.'\',\''.Yii::$app->user->id.'\') Where tipe_surat_detail=\'Dasar\'')->queryScalar();
...
/*
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t7']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforT7::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

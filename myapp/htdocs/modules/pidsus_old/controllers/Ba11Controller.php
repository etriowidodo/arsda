...
use app\modules\pidsus\models\PdsTutSuratforBA11;
 ...
 */
class Ba11Controller extends Controller
{
    public $idJenisSurat='ba11';
    public $perihalSurat='Berita Acara Pelaksanaan Perintah Pengalihan';
    public $title='BA 11 - Berita Acara Pelaksanaan Perintah Pengalihan';
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba11']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA11::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

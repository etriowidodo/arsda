...
use app\modules\pidsus\models\PdsDikSuratforT6;
...
{
    public $idJenisSurat='t6';
    public $perihalSurat='Permintaan Perpanjangan Penahanan Terhadap Tersangka';
    public $title='T6 - Permintaan Perpanjangan Penahanan Terhadap Tersangka';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t6']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforT6::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforT2;
...
{
    public $idJenisSurat='t2';
    public $perihalSurat='SURAT PENAHANAN/PENGALIHAN JENIS PENAHANAN';
    public $title='T2 - Surat Penahanan/Pengalihan Jenis Penahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t2']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforT2::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforT11;
...
{
    public $idJenisSurat='t11';
    public $perihalSurat='SURAT PERINTAH PEMERIKSAAN KESEHATAN TAHANAN';
    public $title='T11 - Surat Perintah Pemeriksaan Kesehatan Tahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t11']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforT11::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

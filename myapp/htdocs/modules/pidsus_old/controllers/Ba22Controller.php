...
use app\modules\pidsus\models\PdsTutSuratforBA22;
 ...
 */
class Ba22Controller extends Controller
{
    public $idJenisSurat='ba22';
    public $perihalSurat='Berita Acara Penyerahan Barang Sitaan';
    public $title='BA-22 Berita Acara Penyerahan Barang Sitaan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba22']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA22::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

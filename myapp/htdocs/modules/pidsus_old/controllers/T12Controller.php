...
use app\modules\pidsus\models\PdsDikSuratforT12;
...
{
    public $idJenisSurat='t12';
    public $perihalSurat='Permintaan Pemeriksaan Kesehatan Tahanan';
    public $title='T12 - Permintaan Pemeriksaan Kesehatan Tahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t12']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforT12::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

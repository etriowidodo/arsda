...
use app\modules\pidsus\models\PdsDikSuratforPidsus12;
 ...
 */
class Pidsus12Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'pidsus12');
		$_SESSION['startDatePidsus12']=new \DateTime($this->getStartDate('p8dik'));
    	$_SESSION['startDatePidsus12']=$_SESSION['startDatePidsus12']->format('d m Y');
...
public function getStartDate($jenisSurat){
    ...
    {
        if (($model = PdsDikSuratforPidsus12::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

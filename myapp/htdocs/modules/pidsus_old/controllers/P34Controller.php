...
use app\modules\pidsus\models\PdsTutSuratforP34;
 ...
 */
class P34Controller extends Controller
{
    public $idJenisSurat='p34';
    public $perihalSurat='Tanda Terima Barang Bukti ';
    public $title='P-34 Tanda Terima Barang Bukti';
...
/*
  ...
  */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p34']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP34::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

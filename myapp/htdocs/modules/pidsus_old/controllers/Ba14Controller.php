...
use app\modules\pidsus\models\PdsDikSuratforBA14;
 ...
 */
class Ba14Controller extends Controller
{
    public $idJenisSurat='ba14';
    public $perihalSurat='BA Pelaksanaan Perintah Pencabutan Penangguhan Penahanan';
    public $title='BA 14 - BA Pelaksanaan Perintah Pencabutan Penangguhan Penahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba14']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA14::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsTutSuratforBA9;
 ...
 */
class Ba9Controller extends Controller
{
    public $idJenisSurat='ba9';
    public $perihalSurat='Berita Acara Pelaksanaan Pidana Mati';
    public $title='BA-9 Berita Acara Pelaksanaan Pidana Mati';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba9']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA9::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

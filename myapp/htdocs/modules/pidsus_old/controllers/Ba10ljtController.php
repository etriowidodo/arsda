...
use app\modules\pidsus\models\PdsDikSuratforBA10;
 ...
 */
class Ba10ljtController extends Controller
{
    public $idJenisSurat='ba10ljt';
    public $perihalSurat='BA Pelaksanaan Perintah Penahanan/Penahanan Lanjutan';
    public $title='BA 10 - BA Pelaksanaan Perintah Penahanan/Penahanan Lanjutan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba10ljt']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA10::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

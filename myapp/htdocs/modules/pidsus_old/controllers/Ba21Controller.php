...
use app\modules\pidsus\models\PdsTutSuratforBA21;
 ...
 */
class Ba21Controller extends Controller
{
    public $idJenisSurat='ba21';
    public $perihalSurat='Berita Acara Penyerahan tanggung Jawab';
    public $title='BA-21 Berita Acara Penyerahan tanggung Jawab';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba21']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA21::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

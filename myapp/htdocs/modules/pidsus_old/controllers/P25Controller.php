...
use app\modules\pidsus\models\PdsTutSuratforP25;
 ...
 */
class P25Controller extends Controller
{
    public $idJenisSurat='p25';
    public $perihalSurat='Surat Perintah melengkapi Berkas Perkara';
    public $title='P-25 Surat Perintah melengkapi Berkas Perkara';
...
*/
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p25']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP25::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

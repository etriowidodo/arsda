...
use app\modules\pidsus\models\PdsTutSuratforBA18;
 ...
 */
class Ba18Controller extends Controller
{
    public $idJenisSurat='ba18';
    public $perihalSurat='Berita Acara Penerimaan dan Penelitian Benda';
    public $title='BA-18 Berita Acara Penerimaan dan Penelitian Benda';
    ...
    public function actionUpdate($id)
    {
        ...
        $modelJaksaAll=KpPegawai::findBySql("select * from pidsus.get_jaksa_all_tut('".$model->id_pds_tut_surat."')")->all();
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba18']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforBA18::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

...
use app\modules\pidsus\models\PdsDikSuratforB16;
 ...
 */
class B16Controller extends Controller
{
	public $idJenisSurat='b16';
	public $perihalSurat='Laporan pelaksanaan lelang benda sitaan / barang bukti berdasarkan pasal 45 KUHAP';
	public $title='B16 - Laporan Pelaksanaan Lelang Benda Sitaan / Barang Bukti';
	...
	*/
    ...
    {
        if (($model = PdsDikSuratforB16::find()->where(['id_pds_dik_surat'=>$id])->one()) !== null) {
            return $model;
        } else {
        	return $this->redirect(['index']);
        }

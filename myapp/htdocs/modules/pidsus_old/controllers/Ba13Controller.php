...
use app\modules\pidsus\models\PdsDikSuratforBA13;
 ...
 */
class Ba13Controller extends Controller
{
    public $idJenisSurat='ba13';
    public $perihalSurat='BA Pelaksanaan Perintah Mengeluarkan dari Tahanan';
    public $title='BA 13 - BA Pelaksanaan Perintah Mengeluarkan dari Tahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba13']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA13::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

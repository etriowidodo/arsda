...
use app\modules\pidsus\models\PdsDikSuratforPidsus18;
...
*/
    ...
    {
        if (($model = PdsDikSuratforPidsus18::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

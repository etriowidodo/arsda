...
use app\modules\pidsus\models\PdsTutSuratforD4;
...
{
    public $idJenisSurat='d4';
    public $perihalSurat='Surat Perintah Penyerahan Denda/Denda Ganti/Uang Pengganti/Biaya Perkara';
    public $title='D-4 Surat Perintah Penyerahan Denda/Denda Ganti/Uang Pengganti/Biaya Perkara';
   ...
   //     $modelJaksa=KpPegawai::findBySql("select * from pidsus.get_jaksa_p8tut('".$model->id_pds_tut_surat."')")->all();
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            */
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/d4']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforD4::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

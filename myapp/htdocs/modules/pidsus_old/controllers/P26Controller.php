...
use app\modules\pidsus\models\PdsTutSuratforP26;
 ...
 */
class P26Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsTut,'p26');
    ...
    {
        if (($model = PdsTutSuratforP26::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

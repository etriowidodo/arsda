...
use app\modules\pidsus\models\PdsDikSuratforT1;
...
{
    public $idJenisSurat='t1';
    public $perihalSurat='SURAT PERINTAH PENANGKAPAN';
    public $title='T1 - Surat Perintah Penangkapan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/t1']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforT1::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

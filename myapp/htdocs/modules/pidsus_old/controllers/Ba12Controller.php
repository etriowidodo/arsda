...
use app\modules\pidsus\models\PdsDikSuratforBA12;
 ...
 */
class Ba12Controller extends Controller
{
    public $idJenisSurat='ba12';
    public $perihalSurat='BA Pelaksanaan Perintah Penangguhan Penahanan';
    public $title='BA 12 - BA Pelaksanaan Perintah Penangguhan Penahanan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba12']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA12::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

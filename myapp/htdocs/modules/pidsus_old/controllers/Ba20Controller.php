...
use app\modules\pidsus\models\PdsDikSuratforBA20;
 ...
 */
class Ba20Controller extends Controller
{
    public $idJenisSurat='ba20';
    public $perihalSurat='BA Pengembalian Barang Bukti';
    public $title='BA 20 - BA Pengembalian Barang Bukti';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/ba20']);
            }
            else {
    ...
    {
        if (($model = PdsDikSuratforBA20::find()->where(['id_pds_dik_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

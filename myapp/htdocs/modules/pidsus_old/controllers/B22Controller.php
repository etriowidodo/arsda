...
use app\modules\pidsus\models\PdsDikSuratforB22;
 ...
 */
class B22Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,$modelDik,'b22');
    ...
    {
        if (($model = PdsDikSuratforB22::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
		//	$model->perihal_lap='Laporan pelaksanaan pemanfaatan / penyerahan / pemusnahan barang terlarang atas barang bukti yang dikembalikan tetapi tidak diambil / barang temuan';

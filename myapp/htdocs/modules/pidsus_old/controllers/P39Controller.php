...
use app\modules\pidsus\models\PdsTutSuratforP39;
 ...
 */
class P39Controller extends Controller
{
    public $idJenisSurat='p39';
    public $perihalSurat='Laporan Hasil Persidangan';
    public $title='p39 - Laporan Hasil Persidangan';
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            if ($_POST['btnSubmit']=='simpan'){
                ...
                return $this->redirect(['../pidsus/p39']);
            }
            else {
    ...
    {
        if (($model = PdsTutSuratforP39::find()->where(['id_pds_tut_surat'=>$id, 'id_jenis_surat'=>$this->idJenisSurat])->one()) !== null) {
            return $model;
        } else {

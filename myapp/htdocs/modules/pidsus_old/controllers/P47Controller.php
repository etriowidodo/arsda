...
use app\modules\pidsus\models\PdsDikSuratforP47;
 ...
 */
class P47Controller extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsDik,'p17');
    ...
    {
        if (($model = PdsDikSuratforP47::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_dik=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {
			...
			$model->update_ip=(string)$_SERVER['REMOTE_ADDR'];
			$model->perihal_lap='Permintaan Perkembangan Hasil Penyelidikan atas nama .......... yang Disangka Melanggar Pasal ..........';
			$model->save();

...
use app\modules\pidsus\models\PdsTutSuratforP18Int;
 ...
 */
class P18intController extends Controller
{
	...
	*/
    ...
    {	
        ...
        $model = $this->findModel($idPdsTut,'p18int');
    ...
    {
        if (($model = PdsTutSuratforP18Int::find()->where('id_jenis_surat=\''.$jenisSurat.'\' and id_pds_tut=\''.$id.'\'')->one()) !== null) {
            return $model;
        } else {

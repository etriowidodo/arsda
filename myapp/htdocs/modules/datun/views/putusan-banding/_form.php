<?php
	...
	$this->title 	= 'Putusan Pengadilan Tinggi';
	...
	$tanggal_pts_banding 	= ($head['tanggal_pts_banding'])?date('d-m-Y',strtotime($head['tanggal_pts_banding'])):'';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/putusan-banding/simpan" enctype="multipart/form-data">
...
<div class="row">        
    <!-- <div class="col-md-6">
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8">
                <input type="text" name="no_putusan" id="no_putusan" class="form-control" value="<?php echo $head['no_putusan']; ?>" required data-error="" maxlength="" readonly />
    ...
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Nomor Putusan Pengadilan Tinggi</label>        
            <div class="col-md-8">
                <input type="text" name="no_pts_banding" id="no_pts_banding" class="form-control" value="<?php echo $head['no_pts_banding']; ?>" required data-error="Nomor Putusan Pengadilan Tinggi belum diisi" maxlength="30"  />
                <div class="help-block with-errors" id="error_custom4"></div>
            </div>
        </div>
    </div>
	 ...
	 <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Tanggal Putusan Pengadilan Tinggi</label>        
            <div class="col-md-4">
                <div class="input-group date">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                   	<input type="text" class="form-control datepicker" id="tanggal_pts_banding"  name="tanggal_pts_banding" value="<?php echo $tanggal_pts_banding;?>" placeholder="DD-MM-YYYY"  required data-error="Tanggal Putusan Pengadilan Tinggi belum diisi"/>
                </div>                      
            </div>
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading single-project-nav">
                        <ul class="nav nav-tabs"> 
                            <li class="active"><a href="#tab-amar" data-toggle="tab">AMAR PUTUSAN BANDING</a></li>  
                        </ul>
                    </div>
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-amar">
                                    <textarea class="ckeditor" id="tab_amar" name="tab_amar" ><?php echo $head['amar_pts_banding']; ?></textarea>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				<?php
					$pathFile 	= Yii::$app->params['putusanBanding'].$head['file_pts_banding'];
					$cek=($head['file_pts_banding'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['putusanBanding'].$head['file_pts_banding'];
                        $labelFile 	= 'Upload File Putusan Banding';
                        if($head['file_pts_banding'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File Putusan Banding';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_pts_banding']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_pts_banding'], strrpos($head['file_pts_banding'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_pts_banding'].'" style="float:left; margin-right:10px;">

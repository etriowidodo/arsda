<?php
	...
	$this->title 	= 'Telaahan';
	$this->subtitle = 'Surah Perintah Untuk Membuat Telaahan (SP1)';
...
<div class="box box-primary" style="border-color:#f39c12; overflow:hidden;">
    <div class="box-header with-border" style="border-color: #c7c7c7;">
		<h3 class="box-title">SURAT PERINTAH UNTUK MEMBUAT TELAAHAN (SP1)</h3>
	</div>
        ...
        <div class="row">        
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo $model['deskripsi_jnsinstansi']; ?>" id="jnsinstan" placeholder="" readonly="true">
        	...
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo $model['deskripsi_instansi']; ?>" id="instans" placeholder="" readonly="true">
                    </div>
        		</div>
        	</div>
        </div>
        <div class="row">        
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo $model['no_register_perkara']; ?>" id="noreg" name="noreg" placeholder="" readonly="true">
                        <div class="help-block with-errors"></div>
        			</div>
        		</div>
        	</div>        
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo $model['deskripsi_inst_wilayah']; ?>" id="instans" placeholder="" readonly="true">
                    </div>
        		</div>
        	</div>
        </div>
        	...
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        ...
                        <input type="hidden" id="npemohon" name="npemohon" value="<?php echo $model['no_surat']; ?>" />
        		...
        		<div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <div class="input-group date">
                            ...
                            <input type="text" id="tgpemohon" name="tgpemohon" class="form-control" value="<?php echo $tgl_permohonan; ?>" readonly />
						</div>						
					</div>
        		</div>
        	</div>
        ...
        <div class="row">        
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo Yii::$app->inspektur->getNamaSatker();?>" id="wilkerja" placeholder="" readonly="true">
                        <div class="help-block with-errors"></div>
        			</div>
        		</div>
        	</div>        
        	<div class="col-md-6">
        		<div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <div class="input-group date">
                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                            <input type="text" id="tgterima" name="tgterima" class="form-control" value="<?php echo $tgl_diterima; ?>" readonly />
						</div>						
					</div>
        		</div>
        	</div>
...
<div class="row">        
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8">
                <input type="text" name="no_surat" id="no_surat" class="form-control" value="<?php echo $model['no_sp1'];?>" required data-error="No SP1 belum diisi" maxlength="40"  />
            ...
            <div class="box-body" style="padding:15px;">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-jpn-modal">
                        ...
                        <tbody>
                        <?php 
                            $sqlnya = "select nip, nama, gol_jpn, pangkat_jpn, jabatan_jpn, pangkat_jpn||' ('||gol_jpn||')' as pangkatgol   
            ...
            <div class="box-body" style="padding:15px;">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_sp1'] == ''){
                        		$sqlx = "select no_urut, tembusan from datun.template_tembusan where kode_template_surat = 'SP-1' order by no_urut";
                        		$resx = User::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_temb_sp1 as no_urut, deskripsi_tembusan_su as tembusan from datun.sp1_tembusan 
										where no_register_perkara = '".$model['no_register_perkara']."' order by no_temb_sp1";
                        		$resx = User::findBySql($sqlx)->asArray()->all();
                        	}
                        	$no = 1;
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				<?php
					$pathFile 	= Yii::$app->params['sp1'].$model['file_sp1'];
					$cek=($model['file_sp1'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['sp1'].$model['file_sp1'];
                        $labelFile 	= 'Upload File SP1';
                        if($model['file_sp1'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File SP1';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($model['file_sp1']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($model['file_sp1'], strrpos($model['file_sp1'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$model['file_sp1'].'" style="float:left; margin-right:10px;">

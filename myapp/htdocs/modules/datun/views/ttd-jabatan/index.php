...
<div class="role-index">
    <div class="inline"><a class="btn btn-success" href="/datun/ttd-jabatan/create"><i class="fa fa-plus jarak-kanan"></i>Tambah Jabatan</a></div>
	...
	<?php
		...
		echo GridView::widget([
			...
			'rowOptions' => function($data){
				$idnya = rawurlencode($data['kode'])."#".rawurlencode($data['kode_tk']);
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#idUbah").on("click", function(){
			...
			var url = window.location.protocol + "//" + window.location.host + "/datun/ttd-jabatan/update?id="+tmp[0]+"&id2="+tmp[1];
			...
			bootbox.confirm({
				...
				callback: function (result) {
					if(result){
						...
						$.ajax({
							type	: "POST",
							url		: "<?php echo Yii::$app->request->baseUrl.'/datun/ttd-jabatan/hapusdata'; ?>",
							data	: { 'id' : id },
							cache	: false,
							dataType: "json",

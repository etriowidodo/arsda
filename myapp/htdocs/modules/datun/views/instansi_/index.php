...
<div class="row">
	<div class="col-md-6">
		<div class="form-group">
			<label class="control-label col-md-3" style="margin-top: 5px;">Jenis Instansi</label>
			<div class="col-md-9">
...
<div class="role-index">
    <div class="inline"><a class="btn btn-success" href="/datun/instansi/create"><i class="fa fa-plus jarak-kanan"></i>Tambah Instansi</a></div>
	...
	<?php
		...
		echo GridView::widget([
			...
			'rowOptions' => function($data){
				$idnya = rawurlencode($data['kode_jenis_instansi'])."#".rawurlencode($data['kode_instansi']);
			...
			'columns' => [
				...
				'2'=>[
					'headerOptions'=>['style'=>'width:53%', 'class'=>'text-center'],
					'format'=>'raw',
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#idUbah").on("click", function(){
			...
			var url = window.location.protocol + "//" + window.location.host + "/datun/instansi/update?id="+tmp[0]+"&id2="+tmp[1];
			...
			bootbox.confirm({
				...
				callback: function (result) {
					if(result){
						...
						$.ajax({
							type	: "POST",
							url		: "<?php echo Yii::$app->request->baseUrl.'/datun/instansi/hapusdata'; ?>",
							data	: { 'id' : id },
							cache	: false,
							dataType: "json",

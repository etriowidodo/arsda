...
<div class="ms-pasal-index">
    ...
    <?= GridView::widget([
		...
		'rowOptions'   => function ($model, $key, $index, $grid) {
            return ['data-uu' => $model['uu'],'data-pasal'=>$model['pasal']];
        },
        'columns' => [
            ...
            [
                'class'=>'kartik\grid\CheckboxColumn',
                    ...
                    'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' => $model['uu']."#".$model['pasal'], 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
		'export' => false,
...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-pasal/update?uu="+uu+"&pasal="+pasal;
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-pasal/update?uu="+id[0]+"&pasal="+id[1];
        $(location).attr('href',url);

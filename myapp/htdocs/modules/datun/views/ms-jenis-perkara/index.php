...
<div class="ms-jenis-perkara-index">
	...
	<?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/ms-jenis-perkara/delete/'
        ]);  
    ?>  
...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-jenis-perkara/update?kode_pidana="+kodepidana+"&jenis_perkara="+jenisperkara;
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-jenis-perkara/update?id="+id;
        $(location).attr('href',url);

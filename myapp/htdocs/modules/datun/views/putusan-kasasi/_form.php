<?php
	...
	$this->title 	    = 'Putusan Mahkamah Agung';
	...
	$tanggal_pts_kasasi = ($head['tanggal_pts_kasasi'])?date('d-m-Y',strtotime($head['tanggal_pts_kasasi'])):'';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/putusan-kasasi/simpan" enctype="multipart/form-data">
...
<div class="row">        
    ...
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Nomor Putusan MA</label>        
            <div class="col-md-8">
                <input type="text" name="no_pts_kasasi" id="no_pts_kasasi" class="form-control" value="<?php echo $head['no_pts_kasasi'] ?>" required data-error="Nomor putusan MA belum diisi" maxlength="30"  />
    ...
    <div class="col-md-6">
	 ...
	 <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Tanggal Putusan MA</label>        
            <div class="col-md-4">
                <div class="input-group date">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                   <input type="text" class="form-control datepicker" id="tanggal_pts_kasasi"  name="tanggal_pts_kasasi" value="<?php echo $tanggal_pts_kasasi;?>" placeholder="DD-MM-YYYY"  required data-error="Tanggal putusan MA belum diisi"/>
                </div>                      
            </div>
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading single-project-nav">
                        <ul class="nav nav-tabs"> 
                            <li class="active"><a href="#tab-amar" data-toggle="tab">AMAR PUTUSAN KASASI</a></li>  
                        </ul>
                    </div>
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-amar">
                                    <textarea class="ckeditor" id="tab_amar" name="tab_amar" ><?php //echo $head['amar_pts_kasasi']; ?></textarea>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				<?php
					$pathFile 	= Yii::$app->params['putusanKasasi'].$head['file_pts_kasasi'];
					$cek=($head['file_pts_kasasi'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['putusanKasasi'].$head['file_pts_kasasi'];
                        $labelFile 	= 'Upload File Putusan Mahkamah Agung';
                        if($head['file_pts_kasasi'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File Putusan Mahkamah Agung';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_pts_kasasi']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_pts_kasasi'], strrpos($head['file_pts_kasasi'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_pts_kasasi'].'" style="float:left; margin-right:10px;">

...
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/templatesurat/simpan" enctype="multipart/form-data">
...
<div class="box-footer text-center"> 
    ...
    <a href="/datun/templatesurat/index" class="btn btn-danger">Batal</a>
</div>
</form>

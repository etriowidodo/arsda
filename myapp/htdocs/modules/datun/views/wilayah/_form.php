...
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/wilayah/simpan">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <input type="text" id="kode" name="kode" class="form-control" maxlength="2" value="<?php echo $model['id_prop'];?>" required data-minlength="2" data-error="Kode harus diisi dengan 2 karakter" <?php echo (!$isNewRecord?'readonly':''); ?> />
				</div>
...
<div class="box-footer text-center"> 
    ...
    <a href="/datun/wilayah/index" class="btn btn-danger">Batal</a>
</div>
</form>

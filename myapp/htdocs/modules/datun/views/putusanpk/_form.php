<?php
	...
	$tanggal_pts_pk 	= ($head['tanggal_pts_pk'])?date('d-m-Y',strtotime($head['tanggal_pts_pk'])):'';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/putusanpk/simpan" enctype="multipart/form-data">
...
<div class="row">        
    <!-- <div class="col-md-6">
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8">
                 <input type="text" name="no_putusan" id="no_putusan" class="form-control" value="<?php echo $head['no_putusan']; ?>" required data-error="Nomor Putusan belum diisi." readonly maxlength="30"  />
            </div>
        </div>
    </div> -->
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-4">
                <div class="input-group date">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    <input type="text" class="form-control datepicker" id="tanggal_terima_jpn"  name="tanggal_terima_jpn" value="<?php echo $tanggal_terima_jpn;?>" placeholder="DD-MM-YYYY" required data-error="Tanggal Terima JPN belum di isi" />
    ...
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Tanggal Putusan PK</label>        
            <div class="col-md-4">
                <div class="input-group date">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    <input type="text" class="form-control datepicker" id="tanggal_pts_pk"  name="tanggal_pts_pk" value="<?php echo $tanggal_pts_pk;?>" placeholder="DD-MM-YYYY" required data-error="Tanggal Putusan PK belum di isi"/>
...
<div class="row">        
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            <label class="control-label col-md-4">Nomor Putusan PK</label>        
            <div class="col-md-8">
                  <input type="text" name="no_pts_pk" id="no_pts_pk" class="form-control" value="<?php echo $head['no_pts_pk']; ?>" required data-error="Nomor Putusan PK belum di isi" maxlength="30"  />
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading single-project-nav">
                        <ul class="nav nav-tabs"> 
                            <li class="active"><a href="#tab-amar" data-toggle="tab">AMAR PUTUSAN PK</a></li>  
                        </ul>
                    </div>
                        <div class="panel-body">
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tab-amar">
                                    <textarea class="ckeditor" id="tab_amar" name="tab_amar" ><?php echo $head['amar_pts_pk']; ?></textarea>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				<?php
					$pathFile 	= Yii::$app->params['putusan_pk'].$head['file_pts_pk'];
					$cek=($head['file_pts_pk'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['putusan_pk'].$head['file_pts_pk'];
                        $labelFile 	= 'Upload File Putusan PK';
                        if($head['file_pts_pk'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File Putusan PK';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_pts_pk']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_pts_pk'], strrpos($head['file_pts_pk'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_pts_pk'].'" style="float:left; margin-right:10px;">

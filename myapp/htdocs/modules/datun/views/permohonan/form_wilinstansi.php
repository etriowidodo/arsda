    ...
    <form class="form-horizontal" id="frm-m2">
        ...
        <div class="row">
            <div class="col-md-12">
				...
				<div class="help-block with-errors text-red" style="font-style:italic" id="errornya-modal-wil-prop"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
				...
				<div class="help-block with-errors text-red" style="font-style:italic" id="errornya-modal-wil-kab"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
				...
				<div class="help-block with-errors text-red" style="font-style:italic" id="errornya-modal-pimp"></div>
            </div>			
        </div>
        <div class="row">
            <div class="col-md-12">
				...
				<div class="help-block with-errors text-red" style="font-style:italic" id="errornya-modal-telp"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
				...
				<div class="help-block with-errors text-red" style="font-style:italic" id="errornya-modal-almt"></div>
            </div>
        </div>

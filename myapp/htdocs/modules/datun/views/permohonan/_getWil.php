...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#tambah_form_wilintansi").on('click', '#simpan_form_wilinstansi', function(e){
			...
			var wil_prop	= $("#m2_prop").val();
			var wil_kab		= $("#m2_kab").val();
			var nm_ins		= $("#m2_inst_wilayah").val();
			var pimp		= $("#m2_pimpinan").val();
			var telp		= $("#m2_telp").val();  
			var alamat		= $("#m2_alamat").val();
			 
			if (wil_prop==''){
				$("#errornya-modal-wil-prop").html('<i style="color:#dd4b39; font-size:12px;">* Wilayah Provinsi masih kosong.</i>');
				setErrorFocus($("#m2_prop"));
				return false;
			} else if (wil_kab==''){
				$("#errornya-modal-wil-kab").html('<i style="color:#dd4b39; font-size:12px;">* Wilayah Kabupaten masih kosong.</i>');
				setErrorFocus($("#m2_kab"));
				return false;
			} else if (nm_ins==''){
				$("#errornya-modal-ins").html('<i style="color:#dd4b39; font-size:12px;">* Nama Instansi masih kosong.</i>');
				setErrorFocus($("#m2_inst_wilayah"));
				return false;
			} else if (pimp==''){
				$("#errornya-modal-pimp").html('<i style="color:#dd4b39; font-size:12px;">* Pimpinan masih kosong.</i>');
				setErrorFocus($("#m2_pimpinan"));
				return false;
			} else if (telp==''){
				$("#errornya-modal-telp").html('<i style="color:#dd4b39; font-size:12px;">* Nomor telepon masih kosong.</i>');
				setErrorFocus($("#m2_telp"));
				return false;
			} else if (alamat==''){
				$("#errornya-modal-almt").html('<i style="color:#dd4b39; font-size:12px;">* Alamat masih kosong.</i>');
				setErrorFocus($("#m2_alamat"));
				return false;
			}  else {			

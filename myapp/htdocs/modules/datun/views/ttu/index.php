...
$this->title = 'Tanda Terima Undangan (S - 4)';
...
<section class="content" style="padding: 0px;">
    <div class="content-wrapper-1">
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-4">No. S-3</label>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-4">Tanggal S-3</label>
                        <div class="col-md-8">
        ...
        <!-- 3 -->
        <div class="box box-primary" style="border-color: #eaba05;overflow: hidden;">
            ...
            <div class="col-md-12" style="padding-bottom:10px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-5">Hari</label>
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="#" placeholder="Hari">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding-bottom:10px;">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-6">Hubungan Dengan yang Diundang</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="#" placeholder="Pekerjaan">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label class="control-label col-md-5">Jam</label>
                        <div class="col-md-7">
                            <div class="input-group date">
                                <div class="input-group-addon">
        ...
        <div class="col-md-12" style="padding: 0px;margin-top:-10px;">
            <h3 class="box-title">
                <a href="#" class='btn btn-primary' onclick="document.getElementById('fileID').click(); return false;" /><i class="fa fa-cloud-upload" aria-hidden="true" ></i> Upload Lampiran S-4</a>

...
<div class="rekap-create">
	<form id="rekap-form" name="rekap-form" class="form-validasi form-horizontal" method="post" action="/datun/laporan-bulanan/cetak" enctype="multipart/form-data">
...
$(document).ready(function(){
	...
	$("#btn_tambahttd, #penandatangan_nama").on('click', function(e){
		...
		$("#penandatangan_modal").find(".modal-body").load("/datun/laporan-bulanan/get_ttd");

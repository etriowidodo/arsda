<?php
	...
	$this->title 	= 'Memori Banding (S-25)';
	...
	$linkCetak		= '/datun/s25/cetak';
	
	$tanggal_s25 	= ($head['tanggal_s25'])?date('d-m-Y',strtotime($head['tanggal_s25'])):''; 
	$tgl_permohonan_banding 	= ($head['tgl_permohonan_banding'])?date('d-m-Y',strtotime($head['tgl_permohonan_banding'])):'';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/s25/simpan" enctype="multipart/form-data">
        ...
        <div class="box box-primary" style="border-color:#f39c12; overflow:hidden;">
            <div class="box-body" style="padding:15px;">
                ...
                <div class="row">        
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">No. Akta Pernyataan Banding</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_permohonan_banding" id="no_permohonan_banding" class="form-control" value="<?php echo $head['no_permohonan_banding']; ?>" maxlength="30" required data-error="No Akta Pernyataan Banding belum diisi"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal Akta Pernyataan Banding</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                         <input type="text" class="form-control datepicker" id="tgl_permohonan_banding"  name="tgl_permohonan_banding" value="<?php echo $tgl_permohonan_banding;?>" placeholder="DD-MM-YYYY" required data-error="Tanggal Akta Pernyataan Banding belum diisi"/>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
							<?php
								$pathFile3 	= Yii::$app->params['relas_s25'].$head['file_akta_penyerahan_banding'];
								$cek3=($head['file_akta_penyerahan_banding'] && file_exists($pathFile3))?1:0;
							?>
							<input type="hidden" name="cek_file3" id="cek_file3" value="<?php echo $cek3; ?>">
                                <input type="file" name="file_template3" id="file_template3" class="form-inputfile" value="<?php echo $head['file_akta_penyerahan_banding']; ?>" />                    
                                <label for="file_template3" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['relas_s25'].$head['file_akta_penyerahan_banding'];
                                        $labelFile  = 'Upload File Akta Penyerahan Banding';
                                        if($head['file_akta_penyerahan_banding'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Akta Penyerahan Banding';
                                            $param1     = chunk_split(base64_encode($pathFile));
                                            $param2     = chunk_split(base64_encode($head['file_akta_penyerahan_banding']));
                                            $linkPt     = "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                            $extPt      = substr($head['file_akta_penyerahan_banding'], strrpos($head['file_akta_penyerahan_banding'],'.'));
                                            echo '<a href="'.$linkPt.'" title="'.$head['file_akta_penyerahan_banding'].'" style="float:left; margin-right:10px;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
                            <?php
                                $pathFile2  = Yii::$app->params['permohonan_banding'].$head['file_permohonan_banding'];
                                $cek2=($head['file_permohonan_banding'] && file_exists($pathFile2))?1:0;
                            ?>
                            <input type="hidden" name="cek_file2" id="cek_file2" value="<?php echo $cek2; ?>">
                                <input type="file" name="file_template2" id="file_template2" class="form-inputfile" value="<?php echo $head['file_permohonan_banding']; ?>" />                    
                                <label for="file_template2" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['permohonan_banding'].$head['file_permohonan_banding'];
                                        $labelFile  = 'Upload File Akta Pernyataan Banding';
                                        if($head['file_permohonan_banding'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Akta Pernyataan Banding';
                                            $param1     = chunk_split(base64_encode($pathFile));
                                            $param2     = chunk_split(base64_encode($head['file_permohonan_banding']));
                                            $linkPt     = "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                            $extPt      = substr($head['file_permohonan_banding'], strrpos($head['file_permohonan_banding'],'.'));
                                            echo '<a href="'.$linkPt.'" title="'.$head['file_permohonan_banding'].'" style="float:left; margin-right:10px;">
                                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                                        }
                                    ?>
                                    <div class="input-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" class="form-control datepicker" id="tanggal_s25"  name="tanggal_s25" value="<?php echo $tanggal_s25;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                            </div> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <textarea id="kepada_yth_s25" name="kepada_yth_s25" class="form-control" style="height:80px;" maxlength="200" ><?php echo $head['kepada_yth_s25'] ?></textarea>
                ...
                <div class="row">        
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="di_s25" id="di_s25" class="form-control" value="<?php echo $head['di_s25']; ?>" maxlength="20"/>
                        ...
                        <?php 
                         /*    if($isNewRecord){
								...
								$sqlnya = "select nip, nama, jabatan as jabatan_jpn,pangkat as pangkat_jpn  , golongan as gol_jpn, pangkat||' ('||golongan||')' as pangkatgol 
                                        from datun.s25_anak where no_register_perkara = '".$head['no_register_perkara']."' and no_surat = '".$head['no_surat']."' order by nip";
                           	}
							$hasil = User::findBySql($sqlnya)->asArray()->all();
                            if(count($hasil) == 0)
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="tab-alasan">
                                <textarea class="ckeditor" id="tab_alasan" name="tab_alasan" ><?php echo $head['alasan_banding']; ?></textarea>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				<?php
					$pathFile 	= Yii::$app->params['s25'].$head['file_s25'];
					$cek=($head['file_s25'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['s25'].$head['file_s25'];
                        $labelFile 	= 'Upload File S-25';
                        if($head['file_s25'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File S-25';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_s25']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_s25'], strrpos($head['file_s25'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_s25'].'" style="float:left; margin-right:10px;">
                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                        }
                    ?>
                    <div class="input-group">

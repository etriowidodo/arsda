...
<div class="ms-uundang-index">
	...
	<?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/ms-u-undang/delete/'
        ]);  
    ?>  
            ...
            [
                'class'=>'kartik\grid\CheckboxColumn',
                    ...
                    'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' => $model['uu'], 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
		'export' => false,
...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-u-undang/update?id="+id;

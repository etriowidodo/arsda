<?php
	...
	$linkCetak		= '/datun/kontra-kasasi/cetak';
	$tanggal_kontra_kasasi = ($head['tanggal_kontra_kasasi'])?date('d-m-Y',strtotime($head['tanggal_kontra_kasasi'])):'';
	$tanggal_memori_kasasi = ($head['tanggal_memori_kasasi'])?date('d-m-Y',strtotime($head['tanggal_memori_kasasi'])):'';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/kontra-kasasi/simpan" enctype="multipart/form-data">
             ...
             <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
							<?php
								$pathFile3 	= Yii::$app->params['relas_kontra_kasasi'].$head['file_relas'];
							...
							<input type="hidden" name="cek_file3" id="cek_file3" value="<?php echo $cek3; ?>">
                                ...
                                <label for="file_template3" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['relas_kontra_kasasi'].$head['file_relas'];
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
                            <?php
                                $pathFile2  = Yii::$app->params['memori_kasasi'].$head['file_memori_kasasi'];
                                $cek2=($head['file_memori_kasasi'] && file_exists($pathFile2))?1:0;
                            ?>
                            <input type="hidden" name="cek_file2" id="cek_file2" value="<?php echo $cek2; ?>">
                                ...
                                <label for="file_template2" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['memori_kasasi'].$head['file_memori_kasasi'];
                                        $labelFile  = 'Upload File Memori Kasasi';
                                        if($head['file_memori_kasasi'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Memori Kasasi';
                                            $param1     = chunk_split(base64_encode($pathFile));
                                            $param2     = chunk_split(base64_encode($head['file_memori_kasasi']));
                                            $linkPt     = "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                            $extPt      = substr($head['file_memori_kasasi'], strrpos($head['file_memori_kasasi'],'.'));
                                            echo '<a href="'.$linkPt.'" title="'.$head['file_memori_kasasi'].'" style="float:left; margin-right:10px;">
                                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                                        }
                                    ?>
                                    <div class="input-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                     <input type="text" class="form-control datepicker" id="tanggal_kontra_kasasi"  name="tanggal_kontra_kasasi" value="<?php echo $tanggal_kontra_kasasi;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                            </div>
                ...
                <div class="row">        
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="di_kontrakasasi" id="di_kontrakasasi" class="form-control" value="<?php echo $head['di_kontrakasasi']; ?>" maxlength="30"/>
                                <div class="help-block with-errors" id="error_custom4"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php 
                            /* if($isNewRecord){
								...
								$sqlnya = "select nip, nama, jabatan as jabatan_jpn,pangkat as pangkat_jpn  , golongan as gol_jpn, pangkat||' ('||golongan||')' as pangkatgol  
                                        from datun.kontra_kasasi_anak where no_register_skks = '".$head['no_register_skks']."' and no_putusan = '".$head['no_putusan']."'
										and tanggal_putusan = '".$head['tanggal_putusan']."' and tanggal_kontra_kasasi = '".$head['tanggal_kontra_kasasi']."' order by nip";
                           	}
							$hasil = User::findBySql($sqlnya)->asArray()->all();
                            if(count($hasil) == 0)
            ...
            <div class="box-body" style="padding:15px;">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="table3">
                        ...
                        <?php
                        	if (!$isNewRecord) {
								$sql2 = "select no_urut, nama_tergugat as nama from datun.anak_tergugat_kontra_kasasi where no_register_perkara = '".$_SESSION['no_register_perkara']."' and no_surat = '".$_SESSION['no_surat']."' order by no_urut";
							} else {
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				 <?php
					$pathFile 	= Yii::$app->params['kontra_kasasi'].$head['file_kontrakasasi'];
					$cek=($head['file_kontrakasasi'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        ...
                        if($head['file_kontrakasasi'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File Kontra Kasasi';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_kontrakasasi']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_kontrakasasi'], strrpos($head['file_kontrakasasi'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_kontrakasasi'].'" style="float:left; margin-right:10px;">
                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                        }
                    ?>
                    <div class="input-group">

<?php
	...
	$linkCetak		    = '/datun/s28/cetak';
	$tanggal_s28 	    = ($head['tanggal_s28'])?date('d-m-Y',strtotime($head['tanggal_s28'])):''; 
    $tgl_permohonan_pk 	= ($head['tgl_permohonan_pk'])?date('d-m-Y',strtotime($head['tgl_permohonan_pk'])):''; 
	...
	$melalui		    = ($isNewRecord)?"Kepaniteraan ".ucwords($head['nama_pengadilan']):$head['melalui'];
  	$isNewRecord2 	    = ($head['no_permohonan_pk'])?0:1;
?>

<?php if($_SESSION['no_surat'] && $_SESSION['no_register_perkara']){ ?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/s28/simpan" enctype="multipart/form-data">
        		...
        		<div class="form-group form-group-sm">
        			...
        			<div class="col-md-8">
                        <input type="text" class="form-control" value="<?php echo $head['no_register_perkara'];?>" id="no_register_perkara" name="no_register_perkara" placeholder="" readonly="true">
						 ...
						 <input type="text" class="form-control hide" id="no_putusan" name="no_putusan" value="<?php echo $head['no_putusan'];?>" placeholder="" hidden="true">
        ...
        <div class="box box-primary" style="border-color:#f39c12; overflow:hidden;">
            <div class="box-body" style="padding:15px;">
                ...
                <div class="row">        
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">No. Akta Pernyataan PK</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_permohonan_pk" id="no_permohonan_pk" class="form-control" value="<?php echo $head['no_permohonan_pk']; ?>" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal Akta Pernyataan PK</label>
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" class="form-control datepicker" id="tgl_permohonan_pk"  name="tgl_permohonan_pk" value="<?php echo $tgl_permohonan_pk;?>" placeholder="DD-MM-YYYY" />
                                </div>
                            </div>
                            <div class="col-md-offset-4 col-md-8"><div class="help-block with-errors" id="error_costom8"></div></div>
				       </div>
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
							<?php
								$pathFile3 	= Yii::$app->params['relas_s28'].$head['file_relas'];
							...
							<input type="hidden" name="cek_file3" id="cek_file3" value="<?php echo $cek3; ?>">
                                ...
                                <label for="file_template3" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['relas_s28'].$head['file_relas'];
                                        $labelFile  = 'Upload File Akta Penyerahan PK';
                                        if($head['file_relas'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Akta Penyerahan PK';
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
							<?php
								$pathFile2 	= Yii::$app->params['permohonan_pk'].$head['file_permohonan_pk'];
								$cek2=($head['file_permohonan_pk'] && file_exists($pathFile2))?1:0;
							?>
							<input type="hidden" name="cek_file2" id="cek_file2" value="<?php echo $cek2; ?>">
                                ...
                                <label for="file_template2" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['permohonan_pk'].$head['file_permohonan_pk'];
                                        $labelFile  = 'Upload File Akta Pernyataan PK';
                                        if($head['file_permohonan_pk'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Akta Pernyataan PK';
                                            $param1     = chunk_split(base64_encode($pathFile));
                                            $param2     = chunk_split(base64_encode($head['file_permohonan_pk']));
                                            $linkPt     = "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                            $extPt      = substr($head['file_permohonan_pk'], strrpos($head['file_permohonan_pk'],'.'));
                                            echo '<a href="'.$linkPt.'" title="'.$head['file_permohonan_pk'].'" style="float:left; margin-right:10px;">
                                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                                        }
                                    ?>
                                    <div class="input-group">
                ...
                <div class="row">        
					 ...
					 <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-4">
                                <div class="input-group date">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" class="form-control datepicker" id="tanggal_s28"  name="tanggal_s28" value="<?php echo $tanggal_s28;?>" placeholder="DD-MM-YYYY" />
                                </div>                      
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                 <textarea id="kepada_yth" name="kepada_yth" class="form-control" style="height:80px;" maxlength="200" ><?php echo $head['kepada_yth_s28']; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="di_s28" id="di_s28" class="form-control" value="<?php echo $head['di_s28']; ?>" maxlength="20"/>
                                <div class="help-block with-errors" id="error_custom4"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php 
						   /*  if($isNewRecord){
								...
								$sqlnya = "select nip, nama, jabatan as jabatan_jpn,pangkat as pangkat_jpn  , golongan as gol_jpn, pangkat||' ('||golongan||')' as pangkatgol   
                                        from datun.s28_anak where no_register_skks = '".$head['no_register_skks']."' and no_putusan = '".$head['no_putusan']."' 
										and tanggal_putusan = '".$head['tanggal_putusan']."' order by nip";
                           	}
							$hasil = User::findBySql($sqlnya)->asArray()->all();
                            if(count($hasil) == 0)
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading single-project-nav">
                        <ul class="nav nav-tabs"> 
                            ...
                            <li class=""><a href="#tab-primair" data-toggle="tab">PRIMAIR</a></li>  
                            <li class=""><a href="#tab-subsidair" data-toggle="tab">SUBSIDAIR</a></li>  
                        </ul>
                    </div>
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="tab-alasan">
                                 <textarea class="ckeditor" id="tab_alasan" name="tab_alasan" ><?php echo $head['alasan']; ?></textarea>
                                <div class="help-block with-errors" id="error_custom4"></div>
                            </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                <?php
					$pathFile 	= Yii::$app->params['s28'].$head['file_s28'];
					$cek=($head['file_s28'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['s28'].$head['file_s28'];
                        $labelFile 	= 'Upload File S-28';
                        if($head['file_s28'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File S-28';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_s28']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_s28'], strrpos($head['file_s28'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_s28'].'" style="float:left; margin-right:10px;">
                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                        }
                    ?>
                    <div class="input-group">
...
<div class="box-footer" style="text-align: center;"> 
	...
	<input type="hidden" name="isNewRecord2" id="isNewRecord2" value="<?php echo $isNewRecord2;?>" />

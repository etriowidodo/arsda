...
<div class="ms-pedoman-index">
	...
	<?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/ms-pedoman/delete/'
        ]);  
    ?>  
    ...
    <?= GridView::widget([
		...
		'rowOptions'   => function ($model, $key, $index, $grid) {
            return ['data-uu' => $model['uu'],'data-pasal'=>$model['pasal'],'data-kategori'=>$model['kategori']];
        },
        'columns' => [
            ...
            [
                'class'=>'kartik\grid\CheckboxColumn',
                    ...
                    'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' => $model['uu']."#".$model['pasal']."#".$model['kategori'], 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
		'export' => false,
...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-pedoman/update?uu="+uu+"&pasal="+pasal+"&kategori="+kategori;
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-pedoman/update?id="+id;
        $(location).attr('href',url);

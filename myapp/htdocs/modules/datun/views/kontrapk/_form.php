<?php
	...
	$linkCetak		    = '/datun/kontrapk/cetak';
	$tanggal_kontra_pk  = ($head['tanggal_kontra_pk'])?date('d-m-Y',strtotime($head['tanggal_kontra_pk'])):'';
	$tanggal_memori_pk  = ($head['tanggal_memori_pk'])?date('d-m-Y',strtotime($head['tanggal_memori_pk'])):'';	
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/kontrapk/simpan" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
							<?php
								$pathFile3 	= Yii::$app->params['relas_kontra_pk'].$head['file_relas']; 
							...
							<input type="hidden" name="cek_file3" id="cek_file3" value="<?php echo $cek3; ?>">
                                ...
                                <label for="file_template3" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['relas_kontra_pk'].$head['file_relas'];
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            <div class="col-md-12">
                            <?php
                                $pathFile2  = Yii::$app->params['memori_pk'].$head['file_memori_pk'];
                                $cek2=($head['file_memori_pk'] && file_exists($pathFile2))?1:0;
                            ?>
                            <input type="hidden" name="cek_file2" id="cek_file2" value="<?php echo $cek2; ?>">
                                ...
                                <label for="file_template2" class="label-inputfile">
                                    <?php 
                                        $pathFile   = Yii::$app->params['memori_pk'].$head['file_memori_pk'];
                                        $labelFile  = 'Upload File Memori PK';
                                        if($head['file_memori_pk'] && file_exists($pathFile)){
                                            $labelFile  = 'Ubah File Memori PK';
                                            $param1     = chunk_split(base64_encode($pathFile));
                                            $param2     = chunk_split(base64_encode($head['file_memori_pk']));
                                            $linkPt     = "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                            $extPt      = substr($head['file_memori_pk'], strrpos($head['file_memori_pk'],'.'));
                                            echo '<a href="'.$linkPt.'" title="'.$head['file_memori_pk'].'" style="float:left; margin-right:10px;">
                                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                                        }
                                    ?>
                                    <div class="input-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                     <input type="text" class="form-control datepicker" id="tanggal_kontra_pk"  name="tanggal_kontra_pk" value="<?php echo $tanggal_kontra_pk;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                            </div>
                ...
                <div class="row">        
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="di_kontrapk" id="di_kontrapk" class="form-control" value="<?php echo $head['di_kontrapk']; ?>" maxlength="30"/>
                                <div class="help-block with-errors" id="error_custom4"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-body" style="padding:15px;">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="table3">
                        ...
                        <?php
                        	if (!$isNewRecord) {
								$sql2 = "select no_urut, nama_tergugat as nama from datun.anak_tergugat_kontra_pk where no_register_perkara = '".$_SESSION['no_register_perkara']."' and no_surat = '".$_SESSION['no_surat']."' order by no_urut";
							} else {
                ...
                <div class="panel with-nav-tabs panel-default">
                    <div class="panel-heading single-project-nav">
                        <ul class="nav nav-tabs"> 
                            <li class="active"><a href="#tab-amar" data-toggle="tab">AMAR PUTUSAN KONTRA PK</a></li>  
                        </ul>
                    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group form-group-sm">
            <div class="col-md-12">
				 <?php
					$pathFile 	= Yii::$app->params['kontra_pk'].$head['file_kontrapk'];
					$cek=($head['file_kontrapk'] && file_exists($pathFile))?1:0;
				?>
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['kontra_pk'].$head['file_kontrapk'];
                        $labelFile 	= 'Upload File Kontra PK';
                        if($head['file_kontrapk'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File Kontra PK';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($head['file_kontrapk']));
                            $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($head['file_kontrapk'], strrpos($head['file_kontrapk'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$head['file_kontrapk'].'" style="float:left; margin-right:10px;">
                            <img src="'.Yii::$app->inspektur->getIconFile($extPt).'" /></a>';
                        }
                    ?>
                    <div class="input-group">

<?php
	...
	$docx 		= new CreateDocxFromTemplate('../modules/datun/template/S-22.docx');
	...
	$hal_pokok 		= '<table border="0" style="border-collapse:collapse; margin-left:28.3pt;"><tbody><tr><td>'.$model['hal_pokok'].'</td></tr></tbody></table>';		
	$tanggapan 		= '<table border="0" style="border-collapse:collapse; margin-left:28.3pt;"><tbody><tr><td>'.$model['tanggapan'].'</td></tr></tbody></table>';		
	$cpokokperkara 	= '<table border="0" style="border-collapse:collapse; margin-left:28.3pt;"><tbody><tr><td>'.$model['penjelasan_alatbukti'].'</td></tr></tbody></table>';
	...
	$ceksepsi 		= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_eksepsi'].'</td></tr></tbody></table>';		
	$cprovisi 		= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_provisi'].'</td></tr></tbody></table>';		
	$cpokokperkara 	= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_pokokperkara'].'</td></tr></tbody></table>';		
	$crekonvensi 	= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_konvensi_rekonvensi'].'</td></tr></tbody></table>';		
	$ckonvensi 		= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_rekonvensi'].'</td></tr></tbody></table>';
	$csubsidair 	= '<table border="0" style="border-collapse:collapse; margin-left:50.3pt;"><tbody><tr><td>'.$model['prim_subsidair'].'</td></tr></tbody></table>';		

	$tglS22 			= ($model['tanggal_s22'])?date("d-m-Y", strtotime($model['tanggal_s22'])):"............";
	...
	$docx->replaceVariableByText(array('tgl_s22'=>tgl_indo($tglS22)),array('parseLineBreaks'=>true));		
	...
	$docx->replaceVariableByHTML('hal_pokok', 'block','<div style="margin-left:18px; line-height:30px; font-family:Trebuchet MS;">'.$hal_pokok.'</div>', $arrDocnya);	
	$docx->replaceVariableByHTML('tanggapan', 'block','<div style="margin-left:18px; line-height:30px; font-family:Trebuchet MS;">'.$tanggapan.'</div>', $arrDocnya);
	$docx->replaceVariableByHTML('penjelasan', 'block','<div style="margin-left:18px; line-height:30px; font-family:Trebuchet MS;">'.$penjelasan.'</div>', $arrDocnya);	
	$docx->replaceVariableByHTML('kesimpulan', 'block','<div style="margin-left:18px; line-height:30px; font-family:Trebuchet MS;">'.$kesimpulan.'</div>', $arrDocnya);		
	...
	$docx->replaceVariableByHTML('pokok_perkara','block','<div style="margin-left:18px;line-height:30px;font-family:Trebuchet MS;">'.$cpokokperkara.'</div>', $arrDocnya);	
	...
	$docx->replaceVariableByHTML('konvensi', 'block','<div style="margin-left:18px; line-height:30px; font-family:Trebuchet MS;">'.$ckonvensi.'</div>', $arrDocnya);	
	...
	$docx->createDocx('template/datun/S-22_KESIMPULAN');
	$file = 'template/datun/S-22_KESIMPULAN.docx';

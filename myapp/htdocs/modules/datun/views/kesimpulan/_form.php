<?php
	...
	$xtanggal_s22 		= ($model['tanggal_s22'])?date("d-m-Y", strtotime($model['tanggal_s22'])):"";
	...
	$model['prim_subsidair'] = ($model['prim_subsidair'])?$model['prim_subsidair']:'Apabila pengadilan berpendapat lain, mohon putusan yang seadil-adilnya (ex aequo et bono).';

	$helpernya 	= Yii::$app->inspektur;
	$tmp_pggt 	= explode("#", $model['penggugat']);
	$penggugat 	= (count($tmp_pggt) > 1)?$tmp_pggt[0].', Dkk':$tmp_pggt[0];
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/kesimpulan/simpan" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="dikeluarkan" name="dikeluarkan" class="form-control" value="<?php echo Yii::$app->inspektur->getLokasiSatker()->lokasi;?>" readonly />
                                </div>
                            </div>
                        </div>										
                    </div>
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" class="form-control datepicker" id="tgl_kesimpulan" name="tgl_kesimpulan" value="<?php echo ($isNewRecord)?date('d-m-Y'):$xtanggal_s22;?>" placeholder="DD-MM-YYYY" >
                                    </div>
                                </div>
                                <div class="col-md-offset-4 col-md-8"><div class="help-block with-errors" id="err_tgls22"></div></div>
                            </div>
                        </div>
                    </div>
			...
			<div class="panel with-nav-tabs panel-default">
				<div class="panel-heading single-project-nav">
                    <ul class="nav nav-tabs"> 
                        <li class="active"><a href="#tab-pokok" data-toggle="tab">Hal pokok perkara</a></li>
                        <li><a href="#tab-tanggapan" data-toggle="tab">Tanggapan alat bukti</a></li>
                        <li><a href="#tab-penjelasan" data-toggle="tab">Penjelasan alat bukti</a></li>
                        <li><a href="#tab-kesimpulan" data-toggle="tab">Kesimpulan</a></li>		   
                    </ul>
				</div>
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-pokok">
                            <textarea name="pokok" id="pokok" class="ckeditor"><?php echo $model['hal_pokok'];?></textarea>
                        </div>
                        <div class="tab-pane fade" id="tab-tanggapan">
                            <textarea name="tanggapan" id="tanggapan" class="ckeditor"><?php echo $model['tanggapan'];?></textarea>
                        </div>
                        <div class="tab-pane fade" id="tab-penjelasan">
                            <textarea name="penjelasan" id="penjelasan" class="ckeditor"><?php echo $model['penjelasan_alatbukti'];?></textarea>
                        </div>	
			...
			<div class="panel with-nav-tabs panel-default">
				<div class="panel-heading single-project-nav">
                    <ul class="nav nav-tabs"> 
                        ...
                        <li><a href="#tab-perkara" data-toggle="tab">Dalam Pokok Perkara</a></li>
                        <li><a href="#tab-rekonpensi" data-toggle="tab">Dalam Rekonvensi</a></li>	
                        <li><a href="#tab-konpensi" data-toggle="tab">Dalam Konvensi dan Rekonvensi</a></li>	   
                    </ul>
				</div>
                <div class="panel-body">
					<div class="tab-content">
                        <div class="tab-pane active" id="tab-eksepsi">
                            <textarea name="eksepsi" id="eksepsi" class="ckeditor"><?php echo $model['prim_eksepsi'];?></textarea>
                        </div>
                        <div class="tab-pane fade" id="tab-provisi">
                            <textarea name="provisi" id="provisi" class="ckeditor"><?php echo $model['prim_provisi'];?></textarea>
                        </div>
                        <div class="tab-pane fade" id="tab-perkara">
                            <textarea name="perkara" id="perkara" class="ckeditor"><?php echo $model['prim_pokokperkara'];?></textarea>
                        </div>	
                        <div class="tab-pane fade" id="tab-rekonpensi">
                            <textarea name="rekonpensi" id="rekonpensi" class="ckeditor"><?php echo $model['prim_rekonvensi'];?></textarea>
                        </div>	
                        <div class="tab-pane fade" id="tab-konpensi">
                            <textarea name="konpensi" id="konpensi" class="ckeditor"><?php echo $model['prim_konvensi_rekonvensi'];?></textarea>
                        </div>								
					</div>
				</div>	
			</div>
	...
	<div class="box box-primary" style="border-color: #f39c12;overflow: hidden;">
    	...
    	<div class="box-body" style="padding:15px;">
			<textarea name="subsidair" id="subsidair" class="ckeditor"><?php echo $model['prim_subsidair'];?></textarea>		
		</div>
	</div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group form-group-sm">
                <div class="col-md-12">
                    <input type="file" name="file_s22" id="file_s22" class="form-inputfile" />                    
                    <label for="file_s22" class="label-inputfile">
                        <?php 
                            $pathFile 	= Yii::$app->params['s22'].$model['file_s22'];
                            $labelFile 	= 'Upload File S-22';
                            if($model['file_s22'] && file_exists($pathFile)){
                                $labelFile 	= 'Ubah File S-22';
                                $param1  	= chunk_split(base64_encode($pathFile));
                                $param2  	= chunk_split(base64_encode($model['file_s22']));
                                $linkPt 	= "/datun/download-file/index?id=".$param1."&fn=".$param2;
                                $extPt		= substr($model['file_s22'], strrpos($model['file_s22'],'.'));
                                echo '<a href="'.$linkPt.'" title="'.$model['file_s22'].'" style="float:left; margin-right:10px;">
    ...
    <div class="box-footer text-center"> 
        ...
        <a class="btn btn-warning jarak-kanan" href="<?php echo '/datun/kesimpulan/cetak';?>" target="_blank">Cetak</a>

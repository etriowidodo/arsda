				 ...
				 <?php $form = ActiveForm::begin(
					...
					<div class="form-group">
				     <label class="control-label col-md-2">Provinsi</label>
						...
						<div class="col-md-6">
						<input disabled="true" class="form-control" value="<?php echo $kode; ?> | <?php echo \Yii::$app->globalfunc->getWil($kode)->deskripsi ?>">
                        </div>
				    ...
				    <div class="form-group">
				     <label class="control-label col-md-2">Kode Kabupaten</label>
				     	<div class="col-md-3">
						<input type="text" class="form-control" value="" id="kdk" name="kdk" style="width:100px;"/>
				    	</div>
				    </div>
				    <div class="form-group">
				     <label class="control-label col-md-2">Deskripsi</label>
				     	<div class="col-md-8">
						<textarea type="text" class="form-control" value="" id="deskripsi" name="deskripsi" style="width:300px;"></textarea>
						</div>
				    </div>
				    <hr style="border-color: #c7c7c7;margin: 10px 0;">
				    <div class="box-footer" style="text-align: center;"> 
						<a class="btn btn-warning" onclick="javascript:simpan();">Simpan</a> 
				        <?= Html::a('Batal', $model->isNewRecord ? ['index?id='.$kode] : ['../datun/wilayahkab/index'], ['class' => 'btn btn-danger']) ?>
				        <!-- END CMS_PIDUM001_16 -->               
				    </div>
				    <?php ActiveForm::end(); ?>
				</div>
...
function simpan(){
	...
	var desk    = document.getElementById('deskripsi').value;
			$.ajax({
				type: "POST",
				url :'/datun/wilayahkab/simpanwil',

...
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/datun/provinsi/simpan">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <input type="text" id="kode" name="kode" class="form-control" maxlength="2" value="<?php echo $model['id_prop'];?>" <?php echo (!$isNewRecord)?'readonly':'';?> required data-error="Kode belum diisi" />
				</div>
...
<div class="box-footer text-center"> 
    ...
    <a href="/datun/provinsi/index" class="btn btn-danger">Batal</a>
</div>
</form>

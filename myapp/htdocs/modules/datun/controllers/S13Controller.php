...
use app\modules\datun\models\searchs\S13 as Search;
...
class S13Controller extends Controller{
    ...
    public function actionIndex(){
		...
		select a.*, d.deskripsi_inst_wilayah, f.nama_pengadilan, f.alamat as alamat_pengadilan, i.no_register_skk, 
		i.tanggal_skk, i.no_register_skks, h.tanggal_ttd as tanggal_skks, i.tanggal_diterima, i.kepada_yth, i.tempat, i.eksepsi, i.provisi, i.pokokperkara, i.rekonvensi, 
		i.prim_eksepsi, i.prim_provisi, i.prim_pokokperkara, i.prim_rekonvensi, i.prim_konvensirekonvensi, i.subsidair, i.file_s13, e.lawan_pemohon as penggugat 
		...
		left join datun.s13 i on i.no_register_perkara = a.no_register_perkara and i.no_surat = a.no_surat 
	...
	public function actionSimpans13(){
		$model 	= new Search;
		$simpan = $model->simpanDatas13(Yii::$app->request->post());
		if($simpan){

...
class KontraBandingController extends Controller{

    public function actionIndex(){
	    if ($_SESSION['no_surat'] && $_SESSION['no_register_perkara'] ) {
			$sqlnya="SELECT h.no_putusan,h.tanggal_putusan,i.tanggal_kontra_banding,i.kepada_yth,
				i.melalui, i.di_kontrabanding, i.file_kontrabanding,i.amar_putusan, a.tanggal_panggilan_pengadilan, i.no_register_perkara as is_cek , a.no_register_perkara, a.no_surat, a.kode_jenis_instansi,
				a.kode_instansi,a.kode_kabupaten,f.nama_pengadilan,f.alamat,b.no_register_skk,i.file_memori_banding, i.file_relas,
				...
				left join datun.kontra_banding i on i.no_register_perkara=a.no_register_perkara and i.no_surat=a.no_surat
				...
				left join datun.skks d on i.no_register_skk=d.no_register_skk and i.tanggal_skk=d.tanggal_skk and i.no_register_perkara=d.no_register_perkara and i.no_surat=d.no_surat and i.no_register_skks=d.no_register_skks
				where a.no_surat='".$_SESSION['no_surat']."' 
				and a.no_register_perkara='".$_SESSION['no_register_perkara']."' ";
			$head 	= KontraBanding::findBySql($sqlnya)->asArray()->one();
    ...
    public function actionCek(){
		if (Yii::$app->request->isAjax) {
			$model = new KontraBanding;
			$nilai = $model->cekKontraBanding(Yii::$app->request->post());
   ...
   public function actionSimpan(){
	...
	public function actionCetak(){
		if($_SESSION['no_surat'] && $_SESSION['no_register_perkara']) {
			$sqlnya = "
				SELECT h.no_putusan, h.amar_putusan as putusan_awal, h.tanggal_putusan,i.tanggal_kontra_banding,i.no_memori_banding,i.tanggal_memori_banding,i.kepada_yth,
					i.melalui, i.di_kontrabanding, i.file_kontrabanding,i.amar_putusan, a.tanggal_panggilan_pengadilan,a.no_register_perkara,a.no_surat,a.kode_jenis_instansi,
					a.kode_instansi,a.kode_kabupaten,f.nama_pengadilan,f.alamat,b.no_register_skk, a.status_pemohon, a.no_status_pemohon,
					b.tanggal_skk,d.no_register_skks,d.tanggal_ttd as tanggal_skks,
					e.nama_instansi as penggugat,c.deskripsi_inst_wilayah as tergugat,
					a.tanggal_diterima, j.nama_pegawai as nama_pemberi,l.deskripsi_jnsinstansi as jns_instansi, j.jabatan_pegawai,
					coalesce(j.jabatan_pegawai, k.jabatan_pegawai) as pemberi_kuasa, k.jabatan_pegawai as penerima_kuasa, c.alamat as alamat_instansi,
					a.pimpinan_pemohon
					from datun.permohonan a 
					...
					left join datun.kontra_banding i on i.no_register_perkara=a.no_register_perkara and i.no_register_skks=d.no_register_skks
			...
			$model 	= KontraBanding::findBySql($sqlnya)->asArray()->one();

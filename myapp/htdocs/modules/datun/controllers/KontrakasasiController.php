...
use app\modules\datun\models\KontraKasasi;

class KontraKasasiController extends Controller{

    public function actionIndex(){
        if ($_SESSION['no_surat'] && $_SESSION['no_register_perkara']) {
			$sqlnya="SELECT h.no_putusan,h.tanggal_putusan,i.tanggal_kontra_kasasi,i.kepada_yth,
				i.melalui, i.di_kontrakasasi, i.file_kontrakasasi,i.amar_putusan, a.tanggal_panggilan_pengadilan,i.no_register_perkara as is_cek ,a.no_register_perkara, a.no_surat,a.kode_jenis_instansi,
				a.kode_instansi,a.kode_kabupaten,f.nama_pengadilan,f.alamat,i.no_register_skk,
				i.tanggal_skk,i.no_register_skks,d.tanggal_ttd as tanggal_skks, i.file_memori_kasasi, i.file_relas,
				...
				left join datun.kontra_kasasi i on i.no_register_perkara=a.no_register_perkara and i.no_surat=a.no_surat
			...
			$head 	= KontraKasasi::findBySql($sqlnya)->asArray()->one();
    ...
    public function actionCek(){
		if (Yii::$app->request->isAjax) {
			$model = new KontraKasasi;
			$nilai = $model->cekKontraKasasi(Yii::$app->request->post());
   ...
   public function actionSimpan(){
	...
	public function actionCetak(){
		if($_SESSION['no_surat'] && $_SESSION['no_register_perkara'] && $_SESSION['no_register_skk'] && $_SESSION['tanggal_skk'] && $_SESSION['no_skks']) {
			$sqlnya = "
				SELECT h.no_putusan, h.amar_putusan as putusan_awal, h.tanggal_putusan,i.tanggal_kontra_kasasi,i.nomor_memori_kasasi,i.tanggal_memori_kasasi,i.kepada_yth,
					i.melalui, i.di_Kontrakasasi, i.file_Kontrakasasi,i.amar_putusan, a.tanggal_panggilan_pengadilan,a.no_register_perkara,a.no_surat,a.kode_jenis_instansi,
					...
					left join datun.kontra_kasasi i on i.no_register_perkara=a.no_register_perkara and i.no_register_skks=d.no_register_skks
			...
			$model 	= KontraKasasi::findBySql($sqlnya)->asArray()->one();

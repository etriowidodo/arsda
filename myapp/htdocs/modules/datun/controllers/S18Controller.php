...
use app\modules\datun\models\searchs\S18 as Search;

class S18Controller extends Controller{
    ...
    public function actionIndex(){	
		...
		h.tanggal_ttd as tanggal_skks, i.no_s18, i.tanggal_s18, i.kepada_yth, i.tempat, i.nomor_sita_jaminan, i.tanggal_sita_jaminan, i.alasan, i.primair, i.subsidair, 
		i.file_s18, e.lawan_pemohon as penggugat 
		...
		left join datun.s18 i on i.no_register_perkara = a.no_register_perkara and i.no_surat = a.no_surat 
	...
	public function actionCetak(){
     ...
     public function actionSimpan(){
		$model 	= new Search;
		$simpan = $model->simpanDatas18(Yii::$app->request->post());
        if($simpan){

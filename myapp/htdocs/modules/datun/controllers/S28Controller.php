...
class S28Controller extends Controller{

  public function actionIndex(){
  if ($_SESSION['no_surat'] && $_SESSION['no_register_perkara']) {
		$sqlnya="SELECT h.no_putusan,h.tanggal_putusan,i.kepada_yth_s28,i.file_s28,i.tanggal_s28,i.alasan,i.di_s28,a.tanggal_panggilan_pengadilan,i.no_register_perkara as is_cek, a.no_register_perkara,a.no_surat,a.kode_jenis_instansi,
						i.no_permohonan_pk,i.tgl_permohonan_pk,i.file_permohonan_pk,i.melalui,i.isi_petitum_primer,i.isi_petitum_subsider,i.file_relas,
						...
						left join datun.s28 i on i.no_register_perkara=a.no_register_perkara and i.no_surat=a.no_surat 
			...
			$head 	= S28::findBySql($sqlnya)->asArray()->one();
    ...
    public function actionCeks28(){
		if (Yii::$app->request->isAjax) {
			$model = new S28;
			$nilai = $model->cekS28(Yii::$app->request->post());
   ...
   public function actionSimpan(){
	...
	public function actionCetak(){ 
		if($_SESSION['no_surat'] && $_SESSION['no_register_perkara']) {
			$sqlnya="SELECT h.no_putusan,h.tanggal_putusan,i.kepada_yth_s28,i.file_s28,i.tanggal_s28,i.alasan,i.di_s28,a.tanggal_panggilan_pengadilan,a.no_register_perkara,a.no_surat,a.kode_jenis_instansi,
							i.no_permohonan_pk,i.tgl_permohonan_pk,i.file_permohonan_pk,i.melalui,i.isi_petitum_primer,i.isi_petitum_subsider,
							a.kode_instansi,a.kode_kabupaten,f.nama_pengadilan,f.alamat,b.no_register_skk, h.amar_putusan,
							b.tanggal_skk,d.no_register_skks,d.tanggal_ttd as tanggal_skks, a.status_pemohon, a.no_status_pemohon,
							e.nama_instansi as penggugat,c.deskripsi_inst_wilayah as tergugat, j.jabatan_pegawai,
							a.tanggal_diterima, j.nama_pegawai as nama_pemberi,l.deskripsi_jnsinstansi as jns_instansi, m.deskripsi_instansi,
							a.pimpinan_pemohon, c.deskripsi_inst_wilayah, k.jabatan_pegawai as jab_skks
							from datun.permohonan a 
							...
							and d.no_register_skk = k.no_register_skk and d.tanggal_skk = k.tanggal_skk and d.no_register_skks = k.no_register_skks
							inner JOIN datun.lawan_pemohon e on a.no_register_perkara=e.no_register_perkara and a.no_surat=e.no_surat 
							left join datun.putusan h on h.no_register_perkara=a.no_register_perkara and h.no_register_skks=d.no_register_skks
							left join datun.s28 i on i.no_register_perkara=a.no_register_perkara and i.no_register_skks=d.no_register_skks
					...
					";
			$model 	= S28::findBySql($sqlnya)->asArray()->one();

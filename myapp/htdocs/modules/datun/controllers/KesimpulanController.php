...
use app\modules\datun\models\Kesimpulan;
...
class KesimpulanController extends Controller{
    public function actionIndex(){
		...
		h.tanggal_ttd as tanggal_skks, i.tanggal_s22, i.kepada_yth, i.tempat, i.hal_pokok, i.tanggapan, i.penjelasan_alatbukti, i.kesimpulan, i.prim_eksepsi, i.prim_provisi, 
		i.prim_pokokperkara, i.prim_rekonvensi, i.prim_konvensi_rekonvensi, i.prim_subsidair, i.file_s22, e.lawan_pemohon as penggugat 
		...
		left join datun.s22 i on i.no_register_perkara = a.no_register_perkara and i.no_surat = a.no_surat 
		...
		$model = Kesimpulan::findBySql($sqlnya)->asArray()->one();			
		return $this->render('index', ['model' => $model]);	
    }
	
   public function actionSimpan(){
		
		$model 	= new Kesimpulan;

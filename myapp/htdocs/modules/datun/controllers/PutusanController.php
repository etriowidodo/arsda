...
use app\modules\datun\models\Putusan;
...
class PutusanController extends Controller{
    ...
    public function actionIndex(){
		if ($_SESSION['no_surat'] && $_SESSION['no_register_perkara']) {
			$model = new Putusan();
		$sqlnya="SELECT h.no_putusan,h.tanggal_putusan,h.amar_putusan,h.file_putusan,a.tanggal_panggilan_pengadilan,
					a.no_register_perkara, a.no_surat,a.kode_jenis_instansi,h.is_inkrah,
					a.kode_instansi,a.kode_kabupaten,f.nama_pengadilan,f.alamat,h.no_register_skk,
					h.tanggal_skk,h.no_register_skks,d.tanggal_ttd as tanggal_skks,
					e.nama_instansi as penggugat,c.deskripsi_inst_wilayah as tergugat,
					a.tanggal_diterima,h.tanggal_terima_jpn 
					...
					left join datun.skk b on h.no_surat=b.no_surat and h.no_register_perkara=b.no_register_perkara and h.no_register_skk=b.no_register_skk and h.tanggal_skk=b.tanggal_skk
					left join datun.skks d on h.no_register_skk=d.no_register_skk and h.tanggal_skk=d.tanggal_skk and h.no_register_perkara=d.no_register_perkara and h.no_surat=d.no_surat and h.no_register_skks=d.no_register_skks
					where a.no_surat='".$_SESSION['no_surat']."' and a.no_register_perkara='".$_SESSION['no_register_perkara']."'";
		$head 	= Putusan::findBySql($sqlnya)->asArray()->one();
    ...
    public function actionCekputusan(){

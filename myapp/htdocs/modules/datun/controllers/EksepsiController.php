...
use app\modules\datun\models\Eksepsi;


class EksepsiController extends Controller{
    ...
    public function actionIndex(){
		...
		h.tanggal_ttd as tanggal_skks, i.tanggal_diterima_s14, i.kepada_yth, i.tempat, i.alasan, i.primair, i.subsidair, i.file_s14, e.lawan_pemohon as penggugat 
		...
		left join datun.s14 i on a.no_register_perkara = i.no_register_perkara and a.no_surat = i.no_surat 
		...
		$model = Eksepsi::findBySql($sqlnya)->asArray()->one();

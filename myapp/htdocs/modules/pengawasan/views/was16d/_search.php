...
/* @var $model app\modules\pengawasan\models\Was16dSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was16d-search">
    ...
    <?= $form->field($model, 'id_was_16d') ?>

    <?= $form->field($model, 'no_was_16d') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'kpd_was_16d') ?>

    <?php // echo $form->field($model, 'id_terlapor') ?>

    <?php // echo $form->field($model, 'tgl_was_16d') ?>
    ...
    <?php // echo $form->field($model, 'batas_waktu') ?>

    <?php // echo $form->field($model, 'ttd_was_16d') ?>

        ...
        <div class="col-md-4">			
             <?=
                $form->field($model, 'tanggal_ba_was3',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                    ...
                    'options' => [
                        'pluginOptions' => [
                         	'startDate' => date('d-m-Y',strtotime($modelSpWas1['tanggal_sp_was1'])),
                            'endDate' => 0,
                            'autoclose' => true
                        ]
                    ]
    ...
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="col-md-7">
				...
				<input type="text" name="NomorSprint" class="form-control" readonly="true" value="<?= $modelSpWas1->nomor_sp_was1 ?>">
		</div>
	</div>
</div>
</div>
...
<div class="col-md-7">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="col-md-8">
             <?= $form->field($model, 'tempat')->textArea(['rows' => '2']) ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-7">		
        	...
        	<span class="input-group-addon">
				...
				<input type="text" name="TglSprint" class="form-control" readonly="true" value="<?= date('d-m-Y',strtotime($modelSpWas1->tanggal_sp_was1))?>">
			</div>
	</div>
</div>
</div>
...
<div class="col-md-12">
  ...
  <div class="tab-content">
    <div style="margin-left: 20px;"><?= $form->field($model, 'terlapor_atau_saksi')->hiddenInput() ?></div>
        ...
        <div class="col-md-12" style="padding-top: 15px;padding-bottom: 15px;">
                <label>Unggah Berkas WAS-10 :
                    <?php if (substr($model->bawas3_file,-3)!='pdf'){?>
                        <?= ($model['bawas3_file']!='' ? '<a href="viewpdf2?id='.$model['id_ba_was3'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
                    <?php } else{?>
                        <?= ($model['bawas3_file']!='' ? '<a href="viewpdf2?id='.$model['id_ba_was3'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
                    <?php } ?>
                </label>
...
<input type="hidden" name="print" value="2" id="print"/> 
    <div class="box-footer" style="margin:0px;padding:0px;background:none;">
      ...
      <?php
      if (!$model->isNewRecord) {
       echo " ".Html::a('<i class ="fa fa-trash"></i> Hapus', ['/pengawasan/ba-was3/hapus', 'id' => $model->id_ba_was3], ['id' => 'hapusBaWas3', 'class' => 'btn btn-primary']);
       	if($model->peruntukan_ba=='Saksi Eksternal'){
       		echo " ".Html::a('<i class ="fa fa-print"></i> Cetak', ['/pengawasan/ba-was3/cetakeks', 'id' => $model->id_ba_was3], ['id' => 'hapusBaWas3', 'class' => 'btn btn-primary']);
       	}else if($model->peruntukan_ba=='Saksi Internal'){
       		echo " ".Html::a('<i class ="fa fa-print"></i> Cetak', ['/pengawasan/ba-was3/cetakint', 'id' => $model->id_ba_was3], ['id' => 'hapusBaWas3', 'class' => 'btn btn-primary']);
       }else if($model->peruntukan_ba=='Terlapor'){
       		echo " ".Html::a('<i class ="fa fa-print"></i> Cetak', ['/pengawasan/ba-was3/cetak', 'id' => $model->id_ba_was3], ['id' => 'hapusBaWas3', 'class' => 'btn btn-primary']);
       	}
      }
       echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/ba-was3/index'], ['id' => 'KembaliBaWas3', 'class' => 'btn btn-primary']);
	   ?>
    </div>
    </div>
<?php ActiveForm::end(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelBawas3 = new Bawas3Search();
                            $dataProviderBawas3 = $searchModelBawas3->searchBawas3terlapor(Yii::$app->request->queryParams);
                        ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <div class="box box-primary" style="padding: 15px;overflow: hidden;">
                        <?php
                            $searchModelBawas3In = new Bawas3Search();
	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <p>
	                        ...
	                        <div class="box box-primary" style="padding: 15px;overflow: hidden;">
	                        <?php
	                            $searchModelBawas3Ek = new Bawas3Search();
 ...
 window.onload = function () {
    ...
    $(document).on('hidden.bs.modal','#MsaksiEks', function (e) {
 	...
 	$(document).on('click','#Mbtntmbahterlapor', function(){
			...
			$('.tbody_terlapor').append('<tr class=\"rows\">'+
				...
				'<input type=\"hidden\" name=\"id_spwas_terlapor\" value=\"'+data.id_sp_was1+'\" id=\"id_spwas_terlapor\"></td>'+
			...
			$('.bdRiksa').append('<tr class=\"rows_riksa\">'+
				...
				'</tr>');
			 $('#bawas3-terlapor_atau_saksi').val('1');
 	...
 	$(document).on('click','#Mbtntmbahsaksiint', function(){
			...
			$('.bd_saksiIn').append('<tr class=\"rows_saksi_int\">'+
				...
				'<input type=\"hidden\" name=\"id_spwas_in\" value=\"'+data.id_sp_was+'\" id=\"id_spwas_in\"></td>'+
	...
	$(document).on('click','#Mbtntmbahsaksieks', function(){
			...
			$('.bd_saksiEk').append('<tr class=\"rows_saksi_eks\">'+
				...
				'<input type=\"hidden\" name=\"id_spwas_ek\" value=\"'+data.id_sp_was+'\" id=\"id_spwas_ek\"></td>'+

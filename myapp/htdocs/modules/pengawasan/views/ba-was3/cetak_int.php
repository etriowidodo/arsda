...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/ba_was_3_int.docx');
...
// //         $noSpWas=$sp_was_1[0]['nomor_sp_was1'];
        ...
        $docx->createDocx('template/pengawasan/ba_was_3_int');
		
        $file = 'template/pengawasan/ba_was_3_int.docx';

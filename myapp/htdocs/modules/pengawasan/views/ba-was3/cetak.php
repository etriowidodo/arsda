...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/ba_was_3.docx');
...
// //         $noSpWas=$sp_was_1[0]['nomor_sp_was1'];
        ...
        $docx->createDocx('template/pengawasan/ba_was_3');
		
        $file = 'template/pengawasan/ba_was_3.docx';

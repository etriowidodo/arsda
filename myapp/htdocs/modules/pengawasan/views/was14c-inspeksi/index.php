...
<div class="dasar-sp-was-master-index">
    ...
    <p>
        ...
        <div class="btn-toolbar">
            ...
            <a class="btn btn-primary btn-sm pull-right" id="create" href="/pengawasan/was14c-inspeksi/create"><i class="glyphicon glyphicon-plus"> </i>&nbsp;&nbsp;WAS-14C</a>
        </div>
    </p>
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr class="">
                        ...
                        <th style="width: 10%;">No WAS-14 C</th>

...
/* @var $model app\modules\pengawasan\models\Was16aSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was16a-search">
    ...
    <?= $form->field($model, 'id_was_16a') ?>

    <?= $form->field($model, 'no_was_16a') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'kpd_was_16a') ?>

    <?php // echo $form->field($model, 'id_terlapor') ?>

    <?php // echo $form->field($model, 'tgl_was_16a') ?>
    ...
    <?php // echo $form->field($model, 'ttd_was_16a') ?>

...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $tglsurat=($model['was1_tgl_surat']!=''?$tglcetak:'<p></p>');
        ...
        $docx->replaceVariableByHTML('kejaksaan', 'inline','<p style="text-align: center;><b>'.$kejaksaan.'</b></p>', array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
        ...
        $docx->replaceVariableByHTML('analisa', 'block','<p style="text-align: justify; margin: 0px;">'.$analisa.'</p>', array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
        ...
        $docx->replaceVariableByHTML('tglcetak', 'inline',' '.$tglsurat, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
		...
		$no_register1 = str_replace("/","_",$no_register);

        ...
        <div class="box-body" style="margin-top:10px;">
            <div class="col-md-12">
                <div class="col-md-6" style="padding-left: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
							<?= $form->field($model, 'no_was_27_inspeksi')->textInput()->label(false) ?>
                ...
                <div class="col-md-6" style="padding-right: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?= $form->field($model, 'tgl_was_27',['addon' => ['prepend' => ['content'=>'<i class="fa fa-calendar" id="tgl_was_27"></i>']]])->textInput()->label(false);?>
                            <!--<input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="4" type="text">-->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12" style="margin-top:10px;">
                <div class="col-md-6"  style="padding-left: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?= $form->field($model, 'kepada_was_27')->textInput()->label(false) ?>    
                            <!--<input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="4" type="text">-->
                        </div>
                    </div>
                </div>
                <div class="col-md-6" style="padding-right: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?= $form->field($model, 'dari_was_27')->textInput()->label(false) ?>
                            <!--<input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="4" type="text">-->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12" style="margin-top:10px;">
                        ...
                        <div class="col-md-9">
                             <?php 
                                $list = [0 => 'Pilih',
                                     ...
                                     echo $form->field($model, 'sifat_was_27')->dropDownList($list)->label(false);
                            ?> 
                        </div>
                    </div>
                </div>
                <div class="col-md-6" style="padding-right: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <?= $form->field($model, 'lampiran_was_27')->textInput()->label(false) ?>
                            <!-- <input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="4" type="text">-->
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12" style="margin-top:10px;">
                <div class="col-md-6" style="padding-left: 0px;">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?= $form->field($model, 'perihal_was_27')->textInput()->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6" style="padding-left: 0px;">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <!--<input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="4" type="text">-->
						<?php
							#Tidak ada field nomor_surat_lapdu dan tanggal_surat_lapdu pada tabel was_27_inspeksi
							if($model->isNewRecord){
							  //$model->nomor_surat_lapdu=$modelLapdu->nomor_surat_lapdu;
							  //$model->tgl_lapdu=$modelLapdu->tanggal_surat_lapdu;
							} 
                        ?>
                        <?//= $form->field($modelLapdu, 'nomor_surat_lapdu')->textInput(['readonly'=>'readonly'])->label(false)  ?>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6" style="padding-right: 0px;">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <!--<input id="dipamaster-tahun" class="form-control" name="DipaMaster[tahun]" maxlength="10" type="text">-->
						<?//= $form->field($modelLapdu, 'tanggal_surat_lapdu')->textInput(['readonly'=>'readonly'])->label(false) ?>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel-body">
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="permasalahan"> 
                                <div class="col-md-12">
                                    <?= $form->field($model, 'permasalahan_was_27')->textarea(['class'=>'ckeditor','rows' => 3])->label(false) ?>
                                </div> 
                            </div>
                            <div class="tab-pane fade" id="data">
                                <div class="col-md-12">
                                    <?= $form->field($model, 'data_was_27')->textarea(['class'=>'ckeditor','rows' => 3])->label(false) ?>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="Analisa">
                                <div class="col-md-12">
                                    <?= $form->field($model, 'analisa_was_27')->textarea(['class'=>'ckeditor','rows' => 3])->label(false) ?>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="kesimpulan">
                                <div class="col-md-12">
                                    <?= $form->field($model, 'kesimpulan_was_27')->textarea(['class'=>'ckeditor','rows' => 3])->label(false) ?>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--Begin----> 
						...
						<div class="panel-body">
							...
							<?php
								...
								foreach ($modelTerlapor as $rowterlapor) {
										$terlapor1 .="
											<li>Terlapor ".$rowterlapor['nama_terlapor'].", Pangkat(Gol) ".$rowterlapor['pangkat_terlapor'].'('.$rowterlapor['golongan_terlapor'].") ,NIP/NRP ".$rowterlapor['nip_terlapor'].($rowterlapor['nrp_terlapor']==''?'':'/'.$rowterlapor['nrp_terlapor'])." jabatan ".$rowterlapor['jabatan_terlapor']." dihentikan pemeriksaan nya kecuali apabila dikemudian hari ditemukan data dan bukti baru.</li>
										";
								}
								$terlapor1.="</ol>";
								...
								foreach ($modelTerlapor as $rowterlapor2) {
										$terlapor2 .="
											<li>Terlapor ".$rowterlapor2['nama_terlapor'].", Pangkat(Gol) ".$rowterlapor2['pangkat_terlapor'].'('.$rowterlapor2['golongan_terlapor'].") ,NIP/NRP ".$rowterlapor2['nip_terlapor'].($rowterlapor2['nrp_terlapor']==''?'':'/'.$rowterlapor2['nrp_terlapor'])." jabatan ".$rowterlapor2['jabatan_terlapor']." dihentikan pemeriksaan nya kecuali apabila dikemudian hari ditemukan data dan bukti baru.</li>
										";
								}
								$terlapor2.="</ol>";
			...
			<div class="col-md-12" style="margin-top:20px;">
				<div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <?= $form->field($model, 'persetujuan_was_27')->textarea(['class'=>'ckeditor','rows' => 3])->label(false) ?>
                    </div>
                </div>
			</div>
			<div class="col-md-12" style="margin-top:20px;">
            ...
            <div class="col-md-12" style="padding-top: 15px;padding-bottom: 15px;">
                <label>Unggah Berkas WAS-27 :
                    <?php if (substr($model->file_was_27,-3)!='pdf'){?>
                        <?= ($model['file_was_27']!='' ? '<a href="viewpdf?id='.$model['id_was_27_inspeksi'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
                    <?php } else{?>
                        <?= ($model['file_was_27']!='' ? '<a href="viewpdf?id='.$model['id_was_27_inspeksi'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
                    <?php } ?>
                </label>
                ...
                <span class="fileupload-exists "> Rubah File</span>         <input type="file" name="file_was_27" id="file_was_27" /></span>
...
<!--End---->  
		...
		<?php
			...
			if(!$model->isNewRecord){
				echo ' '.Html::a('<i class="fa fa-print"></i> Cetak', ['/pengawasan/was27-inspeksi/cetak', 'id' => $model->id_was_27_inspeksi], ['class' => 'btn btn-primary']);
			}
			
			echo ' '.Html::a('<i class="fa fa-arrow-left"></i> Kembali', ['/pengawasan/was27-inspeksi/index'], ['class' => 'btn btn-primary']);
        ?> 
        </div>
        </div>
    </div>
...
/*end js upload*/
	$(document).ready(function(){
		$('#was27inspeksi-tgl_was_27').datepicker();
		/*js upload*/
			!function(e){var t=function(t,n){this.$element=e(t),this.type=this.$element.data("uploadtype")||(this.$element.find(".thumbnail").length>0?"image":"file"),this.$input=this.$element.find(":file");if(this.$input.length===0)return;this.name=this.$input.attr("name")||n.name,this.$hidden=this.$element.find('input[type=hidden][name="'+this.name+'"]'),this.$hidden.length===0&&(this.$hidden=e('<input type="hidden" />'),this.$element.prepend(this.$hidden)),this.$preview=this.$element.find(".fileupload-preview");var r=this.$preview.css("height");this.$preview.css("display")!="inline"&&r!="0px"&&r!="none"&&this.$preview.css("line-height",r),this.original={exists:this.$element.hasClass("fileupload-exists"),preview:this.$preview.html(),hiddenVal:this.$hidden.val()},this.$remove=this.$element.find('[data-dismiss="fileupload"]'),this.$element.find('[data-trigger="fileupload"]').on("click.fileupload",e.proxy(this.trigger,this)),this.listen()};t.prototype={listen:function(){this.$input.on("change.fileupload",e.proxy(this.change,this)),e(this.$input[0].form).on("reset.fileupload",e.proxy(this.reset,this)),this.$remove&&this.$remove.on("click.fileupload",e.proxy(this.clear,this))},change:function(e,t){if(t==="clear")return;var n=e.target.files!==undefined?e.target.files[0]:e.target.value?{name:e.target.value.replace(/^.+\\/,"")}:null;if(!n){this.clear();return}this.$hidden.val(""),this.$hidden.attr("name",""),this.$input.attr("name",this.name);if(this.type==="image"&&this.$preview.length>0&&(typeof n.type!="undefined"?n.type.match("image.*"):n.name.match(/\.(gif|png|jpe?g)$/i))&&typeof FileReader!="undefined"){var r=new FileReader,i=this.$preview,s=this.$element;r.onload=function(e){i.html('<img src="'+e.target.result+'" '+(i.css("max-height")!="none"?'style="max-height: '+i.css("max-height")+';"':"")+" />"),s.addClass("fileupload-exists").removeClass("fileupload-new")},r.readAsDataURL(n)}else this.$preview.text(n.name),this.$element.addClass("fileupload-exists").removeClass("fileupload-new")},clear:function(e){this.$hidden.val(""),this.$hidden.attr("name",this.name),this.$input.attr("name","");if(navigator.userAgent.match(/msie/i)){var t=this.$input.clone(!0);this.$input.after(t),this.$input.remove(),this.$input=t}else this.$input.val("");this.$preview.html(""),this.$element.addClass("fileupload-new").removeClass("fileupload-exists"),e&&(this.$input.trigger("change",["clear"]),e.preventDefault())},reset:function(e){this.clear(),this.$hidden.val(this.original.hiddenVal),this.$preview.html(this.original.preview),this.original.exists?this.$element.addClass("fileupload-exists").removeClass("fileupload-new"):this.$element.addClass("fileupload-new").removeClass("fileupload-exists")},trigger:function(e){this.$input.trigger("click"),e.preventDefault()}},e.fn.fileupload=function(n){return this.each(function(){var r=e(this),i=r.data("fileupload");i||r.data("fileupload",i=new t(this,n)),typeof n=="string"&&i[n]()})},e.fn.fileupload.Constructor=t,e(document).on("click.fileupload.data-api",'[data-provides="fileupload"]',function(t){var n=e(this);if(n.data("fileupload"))return;n.fileupload(n.data());var r=e(t.target).closest('[data-dismiss="fileupload"],[data-trigger="fileupload"]');r.length>0&&(r.trigger("click.fileupload"),t.preventDefault())})}(window.jQuery)
		/*end js upload*/
	});
    ...
    $(document).on('click','.cari_ttd',function() { 
      $('#grid-penandatangan_surat').addClass('loading');
        $("#grid-penandatangan_surat").load("/pengawasan/was27-inspeksi/getttd",function(responseText, statusText, xhr)
            {
    ...
    var data=JSON.parse($(".selection_one:checked").attr("json"));
       $('#was27inspeksi-nip_penandatangan').val(data.nip);
       $('#was27inspeksi-nama_penandatangan').val(data.nama);
       $('#was27inspeksi-jabatan_penandatangan').val(data.nama_jabatan);

            ...
            <thead>
                <tr>
                   <th width="4%" style="text-align:center;">No</th>
                      ...
                      <th width="2%" rowspan="2" style="text-align:center;">Pilih</th>
                </tr>
            </thead>
            <tbody class="bd_saksi_in">
                <?php 
                $no_in=1;
                foreach ($modelSaksiIn as $key) {
                ?>
                <tr>
                    <td style="text-align:center;"><?php echo $no_in?></td>
                    <td><?php echo $key['nip']?></td>
                    <td><?php echo $key['nama_saksi_internal']?></td>
                    <td><?php echo $key['jabatan_saksi_internal']?></td>
                    <td><?php echo $key['pangkat_saksi_internal']?></td>
                    <td><a  id="pilih_saksi_in" data-dismiss="modal" nip="<?php echo $key['nip']?>" nama_saksi_in="<?php echo $key['nama_saksi_internal']?>" jabatan="<?php echo $key['jabatan_saksi_internal']?>" pangkat="<?php echo $key['pangkat_saksi_internal']?>" golongan="<?php echo $key['golongan_saksi_internal']?>" class="btn btn-primary pilih_saksi_in">Pilih</a></td>
                </tr>
                <?php
                $no_in++;
                    }

...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/ba_was_9.docx');
        ...
        $tanggal		    =($model['tgl_ba_was_9']!=''?\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_ba_was_9']):'-'); 
		...
		$docx->replaceVariableByText(array('pasal_9'=>$pasal), array('parseLineBreaks'=>true)); 
		$docx->replaceVariableByText(array('berupa_9'=>$kategori_hukuman), array('parseLineBreaks'=>true)); 

            
		// $no_register1 = str_replace("/","",$no_register);
        $docx->createDocx('template/pengawasan/ba_was_9');
		
        $file = 'template/pengawasan/ba_was_9.docx';

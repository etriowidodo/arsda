                    ...
                    'buttons' => [
                        'pilih' => function ($url, $model,$key) {
                            return Html::button('Pilih', ['class' => 'btn btn-primary','onclick'=>'
																						$("#was16b-ttd_peg_nama").val("'.$model['peg_nama'].'");
																						$("#was16b-ttd_peg_nip").val("'.(empty($model['peg_nip_baru']) ? $model['peg_nip']:$model['peg_nip_baru']) .'");
																						$("#was16b-ttd_peg_pangkat").val("'.$model['gol_pangkat'].'");
																						$("#was16b-ttd_peg_jabatan").val("'.$model['jabatan'].'");
																						$("#was16b-ttd_peg_nik").val("'.$model['peg_nik'].'");
																						$("#was16b-ttd_id_jabatan").val("'.$model['id'].'");

...
/* @var $model app\modules\pengawasan\models\Was16bSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was16b-search">
    ...
    <?= $form->field($model, 'id_was_16b') ?>

    <?= $form->field($model, 'no_was_16b') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'kpd_was_16b') ?>

    <?php // echo $form->field($model, 'id_terlapor') ?>

    <?php // echo $form->field($model, 'tgl_was_16b') ?>
    ...
    <?php // echo $form->field($model, 'ttd_was_16b') ?>

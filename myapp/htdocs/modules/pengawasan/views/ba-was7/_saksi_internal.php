                 ...
                 [
                    ...
                    'buttons' => [
                        'pilih' => function ($url, $model,$key) use ($param){
                            return Html::button('<i class="fa fa-check"></i> Pilih', ['class' => 'btn btn-primary','onclick'=>'Pilih('.$model['id'].','.$model['peg_nik'].',\''.$model['jabatan'].'\', \''.$model['gol_pangkat'].'\', \''.$model['peg_nip_baru'].'\', \''.$model['peg_nama'].'\')']);
                        },
                    ]
                ],

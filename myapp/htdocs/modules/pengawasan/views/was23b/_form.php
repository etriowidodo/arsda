    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                <?= $form->field($model, 'no_was_23b')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                <?= $form->field($model, 'tgl_was_23b',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                <?= $form->field($model, 'kpd_was_23b')->textInput(['maxlength' => true]) ?>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8">
                    <div class="input-group">
                         <?php if(!$model->isNewRecord){ ?>
                            <input id="was23b-dari" class="form-control" name="Was23b[dari]" readonly="readonly" value="<?= $model['jabatan_penandatangan'] ?>"  type="text">
                        <?php }else{ ?>
                            <input id="was23b-dari" class="form-control" name="Was23b[dari]" readonly="readonly" value="Jaksa Agung Muda Pengawasan"  type="text">
                        <?php } ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input id="was23b-was6" name="was23b-was6" type="hidden">
                                    <input id="was23b-idterlapor" name="was23b-idterlapor" type="hidden">
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="col-md-12">
    ...
    <?= $form->field($model, 'sk')->hiddenInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'tanggal_ba')->hiddenInput() ?>

    <?php if(!$model->isNewRecord){ ?>
    <div class="col-md-12" style="padding-top: 15px;padding-bottom: 15px;">
        <label>Unggah Berkas WAS-23b : 
             <?php if (substr($model->upload_file,-3)!='pdf'){?>
                <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_23b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
            <?php } else{?>
                <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_23b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
            <?php } ?>
        </label>
    ...
    <div class="form-group" style="text-align: center;">
        ...
        <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['was23b/index'])?>"><i class="fa fa-arrow-left"></i> Batal</a>
    </div>
</div>
    <?php ActiveForm::end(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas23b = new Was23bSearch();
                            $dataProviderPenandatangan = $searchModelWas23b->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas23b = new Was23bSearch();
                            $dataProviderTerlapor = $searchModelWas23b->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
    ...
    $(document).on('click','#tambah_terlapor',function() {
      ...
      if(jml=>1 && jml<2){
        if(jQuery.inArray(data.nip_terlapor,pecah)==-1){
         $('#was23b-nip_pegawai_terlapor').val(data.nip_terlapor);
         $('#was23b-nama_pegawai_terlapor').val(data.nama_terlapor);
         $('#was23b-jabatan_pegawai_terlapor').val(data.jabatan_terlapor);
         $('#was23b-golongan_pegawai_terlapor').val(data.golongan_terlapor);
         $('#was23b-pangkat_pegawai_terlapor').val(data.pangkat_terlapor);
         $('#was23b-sk').val(data.sk);
         $('#was23b-tanggal_ba').val(data.tanggal_pemberitahuan_ba);
         $('#was23b-was6').val(data.id_ba_was_6);
         $('#was23b-idterlapor').val(data.id_terlapor_l_was2);
         $('#was23b-id_sp_was2').val(data.id_sp_was2);
         $('#was23b-id_ba_was2').val(data.id_ba_was2);
         $('#was23b-id_l_was2').val(data.id_l_was2);
         $('#was23b-id_was15').val(data.id_was15);
         $('#terlapor').modal('hide');
        }else{
            bootbox.alert({
        ...
        var data=JSON.parse($(".MPenandatangan_selection_one:checked").attr("json"));
           $('#was23b-nip_penandatangan').val(data.nip);
           $('#was23b-nama_penandatangan').val(data.nama);
           $('#was23b-nama_dari').val(data.nama_jabatan);
           $('#was23b-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was23b-dari').val(data.nama_jabatan);
           $('#was23b-golongan_penandatangan').val(data.gol_kd);
           $('#was23b-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was23b-jbtn_penandatangan').val(data.jabtan_asli);

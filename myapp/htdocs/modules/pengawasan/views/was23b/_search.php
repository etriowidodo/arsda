...
/* @var $model app\modules\pengawasan\models\Was23bSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was23b-search">
    ...
    <?php // echo $form->field($model, 'id_was_23b') ?>

    <?php // echo $form->field($model, 'no_was_23b') ?>
    ...
    <?php // echo $form->field($model, 'kpd_was_23b') ?>
    ...
    <?php // echo $form->field($model, 'tgl_was_23b') ?>

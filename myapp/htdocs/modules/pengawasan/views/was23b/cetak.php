...
require_once('/wordtest/classes/CreateDocx.inc');
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/was23b.docx');
      ...
      //  $diKpd                =$model['tempat'];
       ...
       $docx->replaceVariableByHTML('tembusan', 'block',$tembusan, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
 		...
 		$docx->createDocx('template/pengawasan/was23b');
		
        $file = 'template/pengawasan/was23b.docx';

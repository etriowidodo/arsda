...
<!-- href="/pengawasan/sk-was-3a/create" -->
    <p>
        <div class="btn-toolbar">
              <a class="btn btn-primary btn-sm pull-right" id="cetak_skwas3a"><i class="glyphicon glyphicon-print"> </i> Cetak </a>&nbsp;
              <a class="btn btn-primary btn-sm pull-right" id="hapus_skwas3a"><i class="glyphicon glyphicon-trash"> </i> Hapus </a>&nbsp;
              <a class="btn btn-primary btn-sm pull-right" id="ubah_skwas3a"><i class="glyphicon glyphicon-pencil"> </i> Ubah </a>&nbsp;
              <a class="btn btn-primary btn-sm pull-right" id="create_skwas3a" ><i class="glyphicon glyphicon-plus"> </i> SK-WAS-3A</a>
            </div>
    </p>
    <style type="text/css">
...
legend.group-border {
    ...
    font-size: 14px;
     ...
     <fieldset class="group-border">
        <legend class="group-border">Daftar SK-WAS-3A</legend>
    <?= GridView::widget([
...
//         $("#create_skwas3a").addClass("disabled");
//         $("#ubah_skwas3a").addClass("disabled");
//         $("#hapus_skwas3a").addClass("disabled");
//         $("#cetak_skwas3a").addClass("disabled");
//       }else{
//         $(this).find('.checkbox-row').prop('checked',true);
//         $("#create_skwas3a").removeClass("disabled");
//         $("#ubah_skwas3a").removeClass("disabled");
//         $("#hapus_skwas3a").removeClass("disabled");
//         $("#cetak_skwas3a").removeClass("disabled");
//       }
//       // alert(z);
// });
...
//     });
  ...
  function ConditionOfButton(n){
        if(n == 1){
           $('#cetak_skwas3a,#ubah_skwas3a,#create_skwas3a, #hapus_skwas3a').removeClass('disabled');
        } else if(n > 1){
           $('#hapus_skwas3a').removeClass('disabled');
           $('#cetak_skwas3a,#ubah_skwas3a,#create_skwas3a').addClass('disabled');
        } else{
           $('#cetak_skwas3a,#ubah_skwas3a,#create_skwas3a, #hapus_skwas3a').addClass('disabled');
        }
    }

    $('#create_skwas3a').click(function(){
       ...
       if(x>=2 || x<=0){
         ...
         return false
           ...
           if(check.nip_trlp != null){
            ...
            location.href='/pengawasan/sk-was-3a/create?id='+check.nip_terlapor+'&id2='+check.pasal;
           } 
         }
    });

    $('#ubah_skwas3a').click(function(){
    ...
    $(document).on('click', '#cetak_skwas3a', function () {

          // alert()
          var x=$(".checkbox-row:checked").length;
          var link=$(".checkbox-row:checked").val();
          var check=JSON.parse($('.checkbox-row:checked').attr('json'));
         // alert(check.id_sk_was_3a);
          ...
          if(check.id_sk_was_3a == null){
             bootbox.alert({
              ...
              location.href='/pengawasan/sk-was-3a/cetak?id='+check.id_sk_was_3a;
           }
          
          //alert(nilai);
        });

$(document).on('click','#hapus_skwas3a',function(){
                                ...
                                var checkValues = $('.checkbox-row:checked').map(function()
                                {
                                 ...
                                 var jml=$('.checkbox-row:checked').length;
                                    for (var i = 0; i<jml; i++) {
                                        ...
                                        $.ajax({
                                            type:'POST',
                                            url:'/pengawasan/sk-was-3a/delete',
                                            data:'id='+data.id_sk_was_3a+'&jml='+jml,

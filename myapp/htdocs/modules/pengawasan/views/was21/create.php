 ...
 <div>
  ...
  <div class="box-header with-border">
      <div class="col-md-12" style="border:1px solid #cecece;border-radius:4px;padding:10px 0px;background-image: linear-gradient(to bottom, rgba(255, 255, 255, 1) 0%, rgba(246, 246, 246, 1) 47%, rgba(237, 237, 237, 1) 100%);margin-top: -15px;">
       <div class="form-group">
              <div class="col-lg-10"> <span class="pull-left" style="margin-left: 15px;"> <a class="btn btn-primary" data-toggle="modal" data-target="#p_was21"><i class="glyphicon glyphicon-user"></i> Tambah Identitas Terlapor</a> </span> </div>
...
<?php
    Modal::begin([
     ...
     <div id="update-21">
            <?php echo $this->render('_form', ['model'=> $model, 'modelTembusan' => $modelTembusan,'modelAlasan' => $modelAlasan,
                'modelTanggapan'=>$modelTanggapan,]); ?></div>
	<?php
Modal::end();?>
<?php
    Modal::begin([

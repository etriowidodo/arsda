...
<div class="box box-primary" style="padding: 15px 15px;">
    <div class="col-md-12">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                <?= $form->field($model, 'no_was_16c')->textInput(['maxlength' => true])->label(false); ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
               <?= $form->field($model, 'kpd_was_16c')->textInput(['maxlength' => true])->label(false); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
                <?= $form->field($model, 'tgl_was_16c',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <!-- <label class="control-label col-md-4">Perihal</label> -->
                <div class="col-md-8">
               <?//= $form->field($model, '')->textInput(['maxlength' => true])->label(false); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12" style="padding-top: 15px;padding-bottom: 15px;">
        <label>Unggah Berkas WAS-11 : 
             <?php if (substr($model->upload_file,-3)!='pdf'){?>
                <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_16c'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
            <?php } else{?>
                <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_16c'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
            <?php } ?>
        </label>
    ...
    <div class="form-group" style="text-align: center;">
        ...
        <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['was16c/index'])?>"><i class="fa fa-arrow-left"></i> Batal</a>
    </div>
</div>
    <?php ActiveForm::end(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas16c = new Was16cSearch();
                            $dataProviderPenandatangan = $searchModelWas16c->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas16c = new Was16cSearch();
                            $dataProviderTerlapor = $searchModelWas16c->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
...
window.onload=function(){
    ...
    $(document).on('hidden.bs.modal','#penandatangan,#terlapor', function (e) {
      $(this)
     ...
     $(document).on('click','#tambah_penandatangan',function() {
      ...
      if(jml=>1 && jml<2){
         $('#was16c-nip_penandatangan').val(data.nip);
         $('#was16c-nama_penandatangan').val(data.nama);
         $('#was16c-jabatan_penandatangan').val(data.nama_jabatan);
         $('#was16c-jbtn_penandatangan').val(data.jabtan_asli);
    ...
    $(document).on('click','#tambah_terlapor',function() {
      ...
      if(jml=>1 && jml<2){
        if(jQuery.inArray(data.nip_terlapor,pecah)==-1){
         $('#was16c-nip_pegawai_terlapor').val(data.nip_terlapor);
         $('#was16c-nama_pegawai_terlapor').val(data.nama_terlapor);
         $('#was16c-jabatan_pegawai_terlapor').val(data.jabatan_terlapor);
         $('#was16c-golongan_pegawai_terlapor').val(data.golongan_terlapor);
         $('#was16c-pangkat_pegawai_terlapor').val(data.pangkat_terlapor);
         $('#was16c-sk').val(data.sk);
         $('#was16c-tanggal_ba').val(data.tanggal_pemberitahuan_ba);

         $('#was16c-id_sp_was2').val(data.id_sp_was2);
         $('#was16c-id_ba_was2').val(data.id_ba_was2);
         $('#was16c-id_l_was2').val(data.id_l_was2);
         $('#was16c-id_was15').val(data.id_was15);
         $('#terlapor').modal('hide');
        }else{
            bootbox.alert({

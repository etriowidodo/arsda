...
$form = ActiveForm::begin([
            ...
            'action' => (empty($model['id_was_16c']) ? Url::toRoute('was16c/create') : Url::toRoute('was16c/update2?id=' . $model["id_was_16c"] . '')),
            'fieldConfig' => [
        ...
        <div class="col-md-9">	
          ...
          if ($model->isNewRecord) {
            $sql = (new \yii\db\Query())
                    ...
                    ->andWhere(['not in', 'terlapor.id_terlapor', (new \yii\db\Query())->select('id_terlapor')->from('was.was_16c')->where(['was_16c.id_register' => $model->id_register])->andWhere('flag != :del', ['del' => '3'])])
                    ->all();
            ...
            echo $form->field($model, 'id_terlapor')->dropDownList($data, ['prompt' => '---Pilih---',
                'onchange' => '
                    ...
                    var temp = e.split("-");
                    $("#was16c-perihal").val("Penyampaian Surat Pernyataan Akan Mengajukan Pembelaan Diri Dihadapan Majelis Kehormatan Jaksa Terlapor atas nama."+temp[1]);
                  '
  ...
  <div class="col-md-12">
    <div class="col-md-8">
      <div class="form-group">
        ...
        <div class="col-md-4">
          <?php if ($model->isNewRecord) { ?>
            <div class="input-group">
              ...
              <input class="form-control" type="text" id="no_was_16c" name="no_was_16c">
            </div>
          <?php } else { ?>
            <div class="input-group">
              <span class="input-group-addon"><?php echo substr($model->no_was_16c, 0, 2); ?></span>
              <input class="form-control" type="text" id="no_was_16c" name="no_was_16c" value="<?php echo substr($model->no_was_16c, 2); ?>">
            </div>
          <?php } ?>
        </div>
        <!--<div class="col-md-4">
        ...
        <div class="col-md-4">
        <?php //echo $form->field($model, 'no_was_16c')->textInput(['maxlength' => true,'style'=>'margin-left:-80px'])  ?>
        </div>-->
      </div>
    </div>
    <div class="col-md-4">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <?=
          $form->field($model, 'tgl_was_16c')->widget(DateControl::className(), [
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">	
          ...
          /* $sql = (new \yii\db\Query())
            ...
            echo $form->field($model, 'kpd_was_16c')->dropDownList($data, ['label'=>'','readonly'=>true]);
           */
...
<div class="box box-primary">
  ...
  <input id="was16c-ttd_peg_nik" class="form-control" type="hidden" name="Was16c[ttd_peg_nik]" value="<?php echo $model->ttd_peg_nik; ?>">
  <input id="was16c-ttd_id_jabatan" class="form-control" type="hidden" name="Was16c[ttd_id_jabatan]" value="<?php echo $model->ttd_id_jabatan; ?>">
  <div class="col-md-6">
    <div class="form-group">
      <label style="margin-top:18px;" class="control-label col-md-3">Nama</label>
      <div class="col-lg-9">
        <div class="form-group field-was16c-ttd_peg_nik">
          <div class="col-sm-12">
        ...
        <div class="form-group field-was16c-ttd_peg_nama">
          <div class="col-sm-12">				 
<?= $form->field($model, 'ttd_peg_nama')->textInput(['class' => 'form-control', 'readonly' => true]) ?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <div class="form-group field-was16c-ttd_peg_nip">
          <div class="col-sm-12">
<?= $form->field($model, 'ttd_peg_nip')->textInput(['class' => 'form-control', 'readonly' => true]) ?>
  ...
  <div style="margin-top:15px;" class="col-md-6">
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <div class="form-group field-was16c-ttd_peg_jabatan">
          <div class="col-sm-12">
<?= $form->field($model, 'ttd_peg_pangkat')->textInput(['class' => 'form-control', 'readonly' => true]) ?>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-9">
        <div class="form-group field-was16c-ttd_peg_inst_satker">
          <div class="col-sm-12">
...
<div class="box box-primary">
  ...
  <div class="box-header with-border">
    <table id="table_tembusan" class="table table-bordered">
      ...
      <tbody id="tbody_tembusan-was16c">
        <?php if (!$model->isNewRecord): ?>
...
<div style="margin:0px;padding:0px;background:none;" class="box-footer">
  <div class="form-group">
    <?php
    echo Html::submitButton($model->isNewRecord ? '<i class="fa fa-pencil-square-o"></i> Simpan' : '<i class="fa fa-pencil-square-o"></i> Simpan', ['class' => $model->isNewRecord ? 'btn btn-primary' : 'btn btn-primary']);
    if (!$model->isNewRecord) {
      echo " " . Html::a('<i class ="fa fa-times"></i> Hapus', ['/pengawasan/was16c/hapus', 'id' => $model->id_was_16c], ['id' => 'hapusWas16c', 'class' => 'btn btn-primary']);
    }
    ?>
  </div>
</div>

...
use app\modules\pengawasan\models\Was9_TuSearch;
...
<div class="was9-index">
    ...
    <h1><?php //print_r($_SESSION);//= Html::encode($this->title) ?></h1>
                                    ...
                                    'columns' => [
                                     ['header'=>'No',
                                       ...
                                       ['class' => 'yii\grid\CheckboxColumn',
                                        'headerOptions'=>['style'=>'text-align:center'],
                                        'contentOptions'=>['style'=>'text-align:center; width:5%' , 'class'=>' aksiint'],
                                                   'checkboxOptions' => function ($data) {
                                                    $result=json_encode($data);
                                                    $jns_saksi='Internal';
                                                    $FungsiWas      =new FungsiComponent();
                                                    $getPanggilan   =$FungsiWas->FunctPanggilan_saksiTuInt_ins($jns_saksi,$data['id_saksi_internal'],$data['no_register']);
                                                    return [ 'value'=>$data['peg_nip_baru'],'json'=>$result,'class'=>'MselectionSI_one','panggilan'=>$getPanggilan.'#'.$data['id_saksi_internal'].'#'.$data['nip'].'#'.$data['nama_saksi_internal']];
                                                    },
                                            ],
                                         ],   
                                ...
                                <?= GridView::widget([
                                    ...
                                    'columns' => [
                                      ...
                                      /*  ['label'=>'Panggilan Ke-',
                                       ...
                                       ['class' => 'yii\grid\CheckboxColumn',
                                        'headerOptions'=>['style'=>'text-align:center'],
                                        'contentOptions'=>['style'=>'text-align:center; width:5%' , 'class'=>' aksieks'],
                                                   'checkboxOptions' => function ($data) {
                                                    $result=json_encode($data);
...
//});
  /*///////////////////////////////////////TOMBOL CLICK SAKSI INTERNAL/////////////////////////////////////////*/
        ...
        $(document).on('click','#Msaksi_internal',function(){
                $('.role').html("<a class='btn btn-primary btn-sm pull-right' id='tambah_internal'><i class='glyphicon glyphicon-plus'> </i> Tambah Nomor</a>");
            }); 
  ...
  /*///////////////////////////////////////TOMBOL CLICK SAKSI EKSTERNAL/////////////////////////////////////////*/
            $('.role').html("<a class='btn btn-primary btn-sm pull-right' id='tambah_eksternal'><i class='glyphicon glyphicon-plus'> </i> Tambah Nomor</a>");
    ...
    /*//////////////////////////////////////////MODAL POPUP TAMBAH SAKSI INTERNAL///////////////////////////////////////////*/
//alam   
        $(document).on('click','#tambah_internal',function(){
 ...
 /*//////////////////////////////////////////MODAL POPUP TAMBAH SAKSI EKSTERNAL///////////////////////////////////////////*/

        $(document).on('click','#tambah_eksternal',function(){
             var check=JSON.parse($('.MselectionSI_one:checked').attr('json'));
             if(check.sifat_was9==1){
                sifat='Biasa';
             }else if(check.sifat_was9==2){
...
$('#hapus_inspektur').click(function(){
 ...
 /*//////////////////////////////////////////MODAL POPUP DOUBLE CLICK TAMBAH SAKSI INTERNAL///////////////////////////////////////////*/

// $(document).on("dblclick", "#areaA tr:has(td)", function(e) {
    $(document).on("dblclick", "#internal tr td:not(.aksiint)", function(e) {
                var id = $(this).closest('tr').find('.MselectionSI_one').attr('json');
                var check=JSON.parse(id);
 ...
 /*//////////////////////////////////////////MODAL POPUP DOUBLE CLICK TAMBAH SAKSI EKSTERNAL///////////////////////////////////////////*/
    $(document).on("dblclick", "#eksternal tr td:not(.aksieks)", function(e) {
               var id = $(this).closest('tr').find('.MselectionSI_one').attr('json');
               var check=JSON.parse(id);

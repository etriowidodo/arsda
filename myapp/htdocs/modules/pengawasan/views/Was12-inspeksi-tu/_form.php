...
<div class="was-form">
    ...
    ?>
        ...
        <div class="box-footer" style="margin:0px;padding:0px;background:none;">
            <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-save"></i> Simpan' : '<i class="fa fa-save"></i> Simpan', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary','id'=>'simpan']) ?>
...
localStorage.setItem("was12inspeksinip_terlapor_OnDB", JSON.stringify([nip_OnDB]));
...
$(document).on('click','#Tambah_terlapor',function(){
    ...
    $(document).on('click','#Mtambah_terlapor',function(){
            ...
            var names=[];
            var cek = JSON.parse(localStorage.getItem("was12nip_terlapor"));
            var cek_OnDB = JSON.parse(localStorage.getItem("was12nip_terlapor_OnDB"));

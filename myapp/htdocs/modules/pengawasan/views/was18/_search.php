...
/* @var $model app\modules\pengawasan\models\Was18Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was18-search">
    ...
    <?= $form->field($model, 'id_was_18') ?>

    <?= $form->field($model, 'no_was_18') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'tgl_was_18') ?>
    ...
    <?php // echo $form->field($model, 'kpd_was_18') ?>

    <?php // echo $form->field($model, 'id_terlapor') ?>

    <?php // echo $form->field($model, 'ttd_was_18') ?>

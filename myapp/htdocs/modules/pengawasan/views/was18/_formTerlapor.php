...
$form = ActiveForm::begin([
      ...
      'action' => (empty($model['id_was_18']) ? Url::toRoute('was18/create') : Url::toRoute('was18/update2?id='.$model["id_was_18"].'')),
      'fieldConfig' => [
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">	
                    ...
                    $sql = (new \yii\db\Query())
                            ...
                            ->andWhere(['not in', 'terlapor.id_terlapor', (new \yii\db\Query())->select('id_terlapor')->from('was.was_18')->where(['was_18.id_register' => $model->id_register])->andWhere('flag != :del', ['del'=>'3'])])
                            ->all();
                    ...
                    echo $form->field($model, 'id_terlapor')->dropDownList($data, ['prompt' => '---Pilih Terlapor---',
                        'onchange'=>'
                          ...
                          var temp = e.split("-");
                          $("#was18-perihal").val("Penerbitan Surat Keputusan Penjatuhan Hukuman Disiplin Terhadap Terlapor an."+temp[1]);
                        '
                ...
                <div class="col-md-4">
                  <?php if ($model->isNewRecord) { ?>
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" id="no_was_18" name="no_was_18">
                    </div>
                  <?php } else { ?>
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo substr($model->no_was_18, 0, 2); ?></span>
                      <input class="form-control" type="text" id="no_was_18" name="no_was_18" value="<?php echo substr($model->no_was_18, 2); ?>">
                    </div>
                  <?php } ?>
                    <!--<div class="input-group">
                        <span class="input-group-addon" style="background: #eee;">R-</span>
                        <input type="text" class="form-control" name="Was18[no_was_18]">
                    </div>-->
                </div>
                <!--<div class="col-md-3">
                    <input id="no_was_18" class="form-control" type="text" readonly="true" value="R-" style="text-align:right;width:50px" name="no_was_18">
                </div>-->
                <!--<div class="col-md-6">
                <?php //echo $form->field($model, 'no_was_18')->textInput(['maxlength' => true, 'style' => 'margin-left:-80px;width:323px;']) ?>
                </div>-->
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?=
                    $form->field($model, 'tgl_was_18')->widget(DateControl::className(), [
...
//                    echo $form->field($model, 'sifat_surat')->dropDownList($data, ['label' => '', 'readonly' => true]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['kd_lookup_item']; ?>" name="Was18[sifat_surat]" class="form-control">
...
//                    echo $form->field($model, 'kpd_was_18')->dropDownList($data, ['label' => '', 'readonly' => true,]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['id_jabatan_pejabat']; ?>" name="Was18[kpd_was_18]" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">	
                    ...
                    $sql = (new \yii\db\Query())
                            ...
                            ->one();
//                    $data = ArrayHelper::map($sql, 'id_jabatan_pejabat', 'jabatan');
//                    echo $form->field($model, 'ttd_was_18')->dropDownList($data, ['label' => '', 'readonly' => true,]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['id_jabatan_pejabat']; ?>" name="Was18[ttd_was_18]" class="form-control">
                    <input type="text" value="<?php echo $sql['jabatan']; ?>" class="form-control" readonly=TRUE>
...
<div class="box box-primary">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was18-ttd_peg_nik">
                    <div class="col-sm-12">
                ...
                <div class="form-group field-was18-ttd_peg_nama">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was18-ttd_peg_nip">
                    <div class="col-sm-12">
    ...
    <div style="margin-top:15px;" class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was18-ttd_peg_jabatan">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was18-ttd_peg_inst_satker">
                    <div class="col-sm-12">

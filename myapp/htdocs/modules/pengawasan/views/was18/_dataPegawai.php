                    ...
                    'buttons' => [
                        'pilih' => function ($url, $model,$key) {
                            return Html::button('Pilih', ['class' => 'btn btn-primary','onclick'=>'
                                  $("#was18-ttd_peg_nama").val("'.$model['peg_nama'].'");
                                  $("#was18-ttd_peg_nip").val("'.(empty($model['peg_nip_baru']) ? $model['peg_nip']:$model['peg_nip_baru']) .'");
                                  $("#was18-ttd_peg_pangkat").val("'.$model['gol_pangkat'].'");
                                  $("#was18-ttd_peg_jabatan").val("'.$model['jabatan'].'");
                                  $("#was18-ttd_peg_nik").val("'.$model['peg_nik'].'");
                                  $("#was18-ttd_id_jabatan").val("'.$model['id'].'");

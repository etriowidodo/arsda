    ...
    <div class="content-wrapper-1">
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-sm-12">
                                     <?= $form->field($model, 'no_sk_was_4b')->textInput()->label(false); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_sk_was_4b',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
             ...
             <?php if(!$model->isNewRecord){ ?>
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_diterima_sk_was_4b',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                                    'type' => DateControl::FORMAT_DATE,
                                    'ajaxConversion' => false,
                                    'options' => [
                                        'pluginOptions' => [
      ...
      <div class="panel panel-primary">
          <div class="panel-heading">Penandatangan</div>
            ...
            <?php if(!$model->isNewRecord){ ?>
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas Sk-Was-4b : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4b'].'&id2='.$model['id_sk_was_4b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?> <?= $model['upload_file']?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4b'].'&id2='.$model['id_sk_was_4b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> <?= $model['upload_file']?>
                    <?php } ?>
                </label>
 ...
 <?php    
       if (!$model->isNewRecord){
        // if($result_expire=='1'){
          ...
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4b/index'], ['id' => 'KembaliSkWas4b', 'class' => 'btn btn-primary']);
        //  }
       }else{
          echo Html::submitButton($model->isNewRecord ? '<i class="fa fa-save"></i> Simpan' : '<i class="fa fa-save"></i> Simpan', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ;
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4b/index'], ['id' => 'KembaliSkWas4b', 'class' => 'btn btn-primary']);
...
#grid-penandatangan_surat.loading .modal-loading-new {display: block;}
    ...
    .field-skwas4bpelapor-nama_pelapor , .field-skwas4bpelapor-alamat_pelapor , .field-skwas4bpelapor-email_pelapor
    , .field-skwas4bpelapor-telp_pelapor, .field-skwas4bpelapor-pekerjaan_pelapor, .field-skwas4bpelapor-kewarganegaraan_pelapor
    , .field-skwas4bpelapor-agama_pelapor, .field-skwas4bpelapor-pendidikan_pelapor, .field-skwas4bpelapor-nama_kota_pelapor
    , .field-skwas4bpelapor-tanggal_lahir_pelapor, .field-skwas4bpelapor-tempat_lahir_pelapor, .field-skwas4bpelapor-sumber_lainnya
    , .field-skwas4bpelapor-id_sumber_laporan ,.field-skwas4b-nip_pegawai_terlapor ,.field-skwas4b-nama_pegawai_terlapor
    ,.field-skwas4b-pangkat_pegawai_terlapor ,.field-skwas4b-golongan_pegawai_terlapor ,.field-skwas4b-jabatan_pegawai_terlapor
    ,.field-skwas4bpemeriksa-nip_pemeriksa ,.field-skwas4bpemeriksa-nrp_pemeriksa ,.field-skwas4bpemeriksa-nama_pemeriksa
    ,.field-skwas4bpemeriksa-pangkat_pemeriksa ,.field-skwas4bpemeriksa-jabatan_pemeriksa ,.field-skwas4bpemeriksa-golongan_pemeriksa{
        display: none;
    }
 
/* #skwas4b-tgl_sk_was_4b-disp{
    width: 405px;
 } */  
</style>
...
$(document).on('click','#addtembusan',function() {
        ...
        $(document).on('click','#tambah_penandatangan',function() {
          ...
          if(jml=>1 && jml<2){
             $('#skwas4b-nip_penandatangan').val(data.nip);
             $('#skwas4b-nama_penandatangan').val(data.nama);
             $('#skwas4b-jabatan_penandatangan').val(data.nama_jabatan);
             $('#skwas4b-golongan_penandatangan').val(data.gol_kd);
             $('#skwas4b-pangkat_penandatangan').val(data.gol_pangkat2);
             $('#skwas4b-jbtn_penandatangan').val(data.jabtan_asli);
    ...
    $(document).on('click','.cari_ttd',function() { 
      $('#grid-penandatangan_surat').addClass('loading');
        $("#grid-penandatangan_surat").load("/pengawasan/sk-was-4b/getttd",function(responseText, statusText, xhr)
            {

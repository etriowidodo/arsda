                    ...
                    'buttons' => [
                        'pilih' => function ($url, $model,$key) {
                            return Html::button('<i class="fa fa-check"></i> Pilih', ['class' => 'btn btn-primary','onclick'=>'
																						$("#skwas4b-ttd_peg_nama").val("'.$model['peg_nama'].'");
																						$("#skwas4b-ttd_peg_nip").val("'.(empty($model['peg_nip_baru']) ? $model['peg_nip']:$model['peg_nip_baru']) .'");
																						$("#skwas4b-ttd_peg_pangkat").val("'.$model['gol_pangkat'].'");
																						$("#skwas4b-ttd_peg_jabatan").val("'.$model['jabatan'].'");
																						$("#skwas4b-ttd_peg_nik").val("'.$model['peg_nik'].'");
																						$("#skwas4b-ttd_id_jabatan").val("'.$model['id'].'");

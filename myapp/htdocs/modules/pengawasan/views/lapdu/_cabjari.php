...
?>
<div class="modal fade" id="modalCabjari" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <div class="box box-primary"  id="get-cabjari-index" style="padding: 15px;overflow: hidden;">
                          <?php $form = ActiveForm::begin([
                                      // 'action' => ['create'],
                                      'method' => 'get',
                                      'id'=>'searchFormCabjari', 
                                      'options'=>['name'=>'searchFormCabjari'],
                                      // 'fieldConfig' => [
                                                  // 'options' => [
                                                  //     'tag' => false,
                                                  //     ],
                                 ...
                                 <?php ActiveForm::end(); ?>
                                  <div id="w0" class="grid-view">
                                      <?php
                                    $MsearchCabjari = new LapduSearch();
                                    $dataProviderCabjari = $MsearchCabjari->searchCabjari(Yii::$app->request->queryParams);
                                ?>
                                    <?php Pjax::begin(['id' => 'MCabjari-tambah-grid', 'timeout' => false,'formSelector' => '#searchFormCabjari','enablePushState' => false]) ?>
                                    <?php
                                    echo GridView::widget([
                                        'dataProvider'=> $dataProviderCabjari,
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default" id="Mtambah_cabjari">Tambah</button>
                </div>
            </div>
        </div>
</div>
<style>
  ...
  #get-cabjari-index.loading .modal-loading-new {display: block;}
</style>
...
$(document).ready(function(){
  ...
  $('#Mtambah_cabjari').click(function(){
    var data =JSON.parse($('.MKejariselection_one:checked').attr('json'));
          ...
          $('#nmkejari').val(data.nama_kejari);
          $('#idunit').val(data.kode_kejari);
          $('#idcabjari').val(data.kode_cabjari);
          $('#cabjari').val(data.inst_nama);
          $("#modalCabjari").modal('hide');
      });

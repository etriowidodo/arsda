...
$this->title = 'Kejati Master';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="kejati-master-index">
    ...
    <p>
        <div class="btn-toolbar">
              ...
              <a class="btn btn-primary btn-sm pull-right" id="create" href="/pengawasan/kejatimaster/create"><i class="glyphicon glyphicon-plus"> Kejati</i></a>
            </div>
    </p>
<?php $form = ActiveForm::begin(
        ['action' => '/pengawasan/kejatimaster/delete', 'id' => 'forum_post', 'method' => 'post',]
    ); ?>
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
                            return ['data-id' => $model['id_kejati']];
                        },
        'columns' => [
            ...
            [
             ...
             'headerOptions'=>['style'=>'width: 4%;'],
                       'checkboxOptions' => function ($data) {
                        return ['value' => $data['id_kejati'],'class'=>'checkbox-row'];
...
$('tr').dblclick(function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pengawasan/kejatimaster/update?id="+id;

...
<div class="was15-inspeksi-form">
    ...
    <div class="box box-primary">
        <div class="box-body" style="padding:15px;">
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-4">Nomor Surat</label>
                        <div class="col-md-8">
                            <?= $form->field($model, 'no_was14b')->textInput(['maxlength' => true])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             ...
                             <?php
                             $model->sifat_was14b='2';
                             ?>
                             <?= $form->field($model, 'sifat_was14b')->dropDownList(['Biasa','Segera','Rahasia'])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <?= $form->field($model, 'perihal_was14b')->textarea(['maxlength' => true,'value'=>'Penyampaian Laporan Hasil Inspeksi Kasus terlapor atas nama'])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <?= $form->field($model, 'lampiran_was14b')->textInput(['maxlength' => true])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                             <?= $form->field($model, 'tgl_was14b',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?= $form->field($model, 'kepada_was14b')->textInput(['maxlength' => true])->label(false) ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                           <?= $form->field($model, 'di_was14b')->textInput(['maxlength' => true])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label col-md-2">Pasal Yang Dilanggar</label>
                        <div class="col-md-10">
                           <?= $form->field($model, 'pasal_pelanggaran')->textArea(['maxlength' => true,'readonly'=>true])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="control-label col-md-2">Hukuman Disiplin</label>
                        <div class="col-md-10">
                           <?= $form->field($model, 'hukdis')->textArea(['maxlength' => true,'readonly'=>true])->label(false) ?>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody id="bd_uraian">
                                        <?php
                                            if(!$model->isNewRecord){
                                                foreach ($modelwas14b as $modelwas14b_terlapor) {
                                                    ?>
                                                    <tr>
                                                        <td class="text-center" width="4%">
                                                            <input id="box1" class="ck_uraian" type="checkbox">
                                                        </td>
                                                        <td><textarea maxlength="50" name="uraian[]" class="form-control uraian"><?= $modelwas14b_terlapor['isi_uraian']?></textarea></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }else{
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas WAS-14b : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was14b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was14b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
                    <?php } ?>
                </label>
    ...
    <div class="form-group" style="text-align: center;">
        ...
        if(!$model->isNewRecord){
        ?>
        <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['was14b-inspeksi/cetak?id='.$model['id_was14b'].''])?>"><i class="fa fa-print"></i> Cetak</a>
        <?php
        }
        ?>
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            ...
                            $dataProviderPenandatanganWas14b = $searchModelWas14b->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
                        <div id="w4" class="grid-view">
                            ...
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas14b,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas14bterlapor = new Was14bSearch();
                            $dataProviderPenandatanganWas14bterlapor = $searchModelWas14bterlapor->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
                        <div id="w1" class="grid-view">
                            <?php Pjax::begin(['id' => 'Mterlapor-tambah-grid', 'timeout' => false,'formSelector' => '#searchFormTerlapor','enablePushState' => false]) ?>
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas14bterlapor,
                                // 'filterModel' => $searchModel,
                                // 'layout' => "{items}\n{pager}",
                                'columns' => [
                                    ['header'=>'No',
...
/*end js upload*/
    ...
    window.onload=function(){
       $(document).on('click','#tambah_penandatangan',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was14b-nip_penandatangan').val(data.nip);
           $('#was14b-nama_penandatangan').val(data.nama);
           $('#was14b-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was14b-golongan_penandatangan').val(data.gol_kd);
           $('#was14b-pangkat_penandatangan').val(data.gol_pangkat2);
     ...
     // alert(a);
       ...
       $(document).on('click','#tambah_terlapor',function() {
        var data=JSON.parse($(".selection_one_terlapor:checked").attr("json"));
           $('#was14b-nip_terlapor').val(data.nip_terlapor);
           $('#was14b-nrp_terlapor').val(data.nrp_terlapor);
           $('#was14b-nama_terlapor').val(data.nama_terlapor);
           $('#was14b-pangkat_terlapor').val(data.pangkat_terlapor);
           $('#was14b-golongan_terlapor').val(data.golongan_terlapor);
           $('#was14b-satker_terlapor').val(data.satker_terlapor);
           $('#was14b-pasal_pelanggaran').val(data.pasal);
           $('#was14b-perihal_was14b').val('Penyampaian Laporan Hasil Inspeksi Kasus terlapor atas nama '+data.nama_terlapor);
           $('#was14b-hukdis').val(data.isi_sk);
       ...
       $(document).on('click','#tambah_kepada',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was14b-nip_penandatangan').val(data.nip);
           $('#was14b-nama_penandatangan').val(data.nama);
           $('#was14b-kepada_was14b').val(data.nama);
           $('#was14b-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was14b-golongan_penandatangan').val(data.gol_kd);
           $('#was14b-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was14b-jbtn_penandatangan').val(data.jabtan_asli);
    ...
    $(document).on('click','.cari_ttd',function() { 
        $('#grid-penandatangan_surat').addClass('loading');
        $("#grid-penandatangan_surat").load("/pengawasan/was14b-inspeksi/getttd",function(responseText, statusText, xhr)
        {

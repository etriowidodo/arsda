...
<div class="col-md-12">
     <!-- <div class="col-md-10"> -->
        ...
        <div class="col-md-12">
            ...
            ?>
            <?php echo $form->field($model, 'was1_narasi_awal')->textarea(['rows' => 3]) ?>
        </div>
        </div>
    <!-- </div> -->
 ...
 <!-- <div class="col-md-10"> -->
    ...
    <div class="col-md-12">
        ...
        <?php
            ...
            ?>
        <?php echo $form->field($model, 'was1_kesimpulan')->textarea(['rows' => 3]) ?>
    </div>
    </div>
<!-- </div> -->
...
<div class="col-md-12">
     <fieldset class="group-border">
                <legend class="group-border">Disposisi Inspektur</legend>
<div class="col-sm-8">
    <div class="form-group">
        <div class="col-md-12 kejaksaan">
        <label class="control-label col-md-2" style="padding: 0px">Isi</label>
             <?php 
             echo $form->field($model, 'isi_disposisi_inspektur')->textarea(['rows' => 5]) ?>
...
<div class="col-sm-4">
    <div class="form-group">
        ...
        <label class="control-label col-md-2" style="padding: 0px">Tanggal</label>
            <?php
                // if($modelWas1[0]['id_level_was1']=='2'){
                ...
                //     }
                // }
                echo $form->field($model, 'tgl_disposisi_inspektur')->widget(DateControl::className(), [
                            'type' => DateControl::FORMAT_DATE,
                            'ajaxConversion' => false,
                            'displayFormat' => 'dd-MM-yyyy',
                            'options' => [
            ...
            ?>       
             <label class="control-label col-md-10" style="padding:0px"> Unggah File Disposisi Inspektur :</label>
			 <div class="col-md-1 kejaksaan">
                      <div class="form-group" >
             ...
             <?php
            echo $form->field($model, 'file_disposisi_inspektur')->widget(FileInput::classname(), [
                'options'=>['accept'=>'application/*'],
               'pluginOptions'=>['allowedFileExtensions'=>['pdf','jpeg','jpg','png'],
                                  'showPreview' => true,
                                'showUpload' => false,

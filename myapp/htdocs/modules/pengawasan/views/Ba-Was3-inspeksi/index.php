...
<div class="ba-was3-index">
    ...
    <p>
        <div class="btn-toolbar">
              ...
              <a class="btn btn-primary btn-sm pull-right" id="" href="/pengawasan/ba-was3-inspeksi/create"><i class="glyphicon glyphicon-plus"> </i> BA.WAS-3</a>
            </div>
    </p>
    <style type="text/css">
...
legend.group-border {
    ...
    ?>
    <?php Pjax::begin(['id' => 'Was12-grid', 'timeout' => false,'formSelector' => '#searchFormBawas3','enablePushState' => false]) ?>
    <?= GridView::widget([
        
        'dataProvider' => $dataProvider,
        // 'filterModel' => $searchModel,
         'tableOptions' => ['class' => 'table table-striped table-bordered table-hover','data-id' => $data['id_ba_was_3']],
         // 'layout' => "{items}\n{pager}",
        'columns' => [
                 ['header'=>'No',
...
window.onload=function(){
        $('#cetak_bawas3,#ubah_bawas3, #hapus_bawas3').addClass('disabled');
        ...
        function ConditionOfButtonTr(n){
                if(n == 1){
                   $('#ubah_bawas3,#cetak_bawas3, #hapus_bawas3').removeClass('disabled');
                } else if(n > 1){
                   $('#hapus_bawas3').removeClass('disabled');
                   $('#ubah_bawas3,#cetak_bawas3').addClass('disabled');
                } else{
                   $('#ubah_bawas3,#cetak_bawas3, #hapus_bawas3').addClass('disabled');
                }
        }
    ...
    $('#ubah_bawas3').click(function(){
       ...
       if(x>=2 || x<=0){
        ...
        location.href='/pengawasan/ba-was3-inspeksi/update?id='+check.id_ba_was3+'&id2='+check.id_terlapor_saksi;
         }
    });
	...
	$('#cetak_bawas3').click(function(){
        ...
        if(check.keterangan=='Terlapor'){
          location.href='/pengawasan/ba-was3-inspeksi/cetak?id='+check.id_ba_was3;
        }else if(check.keterangan=='Saksi Internal'){
          location.href='/pengawasan/ba-was3-inspeksi/cetakint?id='+check.id_ba_was3;
        }else if(check.keterangan=='Saksi Eksternal'){
          location.href='/pengawasan/ba-was3-inspeksi/cetakeks?id='+check.id_ba_was3;
        }
    ...
    $('#hapus_bawas3').click(function(){
        ...
        // var data = $('.checkbox-row:checked').map(function()
        //                         {
        //                             return $(this).val();
        //                         }).get();
             ...
             bootbox.dialog({
                        ...
                        buttons:{
                         ...
                         //   alert(checkValues);
                                ...
                                $.ajax({
                                    type:'POST',
                                    url:'/pengawasan/ba-was3-inspeksi/hapus',
 ...
 $(document).ready(function(){
     ...
     $('tr').dblclick(function(){
      ...
      // alert(id);
             location.href='/pengawasan/ba-was3-inspeksi/update?id='+id+'&id2='+id2;   

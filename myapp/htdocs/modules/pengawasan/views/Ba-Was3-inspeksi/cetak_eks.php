...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/ba_was_3_eks_inspeksi.docx');
...
//          /*permintaan kang putut lokasi harus ada spasi*/
        ...
        /*noSpWas1*/
        $no_sp_was_1=$modelSpWas1['nomor_sp_was2'];

        /*jabatan_penandatangan*/
        $pejabat_sp_was_1=ucwords(strtolower($modelSpWas1['jabatan_penandatangan']));
        // print_r($tgl_sp_was);
...
// //         $noSpWas=$sp_was_1[0]['nomor_sp_was1'];
        ...
        $docx->createDocx('template/pengawasan/ba_was_3_eks_inspeksi');
		
        $file = 'template/pengawasan/ba_was_3_eks_inspeksi.docx';

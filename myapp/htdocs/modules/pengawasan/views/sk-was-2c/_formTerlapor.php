...
$form = ActiveForm::begin([
            ...
            'action' => (empty($model['id_sk_was_2c']) ? Url::toRoute('sk-was-2c/create') : Url::toRoute('sk-was-2c/update2?id='.$model["id_sk_was_2c"].'')),
            'fieldConfig' => [
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="col-md-9">	
                    ...
                    echo $form->field($model, 'ttd_sk_was_2c')->dropDownList($data, ['prompt' => '---Pilih---'], ['label' => '', 'style' => 'width:400px']);  
?>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
                ...
                <div class="col-md-9">
                  <?php if ($model->isNewRecord) { ?>
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" id="no_sk_was_2c" name="no_sk_was_2c">
                    </div>
                  <?php } else { ?>
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo substr($model->no_sk_was_2c, 0, 4); ?></span>
                      <input class="form-control" type="text" id="no_sk_was_2c" name="no_sk_was_2c" value="<?php echo substr($model->no_sk_was_2c, 4); ?>">
                    </div>
                  <?php } ?>
                </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?=
                    $form->field($model, 'tgl_sk_was_2c')->widget(DateControl::className(), [
 ...
 <?php
                   if ($model->isNewRecord) {
                      ...
                      ->where(['b.tingkat_kd' => '13'])
                      ->andWhere(['not in', 'a.id_terlapor', (new \yii\db\Query())->select('id_terlapor')->from('was.sk_was_2c')->where(['sk_was_2c.id_register' => $model->id_register])->andWhere('flag != :del', ['del'=>'3'])])
...
<div class="box box-primary">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2c-ttd_peg_nik">
                    <div class="col-sm-12">
                ...
                <div class="form-group field-sk-was-2c-ttd_peg_nama">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2c-ttd_peg_nip">
                    <div class="col-sm-12">
    ...
    <div style="margin-top:15px;" class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2c-ttd_peg_jabatan">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2c-ttd_peg_inst_satker">
                    <div class="col-sm-12">
...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        <table id="table_tembusan" class="table table-bordered">
            ...
            <tbody id="tbody_tembusan-sk-was-2c">
            <?php if (!$model->isNewRecord): ?>

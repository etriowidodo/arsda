...
/* @var $model app\modules\pengawasan\models\Was20aSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was20a-search">
    ...
    <?php // echo $form->field($model, 'id_was_20a') ?>

    <?php // echo $form->field($model, 'no_was_20a') ?>
    ...
    <?php // echo $form->field($model, 'kpd_was_20a') ?>
    ...
    <?php // echo $form->field($model, 'tgl_was_20a') ?>

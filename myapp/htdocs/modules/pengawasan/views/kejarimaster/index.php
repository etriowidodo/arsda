...
$this->title = 'Kejari Master';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="kejari-master-index">
    ...
    <p>
        <div class="btn-toolbar">
              ...
              <a class="btn btn-primary btn-sm pull-right" id="create" href="/pengawasan/kejarimaster/create"><i class="glyphicon glyphicon-plus"> Kejari</i></a>
            </div>
    </p>
<?php $form = ActiveForm::begin(
        ['action' => '/pengawasan/kejarimaster/delete', 'id' => 'forum_post', 'method' => 'post',]
    ); ?>
    ...
    <?= GridView::widget([
        ...
        'rowOptions' => function ($model, $key, $index, $grid) {
                            return ['data-id' => $model['id_kejari']];
                        },
        'columns' => [
            ...
            [
             ...
             'headerOptions'=>['style'=>'width: 4%;'],
                       'checkboxOptions' => function ($data) {
                        return ['value' => $data['id_kejari'],'class'=>'checkbox-row'];
...
$('tr').dblclick(function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pengawasan/kejarimaster/update?id="+id;

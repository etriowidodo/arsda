...
$form = ActiveForm::begin([
            ...
            'action' => (empty($model['id_sk_was_2a']) ? Url::toRoute('sk-was-2a/create') : Url::toRoute('sk-was-2a/update2?id='.$model["id_sk_was_2a"].'')),
            'fieldConfig' => [
        ...
        <div class="col-md-8">
            <div class="form-group">
                ...
                <div class="col-md-9">	
                    ...
                    echo $form->field($model, 'ttd_sk_was_2a')->dropDownList($data, ['prompt' => '---Pilih---'], ['label' => '', 'style' => 'width:400px']);  
?>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
                ...
                <div class="col-md-9">
                  <?php if ($model->isNewRecord) { ?>
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" id="no_sk_was_2a" name="no_sk_was_2a">
                    </div>
                  <?php } else { ?>
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo substr($model->no_sk_was_2a, 0, 4); ?></span>
                      <input class="form-control" type="text" id="no_sk_was_2a" name="no_sk_was_2a" value="<?php echo substr($model->no_sk_was_2a, 4); ?>">
                    </div>
                  <?php } ?>
                </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?=
                    $form->field($model, 'tgl_sk_was_2a')->widget(DateControl::className(), [
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">	
                   ...
                   if ($model->isNewRecord) {
                      ...
                      ->where(['b.tingkat_kd' => 11])
                      ->andWhere(['not in', 'a.id_terlapor', (new \yii\db\Query())->select('id_terlapor')->from('was.sk_was_2a')->where(['sk_was_2a.id_register' => $model->id_register])->andWhere('flag != :del', ['del'=>'3'])])
...
<div class="box box-primary">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2a-ttd_peg_nik">
                    <div class="col-sm-12">
                ...
                <div class="form-group field-sk-was-2a-ttd_peg_nama">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2a-ttd_peg_nip">
                    <div class="col-sm-12">
    ...
    <div style="margin-top:15px;" class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2a-ttd_peg_jabatan">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-sk-was-2a-ttd_peg_inst_satker">
                    <div class="col-sm-12">
...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        <table id="table_tembusan" class="table table-bordered">
            ...
            <tbody id="tbody_tembusan-sk-was-2a">
            <?php if (!$model->isNewRecord): ?>

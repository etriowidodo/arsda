...
/* @var $model app\modules\pengawasan\models\SkWas2aSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sk-was2a-search">
    ...
    <?= $form->field($model, 'id_sk_was_2a') ?>

    <?= $form->field($model, 'no_sk_was_2a') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'tgl_sk_was_2a') ?>

    <?php // echo $form->field($model, 'ttd_sk_was_2a') ?>

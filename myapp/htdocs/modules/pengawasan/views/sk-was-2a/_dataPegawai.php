                    ...
                    'buttons' => [
                        'pilih' => function ($url, $model,$key) {
                            return Html::button('<i class="fa fa-check"></i> Pilih', ['class' => 'btn btn-primary','onclick'=>'
																						$("#skwas2a-ttd_peg_nama").val("'.$model['peg_nama'].'");
																						$("#skwas2a-ttd_peg_nip").val("'.(empty($model['peg_nip_baru']) ? $model['peg_nip']:$model['peg_nip_baru']) .'");
																						$("#skwas2a-ttd_peg_pangkat").val("'.$model['jabat_tmt'].'");
																						$("#skwas2a-ttd_peg_jabatan").val("'.$model['jabatan'].'");
																						$("#skwas2a-ttd_peg_nik").val("'.$model['peg_nik'].'");
																						$("#skwas2a-ttd_id_jabatan").val("'.$model['id'].'");

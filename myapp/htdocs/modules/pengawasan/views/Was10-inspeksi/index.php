...
<div class="dipa-master-index">
    ...
    <p>
        <div class="btn-toolbar">
            ...
            <a class="btn btn-primary btn-sm pull-right" id="hapus_inspektur"><i class="fa fa-trash">  </i> Hapus</a>&nbsp;
            <a class="btn btn-primary btn-sm pull-right" id="ubah_inspektur"><i class="fa fa-pencil">  </i> Ubah</a>&nbsp;
            ...
            <a class="btn btn-primary btn-sm pull-right" href="/pengawasan/was10-inspeksi/form1"><i class="fa fa-plus"> </i> Terlapor</a>
        </div>
    </p>
    ...
    <div class="box box-primary" style="padding: 15px;overflow: hidden;">
        <?php $form = ActiveForm::begin([
                // 'action' => ['create'],
                'method' => 'get',
                'id'=>'searchFormgridwas10', 
                'options'=>['name'=>'searchFormgridwas10'],
                'fieldConfig' => [
                            'options' => [
                                'tag' => false,
                                ],
        ...
        <div id="w0" class="grid-view"> 
            <?php Pjax::begin(['id' => 'grid-was10-inspeksi', 'timeout' => false,'formSelector' => '#searchFormgridwas10','enablePushState' => false]) ?>
            <?= GridView::widget([
            ...
            'columns' => [
                ...
                ['label'=>'Panggilan Ke-',
                    ...
                    'contentOptions'=>['class'=>'panggilan'],
                        'value' => function ($data) {
                            ...
                            $getPanggilan   =$FungsiWas->FunctPanggilanIns($data['id_pegawai_terlapor'],$data['nip_pegawai_terlapor'],$data['no_register']);
                            return $getPanggilan; 
                    },
                ],  
             ...
             'contentOptions'=>['style'=>'text-align:center; width:5%'],
                       'checkboxOptions' => function ($data) {
                        ...
                        $FungsiWas      =new FungsiComponent();
                        $getPanggilan   =$FungsiWas->FunctPanggilanIns($data['id_pegawai_terlapor'],$data['nip'],$data['no_register']);
 ...
 <!-- Modal Tambah Baru Terlapor -->
    ...
    window.onload=function(){
        ...
        function ConditionOfButtonTr(tn){ 
            if(tn==0){
                $('#detail_terlapor').addClass('disabled');
                $('#ubah_inspektur').addClass('disabled');
                $('#hapus_inspektur').addClass('disabled');
            ...
            if(tn==1){
                $('#detail_terlapor').removeClass('disabled');

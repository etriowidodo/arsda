...
/* @var $model app\modules\pengawasan\models\Was27KlariSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was27-klari-search">
    ...
    <?= $form->field($model, 'id_was_27_klari') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'no_was_27_klari') ?>
    ...
    <?php // echo $form->field($model, 'rncn_henti_riksa_1_was_27_kla') ?>

    <?php // echo $form->field($model, 'rncn_henti_riksa_2_was_27_kla') ?>

    <?php // echo $form->field($model, 'pendapat_1_was_27_kla') ?>

    <?php // echo $form->field($model, 'pendapat') ?>

    <?php // echo $form->field($model, 'persetujuan') ?>

    <?php // echo $form->field($model, 'ttd_was_27_klari') ?>

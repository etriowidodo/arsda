...
?>
    ...
    <section class="content" style="padding: 0px;">
        <div class="box box-primary">
            <div class="box-body" style="padding:15px;">
                <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                    <div class="col-md-5">
                        <div class="form-group">
                            <label class="control-label col-md-4">Tanggal BA.WAS-8</label>
                            <div class="col-md-8">
                                <?= $form->field($model, 'tgl_ba_was_8',['addon' => ['prepend' => ['content'=>'<i class="fa fa-calendar" id="tgl_ba_was_7"></i>']]])->textInput()->label(false);?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                ...
                <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <!-- <input id="pasal" class="form-control" name="pasal" value="" type="text" disabled=""> -->
                ...
                <div class="col-md-12" style="padding-top: 15px;padding-bottom: 15px;">
                    <label>Unggah Berkas WAS-8 : 
                         <?php if (substr($model->upload_file,-3)!='pdf'){?>
                            <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_ba_was_8'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?> <?php echo $model['upload_file']; ?>
                        <?php } else{?>
                            <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_ba_was_8'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> <?php echo $model['upload_file']; ?>
                        <?php } ?>
                    </label>
            ...
            <?php } ?> 
                <div class="col-md-6">
                    <!--<p style="color: red">Pilihan ini muncul ketika form edit, kalo tambah baru gak muncul mas (teks ini dihapus ya mas)</p>-->
                    <div class="form-group">
        ...
        <div class="form-group" style="text-align: center;">
            ...
            <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['ba-was8/index'])?>"><i class="fa fa-arrow-left"></i> Batal</a> 
        </div>
    </section>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelbawas8 = new BaWas8Search();
                            $dataProviderTerlapor = $searchModelbawas8->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
...
<script type='text/javascript'>
	$(document).ready(function(){
		$('#bawas8-tgl_ba_was_8').datepicker(); 
	});
	
	$(document).on('click','#tambah_penerima',function() {
    var data=JSON.parse($(".selection_one:checked").attr("json"));
       $('#bawas8-nip_menerima').val(data.peg_nip_baru);
       $('#bawas8-nrp_menerima').val(data.peg_nrp);
       $('#bawas8-nama_menerima').val(data.nama);
       $('#bawas8-jabatan_menerima').val(data.jabatan);
       $('#bawas8-pangkat_menerima').val(data.gol_pangkat2);
       $('#bawas8-golongan_menerima').val(data.gol_kd);
       $('#penerima').modal('hide');
    ...
    var data=JSON.parse($(".selection_onex:checked").attr("json"));
       $('#bawas8-nama_terlapor').val(data.nama_terlapor);  
       $('#bawas8-nip_terlapor').val(data.nip_terlapor);  
       $('#bawas8-jabatan_terlapor').val(data.jabatan_terlapor); 
       $('#bawas8-nrp_terlapor').val(data.peg_nrp); 
       $('#bawas8-pangkat_terlapor').val(data.pangkat_terlapor); 
       $('#bawas8-golongan_terlapor').val(data.golongan_terlapor);  
       $('#bawas8-sk').val(data.sk);  
       $('#bawas8-tanggal_pemberitahuan_ba').val(data.tgl_ba_was_7); 
       // $('#pasal').val(data.pasal);  
       $('#bawas8-pelanggaran').val(data.pelanggaran);  
       $('#terlapor').modal('hide');

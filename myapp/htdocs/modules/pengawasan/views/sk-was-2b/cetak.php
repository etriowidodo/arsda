...
require_once('/wordtest/classes/CreateDocx.inc');
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/sk_was_2b.docx');
        $kejaksaan=strtoupper($data_satker['inst_nama']);
         
        $nmr_sk_was_2b    =$model['no_sk_was_2b'];
    ...
    //     $detail_uraian="";
    //     $no=1;
    //     foreach ($modelwas12b as $row_uraian) {
    ...
    //     	$no++;
      ...
      //  $membaca .="</table>";
       ...
       $docx->replaceVariableByText(array('nmr_sk_was_2b'=>$nmr_sk_was_2b), array('parseLineBreaks'=>true));
     ...
     //  $docx->replaceVariableByText(array('diterima'=>$tgl_diterima), array('parseLineBreaks'=>true));
       ...
       // // $docx->replaceVariableByText(array('nip_penandatangan'=>$nipTandatangan), array('parseLineBreaks'=>true));
        ...
        $docx->replaceVariableByHTML('nama_tembusan', 'block',$tembusan, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
 		...
 		$docx->createDocx('template/pengawasan/sk_was_2b');
		
        $file = 'template/pengawasan/sk_was_2b.docx';

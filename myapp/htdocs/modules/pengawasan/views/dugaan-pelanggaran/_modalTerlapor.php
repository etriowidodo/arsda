...
function pilihPegawai(id, peg_nik, nip,nama,jabatan){
         ...
         'template' => '{pilih}',
                'buttons' => [
                    'pilih' => function ($url, $model,$key) {
						...
						"onClick"=>"pilihPegawai($(this).attr('idPegawai'), $(this).attr('peg_nik'), $(this).attr('peg_nip'),$(this).attr('peg_nama'),$(this).attr('jabatan'))"]);
                    }

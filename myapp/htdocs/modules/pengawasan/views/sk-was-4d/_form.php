    ...
    <div class="content-wrapper-1">
        <div class="box-header with-border">
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-sm-12">
                                     <?= $form->field($model, 'no_sk_was_4d')->textInput()->label(false); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_sk_was_4d',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
             ...
             <?php if(!$model->isNewRecord){ ?>
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_diterima_sk_was_4d',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                                    'type' => DateControl::FORMAT_DATE,
                                    'ajaxConversion' => false,
                                    'options' => [
                                        'pluginOptions' => [
            ...
            <div class="col-md-12" style="padding: 0px 0;">    
               <div class="col-md-6">
                ...
                <!-- <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-5">Waktu Pelanggaran</label>
                        <div class="col-md-7">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <?//= $form->field($model, 'waktu_kejadian')->textInput(['readonly'=>'readonly'])->label(false); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                                              ...
                                              foreach ($dataTerlapor as $value_terlapor) { ?>
                                                    <tr role="row" class="terlapor">
                                                        <td style="text-align:center;"><?= $no_2 ?>
                                                            <input type="hidden" id="id_sp_was2" name="id_sp_was2" value="<?= $value_terlapor['id_sp_was2'] ?>"> 
                                                            <input type="hidden" id="id_ba_was2" name="id_ba_was2" value="<?= $value_terlapor['id_ba_was2'] ?>">
                                                            <input type="hidden" id="id_l_was2" name="id_l_was2" value="<?= $value_terlapor['id_l_was2'] ?>">
                                                            <input type="hidden" id="id_was15" name="id_was15" value="<?= $value_terlapor['id_was15'] ?>">
                                                            <?= $form->field($model, 'nip_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['nip_terlapor']]); ?>
                                                             <?= $form->field($model, 'nrp_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['nrp_terlapor']]); ?>
                                                            <?= $form->field($model, 'nama_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['nama_terlapor']]); ?>
                                                            <?= $form->field($model, 'pangkat_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['pangkat_terlapor']]); ?>
                                                            <?= $form->field($model, 'golongan_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['golongan_terlapor']]); ?>
                                                            <?= $form->field($model, 'jabatan_pegawai_terlapor')->hiddenInput(['readonly'=>'readonly','value'=>$value_terlapor['jabatan_terlapor']]); ?>
                                                            <?= $form->field($model, 'pelanggaran')->hiddenInput(['value'=>$value_terlapor['pelanggaran']])->label(false); ?>
                                                        </td>
                                                        <td><?= $value_terlapor['nama_terlapor']?></td>
                                                        <td><?= $value_terlapor['nip_terlapor']?></td>
                                                        <td><?= $value_terlapor['pelanggaran']?></td>
                                                        <td><?= $value_terlapor['pasal']?></td>
                                                    </tr>
                                            <?php $no_2++; } ?>  
                            </tbody>
                        </table>    
                            ...
                            <?php 
                                 $menimbang="<ol style='list-style-type: lower-alpha;'>
                                          ...
                                          <li>bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, b, dan c perlu Menetapkan
                                              Keputusan tentang Penjatuhan hukuman disiplin berupa Pemberhentian Dengan Hormat Tidak Atas Permntaan Sendiri sebagai
                                              Pegawai Negeri Sipil.</li>
                                        </ol>";     
                         ...
                         <div class="col-sm-12" ></div>
                            <?php 
                                ...
                                foreach ($dataPeraturan as $valuePeraturan) {
                                 $mengingat .="<li>".$valuePeraturan['nama_peraturan']."</li>";
                                    } 
                                $mengingat  .="</ol>";
                            ...
                            ?>
                                <div>
                                    ...
                                    <?php }else{?>
                                       <?php if($valuePeraturan['nama_peraturan'] == ''){?>
           ...
           <div class="col-md-12" style="padding-top: 15px;">
                <div class="panel panel-primary">
                    <div class="panel-heading">Menetapkan</div>
                    <div class="panel-body">
                        <div class="form-group">
                         <div class="col-sm-12" ></div>
                            <?php 
                                $menetapkan="<table>
                                                <tr>
                                                    <td style='width:10%'>KESATU</td>
                                                    <td style='width:2%'>:</td>
                                                    <td colspan='2'>Menjatuhkan Hukuman Disiplin berupa PEMBERHENTIAN DENGAN HORMAT TIDAK ATAS 
                                                                     PERMINTAAN SENDIRI SEBAGAI PEGAWAI NEGERI SIPIL kepada :</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:10%'>Nama</td>
                                                    <td style='width:78%'>: ".$dataTerlapor['nama_terlapor']."</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:10%'>Pangkat</td>
                                                    <td style='width:78%'>: ".$dataTerlapor['pangkat_terlapor']."</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:10%'>NIP / NRP</td>
                                                    <td style='width:78%'>: ".$dataTerlapor['nip_nrp']."</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:10%'>Jabatan</td>
                                                    <td style='width:78%'>: ".ucwords(strtolower($dataTerlapor['jabatan_terlapor']))."</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:10%'>Unit Kerja</td>
                                                    <td style='width:78%'>: ".ucwords(strtolower($dataTerlapor['instansi']))."</td>
                                                </tr>
                                                <tr>
                                                    <td colspan='4'>Karena yang bersangkutan pada tanggal ".\Yii::$app->globalfunc->ViewIndonesianFormat(date('Y-m-d',strtotime($dataTerlapor['tanggal_surat_lapdu'])))." telah melakukan perbuatan yang melanggar 
                                                                    ketentuan ".$dataTerlapor['pasal'].";</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'>KEDUA</td>
                                                    <td style='width:2%'>:</td>
                                                    <td colspan='2'>Kepada Pegawai tersebut dalam diktum KESATU, 
                                                         diberikan hak-hak kepegawaian sesuai dengan peraturan perundang-undangan.</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'>KETIGA</td>
                                                    <td style='width:2%'>:</td>
                                                    <td colspan='2'>Apabila tidak mengajukan banding administratif, 
                                                         maka keputusan ini mulai berlaku pada hari kelima belas terhitung mulai 
                                                         tanggal yang bersangkutan menerima keputusan ini.</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'>KEEMPAT</td>
                                                    <td style='width:2%'>:</td>
                                                    <td colspan='2'>Keputusan ini disampaikan kepada yang bersangkutan untuk dilaksanakan 
      ...
      <div class="panel panel-primary">
          <div class="panel-heading">Penandatangan</div>
            ...
            <?php if(!$model->isNewRecord){ ?>
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas Sk-Was-4d : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4d'].'&id2='.$model['id_sk_was_4d'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?> <?= $model['upload_file']?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4d'].'&id2='.$model['id_sk_was_4d'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?>  <?= $model['upload_file']?>
                    <?php } ?>
                </label>
                <!-- <input type="file" name="upload_file" /> -->
                <div class="fileupload fileupload-new" data-provides="fileupload">
                <span class="btn btn-primary btn-file fa fa-folder-open"><span class="fileupload-new"> Unggah File </span>
 ...
 <?php    
       if (!$model->isNewRecord){
        // if($result_expire=='1'){
          ...
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4d/index'], ['id' => 'KembaliSkWas4d', 'class' => 'btn btn-primary']);
        //  }
       }else{
          echo Html::submitButton($model->isNewRecord ? '<i class="fa fa-save"></i> Simpan' : '<i class="fa fa-save"></i> Simpan', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ;
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4d/index'], ['id' => 'KembaliSkWas4d', 'class' => 'btn btn-primary']);
...
#grid-penandatangan_surat.loading .modal-loading-new {display: block;}
    ...
    .field-skwas4dpelapor-nama_pelapor , .field-skwas4dpelapor-alamat_pelapor , .field-skwas4dpelapor-email_pelapor
    , .field-skwas4dpelapor-telp_pelapor, .field-skwas4dpelapor-pekerjaan_pelapor, .field-skwas4dpelapor-kewarganegaraan_pelapor
    , .field-skwas4dpelapor-agama_pelapor, .field-skwas4dpelapor-pendidikan_pelapor, .field-skwas4dpelapor-nama_kota_pelapor
    , .field-skwas4dpelapor-tanggal_lahir_pelapor, .field-skwas4dpelapor-tempat_lahir_pelapor, .field-skwas4dpelapor-sumber_lainnya
    , .field-skwas4dpelapor-id_sumber_laporan ,.field-skwas4d-nip_pegawai_terlapor ,.field-skwas4d-nama_pegawai_terlapor
    ,.field-skwas4d-pangkat_pegawai_terlapor ,.field-skwas4d-golongan_pegawai_terlapor ,.field-skwas4d-jabatan_pegawai_terlapor
    ,.field-skwas4dpemeriksa-nip_pemeriksa ,.field-skwas4dpemeriksa-nrp_pemeriksa ,.field-skwas4dpemeriksa-nama_pemeriksa
    ,.field-skwas4dpemeriksa-pangkat_pemeriksa ,.field-skwas4dpemeriksa-jabatan_pemeriksa ,.field-skwas4dpemeriksa-golongan_pemeriksa{
        display: none;
    }
 
/* #skwas4d-tgl_sk_was_4d-disp{
    width: 405px;
 }  */ 
</style>
...
$(document).on('click','#addtembusan',function() {
        ...
        $(document).on('click','#tambah_penandatangan',function() {
          ...
          if(jml=>1 && jml<2){
             $('#skwas4d-nip_penandatangan').val(data.nip);
             $('#skwas4d-nama_penandatangan').val(data.nama);
             $('#skwas4d-jabatan_penandatangan').val(data.nama_jabatan);
             $('#skwas4d-golongan_penandatangan').val(data.gol_kd);
             $('#skwas4d-pangkat_penandatangan').val(data.gol_pangkat2);
             $('#skwas4d-jbtn_penandatangan').val(data.jabtan_asli);
    ...
    $(document).on('click','.cari_ttd',function() { 
      $('#grid-penandatangan_surat').addClass('loading');
        $("#grid-penandatangan_surat").load("/pengawasan/sk-was-4d/getttd",function(responseText, statusText, xhr)
            {

...
require_once('/wordtest/classes/CreateDocx.inc');
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/sk_was_4d.docx');
        $kejaksaan=strtoupper($data_satker['inst_nama']);
         
        $nmr_sk_was_4d    =$model['no_sk_was_4d'];
    ...
    //     	$no++;
      ...
      //  $membaca .="</table>";
       ...
       $docx->replaceVariableByText(array('nmr_sk_was_4d'=>$nmr_sk_was_4d), array('parseLineBreaks'=>true));
       ...
       // // $docx->replaceVariableByText(array('nip_penandatangan'=>$nipTandatangan), array('parseLineBreaks'=>true));
        ...
        $docx->replaceVariableByHTML('nama_tembusan', 'block',$tembusan, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
 		...
 		$docx->createDocx('template/pengawasan/sk_was_4d');
		
        $file = 'template/pengawasan/sk_was_4d.docx';

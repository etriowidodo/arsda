...
/* @var $model app\modules\pengawasan\models\SkWas3cSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sk-was3c-search">
    ...
    <?= $form->field($model, 'id_sk_was_3c') ?>

    <?= $form->field($model, 'no_sk_was_3c') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'tgl_sk_was_3c') ?>

    <?php // echo $form->field($model, 'ttd_sk_was_3c') ?>

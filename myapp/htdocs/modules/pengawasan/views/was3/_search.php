...
/* @var $model app\models\Was3Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was3-search">
    ...
    <?= $form->field($model, 'id_was_3') ?>

    <?= $form->field($model, 'no_was_3') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'tgl_was_3') ?>

    <?php // echo $form->field($model, 'kpd_was_3') ?>

    <?php // echo $form->field($model, 'ttd_was_3') ?>

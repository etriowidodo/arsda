...
/* @var $model app\modules\pengawasan\models\Was19bSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was19b-search">
    ...
    <?= $form->field($model, 'id_was_19b') ?>

    <?= $form->field($model, 'no_was_19b') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'tgl_was_19b') ?>
    ...
    <?php // echo $form->field($model, 'kpd_was_19b') ?>

    <?php // echo $form->field($model, 'id_terlapor') ?>

    <?php // echo $form->field($model, 'ttd_was_19b') ?>

                    ...
                    <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                        <?= $form->field($model, 'kpd_was_20b')->textInput(['maxlength' => true,])->label(false) ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                         <?php if(!$model->isNewRecord){ ?>
                                            <input id="was20b-dari" class="form-control" name="Was20b[dari]" readonly="readonly" value="<?= $model['jabatan_penandatangan'] ?>"  type="text">
                                        <?php }else{ ?>
                                            <input id="was20b-dari" class="form-control" name="Was20b[dari]" readonly="readonly"  type="text">
                                        <?php } ?>
                         ...
                         <!-- <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4">Dari</label>
                                <div class="col-md-8">
                                    <?//= $form->field($model, 'dari')->textInput(['maxlength' => true])->label(false) ?>
                                </div>
                            </div>
                        </div> -->
                    </div>
                    ...
                    <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= $form->field($model, 'tgl_was_20b',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= $form->field($model, 'no_was_20b')->textInput(['maxlength' => true])->label(false) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <?//= $form->field($model, 'hukdis')->textInput(['maxlength' => true])->label(false) ?>
                                    ...
                                    <input id="was20b-sk" name="was20b-sk" type="hidden">
                                    <input id="was20b-was6" name="was20b-was6" type="hidden">
                                    <input id="was20b-idterlapor" name="was20b-idterlapor" type="hidden">
                                    <?php if(!$model->isNewRecord){ ?>    
...
<!--=======================pertanyaan==============================3-->
                  ...
                  <div class="box-header with-border">
                    ...
                    <table id="table_pertanyaan" style="margin-top:3%;" class="table table-bordered">
                            ...
                            if(!$model->isNewRecord){
                                ...
                                echo '<tr data-id="'.$rowPertanyaan['id_was_20b_detail'].'" class="trpertanyaan'.$rowPertanyaan['id_was_20b_detail'].'"></td>';
                                ...
                                echo '<td><a class="btn btn-primary btn-sm hapus_pertanyaan1" rel="trpertanyaan'.$rowPertanyaan['id_was_20b_detail'].'" type="button" style="margin-left:-10%;" id="hapus_pertanyaan1"><i class="glyphicon glyphicon-trash"></i></a></td>';
                                echo '</tr>';
                                } 
                                        }
                                ?>
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas WAS-20b : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_20b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_20b'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
                    <?php } ?>
                </label>
    ...
    <div class="form-group" style="text-align: center;">
        ...
        <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['was20b/index'])?>"><i class="fa fa-arrow-left"></i> Batal</a>
    </div>
</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas20bterlapor = new Was20bSearch();
                            $dataProviderPenandatanganWas20bterlapor = $searchModelWas20bterlapor->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
                        <div id="w1" class="grid-view">
                            <?php Pjax::begin(['id' => 'Mterlapor-tambah-grid', 'timeout' => false,'formSelector' => '#searchFormTerlapor','enablePushState' => false]) ?>
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas20bterlapor,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <div class="box box-primary" style="padding: 15px;overflow: hidden;">
                        <?php
                            $searchModelWas20b = new Was20bSearch();
                            $dataProviderPenandatanganWas20b = $searchModelWas20b->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
                        <div id="w4" class="grid-view">
                            ...
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas20b,
                                // 'filterModel' => $searchModel,
                                // 'layout' => "{items}\n{pager}",
                                'columns' => [
                                    ['header'=>'No',
    ...
    window.onload=function(){
       $(document).on('click','#tambah_penandatangan',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was20b-nip_penandatangan').val(data.nip);
           $('#was20b-nama_penandatangan').val(data.nama);
           $('#was20b-nama_dari').val(data.nama_jabatan);
           $('#was20b-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was20b-dari').val(data.nama_jabatan);
           $('#was20b-golongan_penandatangan').val(data.gol_kd);
           $('#was20b-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was20b-jbtn_penandatangan').val(data.jabtan_asli);
     ...
     $('.edt').hide();
       $(document).on('click','#tambah_terlapor',function() {
        ...
        //alert(data.nama_terlapor);
           $('#was20b-nip_pegawai_terlapor').val(data.nip_terlapor);
           $('#was20b-nrp_pegawai_terlapor').val(data.nrp_terlapor);
           $('#was20b-nama_pegawai_terlapor').val(data.nama_terlapor);
           $('#was20b-pasal_pegawai_pelanggaran').val(data.pasal);
           $('#was20b-jabatan_pegawai_terlapor').val(data.jabatan_terlapor);
           $('#was20b-sk').val(data.sk);
           $('#was20b-was6').val(data.id_ba_was_6);
           $('#was20b-idterlapor').val(data.id_terlapor_l_was2);
           $('#was20b-pangkat_pegawai_terlapor').val(data.pangkat_terlapor);
           $('#was20b-golongan_pegawai_terlapor').val(data.golongan_terlapor);
           $('#was20b-satker_pegawai_terlapor').val(data.satker_terlapor);
       ...
       $(document).on('click','#tambah_kepada',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was20b-nip_penandatangan').val(data.nip);
           $('#was20b-nama_penandatangan').val(data.nama);
           $('#was20b-kepada_was16d').val(data.nama);
           $('#was20b-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was20b-golongan_penandatangan').val(data.gol_kd);
           $('#was20b-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was20b-jbtn_penandatangan').val(data.jabtan_asli);

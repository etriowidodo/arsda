...
/* @var $model app\modules\pengawasan\models\Was20bSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="was20b-search">
    ...
    <?php // echo $form->field($model, 'id_was_20b') ?>
    ...
    <?php // echo $form->field($model, 'kpd_was_20b') ?>
    ...
    <?php // echo $form->field($model, 'unit_kerja_terlapor') ?>

    <?php // echo $form->field($model, 'dari') ?>

    <?php // echo $form->field($model, 'tgl_was_20b') ?>

    <?php // echo $form->field($model, 'no_was_20b') ?>
    ...
    <?php // echo $form->field($model, 'tgl_disampaikan_ba') ?>

    <?php // echo $form->field($model, 'tgl_keberatan_ba') ?>

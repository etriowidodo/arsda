...
require_once('/wordtest/classes/CreateDocx.inc');
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/was20b.docx');
      ...
      //  $tglSk                =$modelSk['tgl_sk'];
        ...
        foreach ($modelwas20b as $rowUraian) {
            $keberatan .="<tr>
       ...
       $docx->replaceVariableByHTML('tembusan', 'block',$tembusan, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
 		...
 		$docx->createDocx('template/pengawasan/was20b');
		
        $file = 'template/pengawasan/was20b.docx';

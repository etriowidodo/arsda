...
require_once('/wordtest/classes/CreateDocx.inc');
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/sk_was_4e.docx');
        $kejaksaan=strtoupper($data_satker['inst_nama']);
         
        $nmr_sk_was_4e    =$model['no_sk_was_4e'];
        $ditetapkan       =$model['di_tempat'];
        $nama_penerima		=$model['nama_pegawai_terlapor'];
        $pangkat_penerima =$model['pangkat_pegawai_terlapor'];
        ...
        $pangkat_penetap  =$model['pangkat_penandatangan'];
    ...
    //     $detail_uraian="";
    //     $no=1;
    //     foreach ($modelwas14e as $row_uraian) {
    ...
    //     	$no++;
      ...
      //  $membaca .="</table>";
       ...
       $docx->replaceVariableByText(array('nmr_sk_was_4e'=>$nmr_sk_was_4e), array('parseLineBreaks'=>true));
       ...
       // // $docx->replaceVariableByText(array('nip_penandatangan'=>$nipTandatangan), array('parseLineBreaks'=>true));
        ...
        $docx->replaceVariableByHTML('nama_tembusan', 'block',$tembusan, array('isFile' => false, 'parseDivsAsPs' => true, 'downloadImages' => false));
 		...
 		$docx->createDocx('template/pengawasan/sk_was_4e');
		
        $file = 'template/pengawasan/sk_was_4e.docx';

    ...
    <div class="box box-primary">
        <div class="box-body" style="padding:15px;">
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                <!-- <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-5">Surat Keputusan</label>
                        <div class="col-md-7">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-3" style="width: 140px;">No SK </label>
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-sm-12">
                                     <?= $form->field($model, 'no_sk_was_4e')->textInput()->label(false); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_sk_was_4e',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
            ...
            <div class="col-md-12" style="padding: 15px 0;">
             <?php if(!$model->isNewRecord){ ?>
                 <div class="col-md-6">
                    <div class="form-group">
                        <label class="control-label col-md-4" style="width: 140px;">Tanggal Diterima</label>
                        <div class="col-md-8">
                            <?=
                                $form->field($model, 'tgl_diterima_sk_was_4e',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                                    'type' => DateControl::FORMAT_DATE,
                                    'ajaxConversion' => false,
                                    'options' => [
                                        'pluginOptions' => [
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                         <div class="col-sm-12" ></div>
                            <?php 
                               $membaca="<ol type='1'>
                                          <li>laporan dari ".$dataPelapor['nama_pelapor']." tanggal ".\Yii::$app->globalfunc->ViewIndonesianFormat($dataTerlapor['tanggal_surat_lapdu'])." tentang dugaan pelanggaran disiplin yang dilakukan
                                          ...
                                          <li>Laporan Hasil Inspeksi Kasus yang dilakukan oleh Nama ".$dataPemeriksa['nama_pemeriksa']." NIP ".$dataPemeriksa['nip_pemeriksa']." NRP ".$dataPemeriksa['nrp_pemeriksa']."
                                              pangkat ".$dataPemeriksa['pangkat_pemeriksa']." Jabatan ".$dataPemeriksa['jabatan_pemeriksa']."</li>
                                        </ol>";   
                            ...
                            <?php 
                                $menimbang="<ol style='list-style-type: lower-alpha;'>
                                          ...
                                          <li>bahwa berdasarkan pertimbangan sebagaimana dimaksud dalam huruf a, b, dan c perlu Menetapkan
                                              Keputusan tentang Penjatuhan hukuman disiplin berupa Pemberhentian Tidak Dengan Hormat sebagai
                            ...
                            <?php 
                                $menetapkan="<table>
                                                <tr>
                                                    ...
                                                    <td colspan='2'>Menjatuhkan Hukuman Disiplin berupa PEMBERHENTIAN DENGAN  TIDAK HORMAT SEBAGAI PEGAWAI NEGERI SIPIL kepada :</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style='width:73%'>: ".$dataTerlapor['jabatan_terlapor']."</td>
                                                </tr>
                                                <tr>
                                                    <td style='width:10%'></td>
                                                    <td style='width:2%'></td>
                                                    <td style='width:15%'>Unit Kerja</td>
                                                    <td style='width:73%'>: ".$dataTerlapor['instansi']."</td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td></td>
                                                    <td colspan='2'>Karena yang bersangkutan pada tanggal ".\Yii::$app->globalfunc->ViewIndonesianFormat($dataTerlapor['tanggal_surat_lapdu'])."
      ...
      <div class="panel panel-primary">
          <div class="panel-heading">Penandatangan</div>
            ...
            <?php if(!$model->isNewRecord){ ?>
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas Sk-Was-4e : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4e'].'&id2='.$model['id_sk_was_4e'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?> <?= $model['upload_file']?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_sk_was_4e'].'&id2='.$model['id_sk_was_4e'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?>  <?= $model['upload_file']?>
                    <?php } ?>
                </label>
 ...
 <?php    
       if (!$model->isNewRecord){
        // if($result_expire=='1'){
          ...
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4e/index'], ['id' => 'KembaliSkWas4e', 'class' => 'btn btn-primary']);
        //  }
       }else{
          echo Html::submitButton($model->isNewRecord ? '<i class="fa fa-save"></i> Simpan' : '<i class="fa fa-save"></i> Simpan', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ;
          echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/sk-was-4e/index'], ['id' => 'KembaliSkWas4e', 'class' => 'btn btn-primary']);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelskwas4e = new SkWas4eSearch();
                            $dataProviderPenandatangan = $searchModelskwas4e->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
...
<style type="text/css">
    ...
    .field-skwas4epelapor-nama_pelapor , .field-skwas4epelapor-alamat_pelapor , .field-skwas4epelapor-email_pelapor
    , .field-skwas4epelapor-telp_pelapor, .field-skwas4epelapor-pekerjaan_pelapor, .field-skwas4epelapor-kewarganegaraan_pelapor
    , .field-skwas4epelapor-agama_pelapor, .field-skwas4epelapor-pendidikan_pelapor, .field-skwas4epelapor-nama_kota_pelapor
    , .field-skwas4epelapor-tanggal_lahir_pelapor, .field-skwas4epelapor-tempat_lahir_pelapor, .field-skwas4epelapor-sumber_lainnya
    , .field-skwas4epelapor-id_sumber_laporan ,.field-skwas4e-nip_pegawai_terlapor ,.field-skwas4e-nama_pegawai_terlapor
    ,.field-skwas4e-pangkat_pegawai_terlapor ,.field-skwas4e-golongan_pegawai_terlapor ,.field-skwas4e-jabatan_pegawai_terlapor
    ,.field-skwas4epemeriksa-nip_pemeriksa ,.field-skwas4epemeriksa-nrp_pemeriksa ,.field-skwas4epemeriksa-nama_pemeriksa
    ,.field-skwas4epemeriksa-pangkat_pemeriksa ,.field-skwas4epemeriksa-jabatan_pemeriksa ,.field-skwas4epemeriksa-golongan_pemeriksa{
        display: none;
    }
 
/* #skwas4e-tgl_sk_was_4e-disp{
    width: 405px;
 }  */ 
</style>
...
$(document).on('click','#addtembusan',function() {
        ...
        $(document).on('click','#tambah_penandatangan',function() {
          ...
          if(jml=>1 && jml<2){
             $('#skwas4e-nip_penandatangan').val(data.nip);
             $('#skwas4e-nama_penandatangan').val(data.nama);
             $('#skwas4e-jabatan_penandatangan').val(data.nama_jabatan);
             $('#skwas4e-golongan_penandatangan').val(data.gol_kd);
             $('#skwas4e-pangkat_penandatangan').val(data.gol_pangkat2);
             $('#skwas4e-jbtn_penandatangan').val(data.jabtan_asli);

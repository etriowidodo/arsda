...
$this->title = 'SK WAS 4E';
$this->subtitle = 'Surat Keputusan PHD Pemberhentian Tidak Dengan Hormat Sebagai PNS';
$session = Yii::$app->session;
$this->params['ringkasan_perkara'] = $_SESSION['was_register'];
$this->params['breadcrumbs'][] = ['label' => 'Sk Was4e', 'url' => ['index']];
$this->params['breadcrumbs'][] = 'SURAT KEPUTUSAN PHD PEMBERHENTIAN TIDAK DENGAN HORMAT SEBAGAI PNS';
?>
<div class="sk-was4e-create">
<br>
    <?= $this->render('_form', [
        'model' => $model,

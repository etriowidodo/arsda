...
<div class="was17-form">
    <!-- <div class="content-wrapper-1"> -->
        ...
        <section class="content" style="padding: 0px;">
            <div class="box box-primary">
                <div class="box-body" style="padding:15px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                  <!--   <div class="input-group"> -->
                                        <?= $form->field($model, 'kpd_was_17')->textInput(['maxlength' => true,'value' => 'Jaksa Agung','readonly'=>'readonly'])->label(false) ?>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                         <?php if(!$model->isNewRecord){ ?>
                                            <input id="was17-dari_was_17" class="form-control" name="Was17[dari_was_17]" readonly="readonly" value="<?= $model['jabatan_penandatangan'] ?>"  type="text">
                                        <?php }else{ ?>
                                            <input id="was17-dari_was_17" class="form-control" name="Was17[dari_was_17]" readonly="readonly"  type="text">
                                        <?php } ?>
                                        <div class="input-group-btn">
                    ...
                    <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= $form->field($model, 'no_was_17')->textInput(['maxlength' => true])->label(false) ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?= $form->field($model, 'tgl_was_17',['addon' => ['prepend' => ['content'=>'<i class="glyphicon glyphicon-calendar"></i>']]])->widget(DateControl::className(), [
                    ...
                    <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;padding-top: 10px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label col-md-4">Ketua MKJ</label>
                                <div class="col-md-8">
                                   <?php 
                                    echo $form->field($model, 'nama_mkj',[
                                                        'addon' => [
                                                            'append' => [
                                                                'content' => Html::button('Cari', ['class'=>'btn btn-primary', "data-toggle"=>"modal", "data-target"=>"#mkj"]),
                                                                'asButton' => true
                                                            ]
                                                        ]
                                                    ])->textInput(['readonly'=>'readonly'])->label(false);
            ...
            <div class="col-md-12" style="padding-top: 15px;">
                <label>Unggah Berkas WAS-17 : 
                     <?php if (substr($model->upload_file,-3)!='pdf'){?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_17'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-image-o"></i></span></a>' :'') ?>
                    <?php } else{?>
                        <?= ($model['upload_file']!='' ? '<a href="viewpdf?id='.$model['id_was_17'].'" target="_blank"><span style="cursor:pointer;font-size:28px;"><i class="fa fa-file-pdf-o"></i></span></a>' :'') ?> 
                    <?php } ?>
                </label>
            ...
            <input id="was17-was15" name="was17-was15" type="hidden">
            <input id="was17-idterlapor" name="was17-idterlapor" type="hidden">

            <?= $form->field($model, 'nip_mkj')->hiddenInput(['maxlength' => true,])->label(false) ?>
            <?= $form->field($model, 'pangkat_mkj')->hiddenInput(['maxlength' => true,])->label(false) ?>
            <?= $form->field($model, 'golongan_mkj')->hiddenInput(['maxlength' => true,])->label(false) ?>
            <?= $form->field($model, 'jabatan_mkj')->hiddenInput(['maxlength' => true,])->label(false) ?>
            <?= $form->field($model, 'jbtn_mkj')->hiddenInput(['maxlength' => true,])->label(false) ?>
    ...
    <div class="form-group" style="text-align: center;">
        ...
        <a class="btn btn-primary" href="<?= \yii\helpers\Url::to(['was17/index'])?>"><i class="fa fa-arrow-left"></i> Batal</a>
    </div>
</div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <?php
                            $searchModelWas17terlapor = new Was17Search();
                            $dataProviderPenandatanganWas17terlapor = $searchModelWas17terlapor->searchTerlapor(Yii::$app->request->queryParams);
                        ?>
                        <div id="w1" class="grid-view">
                            <?php Pjax::begin(['id' => 'Mterlapor-tambah-grid', 'timeout' => false,'formSelector' => '#searchFormTerlapor','enablePushState' => false]) ?>
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas17terlapor,
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <div class="box box-primary" style="padding: 15px;overflow: hidden;">
                        <?php
                            $searchModelWas17 = new Was17Search();
                            $dataProviderPenandatanganWas17 = $searchModelWas17->searchPenandatangan(Yii::$app->request->queryParams);
                        ?>
                        <div id="w4" class="grid-view">
                            ...
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas17,
                                // 'filterModel' => $searchModel,
                                // 'layout' => "{items}\n{pager}",
                                'columns' => [
                                    ['header'=>'No',
...
<!-- begin Terlapor yang Dilanjutkan -->
<div class="modal fade" id="mkj" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="myModalLabel">Ketua MKJ</h4>
                </div>
                <div class="modal-body">
                    <p>
                        <?php $form = ActiveForm::begin([
                        ...
                        <div class="box box-primary" style="padding: 15px;overflow: hidden;">
                        <?php
                            $searchModelWas17mkj = new Was17Search();
                            $dataProviderPenandatanganWas17Mkj = $searchModelWas17mkj->searchMkj(Yii::$app->request->queryParams);
                        ?>
                        <div id="w1" class="grid-view">
                            <?php Pjax::begin(['id' => 'Mterlapor-tambah-grid', 'timeout' => false,'formSelector' => '#searchFormTerlapor','enablePushState' => false]) ?>
                            <?php
                            echo GridView::widget([
                                'dataProvider'=> $dataProviderPenandatanganWas17Mkj,
                                // 'filterModel' => $searchModel,
                                // 'layout' => "{items}\n{pager}",
                                'columns' => [
                                    ['header'=>'No',
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="button" class="btn btn-default" id="tambah_mkj">Tambah</button>
                </div>
            </div>
        </div>
</div>
    ...
    window.onload=function(){
       $(document).on('click','#tambah_penandatangan',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was17-nip_penandatangan').val(data.nip);
           $('#was17-nama_penandatangan').val(data.nama);
           $('#was17-nama_dari').val(data.nama_jabatan);
           $('#was17-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was17-dari_was_17').val(data.nama_jabatan);
           $('#was17-golongan_penandatangan').val(data.gol_kd);
           $('#was17-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was17-jbtn_penandatangan').val(data.jabtan_asli);
       ...
       $(document).on('click','#tambah_terlapor',function() {
        ...
        //alert(data.nama_terlapor);
           $('#was17-nip_pegawai_terlapor').val(data.nip_pegawai_terlapor);
           $('#was17-nrp_pegawai_terlapor').val(data.nrp_pegawai_terlapor);
           $('#was17-nama_pegawai_terlapor').val(data.nama_pegawai_terlapor);
           $('#was17-jabatan_pegawai_terlapor').val(data.jabatan_pegawai_terlapor);
           $('#was17-sk').val(data.sk);
           $('#was17-was15').val(data.id_was15);
           $('#was17-idterlapor').val(data.id_terlapor_l_was2);
          // $('#was17-hukdis').val(data.isi_sk);
           $('#was17-pangkat_pegawai_terlapor').val(data.pangkat_pegawai_terlapor);
           $('#was17-golongan_pegawai_terlapor').val(data.golongan_pegawai_terlapor);
           $('#was17-satker_pegawai_terlapor').val(data.satker_pegawai_terlapor);

           $('#terlapor').modal('hide');

        });

       $(document).on('click','#tambah_mkj',function() {
        var data=JSON.parse($(".selection_one_terlapor:checked").attr("json"));
        //alert(data.nama_terlapor);
           $('#was17-nip_mkj').val(data.nip);
           $('#was17-nama_mkj').val(data.nama);
           $('#was17-pangkat_mkj').val(data.gol_pangkat2);
           $('#was17-golongan_mkj').val(data.gol_kd);
           $('#was17-jbtn_mkj').val(data.jabtan_asli);
           $('#was17-jabatan_mkj').val(data.nama_jabatan);
       ...
       $(document).on('click','#tambah_kepada',function() {
        var data=JSON.parse($(".selection_one:checked").attr("json"));
           $('#was17-nip_penandatangan').val(data.nip);
           $('#was17-nama_penandatangan').val(data.nama);
           $('#was17-kepada_was17').val(data.nama);
           $('#was17-jabatan_penandatangan').val(data.nama_jabatan);
           $('#was17-golongan_penandatangan').val(data.gol_kd);
           $('#was17-pangkat_penandatangan').val(data.gol_pangkat2);
           $('#was17-jbtn_penandatangan').val(data.jabtan_asli);
       ...
       $(document).on('click','#addtembusan',function() {
        ...
        $(document).on('hidden.bs.modal','#terlapor,#penandatangan,#mkj', function (e) {

...
$form = ActiveForm::begin([
      ...
      'action' => (empty($model['id_was_17']) ? Url::toRoute('was17/create') : Url::toRoute('was17/update2?id='.$model["id_was_17"].'')),
      'fieldConfig' => [
                ...
                <div class="col-md-9">	
                    ...
                    if ($model->isNewRecord) {
                      $sql = (new \yii\db\Query())
                              ...
                              ->andWhere(['not in', 'terlapor.id_terlapor', (new \yii\db\Query())->select('id_terlapor')->from('was.was_17')->where(['was_17.id_register' => $model->id_register])->andWhere('flag != :del', ['del'=>'3'])])
                              ->all();


                      $data = ArrayHelper::map($sql, 'id_terlapor', 'nama');
                      echo $form->field($model, 'id_terlapor')->dropDownList($data, ['prompt' => '---Pilih Terlapor---',
                          'onchange'=>'
                            var e = $(this).find("option:selected").text();
                            var temp = e.split("-");
                            $("#was17-perihal").val("Usul Penunjukan Majelis Kehormatan Jaksa untuk melakukan pemeriksaan atas dugaan pelanggaran disiplin Terlapor an."+temp[1]);
                          '
                ...
                <div class="col-md-4">
                  <?php if ($model->isNewRecord) { ?>
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" id="no_was_17" name="no_was_17">
                    </div>
                  <?php } else { ?>
                    <div class="input-group">
                      <span class="input-group-addon"><?php echo substr($model->no_was_17, 0, 2); ?></span>
                      <input class="form-control" type="text" id="no_was_17" name="no_was_17" value="<?php echo substr($model->no_was_17, 2); ?>">
                    </div>
                  <?php } ?>
                    <!--<div class="input-group">
                        <span class="input-group-addon" style="background: #eee;">R-</span>
                        <input type="text" class="form-control" name="Was17[no_was_17]">
                    </div>-->
                </div>
                <!--<div class="col-md-3">
                    <input id="no_was_17" class="form-control" type="text" readonly="true" value="R-" style="text-align:right;width:50px" name="no_was_17">
                </div>-->
                <!--<div class="col-md-6">
                <?php //echo $form->field($model, 'no_was_17')->textInput(['maxlength' => true, 'style' => 'margin-left:-80px;width:323px;']) ?>
                </div>-->
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <?=
                    $form->field($model, 'tgl_was_17')->widget(DateControl::className(), [
...
//                    echo $form->field($model, 'sifat_surat')->dropDownList($data, ['label' => '', 'readonly' => true]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['kd_lookup_item']; ?>" name="Was17[sifat_surat]" class="form-control">
...
//                    echo $form->field($model, 'kpd_was_17')->dropDownList($data, ['label' => '', 'readonly' => true,]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['id_jabatan_pejabat']; ?>" name="Was17[kpd_was_17]" class="form-control">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">	
                    ...
                    $sql = (new \yii\db\Query())
                            ...
                            ->one();
//                    $data = ArrayHelper::map($sql, 'id_jabatan_pejabat', 'jabatan');
//                    echo $form->field($model, 'ttd_was_17')->dropDownList($data, ['label' => '', 'readonly' => true,]);
                    ?>
                    <input type="hidden" value="<?php echo $sql['id_jabatan_pejabat']; ?>" name="Was17[ttd_was_17]" class="form-control">
                    <input type="text" value="<?php echo $sql['jabatan']; ?>" class="form-control" readonly=TRUE>
...
<div class="box box-primary">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was17-ttd_peg_nik">
                    <div class="col-sm-12">
                ...
                <div class="form-group field-was17-ttd_peg_nama">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was17-ttd_peg_nip">
                    <div class="col-sm-12">
    ...
    <div style="margin-top:15px;" class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was17-ttd_peg_jabatan">
                    <div class="col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <div class="form-group field-was17-ttd_peg_inst_satker">
                    <div class="col-sm-12">

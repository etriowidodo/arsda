...
require_once('/wordtest/classes/CreateDocx.inc');
        ...
        $docx = new CreateDocxFromTemplate('../modules/pengawasan/template/was-10.docx');
...
//         /*nip Pemeriksa*/
        $pemeriksa_nip=substr($model['nip_pemeriksa'],0,8).' '.substr($model['nip_pemeriksa'],8,6).' '.substr($model['nip_pemeriksa'],14,1).' '.substr($model['nip_pemeriksa'],15,3).($modelPemeriksa['nrp']!=''?'/':' ').$modelPemeriksa['nrp'];
...
//         /*nama Terlapor*/
        // $terlapor_dugaan=explode(',',$terlapor['nama_pegawai_terlapor']);
...
//         /*pejabatSpWas1*/
        $no_sp_was=$sp_was_1['nomor_sp_was1'];

//         /*jabatan_penandatangan*/
        $pejabat_sp_was=$sp_was_1['jabatan_penandatangan'];
        // print_r($tgl_sp_was);
...
//         /*tembusan spwas1*/
        ...
        $docx->replaceVariableByText(array('pejabat_sp_was'=>$uraianPermasalahan), array('parseLineBreaks'=>true));
        ...
        $docx->createDocx('template/pengawasan/was-10');
		
        $file = 'template/pengawasan/was-10.docx';

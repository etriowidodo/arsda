...
<?php $form = ActiveForm::begin([
            ...
            <div class="col-md-12" style="padding-right: 0px;padding-left: 0px;">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <?= $form->field($model, 'no_surat')->textInput()->label(false);?>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-12" style="padding-top: 10px;padding-right: 0px;padding-left: 0px;">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <?php
                                $loadNip=PegawaiTerlaporWas10::findOne(['nip'=>$_GET['nip']]);
                                $model->nip_pegawai_terlapor=$loadNip['nip'];
    ...
    <div class="box-footer" style="margin:10px;padding:10px;background:none;">
      ...
      if ($model->isNewRecord){
       ...
       ?>
      <?php
        echo Html::a('<i class="fa fa-print"></i> Cetak', ['/pengawasan/was10/cetakdocx', 'id' => $model->id_surat_was10], ['class' => 'btn btn-primary']);
      
       echo " ".Html::a('<i class ="fa fa-arrow-left"></i> Batal', ['/pengawasan/was10/index'], ['id' => 'KembaliSpWas1', 'class' => 'btn btn-primary']);
     ?>
    </div>
    </div>
    <?php ActiveForm::end(); ?>
...
$('#was10-tanggal_pemeriksaan_was10').datepicker({
        ...
        weekday[6]="Minggu";
           ...
           $('#was10-hari_pemeriksaan_was10').val(dayOfWeek);
    },
...
$('#tgl_bertemu').click(function(){
    $("#was10-tanggal_pemeriksaan_was10").datepicker().focus();
});
$('#tgl_was10').click(function(){
    $("#was10-was10_tanggal").datepicker().focus();
});
...
$(document).on('click','#tambah_penandatangan',function() {
    var data=JSON.parse($(".selection_one:checked").attr("json"));
       $('#was10-nip_penandatangan').val(data.nip);
       $('#was10-nama_penandatangan').val(data.nama);
       $('#was10-jabatan_penandatangan').val(data.nama_jabatan);
...
/*////////////////PENANDATANGAN SURAT GRID LOADING////////////////////*/
    ...
    $(document).on('click','.cari_ttd',function() { 
        $('#grid-penandatangan_surat').addClass('loading');
        $("#grid-penandatangan_surat").load("/pengawasan/was10/getttd",function(responseText, statusText, xhr)
            {

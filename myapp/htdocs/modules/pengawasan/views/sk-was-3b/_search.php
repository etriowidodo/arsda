...
/* @var $model app\modules\pengawasan\models\SkWas3bSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="sk-was3b-search">
    ...
    <?= $form->field($model, 'id_sk_was_3b') ?>

    <?= $form->field($model, 'no_sk_was_3b') ?>

    <?= $form->field($model, 'inst_satkerkd') ?>

    <?= $form->field($model, 'id_register') ?>

    <?= $form->field($model, 'tgl_sk_was_3b') ?>

    <?php // echo $form->field($model, 'ttd_sk_was_3b') ?>

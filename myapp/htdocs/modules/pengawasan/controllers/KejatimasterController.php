 ...
 */
class KejatimasterController extends Controller
{
    ...
    {
        $query = " select a.*, b.nama_inspektur from was.kejati a inner join was.inspektur b on b.id_inspektur=a.id_inspektur and id_kejati not in ('-1') order by id_kejati";
    ...
    {
        if (($model = Kejati::findOne($id)) !== null) {
            return $model;
        } else {

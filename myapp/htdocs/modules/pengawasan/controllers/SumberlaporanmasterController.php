...
use app\modules\pengawasan\models\SumberLaporanMasterSearch;
 ...
 */
class SumberlaporanmasterController extends Controller
{
    ...
    {
        $searchModel = new SumberLaporanMasterSearch();
    ...
    {
        if (($model = SumberLaporanMaster::findOne($id)) !== null) {
            return $model;
        } else {

...
use Yii;
use app\modules\pengawasan\models\SkWas4b;
use app\modules\pengawasan\models\SkWas4bPelapor;
use app\modules\pengawasan\models\SkWas4bPemeriksa;
use app\modules\pengawasan\models\SkWas4bUraian;
use app\modules\pengawasan\models\SkWas4bSearch;
...
use app\modules\pengawasan\models\TembusanSkWas4b;
...
/**
 * SkWas4bController implements the CRUD actions for SkWas4b model.
 */
class SkWas4bController extends Controller
{
    ...
    /**
     * Displays a single SkWas4b model.
     * @param string $id
     * @return mixed
     */
    public function actionView($id)
    {
     ...
     public function actionViewpdf($id,$id2){
        $file_upload=$this->findModel($id,$id2);
          ...
          $filepath = '../modules/pengawasan/upload_file/sk_was_4b/'.$file_upload['upload_file'];
    ...
    {
        $model = new SkWas4b();
        $modelPemeriksa = new SkWas4bPemeriksa();
        $modelPelapor = new SkWas4bPelapor();
        ...
        $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'sk_was_4b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        // print_r($dataLapdu);
        // exit();
        $queryp = new Query;
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS4-B' 
        ...
        if ($model->load(Yii::$app->request->post())){
          ...
          // exit();
            ...
            // $model->id_terlapor = $_POST['SkWas4b']['id_terlapor']; 
            // $model->ttd_sk_was_4b = $_POST['SkWas4b']['ttd_sk_was_4b'];
            // $model->no_sk_was_4b = "KEP-".$_POST['no_sk_was_4b'];
          ...
          //  try {
             ...
             // exit();
                   $jml=count($_POST['uraian']);
                    for ($i=0; $i < $jml; $i++) { 
                        $modelsk14bUaraian=new SkWas4bUraian();
                        $modelsk14bUaraian->no_register = $_SESSION['was_register'];
                        $modelsk14bUaraian->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14bUaraian->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14bUaraian->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14bUaraian->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14bUaraian->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14bUaraian->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14bUaraian->id_l_was2   = $model->id_l_was2;
                        $modelsk14bUaraian->id_was15    = $model->id_was15;
                        $modelsk14bUaraian->id_sk_was_4b= $model->id_sk_was_4b;
                        $modelsk14bUaraian->isi_uraian  = $_POST['uraian'][$i];
                        $modelsk14bUaraian->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14bUaraian->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14bUaraian->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14bUaraian);
                       // print_r($model->id_sk_was_4b);
                        // print_r($jml);
                        //  exit();
                        $modelsk14bUaraian->save();
                    }
//SkWas4bPelapor[nama_pelapor]
                    $jmlPelapor=count($_POST['nama_pelapor']);

                    for ($i=0; $i < $jmlPelapor; $i++) { 
                        $modelsk14bPelapor=new SkWas4bPelapor();
                        $modelsk14bPelapor->no_register = $_SESSION['was_register'];
                        $modelsk14bPelapor->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14bPelapor->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14bPelapor->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14bPelapor->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14bPelapor->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14bPelapor->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14bPelapor->id_l_was2   = $model->id_l_was2;
                        $modelsk14bPelapor->id_was15    = $model->id_was15;
                        $modelsk14bPelapor->id_sk_was_4b= $model->id_sk_was_4b;
                        $modelsk14bPelapor->nama_pelapor= $_POST['nama_pelapor'][$i];
                        $modelsk14bPelapor->alamat_pelapor    = $_POST['alamat_pelapor'][$i];
                        $modelsk14bPelapor->email_pelapor     = $_POST['email_pelapor'][$i];
                        $modelsk14bPelapor->telp_pelapor      = $_POST['telp_pelapor'][$i];
                        $modelsk14bPelapor->pekerjaan_pelapor = $_POST['pekerjaan_pelapor'][$i];
                        $modelsk14bPelapor->sumber_lainnya    = $_POST['sumber_lainnya'][$i];
                        $modelsk14bPelapor->id_sumber_laporan = $_POST['id_sumber_laporan'][$i];
                        $modelsk14bPelapor->tempat_lahir_pelapor   = $_POST['tempat_lahir_pelapor'][$i];
                        $modelsk14bPelapor->tanggal_lahir_pelapor  = $_POST['tanggal_lahir_pelapor'][$i];
                        $modelsk14bPelapor->kewarganegaraan_pelapor= $_POST['kewarganegaraan_pelapor'][$i];
                        $modelsk14bPelapor->agama_pelapor          = $_POST['agama_pelapor'][$i];
                        $modelsk14bPelapor->pendidikan_pelapor     = $_POST['pendidikan_pelapor'][$i];
                        $modelsk14bPelapor->nama_kota_pelapor      = $_POST['nama_kota_pelapor'][$i];
                        $modelsk14bPelapor->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14bPelapor->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14bPelapor->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14bPelapor);
                       // print_r($model->id_sk_was_4b);
                       // print_r($modelsk14bPelapor);
                       // exit();
                        $modelsk14bPelapor->save();
                    }
//[nama_pemeriksa]
                    ...
                    for ($i=0; $i < $jmlPemeriksa; $i++) { 
                        $modelsk14bPemeriksa=new SkWas4bPemeriksa();
                        $modelsk14bPemeriksa->no_register = $_SESSION['was_register'];
                        $modelsk14bPemeriksa->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14bPemeriksa->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14bPemeriksa->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14bPemeriksa->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14bPemeriksa->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14bPemeriksa->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14bPemeriksa->id_l_was2   = $model->id_l_was2;
                        $modelsk14bPemeriksa->id_was15    = $model->id_was15;
                        $modelsk14bPemeriksa->id_sk_was_4b= $model->id_sk_was_4b;
                        $modelsk14bPemeriksa->nip_pemeriksa = $_POST['nip_pemeriksa'][$i];
                        $modelsk14bPemeriksa->nrp_pemeriksa     = $_POST['nrp_pemeriksa'][$i];
                        $modelsk14bPemeriksa->nama_pemeriksa    = $_POST['nama_pemeriksa'][$i];
                        $modelsk14bPemeriksa->pangkat_pemeriksa = $_POST['pangkat_pemeriksa'][$i];
                        $modelsk14bPemeriksa->jabatan_pemeriksa = $_POST['jabatan_pemeriksa'][$i];
                        $modelsk14bPemeriksa->golongan_pemeriksa= $_POST['golongan_pemeriksa'][$i];
                        $modelsk14bPemeriksa->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14bPemeriksa->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14bPemeriksa->created_time=date('Y-m-d H:i:s');
                        // print_r($modelsk14bPemeriksa);
                        // exit();
                        $modelsk14bPemeriksa->save();
                    }

                     $pejabat = $_POST['pejabat'];
                    TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>strrev($model->id_sk_was_4b),'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                        for($z=0;$z<count($pejabat);$z++){
                            $saveTembusan = new TembusanWas2;
                            $saveTembusan->from_table = 'Sk-Was-4b';
                            $saveTembusan->pk_in_table = strrev($model->id_sk_was_4b);
                    ...
                    // if ($files != false) {
                    // $path = \Yii::$app->params['uploadPath'].'sk_was_4b/'.$files->name;
                    // $files->saveAs($path);
                    // }
                 // for($i=0;$i<count($tembusan);$i++){
                 //        $saveTembusan = new TembusanSkWas4b();
                 //        $saveTembusan->id_sk_was_4b = $model->id_sk_was_4b;
    ...
    public function actionUpdate($id,$id2)
    {
        ...
        $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_sk_was_4b,'from_table'=>'Sk-Was-4b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])->orderBy('is_order desc')->all();
        $modelSpWas2 = SpWas2::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],'trx_akhir'=>1]);
      //  $dataPemeriksa = PemeriksaSpWas2::findAll(["id_sp_was2"=>$modelSpWas2->id_sp_was2,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
       ...
       // $modelPelapor = SkWas4bPelapor::findAll(["id_sk_was_4b"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        // print_r($dataPemeriksa);
        // exit();
        $dataLapdu = Lapdu::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
      //  $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'was_16b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        a.id_cabjari=d.id_cabjari and 
                        a.no_register=d.no_register 
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS4-B' and b.nip_terlapor='".$_GET['id2']."'";
        $dataTerlapor = $connection->createCommand($modelTerlapor)->queryOne();
        // print_r($dataTerlapor);
        // exit();
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            try {
                ...
                $model->pelanggaran = $dataTerlapor['keterangan_pelanggaran'];
            if($model->save()){
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'sk_was_4b/'.$OldFile)) {
                      unlink(\Yii::$app->params['uploadPath'].'sk_was_4b/'.$OldFile);
                  }

                $jml=count($_POST['uraian']);
                SkWas4bUraian::deleteAll(['id_sk_was_4b'=>$model->id_sk_was_4b,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                    for ($i=0; $i < $jml; $i++) { 
                          $modelsk14bUaraian=new SkWas4bUraian();
                          $modelsk14bUaraian->no_register = $_SESSION['was_register'];
                          $modelsk14bUaraian->id_tingkat  = $_SESSION['kode_tk'];
            ...
            move_uploaded_file($file_tmp,\Yii::$app->params['uploadPath'].'sk_was_4b/'.$rename_file);
            $transaction->commit();
     ...
     public function actionCetak($id){
        ...
        // print_r($model);
        // exit();
        $modelwasUraian1=SkWas4bUraian::findAll(['id_sk_was_4b'=>$model->id_sk_was_4b,'no_register'=>$_SESSION['was_register'],
        ...
        $modelwasUraian2=SkWas4bUraian::findAll(['id_sk_was_4b'=>$model->id_sk_was_4b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian3=SkWas4bUraian::findAll(['id_sk_was_4b'=>$model->id_sk_was_4b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian4=SkWas4bUraian::findAll(['id_sk_was_4b'=>$model->id_sk_was_4b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelTembusan=TembusanWas2::findAll(['pk_in_table'=>$model->id_sk_was_4b,'from_table'=>'Sk-Was-4b',
                            'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                            'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
        ...
        $tgl_sk      =\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_sk_was_4b']);
        $tgl_diterima=\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_diterima_sk_was_4b']);
     ...
     $id_sk_was_4b = $_POST['id'];
     $jumlah = $_POST['jml'];
     
   //  echo $id_bawas3;
        for ($i=0; $i <$jumlah ; $i++) { 
            $pecah=explode(',', $id_sk_was_4b);
           // echo $pecah[$i];
          //  $this->findModel($pecah[$i])->delete();
            SkWas4b::deleteAll(['id_wilayah'=>$_SESSION['was_id_wilayah'],
                               'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
                               'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],
                               'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                               'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],
                               'id_cabjari'=>$_SESSION['kode_cabjari'],'id_sk_was_4b'=>$pecah[$i]]);
            
            TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4b','no_register'=>$_SESSION['was_register'],
                                     'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                                     'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
    ...
    public function actionDelete_old() {
        ...
        for ($i = 0; $i < count($arr); $i++) {
          if (SkWas4b::updateAll(["flag" => 3], "id_sk_was_4b ='" . $arr[$i] . "'")) {
            TembusanSkWas4b::deleteAll('id_sk_was_4b=:del', [':del'=>$arr[$i]]);
            Yii::$app->getSession()->setFlash('success', [
              'type' => 'success',
              'duration' => 3000,
              'icon' => 'fa fa-users',
    ...
    /**
     * Finds the SkWas4b model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return SkWas4b the loaded model
    ...
    $lokasi = $qryLokasi->select('a.inst_lokinst')
        ...
        ->innerJoin('was.sk_was_4b b', 'a.inst_satkerkd=b.inst_satkerkd')
        ->where('length(a.inst_satkerkd)=:inst_satkerkd AND b.id_sk_was_4b=:id_sk_was_4b',
            [':inst_satkerkd' => 2, ':id_sk_was_4b' => $model->id_sk_was_4b])->one();

    $keputusan = VPejabatPimpinan::find()->where('id_jabatan_pejabat=:id_jabatan_pejabat', [':id_jabatan_pejabat' => $model->ttd_sk_was_4b])->one();
    ...
    $odf = new Odf(Yii::$app->params['reportPengawasan'] . "sk_was_4b.odt");

    $odf->setVars('nm_kejaksaan', $instansi['inst_nama']);
    $odf->setVars('keputusan', $keputusan->jabatan);
    $odf->setVars('nmr_sk_was_4b', $model->no_sk_was_4b);
    ...
    $odf->setVars('tgl_ditetapkan', GlobalFuncComponent::tglToWord($model->tgl_sk_was_4b));
    ...
    $query->select('a.jabatan')
        ...
        ->innerJoin('was.tembusan_sk_was_4b b', 'a.id_pejabat_tembusan = b.id_pejabat_tembusan')
        ->innerJoin('was.sk_was_4b c', 'b.id_sk_was_4b = c.id_sk_was_4b')
        ->where("c.id_sk_was_4b=:id_sk_was_4b", [':id_sk_was_4b' => $model->id_sk_was_4b]);
...
select c.id_terlapor,c.id_register,c.id_h_jabatan,e.peg_nama,e.peg_nip,e.peg_nip_baru,y.jml_terlapor from was.terlapor c
    ...
    inner join kepegawaian.kp_pegawai e on (c.peg_nik=e.peg_nik)
        ...
        $odf->exportAsAttachedFile("SK.WAS-4b ".$dugaan['terlapor'].'.odt');   
   }

   public function actionGetttd(){
       
   $searchModelskwas4b = new SkWas4bSearch();
   $dataProviderPenandatangan = $searchModelskwas4b->searchPenandatangan(Yii::$app->request->queryParams);
   ...
   echo GridView::widget([
    ...
    {
        if (($model = SkWas4b::findOne(['id_sk_was_4b'=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])) !== null) {
            return $model;
        } else {

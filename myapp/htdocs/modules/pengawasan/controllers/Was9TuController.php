 ...
 */
class Was9TuController extends Controller
{
    ...
    public function actionIndex()
    {
      ...
      // $query1 = "select * from was.was9 where jbtn_penandatangan='Jaksa Agung Muda Pengawasan'";
    ...
    {
      $connection = \Yii::$app->db;
      $query1 = "update was.was9 set nomor_surat_was9='".$_POST['nomor']."'
        ...
        and id_cabjari='".$_SESSION['kode_cabjari']."'  and id_surat_was9='".$_POST['surat_was9']."' 
      ...
      public function actionInsertnomoreksternal()
    {
      ...
      $query1 = "update was.was9 set nomor_surat_was9='".$_POST['nomor']."'
        ...
        and id_wilayah='".$_SESSION['id_wil']."' and id_level1='".$_SESSION['id_level_1']."' 
        and id_level2='".$_SESSION['id_level_2']."' and id_level3='".$_SESSION['id_level_3']."' 
        and id_level4='".$_SESSION['id_level_4']."'  and id_saksi is not null ";
      $updateinternal = $connection->createCommand($query1);
      // print_r($query1);
      // exit();
      $updateinternal->execute();
  ...
  echo GridView::widget([
      ...
      protected function findModel_int($id_saksi,$id_was9)
    {
        ...
        if (($model = Was9::findBySql("
            ...
            from was.was9 a left join was.saksi_internal b on a.id_saksi_internal=b.id_saksi_internal
        ...
        if (($model = Was9::findBySql("
            select a.*,b.nama_saksi_eksternal as nama_saksi,
             ...
             b.alamat_saksi_eksternal as alamat,b.nama_kota_saksi_eksternal as kota,b.pekerjaan_saksi_eksternal as pekerjaan
              from was.was9 a left join was.saksi_eksternal b on a.id_saksi_eksternal=b.id_saksi_eksternal
               where a.no_register='".$_SESSION['was_register']."' and a.id_tingkat='".$_SESSION['kode_tk']."'
               and a.id_kejati='".$_SESSION['kode_kejati']."' and a.id_kejari='".$_SESSION['kode_kejari']."'

 ...
 */
class Was9InspeksiController extends Controller
{
      ...
      public function actionCreatesaksi()
    {
        ...
        for ($i=0; $i < count($jml); $i++) { 
            ...
            Yii::$app->getSession()->setFlash('success', [
             ...
             'duration' => 3000,
             'icon' => 'fa fa-users',
             'message' => 'Data Was9 Berhasil Disimpan',
             'title' => 'Simpan Data',
             'positonY' => 'top',
             'positonX' => 'center',
    ...
    public function actionCreatesaksi2()
    {
        ...
        if ($model->load(Yii::$app->request->post())){
          $connection = \Yii::$app->db;
            ...
            return $this->redirect(['index(ext)']);
            } catch (Exception $e) {
              $transaction->rollback();
              if(YII_DEBUG){throw $e; exit;} else{return false;}
   ...
   public function actionCreate()
    ...
    $var=str_split($_SESSION['is_inspektur_irmud_riksa']);
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            // print_r($model->jbtn_penandatangan);
            // exit();
    ...
    public function actionUpdate($jns,$id,$nm,$id_saksi,$no,$id_was9)
    {
      ...
      $chars = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
       ...
       if($_GET['jns'] == 'Internal'){
        ...
        $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_surat_was9,'from_table'=>'Was9Inspeksi','no_register'=>$model->no_register,'id_tingkat'=>$model->id_tingkat,'id_kejati'=>$model->id_kejati,'id_kejari'=>$model->id_kejari,'id_cabjari'=>$model->id_cabjari
                                              ,'id_wilayah'=>$model->id_wilayah,'id_level1'=>$model->id_level1,'id_level2'=>$model->id_level2,'id_level3'=>$model->id_level3,'id_level4'=>$model->id_level4])->orderBy('is_order DESC')->all();
                ...
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'was_9inspeksi/'.$OldFile)) {
                    unlink(\Yii::$app->params['uploadPath'].'was_9inspeksi/'.$OldFile);
                        ...
                        TembusanWas2::deleteAll(['from_table'=>'Was9Inspeksi','is_inspektur_irmud_riksa'=>$_SESSION['is_inspektur_irmud_riksa'],'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>$model->id_surat_was9]);
                          ...
                          $arr = array(ConstSysMenuComponent::Was13inspek, ConstSysMenuComponent::Bawas3inspek,
                                       ConstSysMenuComponent::Was11inspek, ConstSysMenuComponent::Bawas4inspek,
                                       ConstSysMenuComponent::Bawas2inspek);
                          // print_r($arr);
                          // exit();
                          for ($i=0; $i < 5 ; $i++) { 
                            WasTrxPemrosesan::deleteAll("no_register='".$_SESSION['was_register']."'
                          ...
                          WasTrxPemrosesan::deleteAll("no_register='".$_SESSION['was_register']."'
                             AND id_sys_menu='3543' and id_wilayah='1' and id_level1 ='6' 
                             and id_level2 ='1' and id_level3 ='2' and id_level4 ='0'");
                            $modelTrxPemrosesan1=new WasTrxPemrosesan();
                            $modelTrxPemrosesan1->no_register=$_SESSION['was_register'];
                            $modelTrxPemrosesan1->id_sys_menu='3543';
...
public function actionGetsaksiint(){
 ...
 // $id_saksi = 7;
  ...
  echo GridView::widget([
     ...
     protected function findModel_eks($id_saksi,$id_was9)
    {
      ...
      public function actionDelete(){
       ...
       Yii::$app->getSession()->setFlash('success', [
         ...
         'duration' => 3000,
         'icon' => 'fa fa-users',
         'message' => 'Data Was9 Berhasil Dihapus',
         'title' => 'Hapus Data',
         'positonY' => 'top',
         'positonX' => 'center',
         'showProgressbar' => true,
    ...
    public function actionDeletewas9(){//internal
   $id= $_POST['id'];
   $pecah=explode(',', $id);
  // echo $id;
  //   echo count($id);
   for ($i=0; $i < count($pecah); $i++) { 
      // echo $pecah[$i];
        ...
        Was9_Inspeksi::deleteAll([
          ...
          'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
          'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],
          'id_saksi_internal'=>$pecahLagi[1],'jenis_saksi'=>'Internal']);
       }else{
      //  echo "jangan hapus ";
      }
   }
  ...
  public function actionDeletewas9b(){//eksternal
   $id= $_POST['id'];
   $pecah=explode(',', $id);
  // echo $id;
    //echo count($id);
   for ($i=0; $i < count($pecah); $i++) { 
     ...
     //   echo "hapus ";
        Was9_Inspeksi::deleteAll([
          ...
          'id_saksi_eksternal'=>$pecahLagi[1],'jenis_saksi'=>'Eksternal']);
       }else{
      //  echo "jangan hapus ";
      }
   }
  ...
  public function actionCetak($id,$no_register,$id_tingkat,$id_kejati,$id_kejari,$id_cabjari){
        ...
        $query2 = "select a.* from was.tembusan_was a
                    ...
                    and a.id_kejati='".$id_kejati."' 
                    and a.id_kejari='".$id_kejari."' and a.id_cabjari='".$id_cabjari."'
                    and a.pk_in_table='".$model['id_surat_was9']."' and from_table='Was9Inspeksi'  $where order by is_order desc";

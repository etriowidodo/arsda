...
use Yii;
use app\modules\pengawasan\models\SkWas4a;
use app\modules\pengawasan\models\SkWas4aPelapor;
use app\modules\pengawasan\models\SkWas4aPemeriksa;
use app\modules\pengawasan\models\SkWas4aUraian;
...
use app\modules\pengawasan\models\TembusanSkWas4a;
...
/**
 * SkWas4aController implements the CRUD actions for SkWas4a model.
 */
class SkWas4aController extends Controller
{
    ...
    /**
     * Displays a single SkWas4a model.
     * @param string $id
     * @return mixed
     */
    public function actionView($id)
    {
     ...
     public function actionViewpdf($id,$id2){
        $file_upload=$this->findModel($id,$id2);
          ...
          $filepath = '../modules/pengawasan/upload_file/sk_was_4a/'.$file_upload['upload_file'];
    ...
    {
        $model = new SkWas4a();
        $modelPemeriksa = new SkWas4aPemeriksa();
        $modelPelapor = new SkWas4aPelapor();
        ...
        $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'sk_was_4a','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        // print_r($dataLapdu);
        // exit();
        $queryp = new Query;
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS4-A' 
        ...
        if ($model->load(Yii::$app->request->post())){
          ...
          // exit();
            ...
            // $model->id_terlapor = $_POST['SkWas4a']['id_terlapor']; 
            // $model->ttd_sk_was_4a = $_POST['SkWas4a']['ttd_sk_was_4a'];
            // $model->no_sk_was_4a = "KEP-".$_POST['no_sk_was_4a'];
          ...
          //  try {
             ...
             // exit();
                   $jml=count($_POST['uraian']);
                    for ($i=0; $i < $jml; $i++) { 
                        $modelsk14aUaraian=new SkWas4aUraian();
                        $modelsk14aUaraian->no_register = $_SESSION['was_register'];
                        $modelsk14aUaraian->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14aUaraian->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14aUaraian->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14aUaraian->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14aUaraian->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14aUaraian->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14aUaraian->id_l_was2   = $model->id_l_was2;
                        $modelsk14aUaraian->id_was15    = $model->id_was15;
                        $modelsk14aUaraian->id_sk_was_4a= $model->id_sk_was_4a;
                        $modelsk14aUaraian->isi_uraian  = $_POST['uraian'][$i];
                        $modelsk14aUaraian->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14aUaraian->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14aUaraian->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14aUaraian);
                       // print_r($model->id_sk_was_4a);
                        // print_r($jml);
                        //  exit();
                        $modelsk14aUaraian->save();
                    }
//SkWas4aPelapor[nama_pelapor]
                    $jmlPelapor=count($_POST['nama_pelapor']);

                    for ($i=0; $i < $jmlPelapor; $i++) { 
                        $modelsk14aPelapor=new SkWas4aPelapor();
                        $modelsk14aPelapor->no_register = $_SESSION['was_register'];
                        $modelsk14aPelapor->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14aPelapor->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14aPelapor->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14aPelapor->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14aPelapor->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14aPelapor->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14aPelapor->id_l_was2   = $model->id_l_was2;
                        $modelsk14aPelapor->id_was15    = $model->id_was15;
                        $modelsk14aPelapor->id_sk_was_4a= $model->id_sk_was_4a;
                        $modelsk14aPelapor->nama_pelapor= $_POST['nama_pelapor'][$i];
                        $modelsk14aPelapor->alamat_pelapor    = $_POST['alamat_pelapor'][$i];
                        $modelsk14aPelapor->email_pelapor     = $_POST['email_pelapor'][$i];
                        $modelsk14aPelapor->telp_pelapor      = $_POST['telp_pelapor'][$i];
                        $modelsk14aPelapor->pekerjaan_pelapor = $_POST['pekerjaan_pelapor'][$i];
                        $modelsk14aPelapor->sumber_lainnya    = $_POST['sumber_lainnya'][$i];
                        $modelsk14aPelapor->id_sumber_laporan = $_POST['id_sumber_laporan'][$i];
                        $modelsk14aPelapor->tempat_lahir_pelapor   = $_POST['tempat_lahir_pelapor'][$i];
                        $modelsk14aPelapor->tanggal_lahir_pelapor  = $_POST['tanggal_lahir_pelapor'][$i];
                        $modelsk14aPelapor->kewarganegaraan_pelapor= $_POST['kewarganegaraan_pelapor'][$i];
                        $modelsk14aPelapor->agama_pelapor          = $_POST['agama_pelapor'][$i];
                        $modelsk14aPelapor->pendidikan_pelapor     = $_POST['pendidikan_pelapor'][$i];
                        $modelsk14aPelapor->nama_kota_pelapor      = $_POST['nama_kota_pelapor'][$i];
                        $modelsk14aPelapor->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14aPelapor->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14aPelapor->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14aPelapor);
                       // print_r($model->id_sk_was_4a);
                       // print_r($modelsk14aPelapor);
                       // exit();
                        $modelsk14aPelapor->save();
                    }
//[nama_pemeriksa]
                    ...
                    for ($i=0; $i < $jmlPemeriksa; $i++) { 
                        $modelsk14aPemeriksa=new SkWas4aPemeriksa();
                        $modelsk14aPemeriksa->no_register = $_SESSION['was_register'];
                        $modelsk14aPemeriksa->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14aPemeriksa->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14aPemeriksa->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14aPemeriksa->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14aPemeriksa->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14aPemeriksa->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14aPemeriksa->id_l_was2   = $model->id_l_was2;
                        $modelsk14aPemeriksa->id_was15    = $model->id_was15;
                        $modelsk14aPemeriksa->id_sk_was_4a= $model->id_sk_was_4a;
                        $modelsk14aPemeriksa->nip_pemeriksa = $_POST['nip_pemeriksa'][$i];
                        $modelsk14aPemeriksa->nrp_pemeriksa     = $_POST['nrp_pemeriksa'][$i];
                        $modelsk14aPemeriksa->nama_pemeriksa    = $_POST['nama_pemeriksa'][$i];
                        $modelsk14aPemeriksa->pangkat_pemeriksa = $_POST['pangkat_pemeriksa'][$i];
                        $modelsk14aPemeriksa->jabatan_pemeriksa = $_POST['jabatan_pemeriksa'][$i];
                        $modelsk14aPemeriksa->golongan_pemeriksa= $_POST['golongan_pemeriksa'][$i];
                        $modelsk14aPemeriksa->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14aPemeriksa->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14aPemeriksa->created_time=date('Y-m-d H:i:s');
                        // print_r($modelsk14aPemeriksa);
                        // exit();
                        $modelsk14aPemeriksa->save();
                    }

                     $pejabat = $_POST['pejabat'];
                    TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4a','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>strrev($model->id_sk_was_4a),'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                        for($z=0;$z<count($pejabat);$z++){
                            $saveTembusan = new TembusanWas2;
                            $saveTembusan->from_table = 'Sk-Was-4a';
                            $saveTembusan->pk_in_table = strrev($model->id_sk_was_4a);
                    ...
                    // if ($files != false) {
                    // $path = \Yii::$app->params['uploadPath'].'sk_was_4a/'.$files->name;
                    // $files->saveAs($path);
                    // }
                 // for($i=0;$i<count($tembusan);$i++){
                 //        $saveTembusan = new TembusanSkWas4a();
                 //        $saveTembusan->id_sk_was_4a = $model->id_sk_was_4a;
    ...
    public function actionUpdate($id,$id2)
    {
        ...
        $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_sk_was_4a,'from_table'=>'Sk-Was-4a','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])->orderBy('is_order desc')->all();
        $modelSpWas2 = SpWas2::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],'trx_akhir'=>1]);
      //  $dataPemeriksa = PemeriksaSpWas2::findAll(["id_sp_was2"=>$modelSpWas2->id_sp_was2,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
        $dataPemeriksa = was10Inspeksi::findOne(["id_sp_was2"=>$modelSpWas2->id_sp_was2,
          ...
          'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],
          'nip_pegawai_terlapor'=>$_GET['id'],'trx_akhir'=>'1']);
        $modelPemeriksa = SkWas4aPemeriksa::findAll(["id_sk_was_4a"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        $modelUraian = SkWas4aUraian::findAll(["id_sk_was_4a"=>$id,
                                              'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],
       ...
       // $modelPelapor = SkWas4aPelapor::findAll(["id_sk_was_4a"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        // print_r($dataPemeriksa);
        // exit();
        $dataLapdu = Lapdu::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
      //  $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'was_16b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        a.id_cabjari=d.id_cabjari and 
                        a.no_register=d.no_register 
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS4-A' and b.nip_terlapor='".$_GET['id2']."'";
        $dataTerlapor = $connection->createCommand($modelTerlapor)->queryOne();
        // print_r($dataTerlapor);
        // exit();
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            try {
                ...
                $model->pelanggaran = $dataTerlapor['keterangan_pelanggaran'];
            if($model->save()){
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'sk_was_4a/'.$OldFile)) {
                      unlink(\Yii::$app->params['uploadPath'].'sk_was_4a/'.$OldFile);
                  }

                $jml=count($_POST['uraian']);
                SkWas4aUraian::deleteAll(['id_sk_was_4a'=>$model->id_sk_was_4a,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                    for ($i=0; $i < $jml; $i++) { 
                          $modelsk14aUaraian=new SkWas4aUraian();
                          $modelsk14aUaraian->no_register = $_SESSION['was_register'];
                          $modelsk14aUaraian->id_tingkat  = $_SESSION['kode_tk'];
            ...
            move_uploaded_file($file_tmp,\Yii::$app->params['uploadPath'].'sk_was_4a/'.$rename_file);
            $transaction->commit();
     ...
     public function actionCetak($id){
        ...
        // print_r($model);
        // exit();
        $modelwasUraian1=SkWas4aUraian::findAll(['id_sk_was_4a'=>$model->id_sk_was_4a,'no_register'=>$_SESSION['was_register'],
        ...
        $modelwasUraian2=SkWas4aUraian::findAll(['id_sk_was_4a'=>$model->id_sk_was_4a,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian3=SkWas4aUraian::findAll(['id_sk_was_4a'=>$model->id_sk_was_4a,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian4=SkWas4aUraian::findAll(['id_sk_was_4a'=>$model->id_sk_was_4a,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelTembusan=TembusanWas2::findAll(['pk_in_table'=>$model->id_sk_was_4a,'from_table'=>'Sk-Was-4a',
                            'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                            'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
        ...
        $tgl_sk      =\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_sk_was_4a']);
        $tgl_diterima=\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_diterima_sk_was_4a']);
     ...
     $id_sk_was_4a = $_POST['id'];
     $jumlah = $_POST['jml'];
     
   //  echo $id_bawas3;
        for ($i=0; $i <$jumlah ; $i++) { 
            $pecah=explode(',', $id_sk_was_4a);
           // echo $pecah[$i];
          //  $this->findModel($pecah[$i])->delete();
            SkWas4a::deleteAll(['id_wilayah'=>$_SESSION['was_id_wilayah'],
                               'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
                               'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],
                               'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                               'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],
                               'id_cabjari'=>$_SESSION['kode_cabjari'],'id_sk_was_4a'=>$pecah[$i]]);
            
            TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4a','no_register'=>$_SESSION['was_register'],
                                     'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                                     'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
    ...
    public function actionDelete_old() {
        ...
        for ($i = 0; $i < count($arr); $i++) {
          if (SkWas4a::updateAll(["flag" => 3], "id_sk_was_4a ='" . $arr[$i] . "'")) {
            TembusanSkWas4a::deleteAll('id_sk_was_4a=:del', [':del'=>$arr[$i]]);
            Yii::$app->getSession()->setFlash('success', [
              'type' => 'success',
              'duration' => 3000,
              'icon' => 'fa fa-users',
    ...
    /**
     * Finds the SkWas4a model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return SkWas4a the loaded model
    ...
    $lokasi = $qryLokasi->select('a.inst_lokinst')
        ...
        ->innerJoin('was.sk_was_4a b', 'a.inst_satkerkd=b.inst_satkerkd')
        ->where('length(a.inst_satkerkd)=:inst_satkerkd AND b.id_sk_was_4a=:id_sk_was_4a',
            [':inst_satkerkd' => 2, ':id_sk_was_4a' => $model->id_sk_was_4a])->one();

    $keputusan = VPejabatPimpinan::find()->where('id_jabatan_pejabat=:id_jabatan_pejabat', [':id_jabatan_pejabat' => $model->ttd_sk_was_4a])->one();
    ...
    $odf = new Odf(Yii::$app->params['reportPengawasan'] . "sk_was_4a.odt");

    $odf->setVars('nm_kejaksaan', $instansi['inst_nama']);
    $odf->setVars('keputusan', $keputusan->jabatan);
    $odf->setVars('nmr_sk_was_4a', $model->no_sk_was_4a);
    ...
    $odf->setVars('tgl_ditetapkan', GlobalFuncComponent::tglToWord($model->tgl_sk_was_4a));
    ...
    $query->select('a.jabatan')
        ...
        ->innerJoin('was.tembusan_sk_was_4a b', 'a.id_pejabat_tembusan = b.id_pejabat_tembusan')
        ->innerJoin('was.sk_was_4a c', 'b.id_sk_was_4a = c.id_sk_was_4a')
        ->where("c.id_sk_was_4a=:id_sk_was_4a", [':id_sk_was_4a' => $model->id_sk_was_4a]);
...
select c.id_terlapor,c.id_register,c.id_h_jabatan,e.peg_nama,e.peg_nip,e.peg_nip_baru,y.jml_terlapor from was.terlapor c
    ...
    inner join kepegawaian.kp_pegawai e on (c.peg_nik=e.peg_nik)
        ...
        $odf->exportAsAttachedFile("SK.WAS-4A ".$dugaan['terlapor'].'.odt');   
   }
...
public function actionGetttd(){       
   ...
   echo GridView::widget([
    ...
    {
        if (($model = SkWas4a::findOne(['id_sk_was_4a'=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])) !== null) {
            return $model;
        } else {

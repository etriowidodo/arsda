...
use app\modules\pengawasan\models\Was20bSearch;
use app\modules\pengawasan\models\Was20bDetail;
...
/**
 * Was20bController implements the CRUD actions for Was20b model.
 */
class Was20bController extends Controller
{
    ...
    /**
     * Lists all Was20b models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new Was20bSearch();
    ...
    /**
     * Displays a single Was20b model.
     ...
     * @param integer $id_was_20b
     * @return mixed
     */
    public function actionView($id_tingkat, $id_kejati, $id_kejari, $id_cabjari, $no_register, $id_sp_was2, $id_ba_was2, $id_l_was2, $id_was15, $id_was_20b)
    {
        return $this->render('view', [
            'model' => $this->findModel($id_tingkat, $id_kejati, $id_kejari, $id_cabjari, $no_register, $id_sp_was2, $id_ba_was2, $id_l_was2, $id_was15, $id_was_20b),
        ]);
    }
     ...
     public function actionViewpdf($id){
        $file_upload=$this->findModel($id);
          ...
          $filepath = '../modules/pengawasan/upload_file/was_20b/'.$file_upload['upload_file'];
    ...
    /**
     * Creates a new Was20b model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate() {
    $model = new Was20b();
    $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'was_20b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
    $modelPertanyaan=Was20bDetail::findAll(['id_was_20b'=>$model->id_was_20b,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
    $modelBaWas6 = BaWas6::findOne(["id_ba_was_6"=>$_POST['was20b-was6']]);
      ...
      try {
        ...
        if ($model->save()) {
           ...
           $jml=count($_POST['pertanyaan']);
            for ($i=0; $i < $jml; $i++) { 
                $model20uaraian=new Was20bDetail();
                ...
                $model20uaraian->id_was_20b  = $model->id_was_20b;
         ...
         // TembusanWas2::deleteAll(['from_table'=>'Was-20b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>strrev($model->id_was_20b),'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
              for($z=0;$z<count($pejabat);$z++){
                  $saveTembusan = new TembusanWas2;
                  $saveTembusan->from_table = 'Was-20b';
                  $saveTembusan->pk_in_table = strrev($model->id_was_20b);
...
//          exit();
    ...
    /**
     * Updates an existing Was20b model.
      ...
      public function actionUpdate($id)
    {
        ...
        $modelTembusan=TembusanWas2::findAll(['pk_in_table'=>$model->id_was_20b,'from_table'=>'Was-20b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        $modelPertanyaan=Was20bDetail::findAll(['id_was_20b'=>$model->id_was_20b,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            if($model->save()){
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'was_20b/'.$OldFile)) {
                      unlink(\Yii::$app->params['uploadPath'].'was_20b/'.$OldFile);
                  }
                ...
                $jml=count($_POST['pertanyaan']);
                Was20bDetail::deleteAll(['id_was_20b'=>$model->id_was_20b,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                for ($i=0; $i < $jml; $i++) { 
                    $model20uaraian=new Was20bDetail();
                    $model20uaraian->no_register = $_SESSION['was_register'];
                    $model20uaraian->id_tingkat  = $_SESSION['kode_tk'];
            ...
            move_uploaded_file($file_tmp,\Yii::$app->params['uploadPath'].'was_20b/'.$rename_file);
            $transaction->commit();
    ...
    /**
     * Deletes an existing Was20b model.
   ...
   //  echo $id_bawas3;
        for ($i=0; $i <$jumlah ; $i++) { 
          ...
          //  $this->findModel($pecah[$i])->delete();
            Was20b::deleteAll(['id_wilayah'=>$_SESSION['was_id_wilayah'],
                               ...
                               'id_cabjari'=>$_SESSION['kode_cabjari'],'id_was_20b'=>$pecah[$i]]);
          
           TembusanWas2::deleteAll(['from_table'=>'Was-20b',
             ...
             // $arr = array(ConstSysMenuComponent::Was20b, ConstSysMenuComponent::Was18);
             //        for ($i=0; $i < 2 ; $i++) { 
             //          WasTrxPemrosesan::deleteAll("no_register='".$_SESSION['was_register']."' AND id_sys_menu='".$arr[$i]."' AND id_wilayah='".$_SESSION['was_id_wilayah']."' and id_level1='".$_SESSION['was_id_level1']."' and id_level2='".$_SESSION['was_id_level2']."' and id_level3='".$_SESSION['was_id_level3']."' and id_level4='".$_SESSION['was_id_level4']."'"); //was-20b
             //        }
     ...
     public function actionCetak($id){
        ...
        $model=$this->findModel($id);
        $modelwas20b=Was20bDetail::findAll(['id_was_20b'=>$model->id_was_20b,'no_register'=>$_SESSION['was_register'],
        ...
        $modelSk=BaWas6::findOne(['nip_terlapor'=>$model->nip_pegawai_terlapor,
         ...
         $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_was_20b,'from_table'=>'Was-20b',
                            'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                            'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
        ...
        $tanggal           =\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_was_20b']);
    ...
    /**
     * Finds the Was20b model based on its primary key value.

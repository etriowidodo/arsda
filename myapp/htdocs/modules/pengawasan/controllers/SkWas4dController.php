...
use Yii;
use app\modules\pengawasan\models\SkWas4d;
use app\modules\pengawasan\models\SkWas4dPelapor;
use app\modules\pengawasan\models\SkWas4dPemeriksa;
use app\modules\pengawasan\models\SkWas4dUraian;
use app\modules\pengawasan\models\SkWas4dSearch;
...
use app\modules\pengawasan\models\TembusanSkWas4d;
...
/**
 * SkWas4dController implements the CRUD actions for SkWas4d model.
 */
class SkWas4dController extends Controller
{
    ...
    /**
     * Displays a single SkWas4d model.
     * @param string $id
     * @return mixed
     */
    ...
    public function actionViewpdf($id,$id2){
        $file_upload=$this->findModel($id,$id2);
          ...
          $filepath = '../modules/pengawasan/upload_file/sk_was_4d/'.$file_upload['upload_file'];
    ...
    {
        $model = new SkWas4d();
        $modelPemeriksa = new SkWas4dPemeriksa();
        $modelPelapor = new SkWas4dPelapor();
       ...
       $sqlPeraturan  ="select a.id_surat,nama_peraturan from was.surat_peraturan a inner join was.master_surat b  on a.id_surat=b.id_surat
        ...
        if ($model->load(Yii::$app->request->post())){
          ...
          // exit();
            ...
            // $model->id_terlapor = $_POST['SkWas4d']['id_terlapor']; 
            // $model->ttd_sk_was_4d = $_POST['SkWas4d']['ttd_sk_was_4d'];
            // $model->no_sk_was_4d = "KEP-".$_POST['no_sk_was_4d'];
          ...
          //  try {
             ...
             // exit();
                   $jml=count($_POST['uraian']);
                    for ($i=0; $i < $jml; $i++) { 
                        $modelsk14dUaraian=new SkWas4dUraian();
                        $modelsk14dUaraian->no_register = $_SESSION['was_register'];
                        $modelsk14dUaraian->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14dUaraian->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14dUaraian->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14dUaraian->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14dUaraian->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14dUaraian->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14dUaraian->id_l_was2   = $model->id_l_was2;
                        $modelsk14dUaraian->id_was15    = $model->id_was15;
                        $modelsk14dUaraian->id_sk_was_4d= $model->id_sk_was_4d;
                        $modelsk14dUaraian->isi_uraian  = $_POST['uraian'][$i];
                        $modelsk14dUaraian->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14dUaraian->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14dUaraian->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14dUaraian);
                       // print_r($model->id_sk_was_4d);
                        $modelsk14dUaraian->save();
                    }
//SkWas4dPelapor[nama_pelapor]
                    $jmlPelapor=count($_POST['nama_pelapor']);
                    for ($i=0; $i < $jmlPelapor; $i++) { 
                        $modelsk14dPelapor=new SkWas4dPelapor();
                        $modelsk14dPelapor->no_register = $_SESSION['was_register'];
                        $modelsk14dPelapor->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14dPelapor->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14dPelapor->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14dPelapor->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14dPelapor->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14dPelapor->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14dPelapor->id_l_was2   = $model->id_l_was2;
                        $modelsk14dPelapor->id_was15    = $model->id_was15;
                        $modelsk14dPelapor->id_sk_was_4d= $model->id_sk_was_4d;
                        $modelsk14dPelapor->nama_pelapor= $_POST['nama_pelapor'][$i];
                        $modelsk14dPelapor->alamat_pelapor    = $_POST['alamat_pelapor'][$i];
                        $modelsk14dPelapor->email_pelapor     = $_POST['email_pelapor'][$i];
                        $modelsk14dPelapor->telp_pelapor      = $_POST['telp_pelapor'][$i];
                        $modelsk14dPelapor->pekerjaan_pelapor = $_POST['pekerjaan_pelapor'][$i];
                        $modelsk14dPelapor->sumber_lainnya    = $_POST['sumber_lainnya'][$i];
                        $modelsk14dPelapor->id_sumber_laporan = $_POST['id_sumber_laporan'][$i];
                        $modelsk14dPelapor->tempat_lahir_pelapor   = $_POST['tempat_lahir_pelapor'][$i];
                        $modelsk14dPelapor->tanggal_lahir_pelapor  = $_POST['tanggal_lahir_pelapor'][$i];
                        $modelsk14dPelapor->kewarganegaraan_pelapor= $_POST['kewarganegaraan_pelapor'][$i];
                        $modelsk14dPelapor->agama_pelapor          = $_POST['agama_pelapor'][$i];
                        $modelsk14dPelapor->pendidikan_pelapor     = $_POST['pendidikan_pelapor'][$i];
                        $modelsk14dPelapor->nama_kota_pelapor      = $_POST['nama_kota_pelapor'][$i];
                        $modelsk14dPelapor->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14dPelapor->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14dPelapor->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14dPelapor);
                       // print_r($model->id_sk_was_4d);
                       // print_r($modelsk14dPelapor);
                       // exit();
                        $modelsk14dPelapor->save();
                    }
//[nama_pemeriksa]
                    ...
                    for ($i=0; $i < $jmlPemeriksa; $i++) { 
                        $modelsk14dPemeriksa=new SkWas4dPemeriksa();
                        $modelsk14dPemeriksa->no_register = $_SESSION['was_register'];
                        $modelsk14dPemeriksa->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk14dPemeriksa->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk14dPemeriksa->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk14dPemeriksa->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk14dPemeriksa->id_sp_was2  = $model->id_sp_was2;
                        $modelsk14dPemeriksa->id_ba_was2  = $model->id_ba_was2;
                        $modelsk14dPemeriksa->id_l_was2   = $model->id_l_was2;
                        $modelsk14dPemeriksa->id_was15    = $model->id_was15;
                        $modelsk14dPemeriksa->id_sk_was_4d= $model->id_sk_was_4d;
                        $modelsk14dPemeriksa->nip_pemeriksa = $_POST['nip_pemeriksa'][$i];
                        $modelsk14dPemeriksa->nrp_pemeriksa     = $_POST['nrp_pemeriksa'][$i];
                        $modelsk14dPemeriksa->nama_pemeriksa    = $_POST['nama_pemeriksa'][$i];
                        $modelsk14dPemeriksa->pangkat_pemeriksa = $_POST['pangkat_pemeriksa'][$i];
                        $modelsk14dPemeriksa->jabatan_pemeriksa = $_POST['jabatan_pemeriksa'][$i];
                        $modelsk14dPemeriksa->golongan_pemeriksa= $_POST['golongan_pemeriksa'][$i];
                        $modelsk14dPemeriksa->created_by  =\Yii::$app->user->identity->id;
                        $modelsk14dPemeriksa->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk14dPemeriksa->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk14dPemeriksa);
                       // print_r($model->id_sk_was_4d);
                       
                        $modelsk14dPemeriksa->save();
                    }

                     $pejabat = $_POST['pejabat'];
                    TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4d','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>strrev($model->id_sk_was_4d),'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                        for($z=0;$z<count($pejabat);$z++){
                            $saveTembusan = new TembusanWas2;
                            $saveTembusan->from_table = 'Sk-Was-4d';
                            $saveTembusan->pk_in_table = strrev($model->id_sk_was_4d);
                    ...
                    // if ($files != false) {
                    // $path = \Yii::$app->params['uploadPath'].'sk_was_4d/'.$files->name;
                    // $files->saveAs($path);
                    // }
                 // for($i=0;$i<count($tembusan);$i++){
                 //        $saveTembusan = new TembusanSkWas4d();
                 //        $saveTembusan->id_sk_was_4d = $model->id_sk_was_4d;
    ...
    public function actionUpdate($id,$id2)
    {
        ...
        $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_sk_was_4d,'from_table'=>'Sk-Was-4d','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])->orderBy('is_order desc')->all();
        
        $modelSpWas2 = SpWas2::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],'trx_akhir'=>1]);
        $dataPemeriksa = PemeriksaSpWas2::findOne(["id_sp_was2"=>$modelSpWas2->id_sp_was2,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
        $modelPemeriksa = SkWas4dPemeriksa::findAll(["id_sk_was_4d"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        $modelUraian = SkWas4dUraian::findAll(["id_sk_was_4d"=>$id,
                                              'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],
       ...
       // $modelPelapor = SkWas4dPelapor::findAll(["id_sk_was_4d"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        // print_r($dataPemeriksa);
        // exit();
        $dataLapdu = Lapdu::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
      ...
      //  $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'was_16b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        ...
        $modelTerlapor="select * from was.lapdu a inner join was.ba_was_8 b
                      ...
                      inner join was.ms_sk c on b.sk=c.kode_sk
                     where b.nip_terlapor='".$_GET['id2']."' and b.terima_tolak='1'";
        $dataTerlapor = $connection->createCommand($modelTerlapor)->queryAll();
        // print_r($dataTerlapor);
        // exit();
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            if($model->save()){
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'sk_was_4d/'.$OldFile)) {
                      unlink(\Yii::$app->params['uploadPath'].'sk_was_4d/'.$OldFile);
                  }

                $jml=count($_POST['uraian']);
                SkWas4dUraian::deleteAll(['id_sk_was_4d'=>$model->id_sk_was_4d,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                    for ($i=0; $i < $jml; $i++) { 
                          $modelsk14dUaraian=new SkWas4dUraian();
                          $modelsk14dUaraian->no_register = $_SESSION['was_register'];
                          $modelsk14dUaraian->id_tingkat  = $_SESSION['kode_tk'];
            ...
            move_uploaded_file($file_tmp,\Yii::$app->params['uploadPath'].'sk_was_4d/'.$rename_file);
            $transaction->commit();
    ...
    {
      $key = $_POST['id_sk_was_4d'];
      $model = SkWas4d::findOne(array('id_sk_was_4d'=>$key));

      //print_r($model);exit();
      $searchModel = new \app\modules\pengawasan\models\Was1Search();
      $modelTembusan = TembusanSkWas4d::findAll(['id_sk_was_4d'=> $key]);
    ...
    public function actionUpdate2_old($id){
      $model = SkWas4d::findOne(array("id_sk_was_4d"=>$id, "flag"=>'1'));
      $model2 = SkWas4d::findOne(array("id_sk_was_4d"=>$id, "flag"=>'1'));
      
      $model->no_sk_was_4d = "KEP-".$_POST['no_sk_was_4d'];
      $model->inst_satkerkd = $_POST["inst_satkerkd"];
      $model->ttd_sk_was_4d = $_POST["SkWas4d"]["ttd_sk_was_4d"];
      $model->ttd_peg_nik = $_POST["SkWas4d"]["ttd_peg_nik"];
      $model->ttd_id_jabatan = $_POST["SkWas4d"]["ttd_id_jabatan"];
      $model->tgl_sk_was_4d = $_POST["SkWas4d"]["tgl_sk_was_4d"];
      ...
      try { 
        if ($model->save()) {
          ...
          TembusanSkWas4d::deleteAll('id_sk_was_4d=:del', [':del'=>$model->id_sk_was_4d]);
   ...
   public function actionDelete() {
     $id_sk_was_4d = $_POST['id'];
     $jumlah = $_POST['jml'];
     
   //  echo $id_bawas3;
        for ($i=0; $i <$jumlah ; $i++) { 
            $pecah=explode(',', $id_sk_was_4d);
           // echo $pecah[$i];
          //  $this->findModel($pecah[$i])->delete();
            SkWas4d::deleteAll(['id_wilayah'=>$_SESSION['was_id_wilayah'],
                               'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
                               'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],
                               'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                               'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],
                               'id_cabjari'=>$_SESSION['kode_cabjari'],'id_sk_was_4d'=>$pecah[$i]]);
            
            TembusanWas2::deleteAll(['from_table'=>'Sk-Was-4d','no_register'=>$_SESSION['was_register'],
    ...
    public function actionDelete2() {
        ...
        for ($i = 0; $i < count($arr); $i++) {
          if (SkWas4d::updateAll(["flag" => 3], "id_sk_was_4d ='" . $arr[$i] . "'")) {
            TembusanSkWas4d::deleteAll('id_sk_was_4d=:del', [':del'=>$arr[$i]]);
            Yii::$app->getSession()->setFlash('success', [
              'type' => 'success',
              'duration' => 3000,
              'icon' => 'fa fa-users',
    ...
    /**
     * Finds the SkWas4d model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return SkWas4d the loaded model
     ...
     */
     ...
     public function actionCetak($id){
        ...
        // print_r($model);
        // exit();
        $modelwasUraian1=SkWas4dUraian::findAll(['id_sk_was_4d'=>$model->id_sk_was_4d,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
        ...
        $modelwasUraian2=SkWas4dUraian::findAll(['id_sk_was_4d'=>$model->id_sk_was_4d,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian3=SkWas4dUraian::findAll(['id_sk_was_4d'=>$model->id_sk_was_4d,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian4=SkWas4dUraian::findAll(['id_sk_was_4d'=>$model->id_sk_was_4d,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelTembusan=TembusanWas2::findAll(['pk_in_table'=>$model->id_sk_was_4d,'from_table'=>'Sk-Was-4d',
                            'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                            'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
        ...
        $tgl_sk      =\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_sk_was_4d']);
        $tgl_diterima=\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_diterima_sk_was_4d']);
    ...
    $lokasi = $qryLokasi->select('a.inst_lokinst')
        ...
        ->innerJoin('was.sk_was_4d b', 'a.inst_satkerkd=b.inst_satkerkd')
        ->where('length(a.inst_satkerkd)=:inst_satkerkd AND b.id_sk_was_4d=:id_sk_was_4d',
            [':inst_satkerkd' => 2, ':id_sk_was_4d' => $model->id_sk_was_4d])->one();

    $keputusan = VPejabatPimpinan::find()->where('id_jabatan_pejabat=:id_jabatan_pejabat', [':id_jabatan_pejabat' => $model->ttd_sk_was_4d])->one();
    ...
    $odf = new Odf(Yii::$app->params['reportPengawasan'] . "sk_was_4d.odt");

    $odf->setVars('nm_kejaksaan', $instansi['inst_nama']);
    $odf->setVars('keputusan', $keputusan->jabatan);
    $odf->setVars('nmr_sk_was_4d', $model->no_sk_was_4d);
    ...
    $odf->setVars('tgl_ditetapkan', GlobalFuncComponent::tglToWord($model->tgl_sk_was_4d));
    ...
    $query->select('a.jabatan')
        ...
        ->innerJoin('was.tembusan_sk_was_4d b', 'a.id_pejabat_tembusan = b.id_pejabat_tembusan')
        ->innerJoin('was.sk_was_4d c', 'b.id_sk_was_4d = c.id_sk_was_4d')
        ->where("c.id_sk_was_4d=:id_sk_was_4d", [':id_sk_was_4d' => $model->id_sk_was_4d]);
...
select c.id_terlapor,c.id_register,c.id_h_jabatan,e.peg_nama,e.peg_nip,e.peg_nip_baru,y.jml_terlapor from was.terlapor c
    ...
    inner join kepegawaian.kp_pegawai e on (c.peg_nik=e.peg_nik)
        ...
        $odf->exportAsAttachedFile("SK.WAS-4d ".$dugaan['terlapor'].'.odt');   
   }


   public function actionGetttd(){
       
   $searchModelskwas4d = new SkWas4dSearch();
   $dataProviderPenandatangan = $searchModelskwas4d->searchPenandatangan(Yii::$app->request->queryParams);
   ...
   echo GridView::widget([
    ...
    {
        if (($model = SkWas4d::findOne(['id_sk_was_4d'=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])) !== null) {
            return $model;
        } else {

...
use Yii;
use app\modules\pengawasan\models\SkWas3b;
use app\modules\pengawasan\models\SkWas3bPelapor;
use app\modules\pengawasan\models\SkWas3bPemeriksa;
use app\modules\pengawasan\models\SkWas3bUraian;
use app\modules\pengawasan\models\SkWas3bSearch;
...
use app\modules\pengawasan\models\TembusanSkWas3b;
...
/**
 * SkWas3bController implements the CRUD actions for SkWas3b model.
 */
class SkWas3bController extends Controller
{
    ...
    /**
     * Displays a single SkWas3b model.
     * @param string $id
     * @return mixed
     */
    public function actionView($id)
    {
     ...
     public function actionViewpdf($id,$id2){
        $file_upload=$this->findModel($id,$id2);
          ...
          $filepath = '../modules/pengawasan/upload_file/sk_was_3b/'.$file_upload['upload_file'];
    ...
    {
        $model = new SkWas3b();
        $modelPemeriksa = new SkWas3bPemeriksa();
        $modelPelapor = new SkWas3bPelapor();
        ...
        $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'sk_was_3b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        // print_r($dataLapdu);
        // exit();
        $queryp = new Query;
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS3-B' 
        ...
        if ($model->load(Yii::$app->request->post())){
          ...
          // exit();
            ...
            // $model->id_terlapor = $_POST['SkWas3b']['id_terlapor']; 
            // $model->ttd_sk_was_3b = $_POST['SkWas3b']['ttd_sk_was_3b'];
            // $model->no_sk_was_3b = "KEP-".$_POST['no_sk_was_3b'];
          ...
          //  try {
             ...
             // exit();
                   $jml=count($_POST['uraian']);
                    for ($i=0; $i < $jml; $i++) { 
                        $modelsk13bUaraian=new SkWas3bUraian();
                        $modelsk13bUaraian->no_register = $_SESSION['was_register'];
                        $modelsk13bUaraian->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk13bUaraian->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk13bUaraian->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk13bUaraian->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk13bUaraian->id_sp_was2  = $model->id_sp_was2;
                        $modelsk13bUaraian->id_ba_was2  = $model->id_ba_was2;
                        $modelsk13bUaraian->id_l_was2   = $model->id_l_was2;
                        $modelsk13bUaraian->id_was15    = $model->id_was15;
                        $modelsk13bUaraian->id_sk_was_3b= $model->id_sk_was_3b;
                        $modelsk13bUaraian->isi_uraian  = $_POST['uraian'][$i];
                        $modelsk13bUaraian->created_by  =\Yii::$app->user->identity->id;
                        $modelsk13bUaraian->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk13bUaraian->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk13bUaraian);
                       // print_r($model->id_sk_was_3b);
                        // print_r($jml);
                        //  exit();
                        $modelsk13bUaraian->save();
                    }
//SkWas3bPelapor[nama_pelapor]
                    $jmlPelapor=count($_POST['nama_pelapor']);

                    for ($i=0; $i < $jmlPelapor; $i++) { 
                        $modelsk13bPelapor=new SkWas3bPelapor();
                        $modelsk13bPelapor->no_register = $_SESSION['was_register'];
                        $modelsk13bPelapor->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk13bPelapor->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk13bPelapor->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk13bPelapor->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk13bPelapor->id_sp_was2  = $model->id_sp_was2;
                        $modelsk13bPelapor->id_ba_was2  = $model->id_ba_was2;
                        $modelsk13bPelapor->id_l_was2   = $model->id_l_was2;
                        $modelsk13bPelapor->id_was15    = $model->id_was15;
                        $modelsk13bPelapor->id_sk_was_3b= $model->id_sk_was_3b;
                        $modelsk13bPelapor->nama_pelapor= $_POST['nama_pelapor'][$i];
                        $modelsk13bPelapor->alamat_pelapor    = $_POST['alamat_pelapor'][$i];
                        $modelsk13bPelapor->email_pelapor     = $_POST['email_pelapor'][$i];
                        $modelsk13bPelapor->telp_pelapor      = $_POST['telp_pelapor'][$i];
                        $modelsk13bPelapor->pekerjaan_pelapor = $_POST['pekerjaan_pelapor'][$i];
                        $modelsk13bPelapor->sumber_lainnya    = $_POST['sumber_lainnya'][$i];
                        $modelsk13bPelapor->id_sumber_laporan = $_POST['id_sumber_laporan'][$i];
                        $modelsk13bPelapor->tempat_lahir_pelapor   = $_POST['tempat_lahir_pelapor'][$i];
                        $modelsk13bPelapor->tanggal_lahir_pelapor  = $_POST['tanggal_lahir_pelapor'][$i];
                        $modelsk13bPelapor->kewarganegaraan_pelapor= $_POST['kewarganegaraan_pelapor'][$i];
                        $modelsk13bPelapor->agama_pelapor          = $_POST['agama_pelapor'][$i];
                        $modelsk13bPelapor->pendidikan_pelapor     = $_POST['pendidikan_pelapor'][$i];
                        $modelsk13bPelapor->nama_kota_pelapor      = $_POST['nama_kota_pelapor'][$i];
                        $modelsk13bPelapor->created_by  =\Yii::$app->user->identity->id;
                        $modelsk13bPelapor->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk13bPelapor->created_time=date('Y-m-d H:i:s');
                      //  print_r( $modelsk13bPelapor);
                       // print_r($model->id_sk_was_3b);
                       // print_r($modelsk13bPelapor);
                       // exit();
                        $modelsk13bPelapor->save();
                    }
//[nama_pemeriksa]
                    ...
                    for ($i=0; $i < $jmlPemeriksa; $i++) { 
                        $modelsk13bPemeriksa=new SkWas3bPemeriksa();
                        $modelsk13bPemeriksa->no_register = $_SESSION['was_register'];
                        $modelsk13bPemeriksa->id_tingkat  = $_SESSION['kode_tk'];
                        $modelsk13bPemeriksa->id_kejati   = $_SESSION['kode_kejati'];
                        $modelsk13bPemeriksa->id_kejari   = $_SESSION['kode_kejari'];
                        $modelsk13bPemeriksa->id_cabjari  = $_SESSION['kode_cabjari'];
                        $modelsk13bPemeriksa->id_sp_was2  = $model->id_sp_was2;
                        $modelsk13bPemeriksa->id_ba_was2  = $model->id_ba_was2;
                        $modelsk13bPemeriksa->id_l_was2   = $model->id_l_was2;
                        $modelsk13bPemeriksa->id_was15    = $model->id_was15;
                        $modelsk13bPemeriksa->id_sk_was_3b= $model->id_sk_was_3b;
                        $modelsk13bPemeriksa->nip_pemeriksa = $_POST['nip_pemeriksa'][$i];
                        $modelsk13bPemeriksa->nrp_pemeriksa     = $_POST['nrp_pemeriksa'][$i];
                        $modelsk13bPemeriksa->nama_pemeriksa    = $_POST['nama_pemeriksa'][$i];
                        $modelsk13bPemeriksa->pangkat_pemeriksa = $_POST['pangkat_pemeriksa'][$i];
                        $modelsk13bPemeriksa->jabatan_pemeriksa = $_POST['jabatan_pemeriksa'][$i];
                        $modelsk13bPemeriksa->golongan_pemeriksa= $_POST['golongan_pemeriksa'][$i];
                        $modelsk13bPemeriksa->created_by  =\Yii::$app->user->identity->id;
                        $modelsk13bPemeriksa->created_ip  =$_SERVER['REMOTE_ADDR'];
                        $modelsk13bPemeriksa->created_time=date('Y-m-d H:i:s');
                        // print_r($modelsk13bPemeriksa);
                        // exit();
                        $modelsk13bPemeriksa->save();
                    }

                     $pejabat = $_POST['pejabat'];
                    TembusanWas2::deleteAll(['from_table'=>'Sk-Was-3b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'pk_in_table'=>strrev($model->id_sk_was_3b),'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                        for($z=0;$z<count($pejabat);$z++){
                            $saveTembusan = new TembusanWas2;
                            $saveTembusan->from_table = 'Sk-Was-3b';
                            $saveTembusan->pk_in_table = strrev($model->id_sk_was_3b);
                    ...
                    // if ($files != false) {
                    // $path = \Yii::$app->params['uploadPath'].'sk_was_3b/'.$files->name;
                    // $files->saveAs($path);
                    // }
                 // for($i=0;$i<count($tembusan);$i++){
                 //        $saveTembusan = new TembusanSkWas3b();
                 //        $saveTembusan->id_sk_was_3b = $model->id_sk_was_3b;
    ...
    public function actionUpdate($id,$id2)
    {
        ...
        $modelTembusan=TembusanWas2::find()->where(['pk_in_table'=>$model->id_sk_was_3b,'from_table'=>'Sk-Was-3b','no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])->orderBy('is_order desc')->all();
        $modelSpWas2 = SpWas2::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],'trx_akhir'=>1]);
      //  $dataPemeriksa = PemeriksaSpWas2::findAll(["id_sp_was2"=>$modelSpWas2->id_sp_was2,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
        $dataPemeriksa = was10Inspeksi::findOne(["id_sp_was2"=>$modelSpWas2->id_sp_was2,
          ...
          'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],
          'nip_pegawai_terlapor'=>$_GET['id'],'trx_akhir'=>'1']);
        $modelPemeriksa = SkWas3bPemeriksa::findAll(["id_sk_was_3b"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        $modelUraian = SkWas3bUraian::findAll(["id_sk_was_3b"=>$id,
                                              'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
                                              'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],
       ...
       // $modelPelapor = SkWas3bPelapor::findAll(["id_sk_was_3b"=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        // print_r($dataPemeriksa);
        // exit();
        $dataLapdu = Lapdu::findOne(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_kejati'=>$_SESSION['kode_kejati'],'id_cabjari'=>$_SESSION['kode_cabjari']]);
      //  $modelTembusanMaster = TembusanWas::find()->where("for_tabel=:condition1 OR for_tabel=:condition2", [":condition1" => 'was_16b','condition2'=>'master'])->orderBy('id_tembusan desc')->all();
        ...
        $modelTerlapor="select a.*,b.*,c.*,a.bentuk_pelanggaran as keterangan_pelanggaran,d.* 
                        ...
                        a.id_cabjari=d.id_cabjari and 
                        a.no_register=d.no_register 
                        where b.saran_dari='Jamwas' and b.sk='SK-WAS3-B' and b.nip_terlapor='".$_GET['id2']."'";
        $dataTerlapor = $connection->createCommand($modelTerlapor)->queryOne();
        // print_r($dataTerlapor);
        // exit();
        ...
        if ($model->load(Yii::$app->request->post())){
            ...
            try {
                ...
                $model->pelanggaran = $dataTerlapor['keterangan_pelanggaran'];
            if($model->save()){
                if($OldFile!='' && file_exists($file_tmp) && file_exists(\Yii::$app->params['uploadPath'].'sk_was_3b/'.$OldFile)) {
                      unlink(\Yii::$app->params['uploadPath'].'sk_was_3b/'.$OldFile);
                  }

                $jml=count($_POST['uraian']);
                SkWas3bUraian::deleteAll(['id_sk_was_3b'=>$model->id_sk_was_3b,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
                    for ($i=0; $i < $jml; $i++) { 
                          $modelsk13bUaraian=new SkWas3bUraian();
                          $modelsk13bUaraian->no_register = $_SESSION['was_register'];
                          $modelsk13bUaraian->id_tingkat  = $_SESSION['kode_tk'];
                  ...
                  // }      
                    for ($i=0; $i < 1 ; $i++) { 
                      ...
                      $arr = array(ConstSysMenuComponent::Bawas6);
                       for ($i=0; $i < 1 ; $i++) { 
                        WasTrxPemrosesan::deleteAll("no_register='".$_SESSION['was_register']."' AND id_sys_menu='".$arr[$i]."' 
                         ...
                         and id_level4='".$_SESSION['was_id_level4']."'"); //was-17
                        $modelTrxPemrosesan=new WasTrxPemrosesan();
                        $modelTrxPemrosesan->no_register=$_SESSION['was_register'];
                        $modelTrxPemrosesan->id_sys_menu=$arr[$i];
                        $modelTrxPemrosesan->id_user_login=$_SESSION['username'];
            ...
            move_uploaded_file($file_tmp,\Yii::$app->params['uploadPath'].'sk_was_3b/'.$rename_file);
            $transaction->commit();
     ...
     public function actionCetak($id){
        ...
        // print_r($model);
        // exit();
        $modelwasUraian1=SkWas3bUraian::findAll(['id_sk_was_3b'=>$model->id_sk_was_3b,'no_register'=>$_SESSION['was_register'],
        ...
        $modelwasUraian2=SkWas3bUraian::findAll(['id_sk_was_3b'=>$model->id_sk_was_3b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian3=SkWas3bUraian::findAll(['id_sk_was_3b'=>$model->id_sk_was_3b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelwasUraian4=SkWas3bUraian::findAll(['id_sk_was_3b'=>$model->id_sk_was_3b,'no_register'=>$_SESSION['was_register'],
                            'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                            'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
                            'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],
                            'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],
        ...
        $modelTembusan=TembusanWas2::findAll(['pk_in_table'=>$model->id_sk_was_3b,'from_table'=>'Sk-Was-3b',
                            'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                            'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
        ...
        $tgl_sk      =\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_sk_was_3b']);
       // $tgl_diterima=\Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_diterima_sk_was_3b']);
     ...
     $id_sk_was_3b = $_POST['id'];
     $jumlah = $_POST['jml'];
     
   //  echo $id_bawas3;
        for ($i=0; $i <$jumlah ; $i++) { 
            $pecah=explode(',', $id_sk_was_3b);
           // echo $pecah[$i];
          //  $this->findModel($pecah[$i])->delete();
            SkWas3b::deleteAll(['id_wilayah'=>$_SESSION['was_id_wilayah'],
                               'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
                               'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4'],
                               'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                               'id_kejati'=>$_SESSION['kode_kejati'], 'id_kejari'=>$_SESSION['kode_kejari'],
                               'id_cabjari'=>$_SESSION['kode_cabjari'],'id_sk_was_3b'=>$pecah[$i]]);
            
            TembusanWas2::deleteAll(['from_table'=>'Sk-Was-3b','no_register'=>$_SESSION['was_register'],
                                     'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],
                                     'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],
    ...
    public function actionDelete_old() {
        ...
        for ($i = 0; $i < count($arr); $i++) {
          if (SkWas3b::updateAll(["flag" => 3], "id_sk_was_3b ='" . $arr[$i] . "'")) {
            TembusanSkWas3b::deleteAll('id_sk_was_3b=:del', [':del'=>$arr[$i]]);
            Yii::$app->getSession()->setFlash('success', [
              'type' => 'success',
              'duration' => 3000,
              'icon' => 'fa fa-users',
    ...
    /**
     * Finds the SkWas3b model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return SkWas3b the loaded model
    ...
    $lokasi = $qryLokasi->select('a.inst_lokinst')
        ...
        ->innerJoin('was.sk_was_3b b', 'a.inst_satkerkd=b.inst_satkerkd')
        ->where('length(a.inst_satkerkd)=:inst_satkerkd AND b.id_sk_was_3b=:id_sk_was_3b',
            [':inst_satkerkd' => 2, ':id_sk_was_3b' => $model->id_sk_was_3b])->one();

    $keputusan = VPejabatPimpinan::find()->where('id_jabatan_pejabat=:id_jabatan_pejabat', [':id_jabatan_pejabat' => $model->ttd_sk_was_3b])->one();
    ...
    $odf = new Odf(Yii::$app->params['reportPengawasan'] . "sk_was_3b.odt");

    $odf->setVars('nm_kejaksaan', $instansi['inst_nama']);
    $odf->setVars('keputusan', $keputusan->jabatan);
    $odf->setVars('nmr_sk_was_3b', $model->no_sk_was_3b);
    ...
    $odf->setVars('tgl_ditetapkan', GlobalFuncComponent::tglToWord($model->tgl_sk_was_3b));
    ...
    $query->select('a.jabatan')
        ...
        ->innerJoin('was.tembusan_sk_was_3b b', 'a.id_pejabat_tembusan = b.id_pejabat_tembusan')
        ->innerJoin('was.sk_was_3b c', 'b.id_sk_was_3b = c.id_sk_was_3b')
        ->where("c.id_sk_was_3b=:id_sk_was_3b", [':id_sk_was_3b' => $model->id_sk_was_3b]);
...
select c.id_terlapor,c.id_register,c.id_h_jabatan,e.peg_nama,e.peg_nip,e.peg_nip_baru,y.jml_terlapor from was.terlapor c
    ...
    inner join kepegawaian.kp_pegawai e on (c.peg_nik=e.peg_nik)
        ...
        $odf->exportAsAttachedFile("SK.WAS-3B ".$dugaan['terlapor'].'.odt');   
   }

   public function actionGetttd(){
       
   $searchModelskwas3b = new SkWas3bSearch();
   $dataProviderPenandatangan = $searchModelskwas3b->searchPenandatangan(Yii::$app->request->queryParams);
   ...
   echo GridView::widget([
    ...
    {
        if (($model = SkWas3b::findOne(['id_sk_was_3b'=>$id,'no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']])) !== null) {
            return $model;
        } else {

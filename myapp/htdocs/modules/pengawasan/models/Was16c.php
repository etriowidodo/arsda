...
/**
 * This is the model class for table "was.was_16c".
 *
 ...
 */
class Was16c extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_16c', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_was_16c', 'created_time', 'updated_time','tanggal_ba'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_was_16c', 'golongan_pegawai_terlapor', 'golongan_penandatangan'], 'string', 'max' => 50],
            [['nip_pegawai_terlapor'], 'string', 'max' => 18],
            [['nrp_pegawai_terlapor'], 'string', 'max' => 10],
            [['nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan','tempat','di','kpd_was_16c','sk'], 'string', 'max' => 100],

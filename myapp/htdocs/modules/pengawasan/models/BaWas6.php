...
/**
 * This is the model class for table "was.ba_was_6".
 *
 ...
 */
class BaWas6 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_ba_was_6', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_ba_was_6', 'created_time', 'updated_time','tgl_sk'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['tempat', 'nama_terlapor', 'nama_menerima','no_sk'], 'string', 'max' => 100],
            [['id_terlapor'], 'string', 'max' => 16],
            [['nip_terlapor', 'nip_menerima', 'created_ip', 'updated_ip'], 'string', 'max' => 18],
            [['nrp_terlapor', 'nrp_menerima' ,'sk'], 'string', 'max' => 10],
            [['pangkat_terlapor', 'pangkat_menerima'], 'string', 'max' => 30],
            [['golongan_terlapor', 'golongan_menerima'], 'string', 'max' => 5],
            [['jabatan_terlapor', 'jabatan_menerima'], 'string', 'max' => 65],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_ba_was_6' => 'Id Ba Was 6',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'tgl_ba_was_6' => 'Tgl Ba Was 6',
            'tempat' => 'Tempat',

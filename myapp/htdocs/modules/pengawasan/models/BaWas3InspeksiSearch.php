 ...
 */
class BaWas3InspeksiSearch extends BaWas3Inspeksi
{
    /**
     * @inheritdoc
     */
	...
	public function searchIndex($params)
     {
         $query="
select a.tanggal_ba_was3,a.id_ba_was3,a.id_terlapor_saksi, b.nama_pegawai_terlapor as nama_dimintai_keterangan,
                 a.nama_pemeriksa, CASE WHEN a.sebagai=0 THEN 'Terlapor' ELSE '' END keterangan from was.ba_was_3_inspeksi a 
                 INNER JOIN was.pegawai_terlapor_was10_inspeksi b 
                 on a.id_terlapor_saksi::int=b.id_pegawai_terlapor and
        ...
        and a.id_cabjari='".$_SESSION['kode_cabjari']."' and a.id_wilayah='".$_SESSION['was_id_wilayah']."' and a.id_level1='".$_SESSION['was_id_level1']."' 
                ...
                and a.id_level4='".$_SESSION['was_id_level4']."'
                 ...
                 CASE WHEN a.sebagai=1 THEN 'Saksi Internal' ELSE '' END keterangan from was.ba_was_3_inspeksi a 
                 INNER JOIN was.saksi_internal_inspeksi b 
                 on a.id_terlapor_saksi::int=b.id_saksi_internal and
         a.no_register=b.no_register and
         a.id_tingkat = b.id_tingkat and
         a.id_kejati  = b.id_kejati and
         a.id_kejari  = b.id_kejari and
        ...
        and a.id_cabjari='".$_SESSION['kode_cabjari']."' and a.id_wilayah='".$_SESSION['was_id_wilayah']."' and a.id_level1='".$_SESSION['was_id_level1']."' 
                ...
                and a.id_level4='".$_SESSION['was_id_level4']."'
                 ...
                 CASE WHEN a.sebagai=2 THEN 'Saksi Eksternal' ELSE '' END keterangan from was.ba_was_3_inspeksi a 
                 INNER JOIN was.saksi_eksternal_inspeksi b 
                 on a.id_terlapor_saksi::int=b.id_saksi_eksternal and
         a.no_register=b.no_register and
         a.id_tingkat = b.id_tingkat and
         a.id_kejati  = b.id_kejati and
         a.id_kejari  = b.id_kejari and
        ...
        $keyWord  = htmlspecialchars($_GET['cari'], ENT_QUOTES);
         if($_GET['cari']!=''){
          $query .=" and (upper(nama_dimintai_keterangan) like'%".strtoupper($keyWord)."%'";
          $query .=" or  upper(nama_pemeriksa) like'%".strtoupper($keyWord)."%'";
    ...
    public function searchBawas3Inspeksiterlapor(){
        $fungsi=new FungsiComponent();
        $where=$fungsi->static_where_alias('a');
        $query="select a.* from was.was10_inspeksi a where a.trx_akhir=1
    ...
    public function searchBawas3skasiint(){
        $fungsi=new FungsiComponent();
        $where=$fungsi->static_where_alias('a');
        $query="select a.*,b.* from was.was9_inspeksi a  inner join was.saksi_internal_inspeksi b 
    ...
    public function searchBawas3skasieks(){
        $fungsi=new FungsiComponent();
        $where=$fungsi->static_where_alias('a');
        $query="select a.*,b.* from was.was9_inspeksi a  inner join was.saksi_eksternal_inspeksi b 
                on  a.no_register = b.no_register and
                    a.id_tingkat = b.id_tingkat and
                    a.id_kejati  = b.id_kejati and
                    a.id_kejari  = b.id_kejari and

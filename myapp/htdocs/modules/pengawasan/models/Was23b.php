...
/**
 * This is the model class for table "was.was_23b".
 *
 ...
 * @property integer $id_was_23b
 * @property string $no_was_23b
 ...
 */
class Was23b extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
        //    [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_23b', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_was_23b', 'tgl_nota_dinas', 'created_time', 'updated_time', 'tanggal_ba'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_was_23b', 'golongan_pegawai_terlapor', 'golongan_penandatangan'], 'string', 'max' => 50],
            [['kpd_was_23b', 'di', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'tempat', 'nama_penandatangan', 'sk'], 'string', 'max' => 100],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_was_23b' => 'Id Was 23b',
            'no_was_23b' => 'No Was 23b',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'kpd_was_23b' => 'Kpd Was 23b',
            'di' => 'Di',

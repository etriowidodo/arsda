...
/**
 * This is the model class for table "was.sk_was_2b".
 *
 ...
 */
class SkWas2b extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
           // [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2b', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_sk_was_2b', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['tgl_lapdu'], 'string', 'max' => 10],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_sk_was_2b', 'golongan_pegawai_terlapor'], 'string', 'max' => 50],

...
use yii\db\Command;
/**
 * SkWas2bSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas2b`.
 */
class SkWas2bSearch extends SkWas2b
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_2b', 'created_time', 'updated_time', 'id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari',
            'no_register', 'no_sk_was_2b', 'golongan_pegawai_terlapor',
            'pasal', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan',
            'waktu_kejadian', 'pangkat_pegawai_terlapor', 'pangkat_penandatangan',
            ...
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2b', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_2b' => $this->tgl_sk_was_2b,
            'ttd_sk_was_2b' => $this->ttd_sk_was_2b,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_2b', $this->id_sk_was_2b])
            ->andFilterWhere(['like', 'no_sk_was_2b', $this->no_sk_was_2b])
    ...
    public function searchDataSkWas2b($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.id_sk_was_2b, c.no_sk_was_2b,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_2b c','a.id_terlapor=c.id_terlapor')
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_2b,d.no_sk_was_2b,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS2-B' and b.no_register='".$_SESSION['was_register']."' 

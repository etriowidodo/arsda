 ...
 */
class Was11Inspeksi extends \yii\db\ActiveRecord
{
    public $cari;
    public $jenis_saksi;
    /**
    ...
    public function rules()
    {
        return [
            ...
            [['id_surat_was9','id_sp_was2','created_by','updated_by'], 'integer'],
            [['sifat_surat','id_surat_was11'], 'integer'],
            [['no_was_11', 'kepada_was11'], 'string', 'max' => 50],
            ...
            [['pangkat_penandatangan','jns_saksi'], 'string', 'max' => 30],

...
/**
 * This is the model class for table "was.sk_was_4c".
 *
 ...
 * @property string $tgl_sk_was_4c
 * @property string $tgl_diterima_sk_was_4c
 ...
 */
class SkWas4c extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
          //  [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4c', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_sk_was_4c', 'tgl_diterima_sk_was_4c', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['tgl_lapdu'], 'string', 'max' => 10],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_sk_was_4c', 'golongan_pegawai_terlapor', 'golongan_pegawai_turun_terlapor'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_sk_was_4c' => 'Id Sk Was 4c',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'no_sk_was_4c' => 'No Sk Was 4c',
            'tgl_lapdu' => 'Tgl Lapdu',
            'pasal' => 'Pasal',
            ...
            'di_tempat' => 'Di Tempat',
            'tgl_sk_was_4c' => 'Tgl Sk Was 4c',
            'tgl_diterima_sk_was_4c' => 'Tgl Diterima Sk Was 4c',

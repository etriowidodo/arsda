...
/**
 * This is the model class for table "was.was_20a_detail".
 *
 ...
 * @property integer $id_was_20a_detail
 ...
 */
class Was20aDetail extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
        //    [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_20a', 'id_was_20a_detail', 'id_wilayah', 'id_level1'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_20a', 'id_was_20a_detail', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_was_20a_detail' => 'Id Was 20a Detail',

...
/**
 * This is the model class for table "was.was_16b".
 *
 ...
 * @property string $kpd_was_16b
 * @property string $dari_was_16b
 ...
 */
class Was16b extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_16b', 'id_wilayah', 'id_level1'], 'required'],
            [['nama_pegawai_terlapor'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_16b', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'sifat_surat', 'created_by', 'updated_by'], 'integer'],
            [['tgl_was_16b', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['kpd_was_16b', 'dari_was_16b'], 'string', 'max' => 70],
            [['no_was_16b', 'golongan_pegawai_terlapor'], 'string', 'max' => 50],
            [['lampiran', 'pangkat_pegawai_terlapor', 'pangkat_penandatangan'], 'string', 'max' => 30],
            [['perihal','pelanggaran'], 'string', 'max' => 1000],
            [['nip_pegawai_terlapor', 'nip_penandatangan'], 'string', 'max' => 18],
            [['nrp_pegawai_terlapor','sk'], 'string', 'max' => 10],
            [['nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan','jbtn_penandatangan'], 'string', 'max' => 100],

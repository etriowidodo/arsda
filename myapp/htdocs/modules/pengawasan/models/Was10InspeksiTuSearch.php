 ...
 */
class Was10InspeksiTuSearch extends Was10Inspeksi
{
    /**
     * @inheritdoc
     */
  ...
  public function searchIndex($params)
    {
        ...
        $query="select*from was.pegawai_terlapor_was10_inspeksi a inner join was.was10_inspeksi b
               on a.id_tingkat = b.id_tingkat and
                ...
                a.id_pegawai_terlapor=b.id_pegawai_terlapor
    ...
    public function searchSpwas($params)
    {
        ...
        $query="select*from was.pegawai_terlapor_sp_was2 a inner join was.sp_was_2 b on a.id_sp_was2=b.id_sp_was2 where b.trx_akhir=1  and a.no_register='".$_SESSION['was_register']."' and a.id_tingkat='".$_SESSION['kode_tk']."' and a.id_kejati='".$_SESSION['kode_kejati']."' and a.id_kejari='".$_SESSION['kode_kejari']."' and a.id_cabjari='".$_SESSION['kode_cabjari']."' $where";
        // print_r($query);
        $keyWord  = htmlspecialchars($_GET['cari'], ENT_QUOTES);
         if($_GET['cari']!=''){
          // $query .=" where upper(nama) like'%".strtoupper($keyWord)."%'";
    ...
    public function searchWas10TuGet($no_register,$id_pegawai_terlapor,$nip)
    {
        $fungsi   =new FungsiComponent();
        $where    =$fungsi->static_where();
        $query="select*from was.was10_inspeksi where no_register='".$no_register."' 

...
/**
 * This is the model class for table "was.was_23a".
 *
 ...
 * @property integer $id_was_23a
 * @property string $no_was_23a
 ...
 * @property string $tgl_was_23a
 * @property string $tgl_nota_dinas
 ...
 */
class Was23a extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            // [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_23a', 'id_wilayah', 'id_level1'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_23a', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'sifat_surat', 'created_by', 'updated_by'], 'integer'],
            [['tgl_was_23a', 'tgl_nota_dinas', 'created_time', 'updated_time', 'tanggal_ba'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_was_23a', 'golongan_pegawai_terlapor', 'golongan_penandatangan'], 'string', 'max' => 50],
            [['kpd_was_23a', 'di', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'tempat', 'nama_penandatangan', 'sk'], 'string', 'max' => 100],
            ...
            [['satker_pegawai_terlapor', 'jabatan_penandatangan', 'jbtn_penandatangan'], 'string', 'max' => 65],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_was_23a' => 'Id Was 23a',
            'no_was_23a' => 'No Was 23a',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'kpd_was_23a' => 'Kpd Was 23a',
            'di' => 'Di',
            ...
            'tgl_was_23a' => 'Tgl Was 23a',
            'tgl_nota_dinas' => 'Tgl Nota Dinas',
            'tempat' => 'Tempat',

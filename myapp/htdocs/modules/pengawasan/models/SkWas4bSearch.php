...
/**
 * SkWas4bSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas4b`.
 */
class SkWas4bSearch extends SkWas4b
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_4b', 'tgl_diterima_sk_was_4b', 'created_time', 'updated_time',
            'id_tingkat','id_kejati', 'id_kejari', 'id_cabjari','no_register',
            'no_sk_was_4b', 'golongan_pegawai_terlapor', 'golongan_pegawai_turun_terlapor',
            ...
            'satker_pegawai_terlapor', 'unit_kerja_terlapor', 'jabatan_penandatangan','di_tempat',
            'golongan_penandatangan','upload_file','created_ip', 'updated_ip'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_4b' => $this->tgl_sk_was_4b,
            'ttd_sk_was_4b' => $this->ttd_sk_was_4b,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_4b', $this->id_sk_was_4b])
            ->andFilterWhere(['like', 'no_sk_was_4b', $this->no_sk_was_4b])
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_4b,d.no_sk_was_4b,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS4-B' and b.no_register='".$_SESSION['was_register']."' 
    ...
    public function searchDataSkWas4b($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.no_sk_was_4b,c.id_sk_was_4b,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_4b c','a.id_terlapor=c.id_terlapor')

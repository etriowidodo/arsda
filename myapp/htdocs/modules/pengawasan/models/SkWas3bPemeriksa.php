...
/**
 * This is the model class for table "was.sk_was_3b_pemeriksa".
 *
 ...
 */
class SkWas3bPemeriksa extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'was.sk_was_3b_pemeriksa';
    }
    ...
    {
        return [
       //     [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_3b', 'id_wilayah', 'id_level1', 'id_pemeriksa_sp_was2'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_3b', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'id_pemeriksa_sp_was2', 'created_by'], 'integer'],
            [['created_time'], 'safe'],

 ...
 */
class WasInspekturindex extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['c.irmud_pegasum_kepbang', 'c.irmud_pidum_datun','c.irmud_intel_pidsus'], 'integer'],
            // [['created_time', 'updated_time'], 'safe'],
            [['tgl_inspektur'], 'safe'],
            [['no_register','satker_terlpaor_awal','nama_terlapor_awal','nama_pelapor','inspektur_terlapor_awal','sumber_laporan','id_inspektur','satus2','satus1','irmud'], 'string'],

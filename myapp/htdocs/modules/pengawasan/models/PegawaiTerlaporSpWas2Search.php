 ...
 */
class PegawaiTerlaporSpWas2Search extends PegawaiTerlaporSpWas2
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['nip', 'nrp_pegawai_terlapor', 'nama_pegawai_terlapor', 'pangkat_pegawai_terlapor', 'golongan_pegawai_terlapor',
             'jabatan_pegawai_terlapor', 'satker_pegawai_terlapor', 'nomor_sp_was2', 'no_register', 'for_tabel'], 'safe'],
        ];
    }

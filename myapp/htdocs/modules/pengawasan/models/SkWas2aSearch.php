...
/**
 * SkWas2aSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas2a`.
 */
class SkWas2aSearch extends SkWas2a
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_2a', 'created_time', 'updated_time' ,
            'id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 
            'no_register', 'no_sk_was_2a', 'golongan_pegawai_terlapor',
            ...
            'id_terlapor', 'nip_pegawai_terlapor', 'nip_penandatangan',
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_2a' => $this->tgl_sk_was_2a,
            'ttd_sk_was_2a' => $this->ttd_sk_was_2a,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_2a', $this->id_sk_was_2a])
            ->andFilterWhere(['like', 'no_sk_was_2a', $this->no_sk_was_2a])
    ...
    public function searchDataSkWas2a($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.no_sk_was_2a,c.id_sk_was_2a,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_2a c','a.id_terlapor=c.id_terlapor')
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_2a,d.no_sk_was_2a,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS2-A' and b.no_register='".$_SESSION['was_register']."' 

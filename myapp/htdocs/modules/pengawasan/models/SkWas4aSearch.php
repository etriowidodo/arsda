...
/**
 * SkWas4aSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas4a`.
 */
class SkWas4aSearch extends SkWas4a
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_awal_hukdis', 'tgl_akhir_hukdis', 'tgl_sk_was_4a', 'tgl_diterima_sk_was_4a', 'created_time', 'updated_time',
            'id_tingkat','id_kejati', 'id_kejari', 'id_cabjari','no_register','no_sk_was_4a', 'golongan_pegawai_terlapor', 'golongan_pegawai_turun_terlapor',
            ...
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4a', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_4a' => $this->tgl_sk_was_4a,
            'ttd_sk_was_4a' => $this->ttd_sk_was_4a,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_4a', $this->id_sk_was_4a])
            ->andFilterWhere(['like', 'no_sk_was_4a', $this->no_sk_was_4a])
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_4a,d.no_sk_was_4a,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS4-A' and b.no_register='".$_SESSION['was_register']."' 
    ...
    public function searchDataSkWas4a($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.no_sk_was_4a,c.id_sk_was_4a,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_4a c','a.id_terlapor=c.id_terlapor')

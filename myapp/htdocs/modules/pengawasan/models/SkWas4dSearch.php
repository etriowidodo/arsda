...
/**
 * SkWas4dSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas4d`.
 */
class SkWas4dSearch extends SkWas4d
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_4d', 'tgl_diterima_sk_was_4d', 'created_time', 'updated_time','id_tingkat','id_kejati', 'id_kejari', 'id_cabjari',
              'no_register','no_sk_was_4d', 'golongan_pegawai_terlapor','pasal', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan',
            ...
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4d', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    // {
    //     $query = BaWas3Inspeksi::find(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
    ...
    public function search($params)
    {
        $query = SkWas4d::find(['no_register'=>$_SESSION['was_register'],'id_tingkat'=>$_SESSION['kode_tk'],
                                       'id_kejati'=>$_SESSION['kode_kejati'],'id_kejari'=>$_SESSION['kode_kejari'],
                                       'id_cabjari'=>$_SESSION['kode_cabjari'],'id_wilayah'=>$_SESSION['was_id_wilayah'],
                                       'id_level1'=>$_SESSION['was_id_level1'],'id_level2'=>$_SESSION['was_id_level2'],
                                       'id_level3'=>$_SESSION['was_id_level3'],'id_level4'=>$_SESSION['was_id_level4']]);
        ...
        $query->andFilterWhere([
            'tgl_sk_was_4d' => $this->tgl_sk_was_4d,
           // 'ttd_sk_was_4d' => $this->ttd_sk_was_4d,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_4d', $this->id_sk_was_4d])
            ->andFilterWhere(['like', 'no_sk_was_4d', $this->no_sk_was_4d]);
           // ->andFilterWhere(['like', 'inst_satkerkd', $this->inst_satkerkd])
    ...
    public function searchIndex($params)
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,c.*,d.id_sk_was_4d,d.no_sk_was_4d,
                ...
                and a.terima_tolak='1' and c.kode_sk='SK-WAS4-D' 
                union 
                select b.bentuk_pelanggaran as keterangan,a.*,c.*,d.id_sk_was_4d,d.no_sk_was_4d,
                d.nip_pegawai_terlapor as nip_trlp,e.* 
                from was.ba_was_9 a
                left join was.l_was_2_terlapor b on a.id_tingkat=b.id_tingkat 
                and a.id_kejati=b.id_kejati 
    ...
    public function searchDataSkWas4d($id_register){
        $query = new Query;
         $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.no_sk_was_4d,c.id_sk_was_4d,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_4d c','a.id_terlapor=c.id_terlapor')

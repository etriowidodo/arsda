...
/**
 * This is the model class for table "was.sk_was_4d".
 *
 ...
 * @property string $tgl_sk_was_4d
 * @property string $tgl_diterima_sk_was_4d
 ...
 */
class SkWas4d extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4d', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_sk_was_4d', 'tgl_diterima_sk_was_4d', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['tgl_lapdu'], 'string', 'max' => 10],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_sk_was_4d', 'golongan_pegawai_terlapor'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'di_tempat' => 'Di Tempat',
            'tgl_sk_was_4d' => 'Tgl Sk Was 4d',
            'tgl_diterima_sk_was_4d' => 'Tgl Diterima Sk Was 4d',

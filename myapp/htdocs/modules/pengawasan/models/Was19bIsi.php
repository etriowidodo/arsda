...
/**
 * This is the model class for table "was.was_19b_isi".
 *
 ...
 */
class Was19bIsi extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
           // [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_wilayah', 'id_level1', 'id_was_19b', 'no_urut_isi'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'id_was_19b', 'no_urut_isi', 'created_by', 'updated_by'], 'integer'],

...
/**
 * This is the model class for table "was.ba_was_9".
 *
 ...
 * @property string $sk
 */
class BaWas9 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_ba_was_9', 'id_wilayah', 'id_level1'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_ba_was_9', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'terima_tolak', 'created_by', 'updated_by'], 'integer'],
            [['tgl_ba_was_9', 'created_time', 'updated_time','tanggal_pemberitahuan_ba'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_ba_was_9' => 'Id Ba Was 9',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'tgl_ba_was_9' => 'Tgl Ba Was 9',
            'tempat' => 'Tempat',

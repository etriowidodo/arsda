...
/**
 * This is the model class for table "was.sk_was_4a".
 *
 ...
 * @property string $no_sk_was_4a
 * @property string $tgl_lapdu
 * @property string $pasal
 * @property string $waktu_kejadian
 * @property string $tgl_awal_hukdis
 * @property string $tgl_akhir_hukdis
 ...
 * @property string $tgl_sk_was_4a
 * @property string $tgl_diterima_sk_was_4a
 ...
 */
class SkWas4a extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
           // [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4a', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [[ 'tgl_awal_hukdis', 'tgl_akhir_hukdis', 'tgl_sk_was_4a', 'tgl_diterima_sk_was_4a', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['tgl_lapdu'], 'string', 'max' => 10],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_sk_was_4a', 'golongan_pegawai_terlapor', 'golongan_pegawai_turun_terlapor'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'no_sk_was_4a' => 'No Sk Was 4a',
            'tgl_lapdu' => 'Tgl Lapdu',
            'pasal' => 'Pasal',
            'waktu_kejadian' => 'Waktu Kejadian',
            'tgl_awal_hukdis' => 'Tgl Awal Hukdis',
            'tgl_akhir_hukdis' => 'Tgl Akhir Hukdis',
            ...
            'di_tempat' => 'Di Tempat',
            'tgl_sk_was_4a' => 'Tgl Sk Was 4a',
            'tgl_diterima_sk_was_4a' => 'Tgl Diterima Sk Was 4a',

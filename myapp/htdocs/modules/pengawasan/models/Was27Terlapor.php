 ...
 */
class Was27Terlapor extends \yii\db\ActiveRecord
{
    // public $id_terlapor;
    /**
     * @inheritdoc
    ...
    {
        return 'was.was_27_detail_terlapor';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['id_was_27_detail_terlapor','id_was_27'], 'integer'],
    ...
    {
        return [
            'id_was_27_detail_terlapor' => 'ID Pegawai Terlapor',
            'nip' => 'NIP',

 ...
 */
class Was12Search extends Was12
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query="select *from was.v_was12 b where b.id_tingkat::text = '".$_SESSION['kode_tk']."' AND b.id_kejati::text ='".$_SESSION['kode_kejati']."'  AND b.id_kejari::text ='".$_SESSION['kode_kejari']."' AND b.id_cabjari::text ='".$_SESSION['kode_cabjari']."'  AND b.no_register::text ='".$_SESSION['was_register']."' $where";

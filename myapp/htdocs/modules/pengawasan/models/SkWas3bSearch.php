...
/**
 * SkWas3bSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas3b`.
 */
class SkWas3bSearch extends SkWas3b
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_3b', 'created_time', 'updated_time',
            'id_tingkat','id_kejati', 'id_kejari', 'id_cabjari','no_register',
            'no_sk_was_3b', 'golongan_pegawai_terlapor','pasal', 'nama_pegawai_terlapor',
            'jabatan_pegawai_terlapor', 'nama_penandatangan','waktu_kejadian', 'pangkat_pegawai_terlapor',
            'pangkat_penandatangan', 'id_terlapor', 'nip_pegawai_terlapor', 'nip_penandatangan',
            'nrp_pegawai_terlapor', 'satker_pegawai_terlapor', 'unit_kerja_terlapor', 'jabatan_penandatangan',
            'di_tempat', 'golongan_penandatangan', 'upload_file', 'created_ip', 'updated_ip'], 'safe'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_3b', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        $dataProvider = new SqlDataProvider([
            'sql' => 'SELECT a.peg_nama, a.peg_nip, a.jabatan, b.id_sk_was_3b, b.no_sk_was_3b FROM was.v_terlapor a ' .
                'INNER JOIN was.sk_was_3b b ON a.id_terlapor = b.id_terlapor ' .
        ...
        $query->andFilterWhere([
            'tgl_sk_was_3b' => $this->tgl_sk_was_3b,
            'ttd_sk_was_3b' => $this->ttd_sk_was_3b,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_3b', $this->id_sk_was_3b])
            ->andFilterWhere(['like', 'no_sk_was_3b', $this->no_sk_was_3b])
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_3b,d.no_sk_was_3b,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS3-B' and b.no_register='".$_SESSION['was_register']."' 

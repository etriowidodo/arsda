...
/**
 * Was23aSearch represents the model behind the search form about `app\modules\pengawasan\models\Was23a`.
 */
class Was23aSearch extends Was23a
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'no_was_23a', 'kpd_was_23a', 'di', 'nip_pegawai_terlapor', 'nrp_pegawai_terlapor', 'nama_pegawai_terlapor', 'pangkat_pegawai_terlapor', 'golongan_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'satker_pegawai_terlapor', 'tgl_was_23a', 'tgl_nota_dinas', 'tempat', 'lampiran', 'perihal', 'nip_penandatangan', 'nama_penandatangan', 'pangkat_penandatangan', 'golongan_penandatangan', 'jabatan_penandatangan', 'jbtn_penandatangan', 'upload_file', 'created_ip', 'created_time', 'updated_ip', 'updated_time', 'sk', 'tanggal_ba'], 'safe'],
    ...
    {
       $query="select*from was.was_23a where no_register='".$_SESSION['was_register']."'  

...
/**
 * This is the model class for table "was.was_16d".
 *
 ...
 */
class Was16d extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
         //   [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_16d', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_was_16d', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_was_16d', 'golongan_pegawai_terlapor', 'golongan_penandatangan'], 'string', 'max' => 50],
            [['id_terlapor'], 'string', 'max' => 16],
            [['nip_pegawai_terlapor'], 'string', 'max' => 18],
            [['nrp_pegawai_terlapor'], 'string', 'max' => 10],
            [['nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan','kpd_was_16d' ,'sk'], 'string', 'max' => 100],

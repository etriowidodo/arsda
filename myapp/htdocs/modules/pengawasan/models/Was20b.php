...
/**
 * This is the model class for table "was.was_20b".
 *
 ...
 * @property string $tgl_was_20b
 * @property string $no_was_20b
 ...
 */
class Was20b extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
        //    [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_was_20b', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_was_20b', 'tgl_disampaikan_ba', 'tgl_keberatan_ba', 'created_time', 'updated_time'], 'safe'],
            ...
            [['nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'dari', 'kpd_was_20b' , 'nama_penandatangan'], 'string', 'max' => 100],
            [['pangkat_pegawai_terlapor', 'nip_penandatangan', 'pangkat_penandatangan'], 'string', 'max' => 30],
            [['golongan_pegawai_terlapor', 'no_was_20b', 'golongan_penandatangan'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'dari' => 'Dari',
            'tgl_was_20b' => 'Tgl Was 20b',
            'no_was_20b' => 'No Was 20b',

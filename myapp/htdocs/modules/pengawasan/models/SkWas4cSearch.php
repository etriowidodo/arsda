...
/**
 * SkWas4cSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas4c`.
 */
class SkWas4cSearch extends SkWas4c
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['tgl_lapdu', 'tgl_sk_was_4c', 'tgl_diterima_sk_was_4c', 'created_time', 'updated_time',
              'id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari',  'no_register', 'no_sk_was_4c', 'golongan_pegawai_terlapor', 'golongan_pegawai_turun_terlapor',
              'pasal', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'jabatan_pegawai_turun_terlapor', 'nama_penandatangan', 
              'waktu_kejadian', 'pangkat_pegawai_terlapor', 'pangkat_pegawai_turun_terlapor', 'pangkat_penandatangan',
              'id_terlapor','nip_pegawai_terlapor', 'nip_penandatangan','nrp_pegawai_terlapor',
            ...
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_4c', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_4c' => $this->tgl_sk_was_4c,
            'ttd_sk_was_4c' => $this->ttd_sk_was_4c,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_4c', $this->id_sk_was_4c])
            ->andFilterWhere(['like', 'no_sk_was_4c', $this->no_sk_was_4c])
    ...
    public function searchIndex($params)
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_4c,d.no_sk_was_4c,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS4-C' and b.no_register='".$_SESSION['was_register']."' 
    ...
    public function searchDataSkWas4c($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.no_sk_was_4c,c.id_sk_was_4c,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_4c c','a.id_terlapor=c.id_terlapor')

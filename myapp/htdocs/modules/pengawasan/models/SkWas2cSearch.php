...
/**
 * SkWas2cSearch represents the model behind the search form about `app\modules\pengawasan\models\SkWas2c`.
 */
class SkWas2cSearch extends SkWas2c
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['created_ip', 'updated_ip','nrp_pegawai_terlapor','nip_pegawai_terlapor', 'nip_penandatangan',
            'satker_pegawai_terlapor', 'unit_kerja_terlapor', 'jabatan_penandatangan' ,'di_tempat','upload_file',
            'golongan_penandatangan', 'id_terlapor', 'waktu_kejadian', 'pangkat_pegawai_terlapor', 'pangkat_penandatangan',
            'pasal', 'nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan', 'tgl_lapdu', 'tgl_sk_was_2c',
            'created_time', 'updated_time','id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari',
            'no_register','no_sk_was_2c', 'golongan_pegawai_terlapor'
            ], 'safe'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2c', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'tgl_sk_was_2c' => $this->tgl_sk_was_2c,
            'ttd_sk_was_2c' => $this->ttd_sk_was_2c,
        ...
        $query->andFilterWhere(['like', 'id_sk_was_2c', $this->id_sk_was_2c])
            ->andFilterWhere(['like', 'no_sk_was_2c', $this->no_sk_was_2c])
    ...
    public function searchDataSkWas2c($id_register){
        $query = new Query;
        $query ->select('a.peg_nama, a.jabatan, a.peg_nip, a.peg_nrp, c.id_sk_was_2c, c.no_sk_was_2c,c.id_register')
                ->from('was.v_terlapor a')
                 ->innerjoin('was.sk_was_2c c','a.id_terlapor=c.id_terlapor')
     ...
     {
         $query="select b.bentuk_pelanggaran as keterangan,a.*,d.id_sk_was_2c,d.no_sk_was_2c,
                  ...
                  and e.trx_akhir=1     
                  where a.saran_dari='Jamwas' and a.sk='SK-WAS2-C' and b.no_register='".$_SESSION['was_register']."' 

...
/**
 * This is the model class for table "was.sk_was_2c_pelapor".
 *
 ...
 */
class SkWas2cPelapor extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
          //  [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2c', 'id_wilayah', 'id_level1', 'id_pelapor'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2c', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'id_pelapor', 'created_by'], 'integer'],

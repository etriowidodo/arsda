...
/**
 * This is the model class for table "was.was_19b".
 *
 ...
 * @property integer $id_was_19b
 * @property integer $kpd_was_19b
 * @property string $dari_was_19b
 * @property string $tgl_was_19b
 * @property string $no_was_19b
 ...
 */
class Was19b extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
          //  [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_wilayah', 'id_level1', 'id_was_19b'], 'required'],
            ...
            [['tgl_was_19b', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['dari_was_19b'], 'string', 'max' => 70],
            [['no_was_19b', 'golongan_pegawai_terlapor'], 'string', 'max' => 50],
            [['lampiran', 'pangkat_pegawai_terlapor', 'pangkat_penandatangan'], 'string', 'max' => 30],
            [['nama_pegawai_terlapor', 'jabatan_pegawai_terlapor', 'nama_penandatangan', 'kpd_was_19b'], 'string', 'max' => 100],
            ...
            [['upload_file','perihal'], 'string', 'max' => 200]
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'id_was_19b' => 'Id Was 19b',
            'kpd_was_19b' => 'Kpd Was 19b',
            'dari_was_19b' => 'Dari Was 19b',
            'tgl_was_19b' => 'Tgl Was 19b',
            'no_was_19b' => 'No Was 19b',

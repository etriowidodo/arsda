...
/**
 * This is the model class for table "was.l_was_2_inspeksi_ttd".
 *
 ...
 * @property integer $id_l_was_2_ttd
 ...
 */
class LWas2InspeksiTtd extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'was.l_was_2_inspeksi_ttd';
    }
    ...
    {
        return [
         //   [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_l_was_2_ttd', 'id_wilayah', 'id_level1'], 'required'],
            [['id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_l_was_2_ttd', 'id_wilayah', 'id_level1', 'id_level2', 'id_level3', 'id_level4', 'created_by', 'updated_by'], 'integer'],

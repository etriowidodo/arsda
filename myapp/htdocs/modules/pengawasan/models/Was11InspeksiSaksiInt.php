...
class Was11InspeksiSaksiInt extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'was.was11_inspeksi_saksi_int';
    }
    /**
     * @inheritdoc
     */
   ...
   // [['id_was10'], 'required'],
    ...
    [['id_was_11','id_was_9','created_by','updated_by','id_sp_was2','id_was11_saksi_int'], 'integer'],

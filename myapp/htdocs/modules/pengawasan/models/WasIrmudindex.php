 ...
 */
class WasIrmudindex extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'was.v_inspektur_index_1';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['tgl_inspektur'], 'safe'],
            [['no_register','satker_terlpaor_awal','nama_terlapor_awal','nama_pelapor','inspektur_terlapor_awal','sumber_laporan','id_inspektur','satus2','satus1'], 'string'],

 ...
 */
class Was11TuSearch extends Was11
{
    /**
     * @inheritdoc
     */
    ...
    public function searchInt($params)
    {
       ...
       //Kondisi penomoran TU-inspektur
        ...
        $query="select*from(select a.*,(select string_agg(nip_saksi_internal||'-'||nama_saksi_internal,'#')
                from was.was_11_detail_int where id_was_11=a.id_surat_was11 and no_register=a.no_register 
                ...
                and a.jenis_saksi='Internal' and upper(a.jabatan_penandatangan)='".strtoupper($insp)."')x";
       // print_r($query);

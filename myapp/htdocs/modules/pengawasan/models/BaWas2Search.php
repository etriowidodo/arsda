 ...
 */
class BaWas2Search extends BaWas2
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_ba_was2', 'no_register', 'hari', 'tgl', 'tempat', 'upload_file', 'created_ip', 'created_time', 'updated_ip', 'updated_time'], 'safe'],
   ...
   public function searchPenandatangan($params)
    {
        $query="select*from was.v_penandatangan where id_surat='Bawas2' and unitkerja_alias='".$_SESSION['was_id_wilayah'].'.'.$_SESSION['was_id_level1'].'.'.$_SESSION['was_id_level2']."'";

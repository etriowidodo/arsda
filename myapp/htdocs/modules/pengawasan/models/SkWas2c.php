...
/**
 * This is the model class for table "was.sk_was_2c".
 *
 ...
 */
class SkWas2c extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
          //  [['id_tingkat', 'id_kejati', 'id_kejari', 'id_cabjari', 'no_register', 'id_sp_was2', 'id_ba_was2', 'id_l_was2', 'id_was15', 'id_sk_was_2c', 'id_wilayah', 'id_level1'], 'required'],
            ...
            [['tgl_sk_was_2c', 'created_time', 'updated_time'], 'safe'],
            [['id_tingkat'], 'string', 'max' => 1],
            [['tgl_lapdu'], 'string', 'max' => 10],
            [['id_kejati', 'id_kejari', 'id_cabjari'], 'string', 'max' => 2],
            [['no_register'], 'string', 'max' => 25],
            [['no_sk_was_2c', 'golongan_pegawai_terlapor'], 'string', 'max' => 50],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_l_was2' => 'Id L Was2',
            'id_was15' => 'Id Was15',
            'id_sk_was_2c' => 'Id Sk Was 2c',
            'id_wilayah' => 'Id Wilayah',
            'id_level1' => 'Id Level1',
            'id_level2' => 'Id Level2',
            'id_level3' => 'Id Level3',
            'id_level4' => 'Id Level4',
            'no_sk_was_2c' => 'No Sk Was 2c',
            'tgl_lapdu' => 'Tgl Lapdu',
            'pasal' => 'Pasal',

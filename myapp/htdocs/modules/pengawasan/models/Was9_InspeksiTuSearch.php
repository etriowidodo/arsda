 ...
 */
class Was9_InspeksiTuSearch extends Was9_Inspeksi
{
    /**
     * @inheritdoc
     */
    ...
    public function search($jns_saksi)
    {
      ...
      ///////////////// Ambil Session Untuk Kondisi Penandatangan Tu /////////////////////////////////////////////      
       ...
       //Kondisi penomoran TU-inspektur
        ...
        $query="select * from was.Was9_inspeksi where jenis_saksi='".$jns_saksi."' and no_register='".$_SESSION['was_register']."'  
                and id_tingkat='".$_SESSION['kode_tk']."' 
                and id_kejati='".$_SESSION['kode_kejati']."' and id_kejari='".$_SESSION['kode_kejari']."' 
                and id_cabjari='".$_SESSION['kode_cabjari']."' and jbtn_penandatangan='Jaksa Agung Muda PENGAWASAN' 
				and id_wilayah='".$_SESSION['id_wil']."' and id_level1='".$_SESSION['id_level_1']."' and id_level2='".$_SESSION['id_level_2']."'
				and id_level3='".$_SESSION['id_level_3']."' and id_level4='".$_SESSION['id_level_4']."' and TRIM(upper(b.jabatan_penandatangan) , ' ')='".strtoupper($insp)."'";
    ...
    public function searchSaksiInternal()
    {
        if($_SESSION['inspektur']=='1'){
         ...
         $query="select a.*,b.* from was.was9_inspeksi a inner join was.saksi_internal_inspeksi b 
                 ...
                 and a.jabatan_penandatangan='".$insp."'
        ...
        public function searchSaksiEksternal()
    {
        ...
        $query="select a.*,b.* from was.was9_inspeksi a inner join was.saksi_eksternal_inspeksi b 
                 ...
                 where a.no_register='".$_SESSION['was_register']."' and a.id_tingkat='".$_SESSION['kode_tk']."' and a.jabatan_penandatangan='".$insp."'
                 and a.id_kejati='".$_SESSION['kode_kejati']."' and a.id_kejari='".$_SESSION['kode_kejari']."' and a.id_cabjari='".$_SESSION['kode_cabjari']."' and a.id_wilayah='".$_SESSION['id_wil']."' and a.id_level1='".$_SESSION['id_level_1']."' and a.id_level2='".$_SESSION['id_level_2']."' and a.id_level3='".$_SESSION['id_level_3']."' and a.id_level4='".$_SESSION['id_level_4']."'  and a.id_saksi_eksternal is not null ";
        $keyWord  = htmlspecialchars($_GET['cari'], ENT_QUOTES);
         if($_GET['cari']!=''){
          // $query .=" where upper(nama) like'%".strtoupper($keyWord)."%'";
          // $query .=" or  upper(jabatan) like'%".strtoupper($keyWord)."%'";

...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/autentikasi/config-satker/simpan">
...
<div style="border-color: #f39c12;padding: 15px;overflow: hidden;" class="box box-primary">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                <label class="control-label col-md-4">Pengadilan Tinggi</label>
                <div class="col-md-6">
                <input type="text" class="form-control" name="p_tinggi" value="<?= $model['p_tinggi'] ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
            <div class="form-group">
                <label class="control-label col-md-4">Pengadilan Negeri</label>
                <div class="col-md-6">
                <input type="text" class="form-control" name="p_negeri" value="<?= $model['p_negeri'] ?>">
                </div>
            </div>
        </div>
    </div>
...
<div class="box-footer text-center"> 
    ...
    <a href="/autentikasi/config-satker/index" class="btn btn-danger">Batal</a>
</div>
</form>
</div>

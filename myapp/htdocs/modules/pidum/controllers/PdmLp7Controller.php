...
use Odf;
use Yii;
use app\modules\pidum\models\VLaporanP7;
use app\modules\pidum\models\LaporanP7;
use app\models\KpInstSatker;
//use app\modules\pidum\models\VLaporanP7Search;
...
class PdmLp7Controller extends Controller
{
    ...
    public function actionCetak()
    {
		...
		$odf = new Odf(Yii::$app->params['report-path']."modules/pidum/template/lp7.odt");

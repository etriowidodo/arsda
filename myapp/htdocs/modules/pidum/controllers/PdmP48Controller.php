...
use app\modules\pidum\models\PdmP48Search;
...
class PdmP48Controller extends Controller
{
    ...
    public function actionGetPutusan(){
        ...
        $sql = "SELECT a.no_reg_tahanan,a.no_register_perkara,a.no_surat, b.no_akta, a.id_ms_rentut, b.tgl_baca as tgl_hidden, to_char(
        (b .tgl_baca) :: TIMESTAMP WITH TIME ZONE,
        'DD-MM-YYYY' :: TEXT
        ) AS tgl_show,c.nama
                from pidum.pdm_putusan_pn_terdakwa a 
                ...
                group by a.no_reg_tahanan,a.no_register_perkara,a.no_surat, b.tgl_dikeluarkan,c.nama, b.no_akta, a.id_ms_rentut,b.tgl_baca
	...
	public function actionCetak($id)
    {
		...
		/*$odf = new \Odf(Yii::$app->params['report-path']."modules/pidum/template/p48.odt");

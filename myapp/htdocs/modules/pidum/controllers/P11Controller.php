...
use app\modules\pidum\models\PdmP11;
use app\modules\pidum\models\PdmP11Search;
...
class P11Controller extends Controller
{
    ...
    public function actionCetak($id){
        ...
        $odf = new \Odf(Yii::$app->params['report-path']."modules/pidum/template/p11.odt");
        ...
        // $report = $c->reportService()->runReport('/reports/pidum/pdm_p11', 'rtf', null, null, $controls);

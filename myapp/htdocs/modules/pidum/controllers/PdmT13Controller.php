...
use Yii;
use app\modules\pidum\models\PdmT13;
use app\modules\pidum\models\PdmT13Search;
...
class PdmT13Controller extends Controller {
    ...
    public function actionUpdate($id_t13) {
        ...
        if (empty($model->id_perkara)) {
            $this->redirect('/pidum/pdm-t13/index');
        }
        $t8 = PdmT8::findOne(['id_perkara' => $id]);
    ...
    public function actionCetak($id) {
        ...
        $odf = new \Odf(Yii::$app->params['report-path'] . "modules/pidum/template/t13.odt");

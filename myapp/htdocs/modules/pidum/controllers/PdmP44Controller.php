...
use Yii;
use app\modules\pidum\models\PdmP44;
use app\modules\pidum\models\PdmP44Search;
...
use app\modules\pidum\models\PdmVwP44;
use app\modules\pidum\models\PdmVwP44Search;
use yii\db\Query;
/**
...
public function actionCetak($id)
    {
		...
		$sql =" SELECT b.no_register_perkara,  b.nama as tersangka,
                ...
                COALESCE(c.denda ,0) as denda_pn, COALESCE(c.biaya_perkara,0) as biaya_pn, c.usuljpu, c.usulterdakwa

...
use app\modules\pidum\models\PdmDetailB10;
...
class DefaultController extends Controller
{
    ...
    public function actionTerdakwaT2()
    {
        $session = new session();
        $no_register_perkara = $session->get('no_register_perkara');
        $terdakwa = VwTerdakwaT2::find()
            ->where(['no_register_perkara' => $no_register_perkara, 'no_urut_tersangka'=>$_POST['no_urut_tersangka']])
            ->one();

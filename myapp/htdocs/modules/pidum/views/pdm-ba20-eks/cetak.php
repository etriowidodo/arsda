<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/BA-20-eks.docx');
...
//    $docx->replaceVariableByHTML('pasal', 'block', $melanggar_pasal, $arrDocnya);
    ...
    $docx->createDocx('../web/template/pidum_surat/BA-20-eks');
    $file = '../web/template/pidum_surat/BA-20-eks.docx';
    if (file_exists($file)) {

...
use app\modules\pidum\models\PdmD1Search;
...
<div class="pdm-d1-index">
    ...
    GridView::widget([
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-d1/update?no_surat="+idb1;

...
<?php
    $js = <<< JS
       /*  $('td').dblclick(function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-t5/update?id_t5="+idt5;
	...
	$('td').dblclick(function (e) {
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-t5/update?id_t5="+id;
        $(location).attr('href',url);
		}
		});

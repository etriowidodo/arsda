...
?>
<div class="modal-content" style="width: 1000px;margin: 30px auto;">
        ...
        <div style="border-color: #f39c12;padding: 15px;overflow: hidden;" class="box box-primary">
            ...
            <div class="row">
				...
				<div class="col-md-12">
				 ...
				 <div class="col-md-2">
             <?php if (!$modelTersangka->isNewRecord && !empty($modelTersangka['foto'])) { ?>
                        <label class="control-label col-md-2"><?= Html::label($modelTersangka['foto']); ?></label>
                    <?php } ?>
					</div>
...
$script = <<< JS
 //<!-- BEGIN CMS_PIDUM001_13 ETRIO WIDODO -->  
    $('#mstersangka-warganegara').click(function(){
        ...
        $('#m_kewarganegaraan').load('/pidum/spdp/wn');
 ...
 //<!-- END CMS_PIDUM001_13 ETRIO WIDODO -->
    ...
    $('#ubah-tersangka').click(function(){
       ...
       $('#m_tersangka').modal('hide');      
        ...
        $.ajax({
            type: "POST",
            url: '/pidum/spdp/update-tersangka?id='+$('#mstersangka-id_tersangka').val(),
            data: $("form").serialize(),
	...
	//BEGIN DANAR CMS_PIDUM001_26 danar Wido 03-06-2016
                        ...
                        $('#mstersangka-umur').change(function(){
                            var date_birth = '';
                            if($('#pdmspdp-tgl_kejadian_perkara-disp').val()!='')
                            {
                                date_birth = $('#pdmspdp-tgl_kejadian_perkara-disp').val();
                            }
                            else
                            {
                                date_birth = $('#spdp-tgl_surat').val();
                            }	

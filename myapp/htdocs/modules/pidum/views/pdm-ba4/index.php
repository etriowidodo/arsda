...
<section class="content" style="padding: 0px;">
    ...
    <div class="content-wrapper-1">
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-ba4/update?no_register_perkara="+no_register_perkara+"&tgl_ba4="+tgl_ba4+"&no_urut_tersangka="+no_urut_tersangka;
        ...
        $("#draft").on("click", function(){
                var url    = '/pidum/pdm-ba4/cetak-draft';
        ...
        $('.btnPrintCheckboxIndex').click(function(){
              ...
              if (count != 1 ){
                  ...
                  var has = id.split('#');
                  var url    = '/pidum/pdm-ba4/cetak?no_register_perkara='+has[0]+'&tgl_ba4='+has[1]+'&no_urut_tersangka='+has[2];
                  window.open(url, '_blank');
                  window.focus();
              }
          }); 

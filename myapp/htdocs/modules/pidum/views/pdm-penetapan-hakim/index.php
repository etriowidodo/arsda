...
<div class="pdm-p38-index">
    ...
    $form = \kartik\widgets\ActiveForm::begin([
        'id' => 'hapus-index',
        'action' => '/pidum/pdm-penetapan-hakim/delete'
    ]);
    ?>
...
$js = <<< JS
    ...
    var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-penetapan-hakim/update?no_penetapan_hakim="+no_penetapan_hakim;

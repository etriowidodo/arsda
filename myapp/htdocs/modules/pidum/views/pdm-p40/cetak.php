<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/p40.docx');
    ...
    $docx->replaceVariableByText(array('pn'=> Yii::$app->globalfunc->GetConfSatker()->p_negeri), array('parseLineBreaks'=>true));
    ...
    $docx->createDocx('../web/template/pidum_surat/p40');
    $file = '../web/template/pidum_surat/p40.docx';
    if (file_exists($file)) {

...
//            var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p20/update?id=" + idp20+"&id_pengantar=" +idpengantar;
//        $(location).attr('href',url);
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p20/update?id=" + id+"&id_pengantar=" +idpengantar;
        $(location).attr('href',url);
		//alert(count);
		}
    });

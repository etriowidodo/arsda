            ...
            <!-- <div id="banding"> -->
                <div class="form-group">
                    <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                 <input type="text" class="form-control" name="inputNoPermohonan" id="inputNoPermohonan"/>
                                 <input type="hidden" class="form-control" name="inputNoAkta" id="inputNoAkta"/>
                            </div>
                            <div class="col-md-4">
    ...
    $js = <<< JS
      ...
      $('#selesai').on("click", function(){
            ...
            var no_akta = $('#inputNoAkta').val();
             ...
             //alert('gg');
            var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-putusan-pn-upayahukum/create?no_akta="+no_akta;
            $(location).attr('href',url);
        });

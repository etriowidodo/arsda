...
//BEGIN CMS_PIDUM_SPDP_001
 //<!-- BEGIN CMS_PIDUM001_13 ETRIO WIDODO -->  
    $('#mstersangkaberkas-warganegara').click(function(){
        ...
        $('#m_kewarganegaraan').load('/pidum/pdm-tahap-dua/wn');
 ...
 //<!-- END CMS_PIDUM001_13 ETRIO WIDODO -->
    ...
    function edit_tersangka(id)
    {
		...
		$('#m_tersangka').html('');
		$('#m_tersangka').load('/pidum/pdm-tahap-dua/show-tersangka?id_tersangka='+id_tersangka);
    ...
    $('#m_tersangka2').html('');
    $('#m_tersangka2').load('/pidum/pdm-tahap-dua/refer-tersangka');

   ...
   <?php 
    ...
    <div class="box-footer" style="text-align: center;">
        ...
        <?php }else{ ?>
            <a href="javascript:void(0)" class="btn btn-warning" id="printToSave">Cetak</a>
        <?php }?>
        <?= Html::a('Batal', $model->isNewRecord ? ['index'] : ['../pidum/pdm-p18/index'], ['class' => 'btn btn-danger']) ?>
...
//script pembatasan tanggal per 1 minggu CreateBy Etrio-Widodo
  ...
  // var cetak   = '/pidum/pdm-p18/cetak?id_p18=""&id_pengantar=""';
...
$('#printToSave').click(function(){
    ...
    //return false;
        ...
        if(print!=''&&tempat!=''&&tgl!=''&&tandaTangan!=''){
             $.ajax({
                type        : 'POST',
                url         :'/pidum/pdm-p18/cek-no-surat',
                data        : 'no_surat='+print,                                
                                    ...
                                    if(id_p18=='0'){
                                        ...
                                        $("#print").val('1');
                                             $.ajax({
                                                type: "POST",
                                                async:    false,
                                                url: '/pidum/pdm-p18/update'+upd,
                                                data: $("form").serialize(),
                                                success:function(data){ 
                                                $('.box-footer').hide(); 
                                                    var cetak   = '/pidum/pdm-p18/cetak?id_p18='+id_p18+'&id_pengantar='+id_pengantar;
                                                    var update  =  updates;
                                                    window.open(cetak, '_blank');
                                                    window.focus();

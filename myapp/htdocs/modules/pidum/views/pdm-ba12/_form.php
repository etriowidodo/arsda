                    ...
                    <div class="col-sm-8">
                        <?php
                            echo $form->field($model, 'id_tersangka')->dropDownList(
                                ArrayHelper::map($modelTersangka, 'id_tersangka', 'nama'), // Flat array ('id'=>'label')
        ...
        <div class="col-md-12">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?= $form->field($model, 'tindakan')->dropDownList(['' => 'Pilih Tindakan', '1' =>'Penangguhan Penahanan Terdakwa', '2' =>'Penangguhan Penahanan Tersangka']) ?>
                    </div>
                </div>
            </div>
            <div class="col-md-6"></div>
...
<hr style="border-color: #c7c7c7;margin: 10px 0;">
    <div class="box-footer" style="text-align: center;">
		...
		<?php if(!$model->isNewRecord){ ?>
			<a class="btn btn-warning" href="<?= \yii\helpers\Url::to(['pdm-ba12/cetak?id='.$model->id_ba12] ) ?>">Cetak</a>
		<?php } ?>
    </div>
        <div id="hiddenId"></div>

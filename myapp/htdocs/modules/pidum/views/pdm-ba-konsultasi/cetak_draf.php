<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/bakonsultasi-draf.docx');
...
//    $docx->replaceVariableByText(array('pangkat_end'=>$model->pangkat_jaksa.' /NIP. '.$model->nip_jaksa), array('parseLineBreaks'=>true));
    ...
    $docx->createDocx('../web/template/pidum_surat/bakonsultasi-draf');
    $file = '../web/template/pidum_surat/bakonsultasi-draf.docx';
    if (file_exists($file)) {

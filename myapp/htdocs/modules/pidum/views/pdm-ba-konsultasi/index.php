...
<?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/pdm-ba-konsultasi/delete/'
        ]);
    ?>
...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-ba-konsultasi/update?id_ba_konsultasi="+id_ba_konsultasi+"&id_perkara="+id_perkara;

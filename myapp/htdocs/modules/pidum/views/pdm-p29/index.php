...
//                        return Url::to(['user/my-action']);
    ...
    <?php $form = ActiveForm::begin(['action' => '/pidum/pdm-p29/unggah/','options' => ['enctype' => 'multipart/form-data']]) ?>
...
<?php
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p29/update?no_register="+no_register;

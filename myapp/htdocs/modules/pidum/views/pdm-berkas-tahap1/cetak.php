<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/checklist.docx');
    ...
    $docx->createDocx('../web/template/pidum_surat/checklist');
    $file = '../web/template/pidum_surat/checklist.docx';
    if (file_exists($file)) {

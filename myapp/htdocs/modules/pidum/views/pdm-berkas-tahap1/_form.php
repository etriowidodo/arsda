...
use app\modules\pidum\models\PdmBerkasTahap1Seacrh;
...
use app\modules\pidum\models\PdmUuPasalTahap1;
...
<?php } ?>
    ...
    <div class="box-footer" style="text-align: center;"> 
        ...
        <?= Html::a('Batal', $model->isNewRecord ? ['index'] : ['../pidum/pdm-berkas-tahap1/index'], ['class' => 'btn btn-danger']) ?>
...
$tgl_server = date('Y-m-d');
        $js = <<< JS
            ...
            $('.tambah').click(function(){
                ...
                var idnya = id1+"|0";
                var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1/show-pengantar-simpan?idPengantar="+idnya;
        ...
        $('td').dblclick(function (e) {
            ...
            var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1/show-pengantar?idPengantar="+id;
            $(location).attr('href',url);
        });
    ...
    $("#IdP16").change(function(){
        ...
        $.ajax({
            type: "POST",
            url: '/pidum/pdm-berkas-tahap1/tanggal',
...
//        $('#pengantar').html('');
//        $('#pengantar').load('/pidum/pdm-berkas-tahap1/show-pengantar?idPengantar='+idnya);
//        $('#pengantar').modal('show');
                
                
//        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1/show-pengantar?idPengantar='+idnya;
...
//                var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1/show-pengantar?idPengantar='+id_pengantar;
//                    $(location).attr('href',url);
//                });
//		$('#pengantar').html('');
//		$('#pengantar').load('/pidum/pdm-berkas-tahap1/show-pengantar?idPengantar='+id_pengantar);
//		$('#pengantar').modal('show');

<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/nota-pendapat.docx');
...
//    $docx->replaceVariableByText(array('petunjuk'=>$nota_pend->petunjuk_nota), array('parseLineBreaks'=>true));
    ...
    $docx->createDocx('../web/template/pidum_surat/nota-pendapat');
    $file = '../web/template/pidum_surat/nota-pendapat.docx';
    if (file_exists($file)) {

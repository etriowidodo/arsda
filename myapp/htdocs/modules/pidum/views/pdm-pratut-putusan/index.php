...
<div id="divTambah" class="col-md-11">
    ...
    <?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/pdm-pratut-putusan/delete/'
        ]);  
    ?>  
...
<?php
    ...
    $js = <<< JS
	 ...
	 var idberkas = $(this).closest('tr').data('idberkas');
			  ...
			  var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-pratut-putusan/update?id_pratut=" + idpratut+"&id_berkas=" +idberkas;

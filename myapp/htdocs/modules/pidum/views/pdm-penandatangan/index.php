...
<div id="divTambah" class="col-md-10">
	...
	<div  class="col-md-1" style="width:6%;">
       ...
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/pdm-penandatangan/delete/'
        ]);  
    ?>  
...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-penandatangan/update?id_ttd=" + idttd;
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-penandatangan/update?id_ttd=" + id;
        $(location).attr('href',url);
		}
    });

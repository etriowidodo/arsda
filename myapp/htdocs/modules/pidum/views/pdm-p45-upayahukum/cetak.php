<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/P-45-UpayaHukum.docx');
...
//        $i=1;
    ...
    $docx->createDocx('../web/template/pidum_surat/P-45-UpayaHukum');
    $file = '../web/template/pidum_surat/P-45-UpayaHukum.docx';
    if (file_exists($file)) {

...
<div class="content-wrapper-1">
    <div class="pdm-p45-form">
        <div class="row">
            <div class="col-md-12">
                <?= $this->render('//pdm-p45/_formHeader', ['form' => $form, 'model' => $model]) ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <?php echo $form->field($model, 'pernyataan_jaksa')->radioList(['menerima' => 'Menerima', 'banding' => 'banding']) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
//                                                        echo $key1; print_r($value1).'<br\>';
                ...
                <?= $this->render('//default/_formFooter', ['form' => $form, 'model' => $model, 'id_table' => $model->no_surat_p45, 'GlobalConst' => GlobalConstMenuComponent::P45_1]) ?>
                <div class="form-group" style="text-align: center;">
                    <?= Html::submitButton($model->isNewRecord ? 'Simpan' : 'Ubah', ['class' => $model->isNewRecord ? 'btn btn-warning' : 'btn btn-warning']) ?>
                    <?php if(!$model->isNewRecord){ ?><a class="btn btn-warning" href="<?= \yii\helpers\Url::to(['pdm-p45-upayahukum/cetak?id='.rawurlencode($model->no_surat_p45)])?>">Cetak</a><?php } ?>
                </div>
            </div>
        </div>
    </div>

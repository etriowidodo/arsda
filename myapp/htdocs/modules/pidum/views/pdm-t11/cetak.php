<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/T-11.docx');
    ...
    $docx->replaceVariableByText(array('tgl_dikeluarkan'=>Yii::$app->globalfunc->ViewIndonesianFormat($T11->tgl_dikeluarkan)), array('parseLineBreaks'=>true));
    ...
    $docx->createDocx('../web/template/pidum_surat/T-11');
    $file = '../web/template/pidum_surat/T-11.docx';
    if (file_exists($file)) {

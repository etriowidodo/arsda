...
<?php
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p11/update2?id="+id;
    ...
    $( "input" ).change(function(e) {
        ...
        if(input.prop( "checked" ) == true){
            ...
            // );
            // $('#btnUpdate').html(
            //     "<a href='/pidum/p13/update2?id="+e.target.value+"' class='btn btn-primary ubah'>Ubah</a>"
            // );
            $('#divHapus').append(

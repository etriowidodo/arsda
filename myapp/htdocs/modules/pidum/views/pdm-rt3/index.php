...
<div class="pdm-p38-index">
    ...
    <?php
            ...
            <div class="inline"><a class='btn btn-warning'  href="/pidum/pdm-nota-pendapat/create" title="Tambah Nota Pendapat">Tambah</a></div>
...
$script1 = <<< JS
        ...
        $(".riwayat").on('click', function(e){
            ...
            $("#m_riwayat").find(".modal-body").load("/pidum/pdm-rt3/riwayat?id="+no_urut_tsk);

...
<div class="pdm-penyelesaian-pratut-index">
    ...
    <?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pidum/pdm-penyelesaian-pratut/deleteberkas/'
        ]);  
    ?>  
 ...
 <div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;padding:20px 0px;">
    ...
    [
		...
		'action' => '/pidum/pdm-penyelesaian-pratut/updateberkas?id_pratut='.$id_pratut.'&id_berkas='.$id_berkas,
...
<?php
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-penyelesaian-pratut/updateberkas?id_pratut=" + idpratut+"&id_berkas=" +idberkas;
	...
	$('#popUpJpu').click(function(){
		$('#m_jpu_16a').html('');
        $('#m_jpu_16a').load('/pidum/p16/jpu16a');

...
$tgl_pengantar = PdmPengantarTahap1::findOne(['id_pengantar' => $_GET['id_pengantar']])->tgl_pengantar;
            ...
            <br>
                ...
                echo $form->field($model, 'file_upload_petunjuk_p19')->widget(FileInput::classname(), [
                    ...
                    if ($model->file_upload_petunjuk_p19 != null || $model->file_upload_petunjuk_p19 != '') { 
                        echo Html::a(Html::img('/image/pdf.png',['width'=>'30', 'style'=>'margin-left:0px;']), '/template/pidum_surat/'.$model->file_upload_petunjuk_p19,['target'=>'_blank'])."&nbsp;";
                    }
                ?>
                </div>
                ...
                echo $form->field($model, 'file_upload_p19')->widget(FileInput::classname(), [
                    ...
                    if ($model->file_upload_p19 != null || $model->file_upload_p19 != '') { 
                        echo Html::a(Html::img('/image/pdf.png',['width'=>'30', 'style'=>'margin-left:0px;']), '/template/pidum_surat/'.$model->file_upload_p19,['target'=>'_blank'])."&nbsp;";
                    }
                ?>
                </div>
    ...
    <div class="box-footer" style="text-align: center;">
        ...
        <?= Html::a('Batal', $model->isNewRecord ? ['index'] : ['../pidum/pdm-p19/index'], ['class' => 'btn btn-danger']) ?>
    </div>
    <?php ActiveForm::end(); ?>
    </div>
</section>
...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p19/update2?id_p19=" + idp19+"&id_p24=" +idp24+"&id_berkas=" +idberkas;

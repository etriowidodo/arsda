...
use app\modules\pidum\models\PdmP26;
...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p26/update?no_surat_p26=" + no_surat_p26;

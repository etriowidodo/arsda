...
<div class="box box-primary keterangan" style="border-color: #f39c12;padding: 15px;overflow: hidden; display:none">
    ...
    <button id="cetak_draft" class='btn btn-primary btnPrintCheckboxIndexDraft' disabled>Cetak Draft P-24</button> <button id="idUbah" class="btn btn-success" disabled >Pendapat</button>
    </div>
	...
	if(id_berkas != '')
            {
                $.ajax({
                        type        : 'POST',
                        url         :'/pidum/pdm-p24/get-pengantar-thp1',
                                      ...
                                      $.each(table,function(i,x){
                                       ...
                                       //  alert(link);
                                        tr  +=  '<tr data-id="'+x.id_p24+'" class="pengantar" >'+
                                                    '<td ondblclick="window.location=\'/pidum/pdm-p24/update?id_p24='+x.id_p24+'&id_pengantar='+x.id_pengantar+'\'" data-col-seq="0" style="width:30;">'+x.no_pengantar+'</td>'+
                                                    '<td ondblclick="window.location=\'/pidum/pdm-p24/update?id_p24='+x.id_p24+'&id_pengantar='+x.id_pengantar+'\'" data-col-seq="1" style="width:30%;">'+x.tgl_pengantar+'</td>'+
                                                    '<td ondblclick="window.location=\'/pidum/pdm-p24/update?id_p24='+x.id_p24+'&id_pengantar='+x.id_pengantar+'\'" data-col-seq="3" style="width: 10%;">'+x.tgl_terima+'</td>'+
                                                   // '<td //ondblclick="window.location=\'/pidum/pdm-p24/update?id_p24='+x.id_p24+'&id_pengantar='+x.id_pengantar+'\'"// data-col-seq="4" style="width: 25%;">'+x.nama_tersangka+'</td>'+
 ...
 $('#idPilih').click (function (e) {
     ...
     $(document).ready(function(){
        ...
        $('#idUbah').click(function(){
          ...
          var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p24/update?id_p24=" + idp24+"&id_pengantar=" +id_pengantar;
  ...
  //       var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p24/update?id_p24=" + idp24+"&id_berkas=" +idberkas;
  //       $(location).attr('href',url);
  //   });
  
  $('.btnPrintCheckboxIndexDraft').click(function(){
            var id_pengantar = $('.child-chekbox:checked').val();
            var cetak   = window.location.protocol + "//" + window.location.host + "/pidum/pdm-p24/cetakdraft?id_pengantar="+id_pengantar; 

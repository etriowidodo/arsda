...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-ba8/update?no_register_perkara=" + no_register_perkara+"&tgl_ba8="+tgl_ba8;

...
<div class="pdm-rencana-dakwaan-index">
   ...
   <!-- <div id="divTambah" class="col-md-11">
    ...
    $form = \kartik\widgets\ActiveForm::begin([
                'id' => 'hapus-index',
                'action' => '/pidum/pdm-rencana-dakwaan/delete'
    ]);
    ?>
...
<?php
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-rencana-dakwaan/update?id_rencana_dakwaan="+id_rencana_dakwaan+"&id_berkas=" +idberkas;

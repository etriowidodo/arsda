                        ...
                        <?php if (!$model->isNewRecord):?>
                            <?php $index_pengantar = 0;foreach ($modelPengantar as $key => $value): ?>
                                <tr data-db="<?= $value['id_pengantar']?>" data-tglpengantar="<?php echo date('d-m-Y',strtotime($value['tgl_pengantar']))?>" id='tr_id<?= $value['id_pengantar']?>' ondblclick="edit_pengantar('<?= $value['id_pengantar']?>')" data-id="<?=  $value['id_pengantar']?>">
                                    <td><input type="text" name="no_pengantar[]" class="form-control hide" value="<?= $value->no_pengantar ?>">
                                    ...
                                    <td><input type="text" name="tgl_terima[]" class="form-control hide" readonly="true" value="<?= date('d-m-Y',strtotime($value->tgl_terima)) ?>"><?= date('d-m-Y',strtotime($value->tgl_terima)) ?></td>
                                    <td>
            ...
            <div class="hide">
                ...
                <input type="hidden" name="MsTersangkaDb[no_urut][]" value="<?= $value2->no_urut ?>" class="form-control tersangka<?= $value2->id_tersangka?>">
                            ...
                            foreach ($modelUU1 as $key4 => $value4){?>
                                    ...
                                    <td style="text-align:center;" id="tdPengantar"><input type='checkbox' name='noPengantar[]' data-c-db='1' class='hapusPengantar' id='hapusPengantar' value="<?= $value['id_pengantar'] ?>"></td>

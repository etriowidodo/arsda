...
<?php
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1-grid/update-berkas-tahap1/?id="+id+"&id_berkas="+id_berkas;
...
<script>
    function pilihSpdp(id) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-berkas-tahap1-grid/create-berkas-tahap1?id="+id;
        $(location).attr('href',url);
    }

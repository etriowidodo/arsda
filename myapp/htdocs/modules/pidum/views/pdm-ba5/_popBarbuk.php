                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-nama-barbuk">
                                        <?= Html::textarea('nama_barbuk','',['class'=>'form-control barbuk','id'=>'nm_barbuk']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-jumlah">
                                        <?= Html::input('number','jumlah_barbuk','',['class'=>'form-control barbuk','id'=>'jml_barbuk', 'min'=>0]); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-satuan">
                                        <?= Html::dropDownList('satuan_barbuk','', ArrayHelper::map(PdmMsSatuan::find()->asArray()->all(),'id','nama'),['class'=>'form-control barbuk','id'=>'satuan_barbuk','prompt'=>'Pilih Satuan']); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-disita">
                                        <?= Html::input('text','sita_barbuk','',['class'=>'form-control barbuk','id'=>'sita_barbuk']); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-tmpt-simpan-barbuk">
                                        <?= Html::input('text','tmpt_simpan_barbuk','',['class'=>'form-control barbuk','id'=>'tmpt_simpan_barbuk']); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group field-kodisi-barbuk">
                                        <?= Html::dropDownList('kondisi_barbuk','',ArrayHelper::map(PdmMsStatusData::find()->where('is_group=:is_group',[':is_group'=>ConstDataComponent::KondisiBarang])->all(),'id','nama'),['class'=>'form-control barbuk','id'=>'kondisi_barbuk','prompt'=>'Pilih Kondisi']); ?>
                                    </div>
                                </div>
                            </div>
                        </div>

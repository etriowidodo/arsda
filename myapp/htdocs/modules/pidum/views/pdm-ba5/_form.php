...
$this->registerJs( "
    ...
    $('#draft').on('click', function(){
            var url    = '/pidum/pdm-ba5/cetak-draft';
            window.open(url, '_blank');
            window.focus();
    });

    $('#cobax').on('click', function(){
        var url    = '/pidum/pdm-ba5/cetak';
        console.log('lolo');
        window.open(url, '_blank');
        //lampiran();
    });
    ...
    $('#ctx').on('click', function(){
        ...
        download(file, 'BA-5.pdf', 'text/pdf');
    });
    ...
    $('a#cetakba').click(function(){
    	...
    	/*$.ajax({
                    type        : 'POST',
                    url         :'/pidum/pdm-ba5/cetak',
                    data        : 'no_urut='+kd,                                
                    success     : function(data){
                                if(data>0){
                                    alert('Silahkan Simpan terlebih dahulu..');
                                }else{
                                	window.location.href = '/pidum/pdm-ba5/cetak?no_urut='+kd;
                                }
                            }
                });*/
            var url    = '/pidum/pdm-ba5/cetak?no_urut='+kd;  
			window.open(url, '_blank');
			window.focus();
    });
	...
	$('#popUpSaksi').click(function(){
		$('#m_saksi').html('');
        $('#m_saksi').load('/pidum/pdm-ba5/get-saksi');
        $('#m_saksi').modal('show');
	});

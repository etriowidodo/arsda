...
<div class="ms-pedoman-index">
    ...
    <div id="divHapus" class="col-md-1" style="width:5%; margin-left:0px;">
        ...
        <a type="button" id="apus" class='btn btn-danger'>Hapus</a>
    </div>
...
<?php
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/ms-pedoman/update?uu="+id[0]+"&pasal="+id[1]+"&kategori="+id[2];
        $(location).attr('href',url);

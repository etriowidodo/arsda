<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pidum/nota-pendapat-t4.docx');
...
//                           ';
    ...
    $docx->createDocx('../web/template/pidum_surat/nota-pendapat-t4');
    $file = '../web/template/pidum_surat/nota-pendapat-t4.docx';
    if (file_exists($file)) {

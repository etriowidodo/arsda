...
$js = <<< JS
    $('td').dblclick(function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pidum/pdm-ba15/update?id="+id;
        $(location).attr('href',url);
    });

    $("#draft").on("click", function(){
            var url    = '/pidum/pdm-ba15/cetak-draft';
    ...
    $('.btnPrintCheckboxIndex').click(function(){
          ...
          if (count != 1 ){
              ...
              console.log(id);
              var has = id.split('#');
              var url    = '/pidum/pdm-ba15/cetak?id='+id;
              window.open(url, '_blank');
              window.focus();
          }
      }); 

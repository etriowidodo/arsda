...
/**
 * PdmP29Search represents the model behind the search form about `app\modules\pidum\models\PdmP29`.
 */
class PdmP29Search extends PdmP29
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['no_register_perkara', 'dikeluarkan', 'tgl_dikeluarkan', 'dakwaan', 'id_penandatangan', 'nama', 'pangkat', 'jabatan', 'id_kejati', 'id_kejari', 'id_cabjari', 'created_by', 'created_ip', 'created_time', 'updated_ip', 'updated_by', 'updated_time','file_upload','riwayat_penahanan'], 'safe'],
        ];
    }

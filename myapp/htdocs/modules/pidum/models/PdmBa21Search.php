...
/**
 * PdmBa21Search represents the model behind the search form about `app\modules\pidum\models\PdmBa21`.
 */
class PdmBa21Search extends PdmBa21 {
    ...
    public function rules() {
        return [
            [['id_ba21', 'id_perkara', 'tgl_surat', 'lokasi', 'nip1', 'nama1', 'pangkat1', 'jabatan1', 'nip2', 'nama2', 'pangkat2', 'jabatan2', 'keperluan', 'dimusnahkan', 'flag', 'created_ip', 'created_time', 'updated_ip', 'updated_time'], 'safe'],
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', 'id_ba21', $this->id_ba21])

...
/**
 * This is the model class for table "pidum.pdm_putusan_pn_terdakwa".
 *
 ...
 * @property string $usulterdakwa
 */
class PdmPutusanPnTerdakwa extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'pidum.pdm_putusan_pn_terdakwa';
    }
    ...
    {
        return [
            [['no_register_perkara', 'no_surat', 'status_rentut', 'no_reg_tahanan'], 'required'],
            [['status_rentut', 'id_ms_rentut', 'masa_percobaan_tahun', 'masa_percobaan_bulan', 'masa_percobaan_hari', 'pidana_badan_tahun', 'pidana_badan_bulan', 'pidana_badan_hari', 'subsidair_tahun', 'subsidair_bulan', 'subsidair_hari', 'id_ms_pidana_pengawasan', 'id_tindakan_bebas', 'kurungan_bulan', 'kurungan_hari', 'status_yakum', 'no_urut_tersangka', 'kurungan_tahun'], 'integer'],
            [['denda', 'biaya_perkara'], 'number'],
            [['pidana_tambahan', 'memberatkan', 'meringankan', 'tolak_ukur', 'undang_undang', 'usuljpu', 'usulterdakwa'], 'string'],

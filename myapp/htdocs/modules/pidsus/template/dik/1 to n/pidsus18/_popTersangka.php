		  ...
		  dataType:'json'
            ...
            .done(function(data) {
                ...
                $('#tbody_tersangka').append(
                        '<tr id="tr_id'+data['id_pds_dik_tersangka']+'">'+
                            '<td>' +
                            ...
                            '</td>'+    
                            '<td><span class="glyphicon glyphicon-pencil" onclick="editTersangka(\''+data['id_pds_dik_tersangka']+'\')"></span><a class="btn btn-danger btn-sm glyphicon glyphicon-remove hapus" onclick="hapusTersangka(\''+data['id_pds_dik_tersangka']+'\')"></a></td>' +
                        '</tr>'

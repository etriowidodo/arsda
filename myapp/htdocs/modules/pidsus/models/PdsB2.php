...
class PdsB2 extends \yii\db\ActiveRecord{
    ...
    public function cekPdsB2($post){
		...
		if($count1 > 0){
			$pesan = '<p style="color:#dd4b39; font-size:12px; margin-bottom:20px;"><i>No PdsB2 dengan nomor '.$nom_p16.' sudah ada</i></p>';

...
class PdsBa2 extends \yii\db\ActiveRecord{
    ...
    public function cekPdsBa2($post){
		$connection = $this->db;
		...
		if($count1 > 0){
			$pesan = '<p style="color:#dd4b39; font-size:12px; margin-bottom:20px;"><i>No PdsBa2 dengan nomor '.$nom_p16.' sudah ada</i></p>';

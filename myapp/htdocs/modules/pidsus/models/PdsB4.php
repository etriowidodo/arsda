...
class PdsB4 extends \yii\db\ActiveRecord{
    ...
    public function cekPdsB4($post){
		...
		if($count1 > 0){
			$pesan = '<p style="color:#dd4b39; font-size:12px; margin-bottom:20px;"><i>No PdsB4 dengan nomor '.$nom_p16.' sudah ada</i></p>';

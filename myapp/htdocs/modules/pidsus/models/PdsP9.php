...
class PdsP9 extends \yii\db\ActiveRecord{
    ...
    public function cekPdsP9($post){
		...
		if($count1 > 0){
			$pesan = '<p style="color:#dd4b39; font-size:12px; margin-bottom:20px;"><i>No PdsP9 dengan nomor '.$nom_p16.' sudah ada</i></p>';

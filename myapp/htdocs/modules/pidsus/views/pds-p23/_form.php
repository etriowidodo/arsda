<?php
	...
	$this->title = 'P-23';
	$this->subtitle = 'Surat Susulan Penyerahan Tersangka dan Barang Bukti';
	...
	$linkBatal		= '/pidsus/pds-p23/index';
	$linkCetak		= '/pidsus/pds-p23/cetak?id1='. rawurlencode($model['no_berkas']);
	$linkHapus		= '/pidsus/pds-p23/hapus';
	...
	$tgl_p22 		= ($model['tgl_p22'])?date('d-m-Y',strtotime($model['tgl_p22'])):'';
	$ttdJabatan 	= $model['penandatangan_status_ttd']." ".$model['penandatangan_jabatan_ttd'];
?>

<?php if($_SESSION['no_spdp'] && $_SESSION['tgl_spdp']){ ?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p23/simpan" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="no_berkas" id="no_berkas" class="form-control" value="<?php echo $model['no_berkas'];?>" required data-error="Berkas belum diisi" readonly />
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tgl_berkas" id="tgl_berkas" class="form-control" value="<?php echo $tgl_berkas;?>" required data-error="Tanggal Berkas belum diisi" readonly />
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_terima" id="tgl_terima" class="form-control" value="<?php echo $tgl_terima;?>" required data-error="Tanggal Terima Berkas belum diisi" readonly />
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Nomor P-22</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_p22" id="no_p22" class="form-control" value="<?php echo $model['no_p22'];?>" required data-error="Nomor P-22 belum diisi" readonly />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal P-22</label>        
                            <div class="col-md-8">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_p22" id="tgl_p22" class="form-control" value="<?php echo $tgl_p22;?>" required data-error="Tanggal P-22 belum diisi" readonly />
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="instansi_penyidik" id="instansi_penyidik" class="form-control" value="<?php echo $model['instansi_penyidik'];?>" readonly/>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsP23::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <?php 
                    ...
                    $hasil1 = PdsP23::findBySql($sqlnya)->asArray()->all();
                    if(count($hasil1) == 0)
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['id_p23'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'P-23' order by no_urut";
                        		$resx = PdsP23::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select a.no_urut as no_urut, a.tembusan as tembusan from pidsus.pds_p23_tembusan a
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p23'].$model['file_upload_p23'];
                        $labelFile 	= 'Unggah File P-23';
                        if($model['file_upload_p23'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File P-23';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($model['file_upload_p23']));
                            $linkPt 	= "/pidsus/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($model['file_upload_p23'], strrpos($model['file_upload_p23'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$model['file_upload_p23'].'" style="float:left; margin-right:10px;">
...
<div class="box-footer" style="text-align: center;"> 
    ...
    <?php if(!$isNewRecord){ ?>
    	...
    	<a class="btn btn-danger jarak-kanan hapus-data" href="<?php echo $linkHapus;?>">Hapus</a>
	<?php } ?>
...
$(document).ready(function(){
	$(".hapus-data").on("click", function(){
		gotoUrl($(this).prop("href"));
		return false;
	});
	function gotoUrl(linknya){
		bootbox.confirm({
			...
			callback: function(result){
				if(result) window.location.href = linknya;
			}
		});	
	}

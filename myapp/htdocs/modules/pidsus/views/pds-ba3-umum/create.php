...
$(document).ready(function(){
	...
	function validasi_upload(){
		...
		var tgl_ba3_umum 	= new Date(tgl_auto($("#tgl_ba3_umum").val()));
		...
		if(fname && $.inArray(extnya, arrExt) == -1){
			...
			setErrorFocus($("#error_custom_file_template"), $("#role-form"), false);
			return false;
		} else if(tgl_p8_umum > tgl_ba3_umum){
			$("body").removeClass("loading");
			$("#error_custom_tgl_ba3_umum").html('<i style="color:#dd4b39; font-size:12px;">Tanggal BA-3 Umum lebih kecil dari tanggal P-8 Umum</i>');
			setErrorFocus($("#error_custom_tgl_ba3_umum"), $("#role-form"), false);
			return false;
		} else if(tgl_ba3_umum > hariIni){
			$("body").removeClass("loading");
			$("#error_custom_tgl_ba3_umum").html('<i style="color:#dd4b39; font-size:12px;">Maximal tanggal BA-3 Umum adalah hari ini</i>');
			setErrorFocus($("#error_custom_tgl_ba3_umum"), $("#role-form"), false);
			return false;
		} else{

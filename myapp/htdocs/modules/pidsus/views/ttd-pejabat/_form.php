...
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/ttd-pejabat/simpan">
...
<div class="box-footer text-center"> 
    ...
    <a href="/pidsus/ttd-pejabat/index" class="btn btn-danger">Batal</a>
</div>
</form>

<?php
	...
	$this->title 	= 'Pidsus-14 Umum';
	$this->subtitle = 'Nota Usul Dinas Pemanggilan Saksi/ Ahli';
	...
	$linkBatal		= '/pidsus/pds-pidsus-14-umum/index';
	$linkCetak		= '/pidsus/pds-pidsus-14-umum/cetak?id1='.$model['no_urut_pidsus14_umum'];
	if($isNewRecord){
		$sqlCek = "select no_p8_umum, tgl_p8_umum from pidsus.pds_p8_umum where ".$whereDefault;
		$model 	= PdsPidsus14Umum::findBySql($sqlCek)->asArray()->one();
	}
	...
	$tgl_pidsus14_umum 	= ($model['tgl_pidsus14_umum'])?date('d-m-Y',strtotime($model['tgl_pidsus14_umum'])):'';
?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-pidsus-14-umum/simpan" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal Pidsus-14 Umum</label>        
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_pidsus14_umum" id="tgl_pidsus14_umum" class="form-control datepicker" value="<?php echo $tgl_pidsus14_umum;?>" required data-error="Tanggal belum diisi" />
                                </div>
                                <div class="help-block with-errors" id="error_custom_tgl_pidsus14_umum"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="table_saksi">
                        ...
                        <?php 
							...
							$sqlnya = "select * from pidsus.pds_pidsus14_umum_saksi where ".$whereDefault." and no_urut_pidsus14_umum = '".$nom14u."' order by no_urut_saksi";
                            $hasil 	= PdsPidsus14Umum::findBySql($sqlnya)->asArray()->all();
                            if(count($hasil) == 0)
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['pidsus_14umum'].$model['file_upload'];
                        $labelFile 	= 'Unggah Pidsus-14 Umum';
                        if($model['file_upload'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah Pidsus-14 Umum';
...
<div class="box-footer" style="text-align: center;"> 
    ...
    <input type="hidden" name="no_urut_pidsus14_umum" id="no_urut_pidsus14_umum" value="<?php echo $model['no_urut_pidsus14_umum']; ?>" />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Usul Saksi/Ahli</h4>
            </div>
...
$(document).ready(function(){
	$(".form-buat-nambah-saksi").on("click", "#btn_popusul", function(){
		...
		$("#tambah_usul_modal").find(".modal-body").load("/pidsus/pds-pidsus-14-umum/getusul", function(){
		...
		$.ajax({
			type	: "POST",
			url		: "/pidsus/pds-pidsus-14-umum/getusul",

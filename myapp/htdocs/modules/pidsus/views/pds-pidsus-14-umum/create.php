...
$(document).ready(function(){
	...
	function validasi_upload(){
		...
		var tgl_pidsus14_umum 	= new Date(tgl_auto($("#tgl_pidsus14_umum").val()));
		...
		if(fname && $.inArray(extnya, arrExt) == -1){
			...
			return false;
		} else if(tgl_p8_umum > tgl_pidsus14_umum){
			$("body").removeClass("loading");
			$("#error_custom_tgl_pidsus14_umum").html('<i style="color:#dd4b39; font-size:12px;">Tanggal Pidsus-14 Umum lebih kecil dari tanggal P-8 Umum</i>');
			setErrorFocus($("#error_custom_tgl_pidsus14_umum"), $("#role-form"), false);
			return false;
		} else if(tgl_pidsus14_umum > hariIni){
			$("body").removeClass("loading");
			$("#error_custom_tgl_pidsus14_umum").html('<i style="color:#dd4b39; font-size:12px;">Maximal tanggal Pidsus-14 Umum adalah hari ini</i>');
			setErrorFocus($("#error_custom_tgl_pidsus14_umum"), $("#role-form"), false);
			return false;
		} else{

<?php use app\modules\pidsus\models\PdsPidsus14Umum; ?>
                            ...
                            <select name="jaksa" id="jaksa" style="width:100%">
								...
								<?php 
                                    $sqlOpt = "
										...
										from pidsus.pds_p8_umum_jaksa 
										where id_kejati = '".$_SESSION["kode_kejati"]."' and id_kejari = '".$_SESSION["kode_kejari"]."' 
											and id_cabjari = '".$_SESSION["kode_cabjari"]."' and no_p8_umum = '".$_SESSION["pidsus_no_p8_umum"]."'
										order by no_urut";
									$resOpt = PdsPidsus14Umum::findBySql($sqlOpt)->asArray()->all();

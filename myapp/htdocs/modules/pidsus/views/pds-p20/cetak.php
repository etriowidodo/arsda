<?php
	...
	$docx = new CreateDocxFromTemplate('../modules/pidsus/template/P-20.docx');
	...
	$sql2 = "select a.no_urut as no_urut, a.tembusan as tembusan from pidsus.pds_p20_tembusan a
	...
	$docx->createDocx('template/pidsus/P-20');
	$file = 'template/pidsus/P-20.docx';
	if (file_exists($file)) {

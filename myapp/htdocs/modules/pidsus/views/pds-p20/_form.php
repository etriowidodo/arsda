<?php
	...
	$this->title = 'P-20';
	$this->subtitle = 'Pemberitahuan bahwa Waktu Penyidikan Telah Habis';
	...
	$linkBatal		= '/pidsus/pds-p20/index';
	$linkCetak		= '/pidsus/pds-p20/cetak?id1='.rawurlencode($model['no_berkas']);
	$linkHapus		= '/pidsus/pds-p20/hapus';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p20/simpan" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsP20::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <?php 
                    ...
                    $hasil1 = PdsP20::findBySql($sqlnya)->asArray()->all();
                    if(count($hasil1) == 0)
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['id_p20'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'P-20' order by no_urut";
                        		$resx = PdsP20::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select a.no_urut as no_urut, a.tembusan as tembusan from pidsus.pds_p20_tembusan a
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p20'].$model['file_upload_p20'];
                        $labelFile 	= 'Unggah File P-20';
                        if($model['file_upload_p20'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File P-20';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($model['file_upload_p20']));
                            $linkPt 	= "/pidsus/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($model['file_upload_p20'], strrpos($model['file_upload_p20'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$model['file_upload_p20'].'" style="float:left; margin-right:10px;">

                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="nama_barang" name="nama_barang" value="<?php echo $model['nama_barang'];?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="disita_dari" name="disita_dari" value="<?php echo $model['disita_dari'];?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="jns_barang" name="jns_barang" value="<?php echo $model['jns_barang'];?>" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="tmp_penyitaan" name="tmp_penyitaan" value="<?php echo $model['tmp_penyitaan'];?>" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-sm">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" id="jml_barang" name="jml_barang" value="<?php echo $model['jml_barang'];?>" />
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                            </div>

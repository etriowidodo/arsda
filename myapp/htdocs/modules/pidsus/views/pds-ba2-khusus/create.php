...
$(document).ready(function(){
	...
	function validasi_upload(){
		...
		var tgl_ba1_khusus 	= ($("#tgl_ba1_khusus").val() != "")?new Date(tgl_auto($("#tgl_ba1_khusus").val())):"";
		var tgl_ba2_khusus 	= new Date(tgl_auto($("#tgl_ba2_khusus").val()));
		...
		if(fname && $.inArray(extnya, arrExt) == -1){
			...
			setErrorFocus($("#error_custom_file_template"), $("#role-form"), false);
			return false;
		} else if(tgl_ba1_khusus == ""){
			$("body").removeClass("loading");
			$("#error_custom_tgl_ba1_khusus").html('<i style="color:#dd4b39; font-size:12px;">Tanggal BA-1 Khusus Belum diisi</i>');
			setErrorFocus($("#error_custom_tgl_ba1_khusus"), $("#role-form"), false);
			return false;
		} else if(tgl_ba1_khusus > tgl_ba2_khusus){
			$("body").removeClass("loading");
			$("#error_custom_tgl_ba2_khusus").html('<i style="color:#dd4b39; font-size:12px;">Tanggal BA-2 Khusus lebih kecil dari tanggal BA-1 Khusus</i>');
			setErrorFocus($("#error_custom_tgl_ba2_khusus"), $("#role-form"), false);
			return false;
		} else if(tgl_ba2_khusus > hariIni){
			$("body").removeClass("loading");
			$("#error_custom_tgl_ba2_khusus").html('<i style="color:#dd4b39; font-size:12px;">Maximal tanggal BA-2 Khusus adalah hari ini</i>');
			setErrorFocus($("#error_custom_tgl_ba2_khusus"), $("#role-form"), false);
			return false;
		} else{

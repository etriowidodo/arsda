...
?>
<?php $form = ActiveForm::begin(['action'=>['getba1umum'], 'method'=>'get', 'id'=>'searchModalGetba1umum', 'options'=>['name'=>'searchModalGetba1umum']]); ?>
<div class="row">
...
<div class="modal-ba1u-index">
	...
	<?php
        Pjax::begin(['id' => 'myPjaxModalba1u', 'timeout' => false, 'formSelector' => '#searchModalGetba1umum', 'enablePushState' => false]);
		echo GridView::widget([
			'tableOptions' => ['class' => 'table table-bordered table-hover', 'id'=>'tabel-ba1u-modal'],
			'dataProvider' => $dataProvider,
			'rowOptions' => function($data){
				$idnya = rawurlencode($data['no_ba1_umum'])."|#|".rawurlencode(date("d-m-Y",strtotime($data['tgl_ba1_umum'])))."|#|".
...
$(document).ready(function(){
	...
	$(".reset-cari-mba1u").on("click", function(){
		$("#mba1u_q1").val("");
		$("#searchModalGetba1umum").trigger("submit");
	});

<?php
	...
	use app\modules\pidsus\models\PdsB2;
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsB2::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
                    ...
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_p16'] == ''){
                        		...
                        		$resx = PdsB2::findBySql($sqlx)->asArray()->all();
                        	} else{

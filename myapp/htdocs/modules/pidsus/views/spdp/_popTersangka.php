        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="nama" id="nama" class="form-control chars-only" value="<?= $model["nama"]?>" />
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="tmpt_lahir" id="tmpt_lahir" class="form-control chars-only" value="<?= $model["tmpt_lahir"]?>" />
                    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="no_identitas" value="<?= $model["no_identitas"]?>" id="no_identitas" class="form-control number-only" placeholder="No Identitas"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="no_hp" id="no_hp" class="form-control number-only" value="<?= $model["no_hp"]?>"/>
                    </div>
                </div>
            </div>
        </div>
...
$(function(){
	...
	function insertToWgn(param){
		$("#id_warganegara").val(param[0]);
		$("#warganegara").val(param[1]);
	}
});
</script>

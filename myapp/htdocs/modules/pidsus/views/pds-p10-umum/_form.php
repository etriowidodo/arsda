<?php
	...
	use app\modules\pidsus\models\PdsP10Umum;

	$this->title 	= 'P-10 Umum';
	...
	$linkBatal		= '/pidsus/pds-p10-umum/index';
	$linkCetak		= '/pidsus/pds-p10-umum/cetak?id1='.rawurlencode($model['no_p10_umum']);
	if($isNewRecord){
		$sqlCek = "select no_p8_umum, tgl_p8_umum from pidsus.pds_p8_umum where ".$whereDefault;
		$model 	= PdsP10Umum::findBySql($sqlCek)->asArray()->one();
	}
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p10-umum/simpan" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group form-group-sm">
                    <label class="control-label col-md-4">Nomor P-10 Umum</label>
                    <div class="col-md-8">
                        <input type="text" name="no_p10_umum" id="no_p10_umum" class="form-control" value="<?php echo $model['no_p10_umum']; ?>" maxlength="50" required data-error="Nomor P-10 Umum belum diisi" />
                        <div class="help-block with-errors" id="error_custom_no_p10_umum"></div>
                    </div>
            	</div>
            </div>
            <div class="col-md-6">
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="tgl_p10_umum" id="tgl_p10_umum" class="form-control datepicker" value="<?php echo $tgl_p10_umum;?>" required data-error="Tanggal P-10 Umum belum diisi" />
                        </div>
                        <div class="help-block with-errors" id="error_custom_tgl_p10_umum"></div>
                    </div>
                </div>
            </div>
		</div>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-md-8">
                        <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                            <option></option>
                            <?php 
                                $resOpt = PdsP10Umum::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <tbody>
                        <?php
                        	if($model['no_p10_umum'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'P-10-Umum' order by no_urut";
                        		$resx = PdsP10Umum::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut, tembusan from pidsus.pds_p10_umum_tembusan where ".$whereDefault." and no_p10_umum = '".$model['no_p10_umum']."' 
										 order by no_urut";
                        		$resx = PdsP10Umum::findBySql($sqlx)->asArray()->all();
                        	}
                        	$no = 1;
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p10_umum'].$model['file_upload'];
                        $labelFile 	= 'Unggah Pidsus P-10 Umum';

<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        ?>
		<a id="pilih-jpu-p2" class="btn btn-success">Pilih</a><a id="btnCloseModal" class="btn btn-danger">Batal</a>
    </div>
	
<script>
    $(document).ready(function(){
        $('#pilih-jpu-p2').click(function(){
        	...
        	for (var i=0, n=checkboxes.length;i<n;i++)  {
                ...
                $('#tbody_jpu').append(
                    '<tr id="trjpu'+data[2]+'">' +
                    '<td><input type="hidden" class="form-control" name="nip_jpu[]" readonly="true" value="'+data[0]+'"> <input type="text" class="form-control" readonly="true" value="'+data[2]+'"> </td>' +

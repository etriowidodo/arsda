<?php
	...
	$this->title = 'P-16';
	$this->subtitle = 'Surat Perintah Penujukan Jaksa Penuntut Umum';
	...
	$linkCetak		= '/pidsus/p16/cetak?nop16='.$model['no_p16'];
...
<div class="row">        
    <div class="col-md-6">
        <div class="form-group form-group-sm">
            ...
            <div class="col-md-8">
                <input type="text" name="no_p16" id="no_p16" class="form-control" value="<?php echo $model['no_p16'];?>" required data-error="No P16 belum diisi" maxlength="50" />
...
<!--                                <th class="text-center" width="15%">Jenis Kelamin</th>
                        ...
                        <tbody>
                        <?php 
                            $sqlnya = "select * from pidsus.pds_spdp_tersangka where ".$whereDefault." order by no_urut";
                            ...
                            if(count($hasil) == 0)
                                ...
                                foreach($hasil as $data){
									$tgl_lahir = ($data['tgl_lahir'])?date('d-m-Y',strtotime($data['tgl_lahir'])):'';
                         ?>	
                              <tr>
                                <td class="text-center"><?php echo $data['no_urut'];?></td>
                                <td class="text-left"><?php echo $data['nama'];?></td>
                                <td class="text-left"><?php echo $data['tmpt_lahir'].', '.$tgl_lahir;?></td>
<!--                                <td class="text-left"><?php echo $ajkl[$data['id_jkl']];?></td>
                    ...
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_p16'] == ''){
                        		...
                        		$resx = P16::findBySql($sqlx)->asArray()->all();
                        	} else{

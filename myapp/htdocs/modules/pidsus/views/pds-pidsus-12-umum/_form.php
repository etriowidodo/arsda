<?php
	...
	$whereDefault 	= "id_kejati = '".$_SESSION["kode_kejati"]."' and id_kejari = '".$_SESSION["kode_kejari"]."' and id_cabjari = '".$_SESSION["kode_cabjari"]."' 
						and no_p8_umum = '".$model['no_p8_umum']."' and no_pidsus12_umum = '".$model['no_pidsus12_umum']."'";
	$linkBatal 		= '/pidsus/pds-pidsus-12-umum/index';
	$linkCetak 		= '/pidsus/pds-pidsus-12-umum/cetak';
	$linkHapus 		= '/pidsus/pds-pidsus-12-umum/hapusdata?id1='.rawurlencode($model['no_p8_umum']).'&id2='.rawurlencode($model['no_pidsus12_umum']);
	...
	$tgl_pidsus12_umum 	= ($model['tgl_pidsus12_umum'])?date('d-m-Y',strtotime($model['tgl_pidsus12_umum'])):'';
?>


<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-pidsus-12-umum/simpan" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Nomor Pidsus-12 Umum</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_pidsus12_umum" id="no_pidsus12_umum" class="form-control" value="<?php echo $model['no_pidsus12_umum'];?>" required data-error="Nomor Pidsus 12 Umum belum diisi" maxlength="50" />
                                <div class="help-block with-errors" id="error_custom_no_pidsus12_umum"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal Pidsus-12 Umum</label>        
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_pidsus12_umum" id="tgl_pidsus12_umum" class="form-control datepicker" value="<?php echo $tgl_pidsus12_umum;?>" required data-error="Tanggal Pidsus-12 Umum belum diisi" />
                                </div>
                                <div class="help-block with-errors" id="error_custom_tgl_pidsus12_umum"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <tbody>
                        <?php
                        	if($model['no_pidsus12_umum'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'Pidsus-12-Umum' order by no_urut";
                        		$resx = PdsPidsus12Umum::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut as no_urut, tembusan from pidsus.pds_pidsus12_umum_tembusan 
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['pidsus_12umum'].$model['file_upload'];
                        $labelFile 	= 'Unggah Pidsus P-12';
                        if($model['file_upload'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah Pidsus P-12';

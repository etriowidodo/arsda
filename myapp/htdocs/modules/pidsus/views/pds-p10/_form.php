<?php
	...
	use app\modules\pidsus\models\PdsP10;
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsP10::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4"><b>Diperlukan Keterangan Ahli dari</b></label>        
                            <div class="col-md-8">
                                <input type="text" name="ket_ahli" id="ket_ahli" class="form-control" value="<?php echo $model['ket_ahli'];?>"  />
                    ...
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_berkas'] == ''){
                        		...
                        		$resx = PdsP10::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut as no_urut, tembusan from pidsus.pds_p18_tembusan 

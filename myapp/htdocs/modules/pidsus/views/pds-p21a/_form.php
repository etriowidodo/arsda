<?php
	...
	use app\modules\pidsus\models\PdsP21a;

	$this->title = 'P-21A';
	$this->subtitle = 'Pemberitahuan Susulan Hasil Penyidikan Sudah Lengkap';
	...
	$linkBatal		= '/pidsus/pds-p21a/index';
	$linkCetak		= '/pidsus/pds-p21a/cetak?id1='.$model['no_berkas'].'&id2='.$model['no_pengantar'];
	$tgl_ttd 		= ($model['tgl_dikeluarkan'])?date('d-m-Y',strtotime($model['tgl_dikeluarkan'])):'';
	$tgl_p21 		= ($model['tgl_p21'])?date('d-m-Y',strtotime($model['tgl_p21'])):'';
	$ttdJabatan 	= $model['penandatangan_status_ttd']." ".$model['penandatangan_jabatan_ttd'];
?>

<?php if($_SESSION['no_spdp'] && $_SESSION['tgl_spdp']){ ?>
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p21a/simpan" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Nomor P21</label>        
                            <div class="col-md-8">
                                <input readonly=""type="text" name="no_p21" id="no_p21" class="form-control" value="<?php echo $model['no_p21'];?>" required data-error="Nomor P21 belum diisi" maxlength="50" />
                    ...
                    <div class="col-md-3">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal P21</label>        
                            <div class="col-md-8">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input readonly="" type="text" name="tgl_p21" id="tgl_p21" class="form-control datepicker" value="<?php echo $tgl_p21;?>" required data-error="Tanggal P21 belum diisi" maxlength="50" />
                                </div>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <?php 
                    ...
                    $hasil1 = PdsP21a::findBySql($sqlnya)->asArray()->all();
                    if(count($hasil1) == 0)
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsP21a::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
							if($model['id_p21a'] == ''){
								$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'P-21A' order by no_urut";
								$resx = PdsP21a::findBySql($sqlx)->asArray()->all();
							} else{
								$sqlx = "select a.no_urut as no_urut, a.tembusan from pidsus.pds_p21a_tembusan a
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p21a'].$model['file_upload_p21a'];
                        $labelFile 	= 'Unggah File P-21A';
                        if($model['file_upload_p21a'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File P-21A';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($model['file_upload_p21a']));
                            $linkPt 	= "/pidsus/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($model['file_upload_p21a'], strrpos($model['file_upload_p21a'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$model['file_upload_p21a'].'" style="float:left; margin-right:10px;">

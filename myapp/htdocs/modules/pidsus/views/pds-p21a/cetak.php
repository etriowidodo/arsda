<?php
	...
	$docx = new CreateDocxFromTemplate('../modules/pidsus/template/P-21A.docx');
	...
	$sql2 = "select a.no_urut as no_urut, a.tembusan from pidsus.pds_p21a_tembusan a
	...
	$docx->replaceVariableByText(array('nomorP21'=>$model['no_surat']), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('tanggalP21'=>tgl_indo($tgl_p21)), array('parseLineBreaks'=>true));
	...
	$docx->createDocx('template/pidsus/P-21A');
	$file = 'template/pidsus/P-21A.docx';
	if (file_exists($file)) {

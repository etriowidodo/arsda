<?php
	...
	$linkBatal		= '/pidsus/pds-b1-umum/index';
	$linkCetak		= '/pidsus/pds-b1-umum/cetak?id1='.rawurlencode($model['no_b1_umum']);
	if($isNewRecord){
		$sqlCek = "select a.no_p8_umum, a.tgl_p8_umum from pidsus.pds_p8_umum a where ".$whereDefault;
		$model 	= PdsB1Umum::findBySql($sqlCek)->asArray()->one();
	}
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-b1-umum/simpan" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group form-group-sm">
                    <label class="control-label col-md-4">Nomor B-1 Umum</label>
                    <div class="col-md-8">
                        <input type="text" name="no_b1_umum" id="no_b1_umum" class="form-control" value="<?php echo $model['no_b1_umum'];?>" required data-error="Nomor B-1 Umum belum diisi" maxlength="50" />
                        <div class="help-block with-errors" id="error_custom_no_b1_umum"></div>
                    </div>
            	</div>
            	<div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsB1Umum::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="berupa_barang" id="berupa_barang" class="form-control" value="<?php echo $model['berupa_barang'];?>" maxlength="70"/>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="diduga_telah" id="diduga_telah" class="form-control" value="<?php echo $model['diduga_telah'];?>" maxlength="70" />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="dikuasai" id="dikuasai" class="form-control" value="<?php echo $model['dikuasai'];?>" maxlength="128"/>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="simpan_di" id="simpan_di" class="form-control" value="<?php echo $model['simpan_di'];?>" maxlength="200" />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_b1_umum'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'B-1-Umum' order by no_urut";
                        		$resx = PdsB1Umum::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut as no_urut, tembusan from pidsus.pds_b1_umum_tembusan a 
                                                where ".$whereDefault." and a.no_b1_umum = '".$model['no_b1_umum']."' order by a.no_urut";
                        		$resx = PdsB1Umum::findBySql($sqlx)->asArray()->all();
                        	}
                        	$no = 1;
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['b1_umum'].$model['file_upload'];
                        $labelFile 	= 'Unggah B-1 Umum';
                        if($model['file_upload'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah B-1 Umum';

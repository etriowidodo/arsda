<?php
	...
	use app\modules\pidsus\models\PdsBa16;
        ...
        <div class="box box-primary">
            <div class="box-body">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control datepicker" id="tanggal" name="tanggal" value="<?php echo $tanggal;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal B-4</label>        
                            <div class="col-md-8">
                                <div class="input-group date">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" class="form-control datepicker" id="tanggal_b4" name="tanggal_b4" value="<?php echo $tanggal_b4;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                                <div class="help-block with-errors" ></div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="nomor_pn" id="nomor_pn" class="form-control" value="<?php echo $model['nomor_pn'];?>"/>
                                <div class="help-block with-errors" ></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <div class="input-group date">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" class="form-control datepicker" id="tanggal_pn" name="tanggal_pn" value="<?php echo $tanggal_pn;?>" placeholder="DD-MM-YYYY"/>
                                </div>
                                <div class="help-block with-errors" ></div>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-jpn-modal">
                        ...
                        <?php 
                            ...
                            $hasil = PdsBa16::findBySql($sqlnya)->asArray()->all();
                            if(count($hasil) == 0)
...
<div class="row">
    <div class="col-md-12">
        <div class="box box-primary form-buat-saksi">
            <div class="box-header with-border">
                <div class="row col-sm-12">
                    <a class="btn btn-danger btn-sm disabled jarak-kanan" id="btn_hapussaksi"><i class="fa fa-trash" style="font-size:14px;"></i></a>	
                    <a class="btn btn-success btn-sm" id="btn_tambahsaksi"><i class="fa fa-user-plus jarak-kanan"></i>Tambah Saksi</a>	
                </div>
            </div>
            <div class="box-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-jpn-modal">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="10%">Umur</th>
                                <th class="text-center" width="40%">Pekerjaan</th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 

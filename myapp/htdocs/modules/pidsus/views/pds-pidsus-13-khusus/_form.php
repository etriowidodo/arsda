<?php
	...
	$linkBatal		= '/pidsus/pds-pidsus-13-khusus/index';
	$linkCetak		= '/pidsus/pds-pidsus-13-khusus/cetak';
        $linkHapus 		= '/pidsus/pds-pidsus-13-khusus/hapusdata?id1='.rawurlencode($model['no_pidsus18']).'&id2='.rawurlencode($model['no_p8_khusus']).'&id3='.rawurlencode($model['no_pidsus13_khusus']);
        if($isNewRecord){
		$sqlCek = "select no_p8_khusus, tgl_p8_khusus from pidsus.pds_p8_khusus a where ".$whereDefault;
		$model 	= PdsPidsus13Khusus::findBySql($sqlCek)->asArray()->one();
	}
	...
	$tgl_pidsus13_khusus 	= ($model['tgl_pidsus13_khusus'])?date('d-m-Y',strtotime($model['tgl_pidsus13_khusus'])):'';
?>

<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-pidsus-13-khusus/simpan" enctype="multipart/form-data">
        ...
        <div class="box box-primary">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Nomor Pidsus-13 Khusus</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_pidsus13_khusus" id="no_pidsus13_khusus" class="form-control" value="<?php echo $model['no_pidsus13_khusus'];?>" required data-error="Nomor Pidsus 13 Khusus belum diisi" maxlength="50" />
                                <div class="help-block with-errors" id="error_custom_no_pidsus13_khusus"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal Pidsus-13 Khusus</label>        
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_pidsus13_khusus" id="tgl_pidsus13_khusus" class="form-control datepicker" value="<?php echo $tgl_pidsus13_khusus;?>" required data-error="Tanggal Pidsus-13 Khusus belum diisi" />
                                </div>
                                <div class="help-block with-errors" id="error_custom_tgl_pidsus13_khusus"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsPidsus13Khusus::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover" id="tableTsk">
                ...
                <?php 
                    ...
                    $resTsk = ($_SESSION["pidsus_no_pidsus18"])? PdsPidsus13Khusus::findBySql($sqlTsk)->asArray()->all():array();
                    if(count($resTsk) == 0)
                    ...
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_pidsus13_khusus'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'Pidsus-13-Khusus' order by no_urut";
                        		$resx = PdsPidsus13Khusus::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut as no_urut, tembusan from pidsus.pds_pidsus13_khusus_tembusan a
						where ".$whereDefault." and a.no_pidsus13_khusus = '".$model['no_pidsus13_khusus']."' order by no_urut";
                        		$resx = PdsPidsus13Khusus::findBySql($sqlx)->asArray()->all();
                        	}
                        	$no = 1;
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['pidsus_13khusus'].$model['file_upload'];

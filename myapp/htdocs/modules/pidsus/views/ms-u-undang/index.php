...
<div class="role-index">
    <div class="inline"><a class="btn btn-pidsus" href="/pidsus/ms-u-undang/create"><i class="fa fa-plus jarak-kanan"></i>Tambah</a></div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#idUbah").on("click", function(){
			...
			var url = window.location.protocol + "//" + window.location.host + "/pidsus/ms-u-undang/update?id="+tm[0];
			...
			bootbox.confirm({
				...
				callback: function (result) {
					if(result){
						...
						$.ajax({
							type	: "POST",
							url	: "<?php echo Yii::$app->request->baseUrl.'/pidsus/ms-u-undang/hapusdata'; ?>",
							data	: { 'id' : id },
							cache	: false,
							dataType: "json",

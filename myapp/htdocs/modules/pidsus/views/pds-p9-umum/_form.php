<?php
	...
	$linkBatal		= '/pidsus/pds-p9-umum/index';
	$linkCetak		= '/pidsus/pds-p9-umum/cetak?id1='.rawurlencode($model['no_p9_umum']);
	if($isNewRecord){
		$sqlCek = "select no_p8_umum, tgl_p8_umum from pidsus.pds_p8_umum where ".$whereDefault;
		$model 	= PdsP9Umum::findBySql($sqlCek)->asArray()->one();
	}
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p9-umum/simpan" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Nomor P-9 Umum</label>        
                            <div class="col-md-8">
                                <input type="text" name="no_p9_umum" id="no_p9_umum" class="form-control" value="<?php echo $model['no_p9_umum'];?>" required data-error="Nomor P-9 Umum belum diisi" maxlength="50" />
                                <div class="help-block with-errors" id="error_custom_no_p9_umum"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Tanggal P-9 Umum</label>        
                            <div class="col-md-4">
                                <div class="input-group">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="tgl_p9_umum" id="tgl_p9_umum" class="form-control datepicker" value="<?php echo $tgl_p9_umum;?>" required data-error="Tanggal P-9 Umum belum diisi" />
                                </div>
                                <div class="help-block with-errors" id="error_custom_tgl_p9_umum"></div>
                            </div>
                        </div>
                    </div>
				</div>
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p9_umum'].$model['file_upload'];
                        $labelFile 	= 'Unggah Pidsus P-9 Umum';
...
$(document).ready(function(){
	...
	$("#pilih_saksi").on('click', function(e){
		...
		if(keperluan){			
			...
			$("#saksi_modal").find(".modal-body").load("/pidsus/pds-p9-umum/getsaksi?keperluan="+encodeURIComponent(keperluan), function(){

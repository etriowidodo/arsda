<?php
	...
	use app\modules\pidsus\models\PdsPidsus14;

	$this->title = 'Pidsus-14';
                    ...
                    <table class="table table-bordered table-hover table-jpn-modal">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="20%">Waktu Pelaksanaan</th>
                                <th class="text-center" width="30%">Jaksa yang Melaksanakan</th>
...
//                            $hasil = PdsPidsus14::findBySql($sqlnya)->asArray()->all();
//                            if(count($hasil) == 0)
...
<div class="modal fade" id="tambah_usul_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog form-horizontal">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Tambah Usul Saksi / Ahli / Tersangka</h4>
            </div>
            <div class="modal-body"></div>
        </div>
    </div>
...
$(document).ready(function(){
		...
		$("#tambah_usul_modal").find(".modal-body").load("/pidsus/pds-pidsus-14/getusul");

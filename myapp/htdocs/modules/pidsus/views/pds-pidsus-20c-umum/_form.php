<?php
	...
	$this->title = 'Pidsus-20C Umum';
	$this->subtitle = 'Permohonan Bantuan Pengwalan Penggeledahan/Penyitaan';
	...
	$linkBatal		= '/pidsus/pds-pidsus-20c-umum/index';
	$linkCetak		= '/pidsus/pds-pidsus-20c-umum/cetak?id1='.rawurlencode($model['no_pidsus20c_umum']);
	if($isNewRecord){
		$sqlCek = "select a.no_p8_umum, a.tgl_p8_umum from pidsus.pds_p8_umum a where ".$whereDefault;
		$model 	= PdsPidsus20cUmum::findBySql($sqlCek)->asArray()->one();
	}
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-pidsus-20c-umum/simpan" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group form-group-sm">
                    <label class="control-label col-md-4">Nomor Pidsus-20C Umum</label>
                    <div class="col-md-8">
                        <input type="text" name="no_pidsus20c_umum" id="no_pidsus20c_umum" class="form-control" value="<?php echo $model['no_pidsus20c_umum'];?>" required data-error="Nomor Pidsus-20C Umum belum diisi" maxlength="50" />
                        <div class="help-block with-errors" id="error_custom_no_pidsus20c_umum"></div>
                    </div>
            	</div>
            	<div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsPidsus20cUmum::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            <label class="control-label col-md-4">Waktu Pelaksanaan Penggeledahan/Penyitaan</label>
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group bootstrap-timepicker">
                                                    ...
                                                    <input type="text" name="jam_penggeledahan" id="jam_penggeledahan" class="form-control timepicker" value="<?php echo $model['jam_penggeledahan']; ?>" required data-error="Jam penggeledahan belum diisi" />
                                                </div>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group form-group-sm">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="tgl_penggeledahan" id="tgl_penggeledahan" class="form-control datepicker" value="<?php echo $tgl_penggeledahan;?>" required data-error="Tanggal penggeledahan belum diisi" />
                                                </div>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="tempat_pelaksanaan" id="tempat_pelaksanaan" class="form-control" value="<?php echo $model['tempat_pelaksanaan']; ?>" />
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['no_b1_umum'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'Pidsus-20c-Umum' order by no_urut";
                        		$resx = PdsPidsus20cUmum::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select no_urut as no_urut, tembusan from pidsus.pds_pidsus20c_umum_tembusan a 
                                                where ".$whereDefault." and a.no_pidsus20c_umum = '".$model['no_pidsus20c_umum']."' order by a.no_urut";
                        		$resx = PdsPidsus20cUmum::findBySql($sqlx)->asArray()->all();
                        	}
                        	$no = 1;
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['pidsus_20cumum'].$model['file_upload'];
                        $labelFile 	= 'Unggah Pidsus-20C Umum';
                        if($model['file_upload'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah Pidsus-20C Umum';
...
$(document).ready(function(){
    ...
    $("#jam_penggeledahan").on('focus', function(){
            $(this).prev().trigger('click');
    });
        /* START AMBIL B-4 */
	$("#pilih_b4").on('click', function(e){
		$("#b4_modal").find(".modal-body").html("");
		$("#b4_modal").find(".modal-body").load("/pidsus/pds-pidsus-20c-umum/getb4");
	...
	$("#b4_modal").on('show.bs.modal', function(e){
        ...
        function getJaksaB4(param){
            ...
            $.post("/pidsus/pds-pidsus-20c-umum/getjaksab4", {id:param}, function(data){
                rwTbl.remove();

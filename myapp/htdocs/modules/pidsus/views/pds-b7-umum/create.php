...
$(document).ready(function(){
	...
	function validasi_upload(){
		...
		if(fname && $.inArray(extnya, arrExt) == -1){
			...
			return false;
		} else if($("#no_b4_umum").val() == ""){
			$("body").removeClass("loading");
			$("#error_custom_no_b4_umum").html('<i style="color:#dd4b39; font-size:12px;">Nomor B-4 Umum belum dipilih</i>');
			...
			$.ajax({
				type	: "POST",
				url		: '<?php echo Yii::$app->request->baseUrl.'/pidsus/pds-b7-umum/cekb7umum'; ?>',

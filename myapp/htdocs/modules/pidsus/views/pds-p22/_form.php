<?php
	...
	use app\modules\pidsus\models\PdsP22;

	$this->title = 'P-22';
	$this->subtitle = 'Penyerahan Tersangka dan Barang Bukti';
	...
	$linkBatal		= '/pidsus/pds-p22/index';
	$linkCetak		= '/pidsus/pds-p22/cetak?id1='.rawurlencode($model['no_berkas']);
	$linkHapus		= '/pidsus/pds-p22/hapus';
...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pidsus/pds-p22/simpan" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-8">
                                <select name="sifat" id="sifat" class="select2" style="width:100%" required data-error="Sifat surat belum diisi">
                                    <option></option>
                                    <?php 
                                        $resOpt = PdsP22::findBySql("select distinct id, nama from ms_sifat_surat order by id")->asArray()->all();
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <?php 
                    ...
                    $hasil1 = PdsP22::findBySql($sqlnya)->asArray()->all();
                    if(count($hasil1) == 0)
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="table_tembusan" class="table table-bordered">
                        ...
                        <?php
                        	if($model['id_p22'] == ''){
                        		$sqlx = "select no_urut, tembusan from pidsus.ms_template_surat_tembusan where kode_template_surat = 'P-22' order by no_urut";
                        		$resx = PdsP22::findBySql($sqlx)->asArray()->all();
                        	} else{
                        		$sqlx = "select a.no_urut as no_urut, a.tembusan as tembusan from pidsus.pds_p22_tembusan a
        ...
        <div class="form-group form-group-sm">
            <div class="col-md-12">
                ...
                <label for="file_template" class="label-inputfile">
                    <?php 
                        $pathFile 	= Yii::$app->params['p22'].$model['file_upload_p22'];
                        $labelFile 	= 'Unggah File P-22';
                        if($model['file_upload_p22'] && file_exists($pathFile)){
                            $labelFile 	= 'Ubah File P-22';
                            $param1  	= chunk_split(base64_encode($pathFile));
                            $param2  	= chunk_split(base64_encode($model['file_upload_p22']));
                            $linkPt 	= "/pidsus/download-file/index?id=".$param1."&fn=".$param2;
                            $extPt		= substr($model['file_upload_p22'], strrpos($model['file_upload_p22'],'.'));
                            echo '<a href="'.$linkPt.'" title="'.$model['file_upload_p22'].'" style="float:left; margin-right:10px;">

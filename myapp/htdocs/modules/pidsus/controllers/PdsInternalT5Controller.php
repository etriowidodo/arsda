...
use app\modules\pidsus\models\PdsInternalT5;

class PdsInternalT5Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsInternalT5;
        $dataProvider = $searchModel->searchPer(Yii::$app->request->get());
        return $this->render('index', ['dataProvider' => $dataProvider]);
    }

    public function actionCreate(){
        $model  = new PdsInternalT5;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsInternalT5::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }

...
class PdsPidsus14Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsPidsus14;
    ...
    public function actionGetusul(){
        if (Yii::$app->request->isAjax) {
            return $this->renderAjax('_tambah_usul');
        }
    }
    

    public function actionCreate(){
        $model  = new PdsPidsus14;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsPidsus14::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }
    ...
    public function actionCekp16(){
		if (Yii::$app->request->isAjax) {
			$model = new PdsPidsus14;
			$nilai = $model->cekPdsPidsus14(Yii::$app->request->post());

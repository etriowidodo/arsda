...
class PdsPidsus15Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsPidsus15;
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsPidsus15::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }
    ...
    public function actionCekp16(){
		if (Yii::$app->request->isAjax) {
			$model = new PdsPidsus15;
			$nilai = $model->cekPdsPidsus15(Yii::$app->request->post());

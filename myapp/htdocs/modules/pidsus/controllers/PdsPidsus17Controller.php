...
use app\modules\pidsus\models\PdsPidsus17;

class PdsPidsus17Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsPidsus17;
        $dataProvider = $searchModel->searchPer(Yii::$app->request->get());
        return $this->render('index', ['dataProvider' => $dataProvider]);
    }

    public function actionCreate(){
        $model  = new PdsPidsus17;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsPidsus17::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }

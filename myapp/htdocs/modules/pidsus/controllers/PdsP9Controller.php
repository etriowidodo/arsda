...
use app\modules\pidsus\models\PdsP9;

class PdsP9Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsP9;
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsP9::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }
    ...
    public function actionCekp16(){
		if (Yii::$app->request->isAjax) {
			$model = new PdsP9;
			$nilai = $model->cekPdsP9(Yii::$app->request->post());

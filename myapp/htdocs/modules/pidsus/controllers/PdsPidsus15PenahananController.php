...
class PdsPidsus15PenahananController extends Controller{
    public function actionIndex(){
        $searchModel = new PdsPidsus15Penahanan;
        $dataProvider = $searchModel->searchPer(Yii::$app->request->get());
        return $this->render('index', ['dataProvider' => $dataProvider]);
    }

    public function actionCreate(){
        $model  = new PdsPidsus15Penahanan;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsPidsus15Penahanan::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }

...
class PdsInternalP16Controller extends Controller{
    public function actionIndex(){
        $searchModel = new PdsInternalP16;
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsInternalP16::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }
    ...
    public function actionCekp16(){
		if (Yii::$app->request->isAjax) {
			$model = new PdsInternalP16;
			$nilai = $model->cekPdsInternalP16(Yii::$app->request->post());

...
class PdsBa10PenahananController extends Controller{
    public function actionIndex(){
        $searchModel = new PdsBa10Penahanan;
        $dataProvider = $searchModel->searchPer(Yii::$app->request->get());
        return $this->render('index', ['dataProvider' => $dataProvider]);
    }

    public function actionCreate(){
        $model  = new PdsBa10Penahanan;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsBa10Penahanan::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }

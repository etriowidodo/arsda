...
class PdsBa10PanjangController extends Controller{
    public function actionIndex(){
        $searchModel = new PdsBa10Panjang;
        $dataProvider = $searchModel->searchPer(Yii::$app->request->get());
        return $this->render('index', ['dataProvider' => $dataProvider]);
    }

    public function actionCreate(){
        $model  = new PdsBa10Panjang;	
    ...
    public function actionUpdate($nop16){
		...
		$model 	= PdsBa10Panjang::findBySql($sqlnya)->asArray()->one();
        return $this->render('create', ['model' => $model]);
    }

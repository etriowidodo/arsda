...
class PdsPidsus13UmumController extends Controller{
    ...
    public function actionCekpidsus13umum(){
		if (Yii::$app->request->isAjax) {
			$model = new PdsPidsus13Umum;
			$nilai = $model->Cekpidsus13umum(Yii::$app->request->post());

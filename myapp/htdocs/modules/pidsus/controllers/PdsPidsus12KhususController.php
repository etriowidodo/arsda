...
class PdsPidsus12KhususController extends Controller{
    ...
    public function actionCekpidsus12khusus(){
        if (Yii::$app->request->isAjax) {
            $model = new PdsPidsus12Khusus;
            $nilai = $model->cekpidsus12khusus(Yii::$app->request->post());

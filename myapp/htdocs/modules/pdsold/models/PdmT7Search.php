...
class PdmT7Search extends PdmT7
{
    ...
    public function search($id, $params)
    {
        ...
        $query->select('a.no_register_perkara,a.no_surat_t7 as no_surat_t7,a.nama_tersangka_ba4 as nama_tersangka,a.nama_jaksa as nama_jaksa,a.json_jpu as json_jpu ')
                    ->from('pidum.pdm_t7 a ')   

...
class PdmBa11Search extends PdmBa11
{
    ...
    {
        return [
            [['no_register_perkara', 'no_surat_t8', 'tgl_ba11', 'id_tersangka', 'no_reg_perkara', 'no_reg_tahanan', 'tgl_penahanan', 'no_sp', 'tgl_sp', 'tindakan', 'tgl_mulai', 'kepala_rutan', 'id_perkara', 'id_kejati', 'id_kejari', 'id_cabjari', 'created_ip', 'created_time', 'updated_ip', 'updated_time', 'nip_jaksa', 'nama'], 'safe'],

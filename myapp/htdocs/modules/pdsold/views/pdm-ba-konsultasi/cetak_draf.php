<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/bakonsultasi-draf.docx');
...
//
    ...
    $docx->replaceVariableByText(array('tersangka'=>Yii::$app->globalfunc->GetHlistTerdakwaSpdp($id_perkara)), array('parseLineBreaks'=>true));
...
//    $docx->replaceVariableByText(array('pangkat_end'=>$model->pangkat_jaksa.' /NIP. '.$model->nip_jaksa), array('parseLineBreaks'=>true));
    ...
    $docx->createDocx('../web/template/pdsold_surat/bakonsultasi-draf');
    $file = '../web/template/pdsold_surat/bakonsultasi-draf.docx';
    if (file_exists($file)) {

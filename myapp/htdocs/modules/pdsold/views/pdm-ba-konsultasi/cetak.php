<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/bakonsultasi.docx');
    ...
    $docx->createDocx('../web/template/pdsold_surat/bakonsultasi');
    $file = '../web/template/pdsold_surat/bakonsultasi.docx';
    if (file_exists($file)) {

...
<form id="role-form" name="role-form" class="form-validasi form-horizontal" method="post" action="/pdsold/pdm-config/simpan">
...
<div class="box-footer text-center"> 
    ...
    <a href="/pdsold/pdm-config/index" class="btn btn-danger">Batal</a>
</div>
</form>
</div>

        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' => $model['id_b11'], 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
        'export' => false,
...
$js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-b11/update?id="+id;

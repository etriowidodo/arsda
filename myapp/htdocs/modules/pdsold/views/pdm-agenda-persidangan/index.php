...
<div class="pdm-agenda-persidangan-index">
    ...
    $form = \kartik\widgets\ActiveForm::begin([
        'id' => 'hapus-index',
        'action' => '/pdsold/pdm-agenda-persidangan/delete'
    ]);
    ?>
...
$js = <<< JS
    ...
    var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-agenda-persidangan/update?no_agenda="+no_agenda;

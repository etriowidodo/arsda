<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/P-45.docx');
...
//        $i=1;
    ...
    for ($i=0; $i < count($tersangka); $i++) { 
        ...
        $menuntut .= '<tr><td width="5%"> - </td><td width="95%"><p> Menjatuhkan pidana terhadap terdakwa '.$tersangka[$i]->nama.' berupa '.PdmMsRentut::findOne($p41Terdakwa->id_ms_rentut)->nama.' ';
...
//        $i=1;
    ...
    $docx->createDocx('../web/template/pdsold_surat/P-45');
    $file = '../web/template/pdsold_surat/P-45.docx';
    if (file_exists($file)) {

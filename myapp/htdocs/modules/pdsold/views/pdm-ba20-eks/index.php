    ...
    GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value'=>function ($model, $key, $index, $widget) {
                            $tsk = VwTerdakwaT2::findAll(['no_register_perkara'=>$model->no_register_perkara,'no_urut_tersangka'=>$model->id_tersangka]);
...
$js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-ba20/update?id="+tm[0]+"&id2="+tm[1];

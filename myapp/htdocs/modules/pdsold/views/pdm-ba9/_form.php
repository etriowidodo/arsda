     ...
     <div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;padding:20px 0px;">
                    ...
                    <div class="help-block"></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                             echo $form->field($model, 'tgl_ba9')->widget(DateControl::classname(), [
    ...
    */?>
    ...
    <div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;">
        ...
        <div class="col-md-12">
            <!-- <div class="col-md-6">
                <div class="form-group">
                    <label for="id_ms_loktahanan" class="control-label col-md-4">Diberikan</label>
                    <div class="col-md-8">
                        <?php //$form->field($model, 'tindakan')->dropDownList(['' => 'Pilih Tindakan', '1' =>'Penangguhan Penahanan Terdakwa', '2' =>'Penangguhan Penahanan Tersangka']) ?>
...
<hr style="border-color: #c7c7c7;margin: 10px 0;">
    <div class="box-footer" style="text-align: center;">
		...
		<?php if(!$model->isNewRecord){ ?>
			<a class="btn btn-warning" href="<?= \yii\helpers\Url::to(['pdm-ba9/cetak?id='.$model->id_tersangka.'&tgl_surat='.$model->tgl_ba9] ) ?>">Cetak</a>
		<?php } ?>
    </div>
        <div id="hiddenId"></div>
...
//JPU
	...
	//Terdakwa
        var lel = $("#pdmba9-no_reg_tahanan_jaksa :selected").text();
        var lol = $("#pdmba9-no_reg_tahanan_jaksa :selected").val();
        ...
        if (lol!==''){
            $.ajax({
                ...
                success:function(data){
                    ...
                    $("#tgl_mulai").val(tgl);
                    $("#pdmba9-no_surat_t8").val(data.no_surat_t8);
                    $("#pdmba9-nama").val(lel);
                    $("#no_reg_tahananx").val(lol);
                    $("#pdmba9-id_tersangka").val(data.no_urut_tersangka);
                    $("#pdmba9-tgl_penahanan-disp").val(data.tgl_mulai)
                   //$("#pdmba9-no_reg_tahanan").val(data.no_reg_tahanan);

...
<div class="pdm-pengembalian-index">
    ...
    <?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pdsold/pdm-pengembalian/deleteberkas/'
        ]);  
    ?>  
...
<?php
	...
	if($(".empty").text()=='Tidak ada data yang ditemukan.'){
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-pengembalian/updateberkas?id=" + idpengembalian+"&id_berkas=" +idberkas;
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-pengembalian/updateberkas?id=" + id+"&id_berkas=" +idberkas;
        $(location).attr('href',url);
		//alert(count);
		}
    });

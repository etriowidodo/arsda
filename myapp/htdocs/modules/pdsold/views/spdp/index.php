...
.disabledCheck{
    ...
    <div class="content-wrapper-1">
        <div class="pidum-pdm-spdp-index">
			...
			<div class="inline"><a class='btn btn-warning'  href="/pdsold/spdp/create" title="Tambah Penerimaan SPDP">Tambah Penerimaan SPDP</a></div>
                                    ...
                                    [
                                        ...
                                        'value' => function ($model, $key, $index, $widget) { //CMS_PIDUM_59 #bowo #16 juni 2016
											if($model->file_upload !=''){
												return  Html::a(Html::img('/image/pdf.png',['width'=>'30']), '/template/pdsold_surat/'.$model->file_upload,['target'=>'_blank'])."&nbsp;".$model->assurat. "<br>" .$model->no_surat . "&nbsp  " . date('d-m-Y', strtotime($model->tgl_surat)) . "<br>Diterima SPDP :  &nbsp" . date('d-m-Y', strtotime($model->tgl_terima));
											}else{
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/spdp/update2?id="+id;

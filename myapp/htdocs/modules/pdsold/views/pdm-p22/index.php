...
<?php
	...
	if($(".empty").text()=='Tidak ada data yang ditemukan.'){
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-p22/update?id=" + idp22+"&id_pengantar=" +idpengantar;
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-p22/update?id=" + id+"&id_pengantar=" +idpengantar;
        $(location).attr('href',url);
		//alert(count);
		}
    });

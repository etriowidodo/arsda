...
<div class="pdm-putusan-pn-index">
    ...
    $form = \kartik\widgets\ActiveForm::begin([
                'id' => 'hapus-index',
                'action' => '/pdsold/pdm-putusan-pn/delete'
    ]);
    ?>
...
<?php
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-putusan-pn/update?id_p41="+id_p41;
      ...
      $('#selesai').on("click", function(){
            ...
            var no_akta = $('#inputNoAkta').val();
             ...
             //alert('gg');
            var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-putusan-pn/create?no_akta="+no_akta;
            $(location).attr('href',url);
        });

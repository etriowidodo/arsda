...
use app\modules\pdsold\models\PdmPutusanPnUpayahukumTerdakwa;
                                         ...
                                         ?>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                echo '<td style="text-align: left; "><input type="checkbox" name="UuTahap2['.$valuex->id.']['.$nilai->no_reg_tahanan.'][pasal][]" "'.$check.'" value="'.$listPasal['id_pasal'].'" style="width:100%"></td>';
                                                   ...
                                                   <div class="biaya_perkara<?= $valuex->id.'_'.$nilai->no_reg_tahanan?>">
                                                      <div class="form-group">
                                                   ...
                                                   <div class="pidana_penjara_<?= $valuex->id.'_'.$nilai->no_reg_tahanan?>">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group">
                                                                <textarea class="form-control" name="PdmP41Terdakwa[<?= $valuex->id ?>][<?= $nilai->no_reg_tahanan ?>][usuljpu][]"><?= $modelTerdakwa->usuljpu ?></textarea>
                                                                <div class="col-sm-12"></div>
                                                                <div class="col-sm-12">
                                                                    <div class="help-block"></div>
                                                                </div>

...
$(document).ajaxSuccess(function(){
       ...
       $('#id_tersangka-grid-container td ').off('click').click(function(){
                    ...
                    $('#pdmba7-nama_tersangka_ba4').val(data.nama_tersangka_ba4);
                    $('#pdmt7-no_surat_t7').val(data.no_surat_t7);
                    $('#pdmt7-tgl_dikeluarkan').val(data.tgl_dikeluarkan);
                    $('#tindakan_status').val(data.ur_tindakan_status);
                    $('#lok_tahanan').val(data.ur_lokasi_tahanan);
                    $('#pdmt7-tgl_mulai').val(data.tgl_mulai);
                    $('#pdmt7-lama').val(data.lama);
                    $('#pdmba7-no_surat_t7').val(data.no_surat_t7);
                    $('#m_tersangka').modal('hide');

...
/* @var $model app\modules\pidum\models\PdmP43Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="pdm-p43-search">
    ...
    <?php // echo $form->field($model, 'notel') ?>

    <?php // echo $form->field($model, 'tgl_notel') ?>

    <?php // echo $form->field($model, 'amar_tut') ?>

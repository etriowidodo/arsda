        ...
        'columns' => [
            ...
            [
                ...
                'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' => $model['id_ba16'], 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
        'export' => false,
...
$js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-ba16/update?id="+id;

...
<div class="ms-inst-penyidik-index">
    <div class="inline">
        <a class='btn btn-warning'  href="/pdsold/ms-inst-penyidik/create" title="Tambah Penerimaan SPDP">
...
$js = <<< JS
    $('td').dblclick(function (e) {
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/ms-inst-penyidik/update?id="+id;
...
$('#idHapus').on('click',function(){
   ...
   $('button').on('click',function(){
    ...
    if(click==0)
    {
       ...
       $.ajax({
            type        : 'POST',
            url         :'/pdsold/ms-inst-penyidik/delete',
            data        : send,                 

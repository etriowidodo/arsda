<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/BA-20.docx');
...
//    $docx->replaceVariableByHTML('pasal', 'block', $melanggar_pasal, $arrDocnya);
    ...
    $docx->createDocx('../web/template/pdsold_surat/BA-20');
    $file = '../web/template/pdsold_surat/BA-20.docx';
    if (file_exists($file)) {

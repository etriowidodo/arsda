...
use app\modules\pdsold\models\PdmP51Search;
...
<div class="pdm-p51-index">
    ...
    GridView::widget([
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-p51/update?id="+idb1;

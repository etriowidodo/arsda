...
/* @var $model app\modules\pidum\models\PdmP36Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="pdm-p36-search">
    ...
    <?php // echo $form->field($model, 'pengadilan') ?>

    <?php // echo $form->field($model, 'alamat') ?>

    <?php // echo $form->field($model, 'tgl_sidang') ?>

...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-ba11/update?id_tersangka=" +id_tersangka+"&no_register_perkara="+no_register_perkara;
        //alert(url);exit;

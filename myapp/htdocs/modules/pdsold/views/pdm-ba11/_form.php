...
<section class="content" style="padding: 0px;">
     ...
     <div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;padding:20px 0px;">
                    ...
                    <div class="help-block"></div>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php
                             echo $form->field($model, 'tgl_ba11')->widget(DateControl::classname(), [
    ...
    */?>
    ...
    <div class="col-md-4"> 
  <?= $form->field($model, 'tindakan')->dropDownList(['1' => 'Pencabutan Penangguhan Penahanan Terdakwa', '2' => 'Pencabutan Penangguhan Penahanan Tersangka']) ?>
  </div>
  </div>
  </div>
...
<hr style="border-color: #c7c7c7;margin: 10px 0;">
    <div class="box-footer" style="text-align: center;">
		...
		<?php if(!$model->isNewRecord){ ?>
			<a class="btn btn-warning" href="<?= \yii\helpers\Url::to(['pdm-ba11/cetak?id='.$model->id_tersangka.'&tgl_surat='.$model->tgl_ba11] ) ?>">Cetak</a>
		<?php } ?>
    </div>
        <div id="hiddenId"></div>
...
//JPU
	...
	//Terdakwa
        var lel = $("#pdmba11-no_reg_tahanan_jaksa :selected").text();
        var lol = $("#pdmba11-no_reg_tahanan_jaksa :selected").val();
        $("#pdmba11-nama").val(lel);
    ...
    $('.cmb_terdakwa').change(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $("#tgl_mulai").val(tgl);
                $("#pdmba11-no_surat_t8").val(data.no_surat_t8);
                $("#pdmba11-nama").val(lel);
                $("#no_reg_tahananx").val(lol);
                $("#pdmba11-id_tersangka").val(data.no_urut_tersangka);
                $("#pdmba11-tgl_penahanan-disp").val(data.tgl_mulai)
               //$("#pdmba11-no_reg_tahanan").val(data.no_reg_tahanan);

            ...
            <div class="form-group">
                <div class="col-md-12">
                    <div class="col-md-8">
                        ...
                        <div class="col-md-4">
                            <?php if (!$model_pn->isNewRecord){
                                    echo $form->field($model, 'pengadilan')->textInput();
                                } else {
                                    $conf = Yii::$app->globalfunc->GetConfSatker();
                                    //echo '<pre>';print_r($conf);exit;
                                    echo $form->field($model, 'pengadilan')->textInput(['value'=>$conf->p_negeri]); 
                                }

                                //if($rp11->no_akta!==''){ ?>
                                   <!--  <input type="hidden" name="status_yakum" value="<?= $rp11->id_status_yakum ?>"> -->
                                    <?php 
                                        //} //exit;
                            ?>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            if($model->isNewRecord){
                                ...
                                echo $form->field($model, $nos)->textInput(['value'=>$val]); 
                            ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                                                   ...
                                                   <div  class="pidana_kurungan_denda" id="pidana_kurungan_denda_<?= $valuex->id.'_'.$nilai->no_urut_tersangka ?>" >
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-md-2" style="width:17%">
                                                              <?= $form->field($modelTerdakwa, 'kurungan_bulan')->textInput(['type' => 'number', 'min' => 0, 'name'=>'PdmP41Terdakwa['.$valuex->id.']['.$nilai->no_urut_tersangka.'][kurungan_bulan][]']); ?>
                                                          </div>
                                                          <label class="control-label col-md-1" style="margin-left:-20px;">Bulan</label>
                                                          <div class="col-md-2" style="margin-left:-30px;width:17%;">
                                                              <?= $form->field($modelTerdakwa, 'kurungan_hari')->textInput(['type' => 'number', 'min' => 0, 'name'=>'PdmP41Terdakwa['.$valuex->id.']['.$nilai->no_urut_tersangka.'][kurungan_hari][]']); ?>
                                                          </div>

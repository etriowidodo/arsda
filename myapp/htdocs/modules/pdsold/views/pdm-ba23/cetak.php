<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/BA-23.docx');
...
//    $docx->replaceVariableByHTML('cara', 'block', $usul_jpu, $arrDocnya);
    ...
    $docx->createDocx('../web/template/pdsold_surat/BA-23');
    $file = '../web/template/pdsold_surat/BA-23.docx';
    if (file_exists($file)) {

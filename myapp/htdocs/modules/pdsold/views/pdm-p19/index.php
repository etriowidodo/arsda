	...
	if(id_berkas != '')
            {
                $.ajax({
                        type        : 'POST',
                        url         :'/pdsold/pdm-p19/get-pengantar-thp1',
                        ...
                        success     : function(data)
                                    {
                                     ...
                                     if(result.count>0)
                                     {
                                      ...
                                      $.each(table,function(i,x){
                                       ...
                                       //  alert(link);
                                        tr  +=  '<tr ondblclick="window.location=\'/pdsold/pdm-p19/update?id_p19='+ x.id_p19+'&id_pengantar='+x.id_pengantar+'&id_berkas='+x.id_berkas+'\'" class="pengantar" >'+

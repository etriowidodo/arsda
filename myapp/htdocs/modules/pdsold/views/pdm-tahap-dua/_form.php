    ...
    <?php
     ...
     if($actual_linkx[5]!=='create'){
        ?>
            ...
            <?= Html::a('Batal', ['/pdsold/pdm-tahap-dua/index'], ['class' => 'btn btn-danger']) ?>
        <?php } ?>
        </div>
        </div>
...
<?php
    ...
    $('.add_saksi').click(function(e){
        ...
        if($('#tr_id'+id_saksi+' td input[type=hidden]').length!=0){
            ...
            if(id_saksi ==''){
                $('#m_saksi').html('');
                $('#m_saksi').load('/pdsold/pdm-tahap-dua/show-saksi');
                $('#m_saksi').modal('show');
            }else{
                $('#m_saksi').html('');
                $('#m_saksi').load('/pdsold/pdm-tahap-dua/show-saksi?id_saksi='+'$model->no_register_perkara|'+id_saksi);
                $('#m_saksi').modal('show');
            }
        ...
        $('#cari_satker').click(function(){
            ...
            $('#m_satker').html('');
            $('#m_satker').load('/pdsold/pdm-tahap-dua/satker?kd='+kode);
            $('#m_satker').modal('show');
        });
        ...
        $('body').on('click','.pilih-pasal',function(e){
           ...
           else
           {
            console.log(value);
                $('#m_pasal').html('');
                $('#m_pasal').load('/pdsold/pdm-tahap-dua/show-pasal?uu='+encodeURI(value));
                $('#m_pasal').modal('show');
           }
        });
        ...
        $('select[name=kode_pidana]').on('change',function(){
                ...
                $.ajax({
                    type: "POST",
                    url: '/pdsold/pdm-tahap-dua/refer-undang',
...
<script>
    function pilihBerkas(id,berkas) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-tahap-dua/create2?id="+id+"&berkas="+berkas;

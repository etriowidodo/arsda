            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <?php
                            $listData = PdmMsStatusData::findAll(['is_group' => ConstDataComponent::PenyerahanBrg22]);
                            $new = array();
...
//                                    ],
    ...
    <div class="box-footer" style="text-align: center;">
        ...
        <?php if (!$model->isNewRecord) : ?>
            <a class="btn btn-warning" href="<?= Url::to(['pdm-ba22/cetak?id=' . $model->id_ba22]) ?>">Cetak</a>
        <?php endif ?>	
    </div>

...
<section class="content" style="padding: 0px;">
    ...
    <div class="box-footer">
        ...
        <?= Html::a('Batal', $model->isNewRecord ? ['../pdsold/pdm-perpanjangan-tahanan/index'] : ['../pdsold/pdm-perpanjangan-tahanan/index'], ['class' => 'btn btn-danger']) ?>
        <!-- END CMS_PIDUM001_16 --> 
    </div>
<div id="hiddenId"></div>
<?php ActiveForm::end(); ?>
...
//End  CMS_PIDUM_SPDP_48 Etrio Widodo
	...
	$('.tambah_calon_tersangka').click(function(e){
		...
		if(href != null){
			...
			$('#m_tersangka').html('');
			$('#m_tersangka').load('/pdsold/pdm-perpanjangan-tahanan/show-tersangka?id_tersangka='+id_tersangka);
    ...
    $('#tersangkaFromSpdp').click(function(){
            $('#m_tersangka').html('');
                $('#m_tersangka2').load('/pdsold/pdm-perpanjangan-tahanan/tersangka');

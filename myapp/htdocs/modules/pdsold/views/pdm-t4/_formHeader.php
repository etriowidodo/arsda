...
<div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;padding:20px 0px;">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label class="control-label col-sm-2">Nomor Surat P-45</label>
            <div class="col-sm-3">
                <?= $form->field($model, 'no_surat_p45')->input('text',
                                ['oninput'  =>'
    ...
    <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="col-sm-4" style="width:40%;"><?= $form->field($model, 'kepada')->textarea(['rows' => 2, 'value' => "Kepala Kejaksaan Tinggi"]) ?></div>
        </div>
    </div>

			...
			<div class="col-md-12">
                ...
                <div class="well well-sm col-md-12 ">
                    <div class="form-inline col-md-12" style="padding:0;">
                        ...
                        <div class="col-md-2" style="font-size:16px;padding-left:0;" >
                            <?php
                             echo Yii::$app->globalfunc->returnDropDownList($form, $model, MsLoktahanan::find()->where('id_loktahanan<>4')->all(), 'id_loktahanan', 'nama', 'id_loktahanan',['disabled' => "disabled"]) ;
                             ?>
                        </div>
                        <div class="col-md-3" style="font-size:16px; ">
                            <?= $form->field($model, 'lokasi')->textInput(['maxlength' => true,'style'=>"width:100%", 'disabled' => "disabled"]) ?> 
                        </div>			
                        <div class="col-md-1">
...
//                            ]);
        ...
        <?= Html::a('Batal', $model->isNewRecord ? ['index'] : ['../pdsold/pdm-t4/index'], ['class' => 'btn btn-danger']) ?>
        <!-- END CMS_PIDUM001_16 --> 
        </div>
    </div>
...
// Etrio Widodo
 ...
 var id_perpanjangan = $(this).val();
            $.ajax({    
                type: "POST",
				dataType: "json",
                url: '/pdsold/pdm-t4/riwayattahanan',

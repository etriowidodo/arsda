...
//                        //$basepath = str_replace('/', '\\', Yii::$app->basePath . '/modules/pdsold/upload_file/ba11/' . $model->uploaded_file);
...
//                    }
    ...
    <div class="box-footer" style="text-align: center;">
        ...
        <?php //echo Html::a('Batal', ['/pdsold/spdp/index'], ['class' => 'btn btn-primary']); ?>
...
<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        $("#pdmba15-no_penetapan").on("change", function(){
            ...
            $.ajax({
                type: "POST",
                url: '/pdsold/pdm-ba15/detail-penetapan',

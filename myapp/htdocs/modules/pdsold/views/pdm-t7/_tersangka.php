...
$(document).ajaxSuccess(function(){
       ...
       $('#id_tersangka-grid-container td ').off('click').click(function(){
                    ...
                    $('#pdmt7-tgl_ba4').val(data.tgl_ba4);
                    $('#pdmt7-no_urut_tersangka').val(data.no_urut_tersangka);
                    $('#pdmt7-nama_tersangka_ba4').val(data.nama);
                    $('#pdmt7-no_surat_perintah').val(data.no_sp_penyidik);
                    $('#pdmt7-tgl_srt_perintah-disp').val(curr_date + "-" + curr_month + "-" + curr_year);
                    $('#pdmt7-tgl_srt_perintah').val(data.tgl_sp_penyidik);

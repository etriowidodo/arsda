...
<div class="pdmt7-index">
    ...
    <?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pdsold/pdm-t7/delete/'
        ]);  
    ?>  
    <div id="divHapus" class="col-md-1">
        <button ype="button" id="apus" class='btn btn-warning '>Hapus</button>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute'=>'no_surat_t7',
                'label' => 'Nomor Surat',
                'format' => 'raw',
                'value'=>function ($model, $key, $index, $widget) {
                    return $model['no_surat_t7'];
                },
...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-t7/update?no_register_perkara=" + no_register_perkara+"&no_surat_t7="+no_surat_t7;

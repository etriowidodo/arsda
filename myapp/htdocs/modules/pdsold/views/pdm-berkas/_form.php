...
?>
        ...
        <?= Html::a('Batal', $model->isNewRecord ? ['index'] : ['../pdsold/pdm-berkas/index'], ['class' => 'btn btn-danger']) ?>
        <!-- END CMS_PIDUM001_16 --> 
        </div>
...
$script = <<< JS
        ...
        var undangPasal = new Bloodhound({
            ...
            remote: {
                url: '/pdsold/default/undang?q=%QUERY',
                wildcard: '%QUERY'
            }
        });
...
$script1 = <<< JS
	...
	$('#popUpTersangka').click(function(){
		$('#m_tersangka').html('');
        $('#m_tersangka').load('/pdsold/pdm-berkas/tersangka');

<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/P-38.docx');
...
//        }
    ...
    if (count($p37) != 0) {
        ...
        $tsk .= '<tr><th width="5%" style="font-family:Times New Roman; font-size:12pt;>No</th> <th width="35%" style="font-family:Times New Roman; font-size:12pt;>Nama Lengkap '.$panggil->keterangan.'<br/>yang dipanggil</th> <th width="40%" style="font-family:Times New Roman; font-size:12pt;>Alamat</th> <th width="20%" style="font-family:Times New Roman; font-size:12pt;>'.$stsket.'</th></tr>';
        $tsk .= '</thead>';
        $tsk .= '<tbody>';
        foreach ($p37 as $rowlistp37) {
            $tsk .= '<tr><td>'.$i.'.</td>
    ...
    $docx->createDocx('../web/template/pdsold_surat/P-38');
    $file = '../web/template/pdsold_surat/P-38.docx';
    if (file_exists($file)) {

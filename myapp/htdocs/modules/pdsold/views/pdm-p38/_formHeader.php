...
<div class="box box-primary" style="border-top-color:#ffb04d;overflow:hidden;padding:20px 0px;">
    ...
    <div class="col-md-12 hide">
        <div class="form-group">
            ...
            <div class="col-sm-3" >
                ...
                <?= $form->field($model, 'dikeluarkan')->hiddenInput(['value' => \Yii::$app->globalfunc->getSatker()->inst_satkerkd])->label(false) ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <?= $form->field($model, 'no_surat_p38')?>
                <?// $form->field($model, 'no_surat_p36')->input('text',
//                                ['oninput'  =>'
...
//                                        this.value=str;
    ...
    <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="col-sm-4" style="width:40%;"><?= $form->field($model, 'kepada')->textarea(['rows' => 2]) ?></div>
        </div>
    </div>

                                                   ...
                                                   <div  class="pidana_kurungan_denda" id="pidana_kurungan_denda_<?= $valuex->id.'_'.$nilai->no_urut_tersangka ?>" >
                                                      <div class="form-group">
                                                          ...
                                                          <div class="col-md-2" style="width:17%">
                                                              <?= $form->field($modelTerdakwa, 'kurungan_bulan')->textInput(['type' => 'number', 'max'=>255, 'min' => 0, 'name'=>'PdmP41Terdakwa['.$valuex->id.']['.$nilai->no_urut_tersangka.'][kurungan_bulan][]']); ?>
                                                          </div>
                                                          <label class="control-label col-md-1" style="margin-left:-20px;">Bulan</label>
                                                          <div class="col-md-2" style="margin-left:-30px;width:17%;">
                                                              <?= $form->field($modelTerdakwa, 'kurungan_hari')->textInput(['type' => 'number', 'max'=>12, 'min' => 0, 'name'=>'PdmP41Terdakwa['.$valuex->id.']['.$nilai->no_urut_tersangka.'][kurungan_hari][]']); ?>
                                                          </div>

<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/P-30.docx');
    ...
    if (count($terdakwa) != 0) {
        ...
        foreach ($terdakwa as $rowqry_p30) {
           $tersangka .= '<tr><td width="5%" height="0%" style="font-family:Times New Roman; font-size:12pt;" >'.$i.'.</td>
                                ...
                                <td width="120%" height="0%" style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["nama"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                ...
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["tmpt_lahir"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Umur/tanggal lahir</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["umur"].'/'.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_lahir"]).'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Jenis kelamin</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["is_jkl"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Kebangsaan/ Kewarganegaraan</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["warganegara1"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Tempat tinggal</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["alamat"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Agama</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["is_agama"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Pekerjaan</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["pekerjaan"].'</td></tr>
                            <tr><td style="font-family:Times New Roman; font-size:12pt;" ></td>
                                <td style="font-family:Times New Roman; font-size:12pt;">Pendidikan</td>
                                <td style="font-family:Times New Roman; font-size:12pt;">: </td>
                                <td style="font-family:Times New Roman; font-size:12pt;">'.$rowqry_p30["is_pendidikan"].'</td></tr>
                                   ';
           $i++;
        }
...
//    if (count($qry_p30) != 0) {
//        $penahanan1 = '<table border="0" width="100%"><tbody>';
//        foreach ($qry_p30 as $rowqry_p30) {
//           $tgl_mulai           = ($rowqry_p30["tgl_mulai_perpanjangan"]=="")?".......................":Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_mulai_perpanjangan"]).' s/d '.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_selesai_perpanjangan"]);
//           $tgl_pengalihan      = ($rowqry_p30["tgl_mulai_pengalihan"]=="" && $rowqry_p30["tgl_selesai_pengalihan"]=="")?"..............................":Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_mulai_pengalihan"]).' s/d '.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_selesai_pengalihan"]);
//           $tgl_penangguhan     = ($rowqry_p30["tgl_penangguhan"]=="")?"..............................":Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_penangguhan"]);
//           $tgl_pencabutan      = ($rowqry_p30["tgl_pencabutan"]=="")?"..............................":Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_pencabutan"]);
//           $tgl_pengeluaran     = ($rowqry_p30["tgl_pengeluaran"]=="")?"..............................":Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_pengeluaran"]);
//           $tgl_rutan           = ($rowqry_p30["lokasi_tahanan"]=="Rutan")?Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_mulai"]).' s/d '.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_selesai"]):"............... s/d ................";
//           $tgl_rumah           = ($rowqry_p30["lokasi_tahanan"]=="Rumah")?Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_mulai"]).' s/d '.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_selesai"]):"............... s/d ................";
//           $tgl_kota           = ($rowqry_p30["lokasi_tahanan"]=="Kota")?Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_mulai"]).' s/d '.Yii::$app->globalfunc->ViewIndonesianFormat($rowqry_p30["tgl_selesai"]):"............... s/d ................";
...
//    $docx->replaceVariableByHTML('penahanan1', 'block', $penahanan1, $arrDocnya);
    ...
    $dakwaan .= '<tr><td width="100%" height="0%" style="font-family:Times New Roman; font-size:12pt;" >'.$p30->catatan.'</td></tr>';
    $dakwaan .= "</tbody></table>";
    $docx->replaceVariableByHTML('dakwaan', 'block',$dakwaan , $arrDocnya);
    
    $docx->replaceVariableByText(array('dikeluarkan'=>$p30->dikeluarkan), array('parseLineBreaks'=>true));
    $docx->replaceVariableByText(array('tgl_dikeluarkan'=>Yii::$app->globalfunc->ViewIndonesianFormat($p30->tgl_dikeluarkan)), array('parseLineBreaks'=>true));
    $docx->replaceVariableByText(array('nama_jpu'=>$p30->nama), array('parseLineBreaks'=>true));
    $docx->replaceVariableByText(array('pangkat_jpu'=>$p30->pangkat), array('parseLineBreaks'=>true));
    $docx->replaceVariableByText(array('nip_jpu'=>$p30->id_penandatangan), array('parseLineBreaks'=>true));
    
    foreach ($uupasal as $rowuupasal ) {
        $pasal  .= $rowuupasal[pasal].", ";
    } 
    $pasal= substr($pasal, 0,-2);
    $docx->replaceVariableByText(array('pasal'=> $pasal), array('parseLineBreaks'=>true));
    
    
    $docx->createDocx('../web/template/pdsold_surat/P-30');
    $file = '../web/template/pdsold_surat/P-30.docx';
    if (file_exists($file)) {

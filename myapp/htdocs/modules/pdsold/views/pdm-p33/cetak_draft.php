<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/P-33-draf.docx');
    ...
    $docx->createDocx('../web/template/pdsold_surat/P-33-draf');
    $file = '../web/template/pdsold_surat/P-33-draf.docx';
    if (file_exists($file)) {

...
<div class="content-wrapper-1">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3" >
                                ...
                                if ($modelCeklis->file_upload != null || $modelCeklis->file_upload != '') {
                                    echo Html::a(Html::img('/image/odt.jpg',['width'=>'30', 'style'=>'margin-left:20px;']), '/template/pdsold_surat/'.$modelCeklis->file_upload,['target'=>'_blank'])."&nbsp;";
                                }
                                ?>
                </div>
                </div>
    ...
    <div class="box-footer" style="text-align: center;">
        ...
        <?= Html::a('Batal', $modelCeklis->isNewRecord ? ['ceklis'] : ['../pdsold/pdm-berkas-tahap1/ceklis'], ['class' => 'btn btn-danger']) ?>

...
<div class="box box-primary keterangan" style="border-color: #f39c12;padding: 15px;overflow: hidden; display:none">
    ...
    <div class="col-md-12 inline pull-right">
      <div class="">
            <?php // echo Html::a('Cetak CekLis', ['/template/pdsold/checklist.odt'], ['class' => 'btn btn-warning']) ?>
...
$js = <<< JS
     $(document).ready(function(){
		...
		$(".select-on-check-all").hide();
         ...
         $('td').dblclick(function (e) {
            ...
            if(id_berkas != '')
            {
                $.ajax({
                        type        : 'POST',
                        url         :'/pdsold/pdm-berkas-tahap1/get-pengantar-thp1',
                        ...
                        success     : function(data)
                                    {
                                     ...
                                     if(result.count>0)
                                     {
                                      ...
                                      $.each(table,function(i,x){
                                       // //var link = "/pdsold/pdm-berkas-tahap1/update?id_berkas=" +x.id_berkas+"&id_pengantar="+x.id_pengantar;
                                       //  alert(link);
                                        tr  +=  '<tr class="pengantar" >'+
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="0" style="width:20%;">'+x.no_pengantar+'<br>'+x.tgl_pengantar+'</td>'+
                                                    /*'<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="1" style="width:10%;">'+x.tgl_pengantar+'</td>'+*/
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="3" style="width: 10%;">'+x.tgl_terima+'</td>'+
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="5" style="width: 10%;">'+x.tgl_selesai+'</td>'+
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="7" style="width: 20%;">'+x.keterangan+'</td>'+
                                      ...
                                      $.each(table,function(i,x){
                                       ...
                                       //  alert(link);
                                        tr  +=  '<tr class="pengantar" >'+
                                                    ...
                                                    /*'<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="1" style="width:10%;">'+x.tgl_pengantar+'</td>'+*/
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="3" style="width: 10%;">'+x.tgl_terima+'</td>'+
                                                    /*'<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="4" style="width: 20%;">'+x.nama_tersangka+'</td>'+*/
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="5" style="width: 10%;">'+x.tgl_selesai+'</td>'+
                                                    '<td ondblclick="window.location=\'/pdsold/pdm-berkas-tahap1/pendapat?id_berkas='+x.id_berkas+'&id_pengantar='+x.id_pengantar+'&id_ceklist='+x.id_ceklist+'\'" data-col-seq="7" style="width: 20%;">'+x.keterangan+'</td>'+
                                                    '<td data-col-seq="6" style="width: 3%;text-align:center">'+
                                                    '<input type="checkbox" class="child-chekbox" value="'+x.id_pengantar+'" data-id="'+x.id_berkas+'" data-idpengantar="'+x.id_pengantar+'" data-idceklist="'+x.id_ceklist+'" >'+
        ...
        $('#idUbah').click(function(){
          ...
          var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-berkas-tahap1/pendapat?id_berkas=" + idbks1+"&id_pengantar=" +id_pengantar+"&id_ceklist=" +id_ceklist;
          $(location).attr('href',url);
        })

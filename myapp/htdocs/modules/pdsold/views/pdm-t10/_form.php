...
<section class="content" style="padding: 0px">
	...
	<?= $this->render('//default/_formFooter', ['form' => $form, 'model' => $model, 'GlobalConst' => GlobalConstMenuComponent::T10, 'id_table' => $model->no_surat_t10]) ?>   
        <div class="box-footer" style="text-align: center;">
            ...
            <?= Html::a('Batal', ['/pdsold/pdm-t10/index'], ['class' => 'btn btn-warning']); ?>
            <?php if(!$model->isNewRecord)
                echo Html::a('Cetak', ['/pdsold/pdm-t10/cetak','id'=>  rawurlencode($model->no_surat_t10)], ['class' => 'btn btn-warning']);
            ?>
        </div>
        <?php ActiveForm::end(); ?>
    </div>

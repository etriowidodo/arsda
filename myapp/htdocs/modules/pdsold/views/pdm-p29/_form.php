                            ...
                            <div class="col-md-12">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-2">Dakwaan</label>
                                        <div class="col-md-10">
                                            <?php// $form->field($model, 'dakwaan')->textarea(['placeholder' => 'Dakwaan','class'=>'ckeditor']); ?>
                                            <?php echo $form->field($model, 'dakwaan')->textarea() ?>
                                                ...
                                                $this->registerJs("
                                                        CKEDITOR.inline( 'PdmP29[dakwaan]');
...
//            echo Html::a('Cetak', ['cetak', 'id' => rawurlencode($model->no_surat_p26)], ['class' => 'btn btn-warning']);?>
            <a class="btn btn-warning" href="<? echo Url::to(["pdm-p29/cetak?id=".$model->no_register_perkara]) ?>">Cetak</a>
        <?php endif ?>	
        <a class="btn btn-warning" href="<? echo Url::to(["pdm-p29/cetak?id=".$model->no_register_perkara]) ?>">Cetak Draft</a>
        <?php  //} else {
//            echo $form->field($modeljaksi, 'nip')->hiddenInput();
//            echo $form->field($modeljaksi, 'nip')->hiddenInput();
//            echo $form->field($modeljaksi, 'jabatan')->hiddenInput();

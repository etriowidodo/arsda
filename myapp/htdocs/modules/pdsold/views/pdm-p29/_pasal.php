...
<script>
    ...
    $('select[name=kode_pidana1]').on('change',function() {
        ...
        $.get( "/pdsold/pdm-tahap-dua/show-pasal-dg-kode-pidana",{kode_pidana:var_kode_pidana,id_uu:var_id_uu} ,function( data ) {
    ...
    $('select[name=jenis_perkara1]').on('change',function() {
        ...
        $.get( "/pdsold/pdm-tahap-dua/show-pasal-dg-kode-pidana",{kode_pidana:var_kode_pidana,id_uu:var_id_uu,jenis_perkara:var_jenis_perkara} ,function( data ) {
            $('#m_pasal').html(data).show();
            console.log(data);
        });
    });

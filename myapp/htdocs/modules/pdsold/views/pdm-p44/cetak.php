<?php
    ...
    $docx   = new CreateDocxFromTemplate('../web/template/pdsold/p44.docx');
    ...
    foreach ($tersangka as $key => $value) {
        ...
        //$bukti ='';
        //echo '<pre>';print_r($id_pasal);exit;
        ...
        if(!empty($tersangka->undang_undang_pn)){
    ...
    $docx->createDocx('../web/template/pdsold_surat/p44');
    $file = '../web/template/pdsold_surat/p44.docx';
    if (file_exists($file)) {

	...
	<div class="box-header with-border">
     ...
     if (!$modelpenyidik->isNewRecord) {
       ...
       <tr id='trJPU'>
        ...
        <td id='tdJPU'><input type='text' name='pangkat[]' id='pangkat' value='<?= $value->pangkat ?>' style='width:150px;' readonly='true' class='form-control' readonly='true'></td>
        <td id='tdJPU'><input type='text' name='jabatan[]' id='jabatan' value='<?= $value->jabatan ?>' style='width:350px;' readonly='true' class='form-control' readonly='true'></td> 
...
<div class="form-group">
	...
	<div class="box-header with-border">
  	...
  	<h3 a class="btn btn-primary addJPU2" id="popUpJpu" data-toggle="modal" data-target="#_jpu">Jaksa Saksi</a></h3>
        ...
        <td id='tdJPU2'><input type='text' name='txtpangkat[]' id='txtpangkat' value='<?= $value->pangkat ?>' style='width:150px;' readonly='true' class='form-control' readonly='true'></td>
        <td id='tdJPU2'><input type='text' name='txtjabatan[]' id='txtjabatan' value='<?= $value->jabatan ?>' style='width:350px;' readonly='true' class='form-control' readonly='true'></td>
		</tr>
        <?php
        }
        }
	...
	<?php if(!$model->isNewRecord): ?>
		<a class="btn btn-warning" href="<?= \yii\helpers\Url::to(['pdm-ba2/cetak?id_perkara='.$model->id_perkara.'&id_ba2='.$model->id_ba2])?>">Cetak</a>
	<?php endif ?>	
    </div>
    <?php ActiveForm::end(); ?>
        ...
        $('#pilih-jpu').click(function () {
            $('input:checkbox:checked').each(function (index) {
                ...
                $('#gridJPU').append(
                        ...
                        '<td><input type="text" class="form-control" name="txtpangkat[]" readonly="true" style="width:150px;" value="' + data[2] + '"> </td>' +
                        '<td><input type="text" class="form-control" name="txtjabatan[]" readonly="true" style="width:350px;" value="' + data[3] + '"> </td>' +
...
function pilihJPU(nip, nama, jabatan, pangkat) {
        ...
        $('#gridJPU1').append(
                ...
                "<td id='tdJPU1" + i + "'><input type='text' name='pangkat[]' id='pangkat' value='" + pangkat + "' style='width:150px;' readonly='true' class='form-control' readonly='true'></td>" +
                "<td id='tdJPU1" + i + "'><input type='text' name='jabatan[]' id='jabatan' value='" + jabatan + "' style='width:350px;' readonly='true' class='form-control' readonly='true'></td>" +
                "</tr>"
                );
        i++;

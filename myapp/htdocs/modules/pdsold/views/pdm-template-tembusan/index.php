...
<div class="pdm-template-tembusan-index">
	...
	<?php
       $form = \kartik\widgets\ActiveForm::begin([
            'id' => 'hapus-index',
            'action' => '/pdsold/pdm-template-tembusan/delete/'
        ]);  
    ?>
...
<?php
    ...
    $js = <<< JS
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-template-tembusan/update?id_tmp_tembusan=" + idtmptembusan;
	...
	$('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-template-tembusan/update?id_tmp_tembusan="+id;
        $(location).attr('href',url);
		//alert(count);
		}
    });

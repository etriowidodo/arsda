<?php
	...
	$docx = new CreateDocxFromTemplate('../web/template/pdsold/BA-8.docx');
	...
	$docx->replaceVariableByText(array('no_reg_tahanan'=>$model['no_reg_tahanan']), array('parseLineBreaks'=>true));
	...
	$docx->replaceVariableByText(array('tmt'=>Yii::$app->globalfunc->ViewIndonesianFormat($model['tgl_mulai'])), array('parseLineBreaks'=>true));
	...
	$docx->replaceVariableByText(array('kepala_rutan'			=> $modelba8['kepala_rutan']), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('hari'=>Yii::$app->globalfunc->GetNamaHari($model['tgl_ba4'])), array('parseLineBreaks'=>true));
	$split = explode("-",$modelba8['tgl_ba8']);
	$docx->replaceVariableByText(array('tgl_ba4'=>Yii::$app->globalfunc->ViewIndonesianFormat($modelba8['tgl_ba8'])), array('parseLineBreaks'=>true));
	...
	$docx->replaceVariableByText(array('lama'=>$modelba8['lama']), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('pasal'=>$varUU), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('tahanan'=>MsLoktahanan::findOne(['id_loktahanan' =>$modelba8['tahanan']])->nama), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('ke_tahanan'=>MsLoktahanan::findOne(['id_loktahanan' =>$modelba8['ke_tahanan']])->nama), array('parseLineBreaks'=>true));

	$docx->replaceVariableByText(array('nama_jaksa'=>$modelJaksa['nama']), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('nip_jaksa'=>$modelJaksa['nip']), array('parseLineBreaks'=>true));
	$docx->replaceVariableByText(array('pangkat_jaksa'=>$modelJaksa['pangkat']), array('parseLineBreaks'=>true));
	// 	$no=0;
	// 	$tembusan_surat = "";
	...
	$docx->createDocx('../web/template/pdsold_surat/ba-8');
	$file = '../web/template/pdsold_surat/ba-8.docx';
	// echo $file;exit;

    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value'=>function ($model, $key, $index, $widget) {
                    return date("d-m-Y", strtotime($model->tgl_ba10));
                },
            ...
            [
                'class'=>'kartik\grid\CheckboxColumn',
                    ...
                    'checkboxOptions' => function ($model, $key, $index, $column) {
                        return ['value' =>$model->id_tersangka.'#'.$model->tgl_ba10, 'class' => 'checkHapusIndex'];
                    }
            ],
        ],
        'export' => false,
...
<?php
    ...
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-ba10/update?id_tersangka=" +id_tersangka+"&no_register_perkara="+no_register_perkara;
        //alert(url);exit;

...
<?php
    $js = <<< JS
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-p31/update?id="+id;
    ...
    $( "input" ).change(function(e) {
        ...
        if(input.prop( "checked" ) == true){
            ...
            // );
            // $('#btnUpdate').html(
            //     "<a href='/pdsold/p31/update?id="+e.target.value+"' class='btn btn-primary ubah'>Ubah</a>"
            // );
            $('#divHapus').append(

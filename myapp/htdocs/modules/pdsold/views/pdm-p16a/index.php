    ...
    <div class="clearfix"><br><br></div>
        ...
        GridView::widget([
            ...
            //                        return Url::to(['user/my-action']);
                ...
                ?>
    <?php $form = ActiveForm::begin(['action' => '/pdsold/pdm-p16a/unggah/','options' => ['enctype' => 'multipart/form-data']]) ?>
...
<?php
    $js = <<< JS
		...
		bootbox.dialog({
                ...
                var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-p16a/update?id="+id;

                    ...
                    [
                        ...
                        'buttons' => [
                            'select' => function ($url, $model) {
                                return Html::checkbox('pilih', false, ['value' => $model['nip'].'#'.$model['nama'].'#'.$model['pangkat'].'#'.$model['jabatan']]);
                            },
                        ]
                    ],
                ],                   
...
$this->registerJs(\yii\web\View::POS_BEGIN);
        $js = <<< JS
                $("#m_jpu").attr('data-backdrop', 'static');
		$("#m_jpu").attr('data-keyboard', false);
        ...
        $('#pilih-jpu').click(function () {
           ...
           /*$('input:checkbox:checked').each(function (index) {  perubahan di line 70 */
            $.each(clickJaksaBaru,function (index,value) {
                ...
                if(jQuery.inArray(data[0], nipBaruValue) > -1) {
                    ...
                    $('#tbody_jpu').append(
                        ...
                        '<td>'+data[1]+'<br>'+data[0]+'<input type="hidden" class="form-control" name="nama_jpu[]" readonly="true" value="' + data[1] + '"><input type="hidden" class="form-control" name="nip_baru[]" readonly="true" value="' + data[0] + '"> </td>' +

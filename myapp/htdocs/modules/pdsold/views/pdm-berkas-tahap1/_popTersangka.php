...
//BEGIN CMS_PIDUM_SPDP_001
 //<!-- BEGIN CMS_PIDUM001_13 ETRIO WIDODO -->  
    $('#mstersangkaberkas-warganegara').click(function(){
        ...
        $('#m_kewarganegaraan').load('/pdsold/pdm-berkas-tahap1/wn');
 ...
 //<!-- END CMS_PIDUM001_13 ETRIO WIDODO -->
    ...
    function edit_tersangka(id)
    {
		...
		$('#m_tersangka').html('');
		$('#m_tersangka').load('/pdsold/pdm-berkas-tahap1/show-tersangka?id_tersangka='+id_tersangka);
	...
	function prosesSimpantersangka(flag){
       ...
       if($("#mstersangkaberkas-nama").val()!=''){
        ...
        if(countEmptyValue >=14 )    
        {
                    ...
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][nama][]" value="'+nama+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][id_tersangka][]" value="'+currentValue+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][tmpt_lahir][]" value="'+$('#mstersangkaberkas-tmpt_lahir').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][tgl_lahir][]" value="'+$('#mstersangkaberkas-tgl_lahir-disp').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][umur][]" value="'+parseInt(umur)+'" class="form-control tersangka'+ currentValue +'">' +                  
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][id_jkl][]" value="'+jekel+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][alamat][]" value="'+$('#mstersangkaberkas-alamat').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][id_identitas][]" value="'+$('#mstersangkaberkas-id_identitas').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][no_identitas][]" value="'+$('#mstersangkaberkas-no_identitas').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][no_hp][]" value="'+$('#mstersangkaberkas-no_hp').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][id_agama][]" value="'+$('#mstersangkaberkas-id_agama').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][warganegara][]" attr-id="'+$('#mstersangkaberkas-warganegara').val()+'" value="'+wn+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][pekerjaan][]" value="'+$('#mstersangkaberkas-pekerjaan').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][suku][]" value="'+$('#mstersangkaberkas-suku').val()+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][id_pendidikan][]" value="'+$('#mstersangkaberkas-id_pendidikan').val()+'" class="form-control tersangka'+ currentValue +'">'+
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][unix][]" value="'+currentValue+'" class="form-control tersangka'+ currentValue +'">' +
                    '<input type="hidden" name="MsTersangkaBaru['+currentValue+'][no_urut][]" value="'+$('#mstersangkaberkas-no_urut').val()+'" class="form-control tersangka'+ currentValue +'">' +unix_tersangka+
                     '</td>' +
                        '<td>' +
    ...
    $('#m_tersangka2').html('');
    $('#m_tersangka2').load('/pdsold/pdm-berkas-tahap1/refer-tersangka');

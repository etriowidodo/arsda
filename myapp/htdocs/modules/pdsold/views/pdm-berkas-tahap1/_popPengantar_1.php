...
<div class="modal-content" style="width:95%;margin: 2% auto;">
    <div class="modal-header">
	Pengantar Berkas Tahap 1
    </div>
	...
	<div class="col-md-12" style="padding:0">
		...
		<div class="col-md-12" style="padding:0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8" style="width:60%;">
                        <input class="form-control" id="no_berkas_popup" readOnly="true">
                    </div>
			...
			<div class="col-md-6" style="width:50%;">
                <div class="form-group">
                    ...
                    <div class="col-md-9"  style="width:25%;">
                             <input class="form-control" id="tgl_berkas_popup" readOnly="true">
			   ...
			   <table id="table_tersangka" class="table table-bordered">
                    ...
                    <tbody id="tbody_tersangka">
                        <?php if (!$model->isNewRecord):?>
                            ...
                            <?php foreach ($modelTersangka2 as $key2 => $value2): ?>
                                <tr data-id="<?= $value2['id_tersangka'] ?>">
									<td id="tdTRS" width="20px"><input type='checkbox' name='tersangka[]' class='hapusTersangka' id='hapusTersangka' value="<?= $value2['id_tersangka'] ?>"></td>
                                    <input type="hidden" name="no_urut[]" class="form-control" value="<?= ($value2['no_urut'] != null) ? $key+1:$value2['no_urut'] ?>" style="width: 50px;">
                                    <td><input type="hidden" name="nama_tersangka[]" class="form-control" readonly="true"style="border:none; background-color:transparent;" value="<?= $value2->nama ?>">
									<a href="#<?php echo $value2['id_tersangka'] ;?>" class="edit_tersangka" >
									<?= $value2->nama ?> </a>
									<input type="hidden" name="id_tersangka[]" class="form-control" readonly="true" value="<?= $value2->id_tersangka ?>"></td>
									<td><input type="text" name="tmpt_lahir_tersangka[]" class="form-control" readonly="true" style="border:none; background-color:transparent;" value="<?php echo  $value2->tmpt_lahir.', '.date('d-m-Y',strtotime($value2->tgl_lahir)) ?>"></td>
									<td><input type="text" name="umur_tersangka[]" class="form-control" readonly="true" style="border:none; background-color:transparent;" value="<?= $value2->umur ?>"></td>
                            ...
                            <div class="col-md-12" style="background-color:whitesmoke; margin-right:10px">
								...
								<?php // if ($model->isNewRecord):?>
                                    <div class="col-md-12 " style="padding-right:0px">
                                            ...
                                            <div class="col-sm-11">
                                                <div class="form-group">
                                                  ...
                                                  <div class="input-group col-md-10" >
                                                     <input type="text" readOnly placeholder="Undang-Undang" attr-id='' value="" class="form-control undang-undang" name="MsUndang[undang][]">
                                                ...
                                                <div class="input-group col-md-10">
                                                    <input type="text" readOnly placeholder="Pasal Undang-Undang" value=""  class="form-control pasal-undang-undang" name="MsUndang[pasal][]">
                                                    <div class="input-group-btn">
										...
										<a class="btn btn-app btn-warning delete-undang-undang hidden" style="background-color:orange;color:white">
									...
									<!-- EDIT Undang-undang -->
									<?php /*if (!$model->isNewRecord):?>
									<?php foreach ($modelUuTahap1 as $keyUU => $valueUU): ?>
									<div class="col-md-12 " style="padding-right:0px">
                                         <div class="form-group field-mspedoman-uu">									 										    
                                            <div class="col-sm-11">
                                                <div class="input-group" style="padding-bottom:5px">
                                                   <input type="text" placeholder="Undang-Undang" class="form-control undang-undang" name="MsUndang[undang][]" value="<?= $valueUU->undang ?>">
                                                    <div class="input-group-btn">
                                                        <a class="btn btn-warning pilih-undang" href="/pdsold/ms-pedoman/create" data-toggle="modal" data-target="#_undang">Pilih</a>
                                                    </div>
                                                </div>
                                                <div class="input-group" style="padding-bottom:5px">
                                                    <input type="text" placeholder="Pasal Undang-Undang" class="form-control pasal-undang-undang" name="MsUndang[pasal][]" value="<?= $valueUU->pasal ?>">
                                                    <div class="input-group-btn">
                                                        <a class="btn btn-warning pilih-pasal" href="javascript:void(0)">Pilih</a>
                                                    </div>
                                                </div>
												...
												if($valueUU->dakwaan == $isi[0]){
												echo '<option  selected  value="'.$isi[0].'" >'.$isi[1].'</option>';
												}
												else{
												echo'<option value="'.$isi[0].'">'.$isi[1].'</option>';
												}
												}
												?>
...
<hr style="border-color: #c7c7c7;margin: 10px 0;">
    ...
    <div class="box-footer" style="text-align: center;"> 
        <?php if($model->isNewRecord): ?>
                <a class="btn btn-warning" id="simpan-pengantar">Simpan</a> 
            <?php else: ?>
                <a class="btn btn-warning" id="ubah-pengantar">Ubah</a> 
            <?php endif; ?>
...
$('#popUpTersangka').click(function(){
	...
	function edit_pengantar(id)
    {
       ...
       // $('body').append(localStorage.content_undang);
		...
		$('#pengantar').html('');
		$('#pengantar').load('/pdsold/pdm-berkas-tahap1/show-pengantar?id_pengantar='+id_pengantar);
...
$('body').off('click').on('click','.delete-undang-undang',function(e){
...
$('body').on('click','.pilih-pasal',function(e){
   ...
   else
   {
    console.log(value);
        $('#m_pasal').html('');
        $('#m_pasal').load('/pdsold/pdm-berkas-tahap1/show-pasal?uu='+encodeURI(value));
        $('#m_pasal').modal('show');
   }
});
$('#_undang div div div button.close').hide();
function pilihUU(id,aa,isi)
{
     $('input.undang-undang:eq('+localStorage.indexUndang+')').val(isi);
     $('input.undang-undang:eq('+localStorage.indexUndang+')').attr('attr-id',id);
    $("#pengantar").css('overflow-y','scroll');
    $('#_undang').modal('hide');
}
...
<script>
    $('select[name=kode_pidana]').on('change',function(){
        ...
        $.ajax({
    		type: "POST",
    		url: '/pdsold/pdm-berkas-tahap1/refer-undang',

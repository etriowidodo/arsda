...
$this->title = 'LP-9';
$this->subtitle = 'LAPORAN PENGHENTIAN PENUNTUTAN/PENYAMPINGAN PERKARA';
        ...
        <div class="box box-primary" style="border-color: #f39c12;">
            <div class="box-header with-border" style="border-color: #c7c7c7;">
                <h3 class="box-title" style="margin-top: 5px;">
                    <strong>LAPORAN PENGHENTIAN PENUNTUTAN/PENYAMPINGAN PERKARA</strong>
                </h3>
            </div>

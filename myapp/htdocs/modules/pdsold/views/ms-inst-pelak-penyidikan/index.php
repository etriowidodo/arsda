...
<div class="inline">
        <a class='btn btn-warning'  href="/pdsold/ms-inst-pelak-penyidikan/create" title="Tambah Penerimaan SPDP">
...
$js = <<< JS
    $('td').dblclick(function (e) {
        ...
        {
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/ms-inst-pelak-penyidikan/update?kode_ip="+ip+"&kode_ipp="+id;
    ...
    $('#idUbah').click (function (e) {
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/ms-inst-pelak-penyidikan/update?kode_ip="+ip+"&kode_ipp="+ipp;
        $(location).attr('href',url);
        }
    });
...
$('#idHapus').on('click',function(){
   ...
   $('button').on('click',function(){
    ...
    if(click==0)
    {
       ...
       $.ajax({
            type        : 'POST',
            url         :'/pdsold/ms-inst-pelak-penyidikan/delete',
            data        : send,                 

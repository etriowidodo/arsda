...
use app\modules\pdsold\models\PdmD4Search;
...
<div class="pdm-d4-index">
    ...
    GridView::widget([
        ...
        var url = window.location.protocol + "//" + window.location.host + "/pdsold/pdm-d4/update?no_surat="+idb1;

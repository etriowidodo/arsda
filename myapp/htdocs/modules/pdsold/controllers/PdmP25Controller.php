...
use app\modules\pdsold\models\PdmP25Search;
...
use app\modules\pdsold\models\PdmDasarKeputusan;
use app\modules\pdsold\models\PdmTemplateBerkas;
...
*/                    
    ...
    public function actionCetak($id_p25){
        ...
        $odf = new \Odf(Yii::$app->params['report-path']."modules/pdsold/template/p25.odt");

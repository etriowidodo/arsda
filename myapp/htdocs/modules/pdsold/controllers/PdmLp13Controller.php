...
class PdmLp13Controller extends Controller
{
 ...
 public function actionCetak()
    {
        ...
        $odf = new \Odf(Yii::$app->params['report-path']."modules/pdsold/template/lp13.odt");

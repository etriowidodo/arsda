...
use app\modules\pdsold\models\PdmRencanaDakwaan;
...
use app\modules\pdsold\models\PdmRencanaDakwaanSearch;
    ...
    public function actionUpdate($id_rencana_dakwaan,$id_berkas) {
       ...
       // $sysMenu = PdmSysMenu::findOne(['kd_berkas' => GlobalConstMenuComponent::P29]);
        ...
        if (empty($model->id_perkara)) {
            $this->redirect('/pdsold/spdp/index');
        }
...
//print_r($model);exit;
    ...
    public function actionCetak($id){
        ...
        $odf = new \Odf(Yii::$app->params['report-path']."modules/pdsold/template/rencana.odt");

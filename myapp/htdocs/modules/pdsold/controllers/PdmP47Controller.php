...
use app\modules\pdsold\models\PdmTembusanP47;
use app\modules\pdsold\models\PdmP47Search;
...
->where ("id_p47='".$id."'")
->one(); 
        $odf = new Odf(Yii::$app->params['report-path'] . "modules/pdsold/template/p47.odt");

...
use Yii;
use app\modules\pdsold\models\PdmBa19;
use app\modules\pdsold\models\PdmBa19Search;
use yii\db\Query;
...
where a.id_perkara = '".$id_perkara."' ";
    ...
    {
		$odf = new \Odf(Yii::$app->params['report-path']."modules/pdsold/template/ba19.odt");

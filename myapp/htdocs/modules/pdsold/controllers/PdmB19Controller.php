...
use app\modules\pdsold\models\PdmTembusanB19;
use app\modules\pdsold\models\PdmBarbukLelang;
...
//        print_r($id);exit();
    ...
    public function actionCetak1($id) {
        $connection = \Yii::$app->db;
        $odf = new Odf(Yii::$app->params['report-path'] . "modules/pdsold/template/b19.odt");

...
use Odf;
use Yii;
use app\modules\pdsold\models\VLaporanP4;
use app\modules\pdsold\models\VLaporanP4Search;
use yii\db\Query;
...
//print_r ($laporan);exit;
        ...
        $odf = new Odf(Yii::$app->params['report-path'] . "modules/pdsold/template/lp4.odt");

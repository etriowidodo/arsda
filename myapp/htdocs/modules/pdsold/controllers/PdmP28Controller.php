...
use app\modules\pdsold\models\PdmSidang;
use app\modules\pdsold\models\VwTerdakwa;
use app\modules\pdsold\models\PdmP28Search;
...
//        return $this->redirect('update');
    ...
    {
        $odf = new \Odf(Yii::$app->params['report-path']."modules/pdsold/template/p28.odt");

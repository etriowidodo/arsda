...
(function ($) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) Melebihi batas ukuran maksimal <b>{maxSize} KB</b>. Upload file lain!',
        ...
        msgInvalidFileExtension: 'Format File "{name}". Tidak sesuai, hanya format "{extensions}" yang didukung.',

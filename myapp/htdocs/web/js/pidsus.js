$(function(){
	...
	$.fn.modal.Constructor.prototype.enforceFocus = function(){
		...
		.on('focusin.bs.modal', function(e){
			if(thismodal.$element[0] !== e.target && !thismodal.$element.has(e.target).length && !$(e.target).hasClass('select2-search__field') && !$(e.target).hasClass('ui-datepicker-year') && !$(e.target).hasClass('ui-datepicker-month')){
				thismodal.$element.trigger('focus');
			}
		});
	}

	$(document).on("keyup blur input", ".chars-only", function(){ 

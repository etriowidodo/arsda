...
$reportFunction->getTersangkaDik($odf,$isi10,$connection);
...
//print_r($row);
// We export the file
$jenisKapital = strtoupper($isi9);
$odf->setVars('ISI9', $jenisKapital);
$odf->exportAsAttachedFile('P15.odt');

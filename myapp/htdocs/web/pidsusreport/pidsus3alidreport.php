...
$odf = new odf("pidsus3alidreport.odt");
...
if ($isi9 != 'ditindaklanjuti dengan dikirim ke instansi atau unit lain') {
	$odf->setVars('isi10', '');
}
//$isi1 = $isi1.'tes';
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 3A Setelah Penyelidikan.odt');

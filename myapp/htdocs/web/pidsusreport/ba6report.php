...
// get info terdakwa
$query="select nama_tersangka from pidsus.pds_tut_tersangka where id_pds_tut_tersangka = ('".$isi9."');";//query to get form's basic setup
//echo $query;
$row = $connection->createCommand($query)->queryOne();
...
$odf->exportAsAttachedFile('BA 6.odt');

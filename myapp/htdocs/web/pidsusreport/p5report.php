...
QRcode::png(($row['id_satker'].'.PDS.P-5.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('P5.odt');

...
$reportFunction->getTtdSuratJaksaTut($odf,$_GET['id'],$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Alasan',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Pasal',$connection);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('P26.odt');

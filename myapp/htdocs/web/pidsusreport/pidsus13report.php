...
$odf = new odf("pidsus13report.odt");
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-13.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 13.odt');

...
$odf = new odf("pidsus11report.odt");
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-11.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 11.odt');

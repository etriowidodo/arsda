...
$odf = new odf("pidsus15report.odt");
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-15.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 15.odt');

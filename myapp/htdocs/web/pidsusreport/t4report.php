...
$reportFunction->getTersangkaDik($odf,$isi1,$connection);
...
$temp_date = date_create($isi_8);

if ($isi11 =='8 Hari')
{
    $temp_date->add(new DateInterval('P8D'));
}
else
{
    $temp_date->add(new DateInterval('P40D'));
}
$isi_9 =  date_format($temp_date, 'Y-m-d');
$isi_9 = $reportFunction->getIdDate($isi_9);
$odf->setVars('isi9',$isi_9);
...
$odf->exportAsAttachedFile('T4 (Tahap Penyidikan).odt');

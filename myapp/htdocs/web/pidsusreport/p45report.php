...
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Menyatakan',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Menuntut',$connection);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('P45.odt');

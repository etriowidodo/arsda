...
$reportFunction->getSuratDetailDiknoNomor($odf,$_GET['id'],'AlasanLelang',$connection,'AL');
$reportFunction->getSuratDetailDikHurup($odf,$_GET['id'],'AlasanLelang',$connection);
$reportFunction->getSuratDetailUraian($odf,$_GET['id'],'Penyitaan',$connection );
...
$umur = $reportFunction->getUmur($isi_10);
$odf->setVars('umur', $umur);
//echo $umur;
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('B12.odt');

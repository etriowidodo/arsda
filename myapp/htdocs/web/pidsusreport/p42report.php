...
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'KeteranganSaksi',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'KeteranganAhli',$connection);
...
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'KeteranganTerdakwa',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'BarangBukti',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'UnsurPasal',$connection);

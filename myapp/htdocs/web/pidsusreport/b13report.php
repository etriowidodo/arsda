...
$reportFunction->getSuratDetailDikHurupFromJenisSurat($odf,$_GET['id'],'AlasanLelang',$connection,'b12');
...
//print_r($row);
// We export the file
$AwalKapital = ucfirst(strtolower($row['kepada']));
$odf->setVars('Kepada', $AwalKapital);
$odf->exportAsAttachedFile('B13.odt');

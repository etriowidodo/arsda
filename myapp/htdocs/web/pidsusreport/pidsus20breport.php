...
$odf = new odf("pidsus20breport.odt");
...
//$reportFunction->getSuratDetailDik($odf,$_GET['id'],'Petunjuk',$connection);
...
$query="select * from pidsus.get_data_jaksa('".$isi10."');";//query to get form's basic setup
//echo $query;
$row = $connection->createCommand($query)->queryOne();
...
//print_r($row);
// We export the file
$isi1hari =$reportFunction->getNamaHari($isi7);
$odf->setVars('nama_hari', $isi1hari);
$odf->exportAsAttachedFile('Pidsus 20B.odt');

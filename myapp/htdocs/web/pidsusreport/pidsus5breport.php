...
$odf = new odf("pidsus5breport.odt");
...
$reportFunction->getBantuanPemanggilan($odf,$_GET['id'],$connection);
...
//$odf->setVars('lokasi_satker', $row['lokasi_satker']);
...
//$odf->setVars('jabatan_ttd', strtoupper($row['jabatan_ttd']));
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-5B.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
$odf->exportAsAttachedFile('Pidsus 5B.odt');

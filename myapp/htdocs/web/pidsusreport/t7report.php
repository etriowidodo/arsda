...
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Dasar',$connection);
...
// get info jaksa 
$query="select * from pidsus.get_data_jaksa('".$isi11."');";//query to get form's basic setup
//echo $query;
$row = $connection->createCommand($query)->queryOne();
...
//print_r($row);
// We export the file
$jenisKapital = strtoupper($isi10);
$odf->setVars('ISI10', $jenisKapital);
$odf->exportAsAttachedFile('T7.odt');

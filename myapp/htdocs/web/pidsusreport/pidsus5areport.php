...
$odf = new odf("pidsus5areport.odt");
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-5A.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
$odf->setVars('isi1hari', $isi1hari);
//echo $i;
//echo $isi1;
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 5A.odt');

...
$odf = new odf("pidsus3blidreport.odt");
...
QRcode::png(($row['id_satker'].'.PDS.Pidsus-3B.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 3B Setelah Penyelidikan.odt');

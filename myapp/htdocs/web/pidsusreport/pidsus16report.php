...
$odf = new odf("pidsus16report.odt");


$reportFunction=new reportFunction();
$connection=$reportFunction->openConnection();
//$reportFunction->getUsulanPermintaan($odf,$_GET['id'],$connection);
$reportFunction->getSuratIsiDik($odf,$_GET['id'],$connection);
$reportFunction->getSuratTargetPemanggilanDik($odf,$_GET['id'],$connection);
$reportFunction->getSuratPenyitaanDik($odf,$_GET['id'],$connection);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 16.odt');

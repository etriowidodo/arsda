...
$reportFunction->getSuratJaksaSaksiDik($odf,$_GET['id'],$connection);
...
//$umurSaksi = $reportFunction->getUmur($isi_6);
//$odf->setVars('umur_saksi', $umurSaksi);
$odf->exportAsAttachedFile('BA 3.odt');

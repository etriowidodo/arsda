...
$odf = new odf("pidsus33areport.odt");
...
$reportFunction->getTersangkaDik($odf,$isi11,$connection);
//$reportFunction->getUsulanPemanggilanDik($odf,$_GET['id'],$connection);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 33A.odt');

...
$reportFunction->getSuratSaksiTut($odf,$_GET['id'],$connection);
...
//print_r($row);
// We export the file
$isi1hari =$reportFunction->getNamaHari($isi4);
$odf->setVars('nama_hari', $isi1hari);
$isi1hari =$reportFunction->getUmur($tgl_lahir);
$odf->setVars('umur', $isi1hari);
$odf->exportAsAttachedFile('P37.odt');

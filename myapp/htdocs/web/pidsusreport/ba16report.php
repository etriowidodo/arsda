...
//$reportFunction->getTersangkaDik($odf,$isi4,$connection);
//$reportFunction->getSuratSaksiLid($odf,$_GET['id'],$connection);
$reportFunction->getSuratJaksaDik($odf,$_GET['id'],$connection);
$reportFunction->getSuratDetailDik($odf,$_GET['id'],'Penggeledahan',$connection );
$reportFunction->getSuratDetailDik($odf,$_GET['id'],'Penyitaan',$connection );
...
$odf->setVars('jabatan', $row['jabatan_ttd']);
...
$odf->exportAsAttachedFile('BA 16.odt');

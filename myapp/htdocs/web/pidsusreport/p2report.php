...
$reportFunction->getSuratDetail($odf,$_GET['id'],'Dasar',$connection);
$reportFunction->getSuratDetail($odf,$_GET['id'],'Pertimbangan',$connection);
$reportFunction->getSuratDetail($odf,$_GET['id'],'Untuk',$connection);
...
QRcode::png(($row['id_satker'].'.PDS.P-2.'.$row['no_surat']), $qrtemplate, $errorCorrectionLevel, $matrixPointSize, 2);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('P2.odt');
//MSM Change Code CMS_PIDSUS001_06
// ~~~~~ QR Code by Danar 11 mei 2016 ~~~~~~

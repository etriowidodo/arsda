...
$reportFunction->getDataSurat($odf,$isi2,$connection,'dik');
...
if ($isi_5>260)
{
	$odf->setVars('putusan',$isi6." Nomor ".$isi7." Tanggal ".$isi8);
	$odf->setVars('isi6', '');
	$odf->setVars('isi7', '');
	$odf->setVars('isi8', '');
	//echo "tes";
...
$odf->exportAsAttachedFile('BA 20.odt');

...
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'KetSaksi',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'KetAhli',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Surat',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Petunjuk',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Tersangka',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Bukti',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Hukum',$connection);
$reportFunction->getSuratDetailTut($odf,$_GET['id'],'Kesimpulan',$connection);
...
//print_r($row);
// We export the file
$isi1hari =$reportFunction->getNamaHari($isi1);
$odf->setVars('hari_surat', $isi1hari);
$odf->exportAsAttachedFile('BA 5.odt');

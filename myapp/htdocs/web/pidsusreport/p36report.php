...
$reportFunction->getSuratTersangkaTut($odf,$_GET['id'],$connection);
...
//print_r($row);
// We export the file
$isi1hari =$reportFunction->getNamaHari($isi3);
$odf->setVars('nama_hari', $isi1hari);
$odf->exportAsAttachedFile('P36.odt');

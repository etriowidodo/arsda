...
//$reportFunction->getSuratDetailDik($odf,$_GET['id'],'Alasan',$connection);
...
//print_r($row);
// We export the file
$AwalKapital = ucfirst(strtolower($isi4));
$odf->setVars('isi4', $AwalKapital);
$odf->exportAsAttachedFile('B14.odt');

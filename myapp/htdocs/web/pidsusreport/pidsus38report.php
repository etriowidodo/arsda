...
$odf = new odf("pidsus38report.odt");
...
// get info jaksa penyidik
$query="select nama_tersangka from pidsus.pds_tut_tersangka where id_pds_tut_tersangka =('".$isi10."');";//query to get form's basic setup
//echo $query;
$row = $connection->createCommand($query)->queryOne();
...
$odf->exportAsAttachedFile('Pidsus 38.odt');

...
$reportFunction->getDataSurat($odf,$isi1,$connection,'dik');
$reportFunction->getSuratJaksaDik($odf,$_GET['id'],$connection,'J');
$reportFunction->getSuratJaksaDik($odf,$_GET['id'],$connection,'JT');
...
$odf->exportAsAttachedFile('BA 17.odt');

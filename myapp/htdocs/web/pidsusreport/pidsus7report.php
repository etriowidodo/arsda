...
$reportFunction->getSuratDetailDik($odf,$_GET['id'],'SaranPendapat',$connection);
...
//print_r($row);
// We export the file
$odf->exportAsAttachedFile('Pidsus 7 - Tahap Penyidikan.odt');

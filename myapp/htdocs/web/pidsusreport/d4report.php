...
// get info jaksa penuntut umum
$query="select * from pidsus.get_data_jaksa('".$isi9."');";//query to get form's basic setup
//echo $query;
$row = $connection->createCommand($query)->queryOne();
...
$odf->exportAsAttachedFile('D4.odt');
